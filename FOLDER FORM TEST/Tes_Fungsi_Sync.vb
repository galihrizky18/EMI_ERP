Public Class Tes_Fungsi_Sync

    Dim Random As New Random()



    Private Sub Tes_Fungsi_Sync_Load(sender As Object, e As EventArgs) Handles MyBase.Load
...
#Region "PROSES PENGAJUAN PEMUSNAHAN BARANG"
                                ...
                                '=================================================
                                SQL = "insert into N_EMI_Transaksi_Transfer_Waste (kode_perusahaan, No_faktur, Kode_Stock_Owner, Tanggal, Jam, UserID, Lokasi, Keterangan, Flag_Waste_Product) Values "
                                SQL = SQL & "('" & KodePerusahaan & "', '" & Trim(No_Faktur_Waste) & "', '" & SoTujuan & "', "
                                SQL = SQL & "'" & tgl_skg & "', '" & tgl_skg.ToString("HH:mm:ss") & "', '" & UserID & "', "
                                SQL = SQL & "'" & Ket_Lokasi_HO & "', '" & Keterangan_Faktur_Pengajuan & "', 'Y')"
                                ExecuteTrans(SQL)
                                ...
                                Using Ds2 = BindingTrans(SQL)
                                    If Ds2.Tables("MyTable").Rows.Count <> 0 Then
                                        For j As Integer = 0 To Ds2.Tables("MyTable").Rows.Count - 1
                                            ...
                                            SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' "
                                            SQL = SQL & "and No_Faktur = '" & Trim(No_Faktur_Waste) & "' "
                                            ...
                                            Using Dr = OpenTrans(SQL)
                                                ...
                                                Else
                                                    ...
                                                    SQL = SQL & "('" & KodePerusahaan & "', '" & Trim(No_Faktur_Waste) & "', '" & Produk_KdBarang & "', "
                                            ...
                                            SQL = SQL & "kode_Perusahaan='" & KodePerusahaan & "' and "
                                            SQL = SQL & "No_Faktur='" & No_Faktur_Waste & "' and "
                                            ...
                                            Using Ds3 = BindingTrans(SQL)
                                                If Ds3.Tables("MyTable").Rows.Count <> 0 Then
                                                    ...
                                                    For Index As Integer = 0 To Ds3.Tables("MyTable").Rows.Count - 1
                                                        ...
                                                        SQL = SQL & "'" & KodePerusahaan & "', '" & Trim(No_Faktur_Waste) & "', '" & Produk_IDWarehouse_Tujuan & "', "
                                ...
                                Using Ds3 = BindingTrans(SQL)
                                    If Ds3.Tables("MyTable").Rows.Count <> 0 Then
                                        For k As Integer = 0 To Ds3.Tables("MyTable").Rows.Count - 1
                                            ...
                                            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and a.no_Faktur = b.No_Faktur and "
                                            SQL = SQL & "b.Kode_Perusahaan = c.Kode_Perusahaan and b.no_Faktur = c.No_Faktur and b.urut_oto=c.urut_TF "
                                            SQL = SQL & "and a.No_Faktur = '" & No_Faktur_Waste & "' and c.urut_oto = '" & Validasi_Urut_Oto & "'  "
                                            Using Dr = OpenTrans(SQL)
                                                If Dr.Read Then
...
#End Region
                                            ...
                                            SQL = "insert into N_EMI_Transaksi_Transfer_Waste_Det2(kode_perusahaan, No_faktur, Urut_Det, No_Pallet, "
                                            SQL = SQL & "Serial_Number, Jumlah, UserID, Tanggal, Jam, Kode_Voucher, Jumlah_Bags) values( "
                                            SQL = SQL & "'" & KodePerusahaan & "', '" & No_Faktur_Waste & "', '" & Validasi_Urut_Oto & "', "
