...
Public Class Emi_Display_Timbang_FloorScale_Barang_Lain
    ...
    Private Sub Load_Lv()
        Try
            ...
            SQL = SQL & "from EMI_Barang_Masuk_Perpallet_Barang_Lain a, Suppliers c, Barang_Lain d "
    ...
    Private Sub Emi_Display_Timbang_FloorScale_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        If EMI_Timbang_Floor_Scale_Barang_Lain.SerialPort.IsOpen Then
            EMI_Timbang_Floor_Scale_Barang_Lain.SerialPort.Close()
            EMI_Timbang_Floor_Scale_Barang_Lain.SerialPort.Dispose()
        End If
    End Sub
End Class