Public Class N_EMI_Laporan_Pembelian_Asset

    Dim JudulForm As String = "Laporan Pembelian"

    Dim Switch_Auto_Complete As Boolean = True
    ...
    Private Sub Txt_KdSupplier_TextChanged(sender As Object, e As EventArgs) Handles Txt_Faktur.TextChanged
        ...
        Try
            ...
            Lv.SubItems.Add("--- SELURUH ---")
            SQL = "select No_Faktur, Tanggal, UserID from emi_pembelian_barang_lain where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur like '%" & Txt_Faktur.Text & "%' and Status is null "
    ...
    Private Sub BtnCetak_Click(sender As Object, e As EventArgs) Handles BtnCetak.Click
        ...
        Try
            ...
            SQL = "select * from View_Laporan_Pembelian_Asset "
            SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and Tanggal between '" & Format(Tgl1.Value, "yyyy-MM-dd") & "' and '" & Format(Tgl2.Value, "yyyy-MM-dd") & "' "

            SF = "{View_Laporan_Pembelian_Asset.kode_perusahaan} = '" & KodePerusahaan & "' "
            SF = SF & "and {View_Laporan_Pembelian_Asset.Tanggal} >= #" & Format(Tgl1.Value, "yyyy-MM-dd") & "# and "
            SF = SF & "{View_Laporan_Pembelian_Asset.Tanggal} <= #" & Format(Tgl2.Value, "yyyy-MM-dd") & "# "

            If Not Txt_Faktur.Text = "--- SELURUH ---" Then
                SQL = SQL & "and no_faktur = '" & Txt_Faktur.Text & "' "
                SF = SF & "And {View_Laporan_Pembelian_Asset.no_faktur} = '" & Txt_Faktur.Text & "'"
            End If

            If Not Txt_KdSupplier.Text = "--- SELURUH ---" Then
                SQL = SQL & "and kode_supplier = '" & Txt_KdSupplier.Text & "' "
                SF = SF & "And {View_Laporan_Pembelian_Asset.kode_supplier} = '" & Txt_KdSupplier.Text & "'"
            End If

            If Not Txt_KdBarang.Text = "--- SELURUH ---" Then
                SQL = SQL & "and kode_barang = '" & Txt_KdBarang.Text & "' "
                SF = SF & "And {View_Laporan_Pembelian_Asset.kode_barang} = '" & Txt_KdBarang.Text & "'"
            End If
            Using DS = BindingTrans(SQL)
                With DS.Tables("MyTable")
                    If .Rows.Count <> 0 Then

                        Dim CrDoc As New N_EMI_CR_Laporan_Pembelian_Asset
    ...
    Private Sub Txt_Faktur_Leave(sender As Object, e As EventArgs) Handles Txt_Faktur.Leave
        ...
        Try
            ...
            If Not Txt_Faktur.Text = "--- SELURUH ---" Then
                ...
                SQL = "select No_Faktur, Tanggal, UserID from emi_pembelian_barang_lain where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & Txt_Faktur.Text & "' and Status is null "
                Using Dr = Open(SQL)
                    If Dr.Read Then
    ...
    Private Sub Txt_KdBarang_Leave(sender As Object, e As EventArgs) Handles Txt_KdBarang.Leave
        ...
        Try
            ...
            If Not Txt_KdSupplier.Text = "--- SELURUH ---" Then
                ...
                SQL = "select kode_barang, nama from barang_lain where kode_perusahaan = '" & KodePerusahaan & "' and "
