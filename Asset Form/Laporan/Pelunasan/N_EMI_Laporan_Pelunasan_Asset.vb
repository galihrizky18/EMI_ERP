Public Class N_EMI_Laporan_Pelunasan_Asset
    ...
    Private Sub kosong()
        ...
        Txt_UserValidasi.Text = OpsiSeluruh
        Txt_KdPerusahaan.Text = OpsiSeluruh : Txt_NmPerusahaan.Text = OpsiSeluruh
        Txt_KdKategori.Text = OpsiSeluruh : Txt_NmKategori.Text = OpsiSeluruh
    ...
    Private Sub Txt_Faktur_TextChanged(sender As Object, e As EventArgs) Handles Txt_Faktur.TextChanged
        ...
        Try
            ...
            SQL = "select No_Val, Tanggal from EMI_Pelunasan_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Val like '%" & Txt_Faktur.Text & "%' and status is null"
    ...
    Private Sub Txt_KdKategori_TextChanged(sender As Object, e As EventArgs) Handles Txt_KdKategori.TextChanged
        ...
        Try
            ...
            SQL = "select Kode_Master_Kategori_Biaya_Import, Keterangan from Master_Kategori_Biaya_Import_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and Kode_Master_Kategori_Biaya_Import like '%" & Txt_KdKategori.Text & "%'"
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
    ...
    Private Sub Txt_NmKategori_TextChanged(sender As Object, e As EventArgs) Handles Txt_NmKategori.TextChanged
        ...
        Try
            ...
            SQL = "select Kode_Master_Kategori_Biaya_Import, Keterangan from Master_Kategori_Biaya_Import_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and Keterangan like '%" & Txt_NmKategori.Text & "%'"
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    Lv = Lv_Kategori.Items.Add(Dr("Kode_Master_Kategori_Biaya_Import"))
                    Lv.SubItems.Add(If(General_Class.CekNULL(Dr("Keterangan")) = "", "-", Dr("Keterangan")))
    ...
    Private Sub Txt_Faktur_Leave(sender As Object, e As EventArgs) Handles Txt_Faktur.Leave
        ...
        Try
            ...
            If Not Txt_Faktur.Text = "--- SELURUH ---" Then
                ...
                SQL = "select No_Val, Tanggal from EMI_Pelunasan_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Val = '" & Txt_Faktur.Text & "' and status is null"
                Using Dr = Open(SQL)
                    If Dr.Read Then
    ...
    Private Sub Txt_KdKategori_Leave(sender As Object, e As EventArgs) Handles Txt_KdKategori.Leave
        ...
        Try
            ...
            If Not Txt_KdKategori.Text = "--- SELURUH ---" Then
                ...
                SQL = "select Kode_Master_Kategori_Biaya_Import, Keterangan from Master_Kategori_Biaya_Import_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and Kode_Master_Kategori_Biaya_Import = '" & Txt_KdKategori.Text & "'"
                Using Dr = Open(SQL)
                    If Dr.Read Then
    ...
    Private Sub BtnCetak_Click(sender As Object, e As EventArgs) Handles BtnCetak.Click
        ...
        Try
            ...
            SQL = "select * from View_Laporan_Pelunasan_Asset "
            SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and Tanggal between '" & Format(Tgl1.Value, "yyyy-MM-dd") & "' and '" & Format(Tgl2.Value, "yyyy-MM-dd") & "' "

            SF = "{View_Laporan_Pelunasan_Asset.kode_perusahaan} = '" & KodePerusahaan & "' "
            SF = SF & "and {View_Laporan_Pelunasan_Asset.Tanggal} >= #" & Format(Tgl1.Value, "yyyy-MM-dd") & "# and "
            SF = SF & "{View_Laporan_Pelunasan_Asset.Tanggal} <= #" & Format(Tgl2.Value, "yyyy-MM-dd") & "# "

            If Not Txt_Faktur.Text.ToUpper = OpsiSeluruh.ToUpper Then
                SQL = SQL & "and No_Val = '" & Txt_Faktur.Text & "' "
                SF = SF & "And {View_Laporan_Pelunasan_Asset.No_Val} = '" & Txt_Faktur.Text & "'"
            End If

            If Not Txt_UserValidasi.Text.ToUpper = OpsiSeluruh.ToUpper Then
                SQL = SQL & "and UserValidasi = '" & Txt_UserValidasi.Text & "' "
                SF = SF & "And {View_Laporan_Pelunasan_Asset.UserValidasi} = '" & Txt_UserValidasi.Text & "'"
            End If

            If Not Txt_KdPerusahaan.Text.ToUpper = OpsiSeluruh.ToUpper Then
                SQL = SQL & "and kode_perusahaan_Biaya_Import = '" & Txt_KdPerusahaan.Text & "' "
                SF = SF & "And {View_Laporan_Pelunasan_Asset.kode_perusahaan_Biaya_Import} = '" & Txt_KdPerusahaan.Text & "'"
            End If

            If Not Txt_KdKategori.Text.ToUpper = OpsiSeluruh.ToUpper Then
                SQL = SQL & "and kode_master_kategori_biaya_import = '" & Txt_KdKategori.Text & "' "
                SF = SF & "And {View_Laporan_Pelunasan_Asset.kode_master_kategori_biaya_import} = '" & Txt_KdKategori.Text & "'"
            End If
            ...
            Using DS = BindingTrans(SQL)
                With DS.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        ...
                        Dim CrDoc As New N_EMI_CR_Laporan_Pelunasan_Asset
