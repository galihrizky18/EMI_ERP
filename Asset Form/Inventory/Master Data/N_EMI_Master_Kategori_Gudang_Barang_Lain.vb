Public Class N_EMI_Master_Kategori_Gudang_Barang_Lain
    ...
    Dim Lv_Kd_Kategori_Gudang, Lv_Keterangan, Lv_Gudang, Lv_Kd_So_Gudang, Lv_Urut As String
    ...
    Dim item_Kd_So_Gudang As Integer = 4
    ...
    Private Sub N_EMI_Master_Kategori_Gudang_Barang_Lain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Lv_Data.Columns.Add("Kode Kategori Gudang", 160, HorizontalAlignment.Left)
        Lv_Data.Columns.Add("Keterangan", 280, HorizontalAlignment.Left)
        Lv_Data.Columns.Add("Gudang", 150, HorizontalAlignment.Left)
        Lv_Data.Columns.Add("Jenis Gudang", 130, HorizontalAlignment.Center)
        'Hide
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            Lv_Data.Items.Clear()
            SQL = $"
				select a.kode_kategori_gudang, a.kode_Stock_owner_gudang, b.Keterangan as Gudang, a.keterangan, a.Urut_Oto, a.Jenis_Gudang
				...
				order by a.kode_kategori_gudang, a.tanggal, a.jam
			"
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            If Btn_Simpan.Tag.ToString.ToUpper = "SIMPAN" Then
                ...
                '========================================================================
                '=      CEK APAKAH KATEGORI SUDAH MEMILIKI WAREHOUS DAN DEPARTEMETN     =
                '========================================================================
                'SQL = $"
                '    SELECT
                '        CASE
                ...
                'Using Dr = OpenTrans(SQL)
                '    If Dr.Read Then
                '        If Dr("Hasil_Check") = "Y" Then
                '            Dr.Close()
                '            CloseTrans()
                '            CloseConn()
                '            MessageBox.Show($"Gudang Sudah Terpenuhi", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                '            Exit Sub
                '        End If
                '    End If
                'End Using
                ...
                SQL = $"
                    select Kode_Perusahaan from N_EMI_Master_Kategori_Gudang_Barang_Lain
                    where Kode_Perusahaan = '{KodePerusahaan}'
                    and status is null
                    and Kode_Kategori_Gudang = '{Txt_Kd_Kategori.Text.Trim}'
                    and Jenis_Gudang = '{arrJenisGudang(Cmb_Jenis_Gudang.SelectedIndex)}'
                "
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        Dr.Close()
                        CloseTrans()
                        CloseConn()
                        MessageBox.Show($"Gudang Sudah Ada", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                        Exit Sub
                    End If
                End Using
                ...
                SQL = $"
                    ...
                    where Kode_Perusahaan = '{KodePerusahaan}'
                    and status is null
                    and Kode_Stock_Owner_Gudang = '{arrGudang(Cmb_Gudang.SelectedIndex)}'
                "
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        Dr.Close()
                        CloseTrans()
                        CloseConn()
                        MessageBox.Show($"Gudang Sudah Dipakai", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                        Exit Sub
                    End If
                End Using
            ...
            ElseIf Btn_Simpan.Tag.ToString.ToUpper = "UPDATE" Then
                ...
                SQL = $"
					...
					where Kode_Perusahaan = '{KodePerusahaan}'
					and status is null
					and Urut_Oto = '{Txt_Id_Kategori_Gudang.Text.Trim}'
				"
                Using Dr = OpenTrans(SQL)
                    If Not Dr.Read Then
                        Dr.Close()
    ...
    Private Sub Btn_Delete_Click(sender As Object, e As EventArgs) Handles Btn_Delete.Click
        ...
        Try
            ...
            SQL = $"
                ...
                where Kode_Perusahaan = '{KodePerusahaan}'
                and Status is null
                and Id_Kategori_Gudang = '{Txt_Id_Kategori_Gudang.Text.Trim}'
            "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    Dr.Close()
    ...
    Private Sub Txt_Id_Kategori_Gudang_Leave(sender As Object, e As EventArgs) Handles Txt_Id_Kategori_Gudang.Leave
        If Txt_Id_Kategori_Gudang.Text.Trim.Length = 0 Then Exit Sub
        ...
        Try
            ...
            SQL = $"
				...
				where Kode_Perusahaan = '{KodePerusahaan}'
				and Status is null
				and Urut_Oto = '{Txt_Id_Kategori_Gudang.Text}'
			"
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
    ...
    Private Sub Lv_Data_DoubleClick(sender As Object, e As EventArgs) Handles Lv_Data.DoubleClick
        ...
        Txt_Id_Kategori_Gudang.Text = Lv_Urut
        Txt_Id_Kategori_Gudang_Leave(sender, New EventArgs)
