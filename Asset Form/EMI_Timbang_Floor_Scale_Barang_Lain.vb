...
Public Class EMI_Timbang_Floor_Scale_Barang_Lain
    ...
    Private Sub get_data_BM()
        Try
            ...
            SQL = SQL & "EMI_Barang_Masuk_Perpallet_Barang_Lain a, Barang_Lain b "
            ...
            SQL = "select dbo.ubah_satuan_lain('" & KodePerusahaan & "', 'masa','" & TxtKdBarang.Text & "', '" & Satuan_bags & "',"
    ...
    Private Sub get_data_TF()
        Try
            ...
            Dim Satuan_bags As String
            SQL = "select a.jumlah_bags, b.Berat_bags, satuan_berat_bags from "
            SQL = SQL & "tf_stock_det_barang_lain a, Barang_Lain b "
    ...
    Public Sub GetSisaTransfer()
        Try
            ...
            SQL = "select Jumlah_Barang, Jumlah_Bags from tf_stock_det_barang_lain where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & txtKodeTransfer.Text & "' and Urut_Oto = '" & txtUrutOto.Text & "'"
            Using dr = OpenTrans(SQL)
                If dr.Read Then
            ...
            SQL = SQL & "from tf_stock_det2_barang_lain a "
            ...
            '====================================
            Dim sisaJumlah_Kecil As Double = 0
            SQL = "select dbo.ubah_satuan_lain('" & KodePerusahaan & "', 'masa','" & TxtKdBarang.Text & "', '" & Txt_SatuanKecil.Text & "',"
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        If CmbJenisTimbang.Text.Trim.ToUpper = "BARANG MASUK" Then
            ...
            Try
                ...
                'UBAH KE SATUAN PO
                SQL = "select dbo.ubah_satuan_lain('" & KodePerusahaan & "','MASA','" & TxtKdBarang.Text & "',"
        ...
        ElseIf CmbJenisTimbang.Text.Trim.ToUpper = "TRANSFER STOCK" Then
            ...
            Try
                ...
                SQL = SQL & "from Tf_Stock_Parent_Barang_Lain a, tf_stock_Barang_Lain b, tf_stock_det_barang_lain c "
                ...
                SQL = "select dbo.ubah_satuan_lain('" & KodePerusahaan & "', 'masa','" & GetDataKdBrg & "', '" & CmbSatuan.SelectedItem.ToString & "',"
                ...
                SQL = "select Nama,round(good_stock,2) as good_stock, Jumlah_Bags from Barang_Lain where Kode_Perusahaan='" & KodePerusahaan & "' and Kode_Stock_Owner='" & GetSoAwal & "' "
                ...
                Using dr = OpenTrans(SQL)
                    If dr.Read Then
                        ...
                        Else
                            dr.Close()
                            SQL = "update Barang_Lain set Good_Stock = Good_Stock - " & nilai_kecildetail & ", "
                ...
                Using dr = OpenTrans(SQL)
                    If dr.Read Then
                        ...
                        Else
                            dr.Close()
                            SQL = "update barang_lain_sn set jumlah = jumlah - " & nilai_kecildetail & ", "
                            SQL = SQL & "Jumlah_Bags = Jumlah_Bags - " & Val(HilangkanTanda(TxtJumlahBagsDetail.Text)) & " "
                ...
                SQL = "update Barang_Lain set Good_Stock= Good_Stock + " & nilai_kecildetail & ", Jumlah_Bags = Jumlah_Bags + " & Val(HilangkanTanda(TxtJumlahBagsDetail.Text)) & " "
...
#End Region
                ...
                SQL = "insert into tf_stock_det2_barang_lain(kode_perusahaan, No_faktur, Urut_Det, No_Pallet, "
                ...
                SQL = "delete from Cetak_TransferStock_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and "
                SQL = SQL & "Tanggal_Cetak between '" & Format(tglDuaHariSebelum, "yyyy-MM-dd") & "' and '" & Format(tgl_skg, "yyyy-MM-dd") & "' "
                ExecuteTrans(SQL)

                SQL = "insert into Cetak_TransferStock_Barang_Lain (kode_perusahaan, kode_barang, Barcode, Nama, QrUtuh, Qr, Tgl_Expired, batch, tanggal_cetak, kode_unik_print,tanggal_masuk,metode_pengeluaran_stok) values "
        ...
        If CmbJenisTimbang.Text.Trim.ToUpper = "BARANG MASUK" Then
            cetakmasuk()
            Emi_Display_Timbang_FloorScale_Barang_Lain.kosong()
            Me.Close()
        ElseIf CmbJenisTimbang.Text.Trim.ToUpper = "TRANSFER STOCK" Then
            ...
            If result = DialogResult.Yes Then
                ...
                If Val(HilangkanTanda(Txt_Sisa_Jumlah.Text)) = 0 Then
                    ...
                    Try
                        ...
                        SQL = "update tf_stock_det_barang_lain set  "
                        SQL = SQL & "Selesai = 'Y' "
                        SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
                    ...
                    EMI_Display_Transfer_Barang_Lain.kosong()
                    Me.Close()
                    Exit Sub
                End If
    ...
    Private Sub cetaktransfer(ByVal kode_unikPrintBarcode As String)
        Try
            ...
            If CmbJenisTimbang.Text.Trim.ToUpper = "TRANSFER STOCK" Then
                ...
                SQL = "Select a.Kode_Perusahaan from Tf_Stock_Parent_Barang_Lain a, tf_stock_det_barang_lain b where "
                ...
                If Selesai = "Y" Then
                    ...
                    SQL = SQL & "from Vw_Tf_Stock_Detail_Barang_Lain a "
                    SQL = SQL & "where a.Kode_Perusahaan = '" & KodePerusahaan & "' "
                    SQL = SQL & "and a.No_Faktur = '" & txtKodeTransfer.Text & "' "
                    Using Ds = BindingTrans(SQL)
                        If Ds.Tables("MyTable").Rows.Count <> 0 Then

                            CrDoc = New Rpt_EMI_Faktur_Transfer_Stock_Detail_Barang_Lain
                            kertas = "Faktur"
                            ...
                            '    CrDoc.RecordSelectionFormula = "{Vw_Tf_Stock_Detail_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {Vw_Tf_Stock_Detail_Barang_Lain.No_Faktur}='" & txtKodeTransfer.Text & "' "
                ...
                SQL = "select Kode_Perusahaan from Cetak_TransferStock_Barang_Lain where Kode_Perusahaan='" & KodePerusahaan & "' and kode_unik_print='" & kode_unikPrintBarcode & "'"
                Using Ds = BindingTrans(SQL)
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then

                        CrDoc = New NewBarcodeTransferStock_Barang_Lain
                        kertasBarcode = "BarcodeFG"
                        CrDoc.SetDataSource(Ds)
                        CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                        CrDoc.RecordSelectionFormula = "{Cetak_TransferStock_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {Cetak_TransferStock_Barang_Lain.kode_unik_print} = '" & kode_unikPrintBarcode & "' "
    ...
    Private Sub cetakmasuk()
        ...
        Try
            ...
            SQL = SQL & "From EMI_Barang_Masuk_Perpallet_Barang_Lain a,EMI_Barang_Masuk_Perpallet_Detail_Barang_Lain b, Barang_Lain c, EMI_Register_Kendaraan_BM d "
            SQL = SQL & "Where a.Kode_Perusahaan = b.Kode_Perusahaan And a.Kode_Perusahaan = c.Kode_Perusahaan "
            SQL = SQL & "And a.No_Faktur = b.No_Faktur And b.Kode_Stock_Owner = c.Kode_Stock_Owner "
        ...
        Try
            ...
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    ...
                    CrDoc.SetDataSource(Ds)
                    CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                    CrDoc.RecordSelectionFormula = "{Cetak_Barang_Masuk_Perpallet_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {Cetak_Barang_Masuk_Perpallet_Barang_Lain.no_barang_masuk_per_pallet} = '" & txtKodeTransfer.Text & "'  and {Cetak_Barang_Masuk_Perpallet_Barang_Lain.Kode_Unik_Print} = '" & kode_unik_print & "' "
                    ...
                    '    CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                    '    CrDoc.PrintOptions.PrinterName = ""
                    '    CrDoc.RecordSelectionFormula = "{Cetak_Barang_Masuk_Perpallet_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {Cetak_Barang_Masuk_Perpallet_Barang_Lain.no_barang_masuk_per_pallet} = '" & txtKodeTransfer.Text & "'" 'and IsNull({EMI_Barang_Masuk_Perpallet_Barang_Lain.Sdh_Cetak}) "
