Public Class N_EMI_SD_Display_Pelunasan_Hutang_Asset
    ...
    Private Sub LoadDetail(ByVal NoPelunasan As String)
        ...
        Try
            ...
            SQL = SQL & "isnull(( "
            SQL = SQL & "select top 1 y.no_transaksi from EMI_Pelunasan_Detail_DP_Barang_Lain z, EMI_Transaksi_Pembayaran_Dimuka_Detail_Asset x, EMI_Transaksi_Pembayaran_Dimuka_Asset y "
