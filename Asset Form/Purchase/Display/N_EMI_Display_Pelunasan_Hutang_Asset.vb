Public Class N_EMI_Display_Pelunasan_Hutang_Asset
    ...
    Private Sub LvHutangBiaya_DoubleClick(sender As Object, e As EventArgs) Handles LvHutangBiaya.DoubleClick
        ...
        Try
            ...
            SQL = SQL & "from EMI_Pelunasan_Barang_Lain a, EMI_Pelunasan_Detail_Barang_Lain b "
            ...
            Using Ds = BindingTrans(SQL)
                With Ds.Tables("MyTable")
                    If .Rows.Count = 0 Then
                        ...
                        CloseConn()
                        MessageBox.Show("Data Pelunasan Tidak Ditemukan", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                        Exit Sub
                    End If
                End With
            End Using
        ...
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Kosong()
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_NoPO.Text = Lv_NoPemb
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_TanggalPO.Text = Lv_TglPO
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_TanggalJatuhTempo.Text = Lv_JatuhTempo
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_Kategori.Text = Lv_NmKategori
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_Perusahaan.Text = Lv_Perusahaan
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_Keterangan.Text = Lv_Keterangan
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_KdPerusahaanBiayaImport.Text = Lv_KdPerusahaanBiayaImport
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_KdMasterKategori.Text = Lv_KdKategori
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_TotalHutang.Text = Lv_Hutang

        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_MataUang.Text = Lv_MataUang
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_MataUang2.Text = Lv_MataUang
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.Txt_MataUang3.Text = Lv_MataUang

        'EMI_Detail_Hutang_Biaya_Import.Load_Lv()
        N_EMI_SD_Display_Pelunasan_Hutang_Asset.ShowDialog()
    ...
    Private Sub GetData(ByVal Optional Filter As Boolean = False)
        ...
        Try
            ...
            SQL = SQL & "from View_EMI_Pelunasan_Barang_Lain a "
            SQL = SQL & "where a.kode_Perusahaan = '" & KodePerusahaan & "' "
