...
Public Class N_EMI_Validasi_Pemakaian_Stock_Barang_Lain
    ...
    Private Sub Btn_TimbangFloorScale_Click(sender As Object, e As EventArgs) Handles Btn_TimbangFloorScale.Click
        ...
        Try
            ...
            SQL = SQL & "From N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain a, N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain_Detail b, N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain_Det c, barang_lain d Where "
            ...
            SQL = SQL & "from N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain a, N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain_Detail b, N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain_Det c "
            ...
            SQL = "select isnull(Flag_Stock_Rejected, 'T') as Flag_Reject from N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain "
            ...
            SQL = "update N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain_Det set  "
    ...
    Private Sub Btn_Scan_Click(sender As Object, e As EventArgs) Handles Btn_Scan.Click
        ...
        If Txt_QR.Text.Trim.Length = 0 Then
            MessageBox.Show("Silahkan Scan Barcode Terlebih Dahulu", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        ...
        If TanyaInput = vbYes Then
            ...
            Try
                ...
                SQL = SQL & "and a.Kode_Perusahaan='" & KodePerusahaan & "' "
                SQL = SQL & "and a.Jumlah <> 0 "
                SQL = SQL & "and a.qr_code + '-' + a.kode_unik_berjalan ='" & Txt_QR.Text & "' "
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                ...
                SQL = SQL & "Tgl_Expired, Tgl_Produksi, Stock_PO, Stock_Inquiry, Id_Warehouse, id_Susunan, Qr_Code, Kode_Unik_Berjalan, Kode_Unik_Asal, Nomor_Pallet, batch_number, Warna, Stock_Berjalan) "
                SQL = SQL & "select Kode_Perusahaan, '" & GetSoAwal & "', Kode_Barang, '" & SN_Baru & "', 0, 0, "
                SQL = SQL & "Tgl_Expired, Tgl_Produksi, Stock_PO, Stock_Inquiry, '" & available_Id_Warehouse & "', id_Susunan , Qr_Code, '" & newKodeUnikBerjalan & "', "
                SQL = SQL & "Kode_Unik_Asal, '" & available_NoPallet & "', batch_number, '" & warnaLama & "', '" & nilai_kecildetail & "' "
                ...
                ''============================
                ''TAMBAH BARANG
                'SQL = "update barang_lain set Good_Stock= Good_Stock + 0, Jumlah_Bags = Jumlah_Bags + 0 "
                'SQL = SQL & "where Kode_Perusahaan='" & KodePerusahaan & "' and Kode_Stock_Owner='" & GetSoAwal & "' "
                'SQL = SQL & " and Kode_Barang='" & GetDataKdBrg & "'"
                'ExecuteTrans(SQL)
                ...
                SQL = "insert into N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain_Det2 (Kode_Perusahaan, No_Faktur, Urut_Det, No_Pallet, Serial_Number, Jumlah, UserID, Tanggal, Jam) values "
                SQL = SQL & "('" & KodePerusahaan & "', '" & GetDataKodeTransfer & "', '" & GetDataUrutOto & "', '" & available_NoPallet & "', '" & SN_Baru & "', "
                SQL = SQL & "'" & nilai_kecildetail & "', '" & UserID & "', '" & Format(tgl_skg, "yyyy-MM-dd") & "', '" & tgl_skg.ToString("HH:mm:ss") & "')"
                ExecuteTrans(SQL)
    ...
    Private Sub Popup_Timbang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Label1.Text = "Validasi - Pemakaian Stock Asset"
    ...
    Private Sub get_transfer_stock()
        Try
            ...
            SQL = SQL & "From N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain a, N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain_Detail b, N_EMI_Transaksi_Pemakaian_Stock_Barang_Lain_Det c, barang_lain d, barang_lain_sn e Where "
            SQL = SQL & "a.kode_Perusahaan = b.kode_Perusahaan And a.no_faktur = b.no_faktur And "
            SQL = SQL & "b.kode_Perusahaan = c.kode_Perusahaan And b.no_faktur = c.no_faktur And b.Urut_Oto = c.urut_TF "
            SQL = SQL & "And b.Kode_Barang=d.Kode_Barang And a.Kode_Stock_Owner=d.kode_stock_Owner And b.kode_Perusahaan=d.Kode_Perusahaan "
            SQL = SQL & "And a.status Is null and c.selesai is null "
