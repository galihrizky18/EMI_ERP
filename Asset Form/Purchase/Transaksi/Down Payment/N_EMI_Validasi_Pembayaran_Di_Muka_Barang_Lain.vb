Public Class N_EMI_Validasi_Pembayaran_Di_Muka_Barang_Lain
    ...
    Private Sub ValidasiToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ValidasiToolStripMenuItem.Click
        ...
        Try
            ...
            If CekButtonRole("Validasi_Pembelian_Down_Payment_Aset") = "T" Then
                CloseTrans()
                CloseConn()
            ...
            SQL = "update Emi_Pembelian_barang_lain set "
    ...
    Private Sub Btn_Cari_Click(sender As Object, e As EventArgs) Handles Btn_Cari.Click
        Try
            ...
            SQL = SQL & "a.Grand_Sebelum_PPN as Jumlah_Hutang, a.PPN, a.Nilai_PPN, a.Grand, a.Nilai_DP "
            SQL = SQL & "From emi_pembelian_barang_lain a, EMI_Pembelian_PO_barang_lain b, Suppliers c  where "
            ...
            SQL = SQL & "and a.kode_perusahaan = '" & KodePerusahaan & "' and a.Status is null and a.Nilai_DP<>0 and Validasi_DP is null "
    ...
    Private Sub kosong()
        ...
        Cmb_Order.Items.Add("Supplier") : arrcari.Add("c.nama")
        Cmb_Order.Items.Add("Tanggal PO") : arrcari.Add("b.tanggal_release")
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_Pembelian.SelectedIndexChanged
        Try
            ...
            SQL = SQL & "From EMI_Pembelian_Detail2_barang_lain a, barang_lain b "
