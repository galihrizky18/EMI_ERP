...
Public Class N_EMI_Display_Purchase_Requisition_Barang_Lain_Departement
    ...
    Private Sub BtnBarangMasuk_Cari_Click(sender As Object, e As EventArgs) Handles BtnBarangMasuk_Cari.Click
        Try
            ...
            'SQL = "select a.No_Faktur, a.tanggal, a.tanggal_release, a.keterangan, a.userid, a.Flag_Release, a.Status, 'ada kode' as Jenis "
            'SQL = SQL & "from N_EMI_Purchase_Requisition_Barang_Lain_Departement a, N_EMI_Purchase_Requisition_Barang_Lain_Departement_Detail b, "
            'SQL = SQL & "Barang_Lain c, View_Kategori_Turunan d, N_EMI_Master_Kategori_Gudang_Binding_User_Barang_Lain e "
            'SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and a.No_Faktur = b.No_Faktur and b.Kode_Perusahaan = c.Kode_Perusahaan and "
            'SQL = SQL & "b.Kode_Stock_Owner = c.Kode_Stock_Owner and b.Kode_Barang = c.Kode_Barang and c.Kode_Perusahaan = d.Kode_Perusahaan and "
            'SQL = SQL & "c.Id_Sub_Kategori_Jenis_3 = d.Id_Sub_Kategori_Jenis_3 and a.kode_perusahaan = e.kode_perusahaan "
            'SQL = SQL & "and a.Kode_Kategori_GUdang = e.Kode_Kategori_GUdang  "

            'SQL = SQL & "and e.kode_kategori_gudang in (" & inGudang & ") "

            ''SQL = SQL & "and a.userid = '" & UserID & "' "
            'SQL = SQL & "and a.Kode_Perusahaan = '" & KodePerusahaan & "' and b.Kode_Barang <> '-' "
            ...
            'SQL = SQL & "union all "
            'SQL = SQL & "select a.No_Faktur, a.tanggal, a.tanggal_release, a.keterangan, a.userid, a.Flag_Release, a.Status, 'tidak ada kode' as Jenis "
            'SQL = SQL & "from N_EMI_Purchase_Requisition_Barang_Lain_Departement a, N_EMI_Purchase_Requisition_Barang_Lain_Departement_Detail b, "

            'SQL = SQL & "N_EMI_View_Master_Kategori_Gudang_Binding_Departement_Barang_Lain c "

            'SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and a.No_Faktur = b.No_Faktur "
            'SQL = SQL & "and a.Kode_Perusahaan = '" & KodePerusahaan & "' and b.Kode_Barang = '-' "
            'SQL = SQL & "and c.Kode_Perusahaan = a.Kode_Perusahaan and c.Kode_Kategori_Gudang = a.Kode_Kategori_Gudang    "


            'SQL = SQL & "and c.kode_kategori_gudang in (" & inGudang & ") "
