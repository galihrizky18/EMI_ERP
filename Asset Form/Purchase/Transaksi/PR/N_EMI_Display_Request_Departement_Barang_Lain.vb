Public Class N_EMI_Display_Request_Departement_Barang_Lain
    ...
    Private Sub CariXXX(ByVal semua As String)
        Try
            OpenConn()
            ...
            SQL = SQL & "Barang_Lain e, View_Kategori_Turunan f, N_EMI_View_Master_Kategori_Gudang_Binding_Barang_Lain g "
            SQL = SQL & "where a.Kode_Perusahaan = '" & KodePerusahaan & "' and d.Status is null "
            SQL = SQL & "and a.Kode_Perusahaan = b.Kode_Perusahaan and a.Id_Cost_Center = b.Id_Cost_Center and a.Kode_Perusahaan = e.Kode_Perusahaan and "

            SQL = SQL & "a.Kode_Stock_Owner = e.Kode_Stock_Owner and a.Kode_Barang = e.Kode_Barang and e.Kode_Perusahaan = f.Kode_Perusahaan and "
