...
Public Class Emi_Display_Barang_Penawaran_Barang_Lain
    ...
    Private Sub kosong()
        If dari = "Transaksi Penawaran Lain" Then
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            '==========================================================
            arrDvUtama.Clear()
            For i As Integer = 0 To Transaksi_Penawaran_Barang_Lain.DgvMaster_Penawaran.Rows.Count - 1
                arrDvUtama.Add(Transaksi_Penawaran_Barang_Lain.DgvMaster_Penawaran.Rows(i).Cells(0).Value)
            Next
            ...
            Lv_Data.Items.Clear()
            SQL = ";with cte as( "
            SQL = SQL & "(select a.kode_perusahaan, a.kode_barang, a.Nama, a.Flag_PPN, "
            SQL = SQL & "ISNULL((Select top(1)'Y' from EMI_Master_Penawaran_Barang_Lain x, EMI_Master_Penawaran_Detail_Barang_Lain y where x.Kode_Perusahaan = y.Kode_Perusahaan And x.No_Faktur = y.No_Faktur "
            ...
            SQL = SQL & "ISNULL((select z.satuan from barang_Detail_Satuan_lain z where z.Kode_Perusahaan = a.Kode_Perusahaan and z.Kode_barang = a.Kode_Barang and Flag_Tampil_Display = 'Y'), '-') as satuan_display "
            ...
            SQL = SQL & "group by a.kode_perusahaan, a.kode_barang, a.Nama, a.Flag_PPN ) "
            SQL = SQL & "union all "
            SQL = SQL & "(select a.kode_perusahaan, a.kode_barang, a.Nama, a.Flag_PPN, "
            SQL = SQL & "ISNULL((Select top(1)'Y' from EMI_Master_Penawaran_Barang_Lain x, EMI_Master_Penawaran_Detail_Barang_Lain y where x.Kode_Perusahaan = y.Kode_Perusahaan And x.No_Faktur = y.No_Faktur "
            SQL = SQL & "And x.Selesai Is null And '" & Format(tgl_skg, "yyyy-MM-dd") & "' between x.Tgl_Penawaran_Hrg And Periode_Akhir_Penawaran And y.Kode_Perusahaan = a.Kode_Perusahaan And y.Kode_Barang = a.Kode_Barang),null) As ada_data, "
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            Transaksi_Penawaran_Barang_Lain.arrKdBarangPilihBarang.Clear()
            Transaksi_Penawaran_Barang_Lain.arrNamaBarangPilihBarang.Clear()
            Transaksi_Penawaran_Barang_Lain.arrSatuanPilihBarang.Clear()
            Transaksi_Penawaran_Barang_Lain.arrPPN.Clear()
            ...
            For i As Integer = 0 To arrSelectedBarang.Count - 1
                ...
                Transaksi_Penawaran_Barang_Lain.arrKdBarangPilihBarang.Add(itemData(0))
                Transaksi_Penawaran_Barang_Lain.arrNamaBarangPilihBarang.Add(itemData(1))
                Transaksi_Penawaran_Barang_Lain.arrSatuanPilihBarang.Add(itemData(2))
                Transaksi_Penawaran_Barang_Lain.arrPPN.Add(itemData(3))

            Next

            Transaksi_Penawaran_Barang_Lain.LoadDataPenawaran()
