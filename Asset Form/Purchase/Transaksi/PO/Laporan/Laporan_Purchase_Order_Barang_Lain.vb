Public Class Laporan_Purchase_Order_Barang_Lain
    ...
    Private Sub Kosong()
        ...
        Cmb_ParamLain.Items.Add("User Created") : arrParamLain.Add("User_Created") : arrParamLainSF.Add("{View_Laporan_Sub_PO_Barang_Lain.User_Created}")
        Cmb_ParamLain.Items.Add("User Release") : arrParamLain.Add("User_Release") : arrParamLainSF.Add("{View_Laporan_Sub_PO_Barang_Lain.User_Release}")
    ...
    Private Sub Txt_Faktur_TextChanged(sender As Object, e As EventArgs) Handles Txt_Faktur.TextChanged
        ...
        Try
            ...
            Lv.SubItems.Add("--- SELURUH ---")
            SQL = "select No_Faktur, No_Nota, Tanggal from EMI_Pembelian_PO_Barang_Lain where Kode_Perusahaan ='" & KodePerusahaan & "' and No_Faktur like '%" & Txt_Faktur.Text & "%' and Status is null "
    ...
    Private Sub Txt_Faktur_Leave(sender As Object, e As EventArgs) Handles Txt_Faktur.Leave
        ...
        Try
            ...
            If Not Txt_Faktur.Text = "--- SELURUH ---" Then
                ...
                SQL = "select No_Faktur, No_Nota, Tanggal from EMI_Pembelian_PO_Barang_Lain where Kode_Perusahaan ='" & KodePerusahaan & "' and No_Faktur = '" & Txt_Faktur.Text & "' and Status is null "
                Using Dr = Open(SQL)
                    If Dr.Read Then
    ...
    Private Sub BtnCetak_Click(sender As Object, e As EventArgs) Handles BtnCetak.Click
        ...
        Try
            ...
            SQL = "select kode_perusahaan from View_Laporan_Sub_PO_Barang_lain  "
            ...
            SF = "{View_Laporan_Sub_PO_Barang_Lain.kode_perusahaan} = '" & KodePerusahaan & "' "
            SF = SF & "and {View_Laporan_Sub_PO_Barang_Lain." & arrTanggal(Cmb_Periode.SelectedIndex) & "} >= #" & Format(Tgl1.Value, "yyyy-MM-dd") & "# and "
            SF = SF & "{View_Laporan_Sub_PO_Barang_Lain." & arrTanggal(Cmb_Periode.SelectedIndex) & "} <= #" & Format(Tgl2.Value, "yyyy-MM-dd") & "# "

            If Not Cmb_Status.SelectedIndex = 0 Then

                If Cmb_Status.SelectedIndex = 1 Then
                    SQL = SQL & "and Status_PO = 'COMPLETED' "
                    SF = SF & "And {View_Laporan_Sub_PO_Barang_Lain.Status_PO} = 'COMPLETED' "
                ElseIf Cmb_Status.SelectedIndex = 2 Then
                    SQL = SQL & "and Status_PO = 'SUBMITED' "
                    SF = SF & "And {View_Laporan_Sub_PO_Barang_Lain.Status_PO} = 'SUBMITED' "

                ElseIf Cmb_Status.SelectedIndex = 3 Then
                    SQL = SQL & "and Status_PO = 'UNSUBMITED' "
                    SF = SF & "And {View_Laporan_Sub_PO_Barang_Lain.Status_PO} = 'UNSUBMITED' "
                End If
            ...
            If Not Txt_Faktur.Text = "--- SELURUH ---" Then
                ...
                SF = SF & "And {View_Laporan_Sub_PO_Barang_Lain.no_faktur} = '" & Txt_Faktur.Text & "'"
            End If

            If Not Txt_KdSupplier.Text = "--- SELURUH ---" Then
                SQL = SQL & "and Kode_Supplier = '" & Txt_KdSupplier.Text & "' "
                SF = SF & "And {View_Laporan_Sub_PO_Barang_Lain.Kode_Supplier} = '" & Txt_KdSupplier.Text & "'"
            End If

            If Not Txt_KdBarang.Text = "--- SELURUH ---" Then
                SQL = SQL & "and Kode_Barang = '" & Txt_KdBarang.Text & "' "
                SF = SF & "And {View_Laporan_Sub_PO_Barang_Lain.Kode_Barang} = '" & Txt_KdBarang.Text & "'"
            End If
            ...
            Using DS = BindingTrans(SQL)
                With DS.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        ...
                        Dim CrDoc As New Rpt_Laporan_Sub_PO_Barang_Lain
