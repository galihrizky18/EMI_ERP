Public Class EMI_Pembelian_PR_Summary_Data_Barang_Lain
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_PR.SelectedIndexChanged
        Try
            ...
            SQL = SQL & "isnull((select sum(y.Jumlah) from EMI_Pembelian_PO_Barang_Lain x, EMI_Pembelian_PO_Det_Barang_Lain y "
            ...
            SQL = SQL & "From EMI_Purchase_Requisition_Barang_Lain_Detail a, barang_Lain b "
            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and "
            SQL = SQL & "a.Kode_Stock_Owner = b.Kode_Stock_Owner  and a.Kode_Barang = b.Kode_Barang "
            SQL = SQL & "and a.kode_perusahaan = '" & KodePerusahaan & "' "
            ...
            SQL = SQL & "from EMI_Purchase_Requisition_Barang_Lain a, EMI_Purchase_Requisition_Barang_Lain_Detail b,EMI_Pembelian_PO_Det_Induk_Barang_Lain c,EMI_Pembelian_PO_Induk_Barang_Lain d  "
    ...
    Private Sub CetakUlangToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangToolStripMenuItem.Click
        ...
        Try
            ...
            SQL = "select Kode_Perusahaan, No_Faktur from N_EMI_Transaksi_Purchase_Requisition_Barang_Lain_View "
            SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' "
                ...
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    With Ds.Tables(0)
                        ...
                        With A_Place_For_Printing2
                            ...
                            CrDoc.RecordSelectionFormula = " {N_EMI_Transaksi_Purchase_Requisition_Barang_Lain_View.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_Transaksi_Purchase_Requisition_Barang_Lain_View.No_Faktur} = '" & Lv_PR.FocusedItem.Text & "'"
    ...
    Private Sub BatalToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BatalToolStripMenuItem.Click
        ...
        Try
            ...
            If CekButtonRole("Pembatalan_PR_Barang_Lain") = "T" Then
                CloseTrans()
                CloseConn()
            ...
            SQL = SQL & "EMI_Purchase_Requisition_Barang_Lain_Detail b,EMI_Pembelian_PO_Det_Induk_Barang_Lain c,EMI_Pembelian_PO_Induk_Barang_Lain d "
