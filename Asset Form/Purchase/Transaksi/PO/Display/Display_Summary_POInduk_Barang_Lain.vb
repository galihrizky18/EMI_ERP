...
Public Class Display_Summary_POInduk_Barang_Lain
    ...
    Private Sub CetakUlangToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangToolStripMenuItem.Click
        ...
        Try
            ...
            '==================================
            SQL = "update EMI_Pembelian_PO_Induk_barang_lain set Jumlah_Print = isnull(Jumlah_Print,0) + 1 where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & Lv_PO.FocusedItem.Text & "'"
            ExecuteTrans(SQL)
    ...
    Private Sub Lv_PO_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_PO.SelectedIndexChanged
        ...
        Try
            ...
            SQL = SQL & "FROM EMI_Pembelian_PO_Detail_Induk_Barang_Lain a, barang_lain b "
    ...
    Private Sub BatalToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BatalToolStripMenuItem.Click
        ...
        Try
            ...
            '=     CEK BUTTON ROLE     =
            '===========================
            If CekButtonRole("Pembatalan_POInduk_Barang_Lain") = "T" Then
                CloseTrans()
                CloseConn()
            ...
            '==========================================
            SQL = "select Status from EMI_Pembelian_PO_Induk_Barang_Lain "
            ...
            SQL = SQL & "from EMI_Pembelian_PO_Induk_Barang_Lain a, EMI_Pembelian_PO_det_Induk_Barang_Lain b, EMI_Pembelian_PO_Det_Barang_Lain c, EMI_Pembelian_PO_Barang_Lain d "
            ...
            SQL = SQL & "EMI_Pembelian_PO_det_Induk_barang_lain where "
            ...
            Using ds = BindingTrans(SQL)
                With ds.Tables("MyTable")
                    For index = 0 To .Rows.Count - 1
                        ...
                        SQL = "Update EMI_Purchase_Requisition_Barang_Lain_Detail set Flag_Sudah_PO = null where "
                        SQL = SQL & "Kode_Perusahaan = '" & KodePerusahaan & "' and "
            ...
            '==================================
            SQL = "update EMI_Pembelian_PO_Induk_barang_lain set Status = 'Y', "
    ...
    Private Sub SelesaiToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelesaiToolStripMenuItem.Click
        ...
        Try
            ...
            If CekButtonRole("Penyelesaian_POInduk_Barang_Lain") = "T" Then
                CloseTrans()
                CloseConn()
            ...
            '=======================================
            SQL = "select Selesai from EMI_Pembelian_PO_Induk_Barang_Lain  "
            SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & Lv_PO.FocusedItem.Text & "' "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    If General_Class.CekNULL(Dr("Selesai")) = "Y" Then
            ...
            '========================================
            SQL = "update EMI_Pembelian_PO_Induk_barang_lain set Selesai = 'Y', UserID_Selesai = '" & UserID & "', "
