...
Public Class EMI_PO_Pembelian_Display_View_Barang_Lain
    ...
    Private Sub Cari()
        Try
            ...
            SQL = SQL & "),0) as jumlah "
            SQL = SQL & "From EMI_Purchase_Requisition_Barang_Lain a, EMI_Purchase_Requisition_Detail_Barang_Lain b ,barang_lain c, Emi_Role_Kategori_PO d "
        ...
        For indexDisplayUserPO As Integer = 0 To Dgv_Pr.Rows.Count - 1
            ...
            If Dgv_Pr.Rows(indexDisplayUserPO).Cells(0).Value = True Then
                ...
                For i As Integer = 0 To EMI_PO_Pembelian.LvPO_DataPO.Items.Count - 1
                    ...
                    If EMI_PO_Pembelian.LvPO_DataPO.Items(i).SubItems(cellPO_KdBarang).Text = Dgv_Pr.Rows(indexDisplayUserPO).Cells(3).Value Then

                        'cek di lv emi po apakah sudah ada data yang sama atau belum
                        If EMI_PO_Pembelian.LvPO_DataPO.Items(i).SubItems(cellPO_Satuan).Text <> Dgv_Pr.Rows(indexDisplayUserPO).Cells(9).Value Then
                        ...
                        If EMI_PO_Pembelian.LvPO_DataPO.Items(i).SubItems(cellPO_ID).Text = "T" Then
                            ...
                            If EMI_PO_Pembelian.LvPO_DataPO.Items(i).SubItems(cellPO_NoPenawaran).Text = Dgv_Pr.Rows(indexDisplayUserPO).Cells(10).Value Then
                                If EMI_PO_Pembelian.LvPO_DataPO.Items(i).SubItems(cellPO_PR).Text = Dgv_Pr.Rows(indexDisplayUserPO).Cells(11).Value Then
