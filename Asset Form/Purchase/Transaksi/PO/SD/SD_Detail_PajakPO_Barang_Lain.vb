Public Class SD_Detail_PajakPO_Barang_Lain
    ...
    Private Sub GetData()
        Try
            ...
            '=======================================
            SQL = "select Kode_Perusahaan from EMI_Pembelian_PO_Induk_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & No_Fak & "' "
            Using Ds = BindingTrans(SQL)
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then

                        SQL = "select a.No_Faktur, a.Persentase, b.Keterangan "
                        SQL = SQL & "from EMI_Detail_PPH_PO_Induk_Barang_Lain a, EMI_Master_Pajak b "
