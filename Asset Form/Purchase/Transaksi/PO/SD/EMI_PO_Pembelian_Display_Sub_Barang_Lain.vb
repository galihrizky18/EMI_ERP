Public Class EMI_PO_Pembelian_Display_Sub_Barang_Lain
    ...
    Public Sub Cari(ByVal semua As String)
        Try
            ...
            SQL = SQL & "FROM rencana_order_Barang_Lain ro, suppliers s, emi_pembelian_Po_Barang_Lain c "
                ...
                With ds.Tables("MyTable")
                    For index = 0 To .Rows.Count - 1
                        ...
                        If General_Class.CekNULL(.Rows(index).Item("Flag_Submit_PO")) = "" Then
                            ...
                            SQL = SQL & " FROM rencana_order_Barang_Lain ro WHERE "
                        ...
                        If General_Class.CekNULL(.Rows(index).Item("Flag_Submit_PO")) = "Y" Or General_Class.CekNULL(.Rows(index).Item("Flag_Loading_Barang")) = "Y" Then
                            ...
                            SQL = SQL & " FROM submit_PO_Barang_Lain bi, rencana_order_Barang_Lain ro WHERE bi.id_rencana = ro.id_rencana and bi.status is null and "
                            SQL = SQL & " ro.kode_perusahaan = '" & KodePerusahaan & "' AND ro.id_rencana = '" & .Rows(index).Item("id_rencana") & "'  "
                        ...
                        If General_Class.CekNULL(.Rows(index).Item("Flag_OTW")) = "Y" Then
                            ...
                            SQL = SQL & " from rencana_order_Barang_Lain a, ubah_status_otw_Barang_Lain b  "
                        ...
                        If General_Class.CekNULL(.Rows(index).Item("Flag_Draft")) = "Y" Then
                            ...
                            SQL = SQL & " from Rencana_Order_Barang_Lain a, Tracking_Dokumen_Barang_Lain b  "
                            SQL = SQL & " where a.kode_perusahaan = b.kode_perusahaan and a.id_rencana = b.id_rencana and a.kode_perusahaan = '" & KodePerusahaan & "' and a.id_rencana = '" & .Rows(index).Item("id_rencana") & "'  "
                        ...
                        If General_Class.CekNULL(.Rows(index).Item("Flag_Kapal_Tiba")) = "Y" Then
                            ...
                            SQL = SQL & " FROM kapal_tiba_import_Barang_Lain kt, rencana_order_Barang_Lain ro , pelabuhan p "
                        ...
                        If Penjaluran = "Y" Then
                            ...
                            SQL = SQL & " , 'Penjaluran' as status from Rencana_Order_Barang_Lain a,penjaluran_import_Barang_Lain b  "
                        ...
                        If General_Class.CekNULL(.Rows(index).Item("Flag_SPPB")) = "Y" Then
                            ...
                            SQL = SQL & " ' )'  "
                            SQL = SQL & " ) as Keterangan , 'SPPB' as status from  rencana_order_Barang_Lain a ,sppb_import_Barang_Lain b "
                            SQL = SQL & " where a.kode_perusahaan = b.kode_perusahaan and a.id_rencana = b.id_rencana and "
                            SQL = SQL & " a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.ID_Rencana = '" & .Rows(index).Item("id_rencana") & "' "
                        ...
                        If General_Class.CekNULL(.Rows(index).Item("Flag_Tarik_Kontainer")) = "Y" Then
                            SQL = " SELECT top 1 ('Tgl Tarik Terakhir : '+ format(ISNULL((select top 1 tgl_tarik from tarik_kontainer_Barang_Lain where id_rencana ='" & .Rows(index).Item("id_rencana") & "' and kode_perusahaan ='" & KodePerusahaan & "'),"
                            SQL = SQL & " (select top 1 tgl_tarik from tarik_kontainer_Barang_Lain where id_rencana ='" & .Rows(index).Item("id_rencana") & "' and kode_perusahaan ='" & KodePerusahaan & "')),'dd MMM yyyy')"
                            SQL = SQL & " )as keterangan, 'Tarik Kontainer' as status "
                            SQL = SQL & " FROM tarik_kontainer_Barang_Lain tk, rencana_order_Barang_Lain ro WHERE tk.id_rencana = ro.id_rencana and "
                            SQL = SQL & " ro.kode_perusahaan = '" & KodePerusahaan & "' AND ro.id_rencana = '" & .Rows(index).Item("id_rencana") & "' "
                        ...
                        If General_Class.CekNULL(.Rows(index).Item("Flag_Bongkar")) = "Y" Or General_Class.CekNULL(.Rows(index).Item("Flag_sudah_Transaksi")) = "Y" _
                            ...
                            SQL = SQL & " FROM bongkar_import_Barang_Lain bi, rencana_order_Barang_Lain ro WHERE bi.id_rencana = ro.id_rencana and  "
                            SQL = SQL & " ro.kode_perusahaan = '" & KodePerusahaan & "' AND ro.id_rencana = '" & .Rows(index).Item("id_rencana") & "'  "
