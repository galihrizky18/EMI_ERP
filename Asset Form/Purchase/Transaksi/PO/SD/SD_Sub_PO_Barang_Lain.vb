Public Class SD_Sub_PO_Barang_Lain
    ...
    Private Sub Lv_Data_Induk_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_Data_Induk.SelectedIndexChanged
        ...
        Try
            ...
            SQL = SQL & "from EMI_Pembelian_PO_Induk_Barang_Lain a, EMI_Pembelian_PO_Det_Induk_Barang_Lain b, Barang_lain c "
    ...
    Public Sub Ambil_Data_Induk(ByVal isBahan As Boolean, Optional ByVal KdBarang As String = "")
        ...
        Try
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    EMI_PO_Pembelian_Sub_Barang_Lain.Txt_Faktur_Induk.Text = Dr("No_Faktur")
                    'EMI_PO_Pembelian_Sub_barang_lain.DtpPO_Tgl.Value = Dr("Tanggal_Release")
                    'EMI_PO_Pembelian_Sub_barang_lain.DtpPO_ETD.Value = Dr("ETD_Simulasi")
                    EMI_PO_Pembelian_Sub_Barang_Lain.TxtPO_NoNota.Text = Dr("Keterangan")
                    EMI_PO_Pembelian_Sub_Barang_Lain.TxtPO_KdSupplier.Text = Dr("Kode_Supplier")
                    EMI_PO_Pembelian_Sub_Barang_Lain.TxtPO_NmSupplier.Text = Dr("Nama_Supplier")
                    EMI_PO_Pembelian_Sub_Barang_Lain.CmbPO_MataUang.Text = Dr("Mata_Uang")
                    EMI_PO_Pembelian_Sub_Barang_Lain.CmbPO_JnsBayar.SelectedIndex = EMI_PO_Pembelian_Sub_Barang_Lain.arrPembayaran.IndexOf(Dr("Jenis_Pembayaran"))
                    EMI_PO_Pembelian_Sub_Barang_Lain.cmbJenisPengiriman.SelectedItem = Dr("Tempo_Pembayaran")
                    EMI_PO_Pembelian_Sub_Barang_Lain.txtJatuhTempo.Text = Dr("Lama_Pembayaran")
                    EMI_PO_Pembelian_Sub_Barang_Lain.PPN = Dr("PPN")
                    EMI_PO_Pembelian_Sub_Barang_Lain.TxtPO_PersenPPN.Text = Dr("PPN")

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvSupplier2.Visible = False

                    EMI_PO_Pembelian_Sub_Barang_Lain.CmbPO_MataUang.Enabled = False
                    EMI_PO_Pembelian_Sub_Barang_Lain.TxtPO_NoNota.Focus()
                Else
                    Dr.Close()
                    CloseConn()
        ...
        Try
            ...
            '=     GET DATA BARANG     =
            '===========================
            Dim index As Integer = EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows.Count
            ...
            SQL = SQL & "and x.no_urut_pr=d.no_urut_pr and x.urut_det_induk = d.No_Urut and z.status is null), d.Jumlah) as Sisa, d.No_Urut as Urut_det, '-' as Jenis_Kategori "

            SQL = SQL & "from EMI_Pembelian_PO_Induk_Barang_Lain a, barang_lain c, EMI_Pembelian_PO_Det_Induk_Barang_Lain d " ', kategori_besar e "
            ...
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    ...
                    '===================================
                    If EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows.Count <> 0 Then
                        If Not EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(0).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellJnsKategori).Value = Dr("Jenis_Kategori") Then
                            CloseConn()
                    ...
                    'TODD :Perhatikan ini
                    For i As Integer = 0 To EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows.Count - 1
                        If EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(i).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellFakInduk).Value = Dr("No_Faktur") _
                            And EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(i).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_KdBarang).Value = Dr("Kode_Barang") _
                            And EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(i).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellUrutDet).Value = Dr("Urut_det") _
                            And EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(i).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Harga).Value = Dr("Harga_Satuan_Besar") Then

                            Continue Do
                        End If
                    Next

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows.Add(1)

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Lokasi).Value = Dr("Kode_Stock_Owner")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_KdBarang).Value = Dr("Kode_Barang")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_NmBarang).Value = Dr("Nama")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Harga).Value = Format(Dr("Harga_Satuan_Besar"), "N4")

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_JumlahPO).Value = Format(Dr("Jumlah"), "N2")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Sisa).Value = Format(Dr("Sisa"), "N2")

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Jumlah).Value = Format(0, "N2") 'user isi

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Satuan).Value = Dr("Satuan")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Harga_SB).Value = Dr("Harga_Barang")

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Jumlah_SB).Value = 0 ' generate berdasaerkan jumlah

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Satuan_SB).Value = Dr("Satuan_Barang")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_NoPenawaran).Value = Dr("No_Penawaran")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_ID).Value = "T"

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Total).Value = Format(0, "N2") 'TOtal auto generate jumlah * harga
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Urut).Value = ""
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_PR).Value = Dr("No_Urut_PR")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellTempoPembayaran).Value = Dr("Tempo_Pembayaran")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellJatuhTempo).Value = Dr("Lama_Pembayaran")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellFakPenawaran).Value = Dr("No_Penawaran")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellFakInduk).Value = Dr("No_Faktur")
                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellUrutDet).Value = Dr("Urut_det")

                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellJnsKategori).Value = Dr("Jenis_Kategori")


                    EMI_PO_Pembelian_Sub_Barang_Lain.LvPO_DataPO.Rows(index).Cells(EMI_PO_Pembelian_Sub_Barang_Lain.cellPO_Jumlah).Style.BackColor = Color.LightGray
        ...
        EMI_PO_Pembelian_Sub_Barang_Lain.disableSebagian()
        EMI_PO_Pembelian_Sub_Barang_Lain.Cmb_Ekspedisi.Enabled = True
        Me.Close()
