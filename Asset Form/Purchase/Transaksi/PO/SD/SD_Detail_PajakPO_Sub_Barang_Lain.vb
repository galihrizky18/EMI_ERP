Public Class SD_Detail_PajakPO_Sub_Barang_Lain
    ...
    Private Sub GetData()
        ...
        Try
            ...
            Lv_Data.Items.Clear()
            If asal = "SUBPO" Then
                SQL = "select Persentase, Kode_Tarif from EMI_Detail_PPH_PO_Induk_Barang_Lain where kode_perusahaan = '" & KodePerusahaan & "' and no_faktur = '" & Txt_NoFakInduk.Text & "' and flag_ppn is null"
            ElseIf asal = "PEMBELIAN" Then
                SQL = "select Persentase, Kode_Tarif from EMI_Detail_PPH_PO_Barang_Lain where kode_perusahaan = '" & KodePerusahaan & "' and No_Faktur_Induk = '" & Txt_NoFakInduk.Text & "' and No_Faktur = '" & No_FakturSub.Text & "' and flag_ppn is null"
            End If
