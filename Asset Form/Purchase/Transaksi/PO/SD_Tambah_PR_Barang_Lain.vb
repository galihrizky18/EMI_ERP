...
Public Class SD_Tambah_PR_Barang_Lain
    ...
    Private Sub Btn_Simpan_Click_1(sender As Object, e As EventArgs) Handles BtnPilihBarang_Simpan.Click
        ...
        ElseIf asal = "Purchase_Requisition_Barang_Lain" Then
            ...
            If isAsset Then
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(9).Value = Txt_Id_CostCenter.Text
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(10).Value = Txt_IdGedung.Text
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(12).Value = Txt_CostCenter.Text
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(13).Value = Txt_Gedung.Text
            Else
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(9).Value = Ket_Cost_Center_HO_Proyek
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(10).Value = ""
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(12).Value = "-"
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(13).Value = "-"
            End If

            Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(11).Value = Cmb_Stock.Text

            If Cmb_Stock.Text = "Y" Then
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(14).Value = "Stock"
            Else
                Purchase_Requisition_Barang_Lain.Dgv_DataBarang.Rows(index).Cells(14).Value = "Non Stock"
            End If
