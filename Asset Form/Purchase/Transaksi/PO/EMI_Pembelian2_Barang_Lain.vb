Public Class EMI_Pembelian2_Barang_Lain
    ...
    Private Sub Generate_Faktur_Pelunasan()
        Txt_Faktur_Pelunasan.Text = fValPelBL & Format(tgl_skg, "MMyy") & "-" &
                             General_Class.Get_Last_Number2("EMI_Pelunasan_barang_lain", "no_val", 5,
                             "Kode_perusahaan", KodePerusahaan,
                             "And", "substring(no_val, 1, " & Len(fValPelBL) + 4 & ")", fValPelBL & Format(tgl_skg, "MMyy"))
    End Sub
    ...
    Private Sub get_no_faktur()
        TxtPembelian_NoFaktur.Text = FPembelianL & arrInisialFaktur.Item(CmbPembelian_Lokasi.SelectedIndex) & "-" & Format(DtpPembelian_Tgl.Value, "MM/yy") & "-" &
                                  General_Class.Get_Last_Number2("EMI_Pembelian_Barang_Lain", "no_faktur", 5,
                                  "Kode_perusahaan", KodePerusahaan,
                                  "And", "substring(no_faktur,1," & Len(FPembelianL) + Len(arrInisialFaktur.Item(CmbPembelian_Lokasi.SelectedIndex)) + 6 & ")", FPembelianL & arrInisialFaktur.Item(CmbPembelian_Lokasi.SelectedIndex) & "-" & Format(DtpPembelian_Tgl.Value, "MM/yy"))
    End Sub
    ...
    Private Sub HitungGrandTotal()
        ...
        Try
            ...
            SQL = SQL & "from EMI_Pembelian_PO_Barang_Lain a "
            SQL = SQL & "where "
            ...
            If Flag_import = "T" Then
                ...
                SQL = SQL & "from Transaksi_Biaya_Lokal_Barang_Lain a, Transaksi_Biaya_Lokal_Detail_Barang_Lain b, Master_Kategori_Biaya_Import c where "
    ...
    Public Sub TxtPembelian_NoPO_Leave(sender As Object, e As EventArgs) Handles TxtPembelian_NoPO.Leave
        Try
            ...
            SQL = SQL & "from EMI_Detail_PPH_PO_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' "
            ...
            'SQL = SQL & "EMI_Pembelian_Selisih_Barang_Masuk_Barang_Lain a, EMI_Pembelian_Selisih_Barang_Masuk_Det_Barang_Lain b, "
            'SQL = SQL & "emi_pembelian_loading_detail_barang_lain c "
            ...
            SQL = SQL & "emi_pembelian_loading_detail_barang_lain c, emi_pembelian_loading_barang_lain d, EMI_Pembelian_PO_Barang_Lain e  "
            SQL = SQL & "where  "
            ...
            Using dr = OpenTrans(SQL)
                Do While dr.Read
                    ...
                    If dr("flag_selisih_bm") = "T" Then
                        EMI_PO_Pembelian_Display2_Barang_Lain.bolehLewat = False
                        CloseConn()
                    ...
                    EMI_PO_Pembelian_Display2_Barang_Lain.bolehLewat = True
            ...
            SQL = SQL & "EMI_Barang_Masuk_Perpallet_Barang_Lain x where x.No_Pembelian_Loading=c.no_faktur and x.status is null),NULL) as Kode_Stock_Owner, "
            ...
            SQL = SQL & "From EMI_Pembelian_Selisih_Barang_Masuk_Barang_Lain a, EMI_Pembelian_Selisih_Barang_Masuk_Det_Barang_Lain b, "
            SQL = SQL & "emi_pembelian_loading_detail_barang_lain c, Barang_Lain d "
            SQL = SQL & "Where a.Kode_Perusahaan = b.Kode_Perusahaan And a.No_Faktur = b.no_faktur And a.status Is null "
            SQL = SQL & "And b.Kode_Perusahaan=c.Kode_Perusahaan And b.Urut_Loading=c.Urut_Oto And "
            ...
            Using ds = BindingTrans(SQL)
                With ds.Tables("MyTable")
                    For index = 0 To .Rows.Count - 1
                        ...
                        Dim harga_real As Double = ubah_satuan_lain(.Rows(index).Item("Kode_Barang"), .Rows(index).Item("Harga"), .Rows(index).Item("Satuan"), .Rows(index).Item("satuan_display"), "UANG")
                        Dim harga As Double = .Rows(index).Item("hpp_satuan_display")
                        Dim jumlahkirim As Double = ubah_satuan_lain(.Rows(index).Item("Kode_Barang"), .Rows(index).Item("Jumlah_PL"), .Rows(index).Item("Satuan"), .Rows(index).Item("satuan_display"), "MASA")
                        Dim Jumlahmasuk As Double = ubah_satuan_lain(.Rows(index).Item("Kode_Barang"), .Rows(index).Item("Jumlah_Masuk"), .Rows(index).Item("Satuan"), .Rows(index).Item("satuan_display"), "MASA")
                        ...
                        If Flag_import = "Y" Then
                            ...
                            SQL = SQL & "from emi_pembelian_loading_barang_lain a, HPP_Import_Barang_Lain b where "
                            ...
                            SQL = SQL & "from Total_Billing_Barang_Lain a, Detail_Total_Billing_Barang_Lain b where a.Kode_Perusahaan=b.Kode_perusahaan and a.No_Faktur=b.No_Faktur "
                            ...
                            End Using
                        Else
                            SQL = "select PPN from EMI_Pembelian_PO_Barang_Lain "
                        ...
                        'SQL = "INSERT INTO EMI_Pembelian_Detail_Barang_Lain(Kode_Perusahaan,No_Faktur,Kode_Stock_Owner,"
            ...
            'SQL = SQL & "b.Satuan as satuan, c.Harga_barang As Harga, c.Satuan as satuan_display, c.hpp_satuan_display From EMI_Pembelian_Selisih_Barang_Masuk_Barang_Lain a, EMI_Pembelian_Selisih_Barang_Masuk_Det_Barang_Lain b, "
            'SQL = SQL & "emi_pembelian_loading_detail_barang_lain c, Barang_Lain d Where a.Kode_Perusahaan = b.Kode_Perusahaan "
            ...
            SQL = SQL & "(a.Nilai- "
            SQL = SQL & "isnull(( "
            SQL = SQL & "select sum(x.nilai) from EMI_Transaksi_Pembayaran_Dimuka_Asset_Pajak x "
            SQL = SQL & "where x.kode_perusahaan=a.kode_perusahaan and x.no_faktur = a.No_Transaksi and x.flag_ppn is null ),0)) - "
            SQL = SQL & "ISNULL(( "
            SQL = SQL & "select z.nilai from EMI_Pelunasan_Detail_DP_Barang_Lain z, EMI_Pelunasan_Barang_Lain w "
            ...
            'SQL = SQL & "select z.No_Faktur_Induk "
            'SQL = SQL & "from Emi_Pembelian_PO_Barang_Lain z "
            'SQL = SQL & "where z.Kode_Perusahaan = a.Kode_Perusahaan "
            'SQL = SQL & "and z.Status is null "
            'SQL = SQL & "and z.No_Faktur = '" & TxtPembelian_NoPO.Text & "') "
    ...
    Private Sub BtnPembelian_CariPO_Click(sender As Object, e As EventArgs) Handles BtnPembelian_CariPO.Click
        'SD_Pilih_PO2_Barang_Lain.asal = Jenis
        'SD_Pilih_PO2_Barang_Lain.filter_tambahan = " and a.lokasi =  '" & CmbPembelian_Lokasi.Text & "' " ' and a.Flag_Timbang_Keluar = 'Y'
        'SD_Pilih_PO2_Barang_Lain.ShowDialog()
    End Sub
    ...
    Private Sub BtnPembelian_Simpan_Click(sender As Object, e As EventArgs) Handles BtnPembelian_Simpan.Click
        ...
        Try
            ...
            SQL = "INSERT INTO EMI_Pembelian_Barang_Lain(Kode_Perusahaan,No_Faktur,Lokasi,Tanggal,Jam,"
            ...
            For i As Integer = 0 To tempDataPajak.Count - 1
                ...
                SQL = "insert into EMI_Detail_PPH_Pembelian_Barang_Lain (Kode_Perusahaan, No_faktur, No_faktur_PO, Persentase, Nilai, Kode_Tarif, Flag_PPN, Kode_Akun ) values "
            ...
            For a As Integer = 0 To LvPembelian_DataPembelian.Items.Count - 1
                ...
                SQL = "Select No_Faktur, Flag_Masuk_Hutang_Bahan from EMI_Pembelian_Selisih_Barang_Masuk_Barang_Lain "
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "Update EMI_Pembelian_Selisih_Barang_Masuk_Det_Barang_Lain set Flag_Validasi='Y' where "
                        SQL = SQL & "no_faktur ='" & No_Selisih & "' and kode_barang='" & LvKd_Brg & "' "
                        SQL = SQL & "And Kode_Perusahaan ='" & KodePerusahaan & "' "
                        ExecuteTrans(SQL)

                        SQL = "Update emi_pembelian_loading_detail_barang_lain set Flag_Pembelian='Y' where "
                ...
                If Flag_Masuk_Hutang = "Y" Then
                    SQL = "Update emi_pembelian_loading_detail_barang_lain set Flag_Masuk_Hutang='Y' where "
                    SQL = SQL & "no_faktur ='" & LvNo_PO & "' and kode_barang='" & LvKd_Brg & "' "
                    SQL = SQL & "And Kode_Perusahaan ='" & KodePerusahaan & "' "
                    ExecuteTrans(SQL)
                End If

                SQL = "Select Kode_Perusahaan from emi_pembelian_loading_detail_barang_lain "
                SQL = SQL & "where No_Faktur ='" & LvNo_PO & "' and Kode_Perusahaan='" & KodePerusahaan & "' "
                SQL = SQL & "and Flag_Pembelian is null "
                Using Dr = OpenTrans(SQL)
                    If Not Dr.Read Then
                        Dr.Close()
                        SQL = "Update emi_pembelian_loading_barang_lain set Flag_Pembelian='Y' where "
...
#Region "Update Harga"
                ...
                SQL = SQL & "from EMI_Barang_Masuk_Perpallet_Barang_Lain a "
                    ...
                    With Ds.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            ...
                            For k As Integer = 0 To Ds.Tables("MyTable").Rows.Count - 1
                                ...
                                SQL = "insert into barang_lain_sn (Kode_Perusahaan, Kode_Stock_Owner, Kode_Barang, Serial_Number, Jumlah, Warna, Jumlah_Bags, Lama, thn, Tgl_Expired, Tgl_Produksi, "
                                SQL = SQL & "Bulan, Stock_PO, Stock_Inquiry, Id_Warehouse, id_Susunan, rr, Id_Nametag_pallet, Batch_Number, Qr_Code, Kode_Unik_Berjalan, Kode_Unik_Asal, Nomor_Pallet, Flag_QI, Tgl_Masuk, id_Gedung, ID_Cost_Center) "
                                ...
                                SQL = SQL & "Stock_Inquiry, Id_Warehouse, id_Susunan, rr, Id_Nametag_pallet, Batch_Number, Qr_Code, Kode_Unik_Berjalan, Kode_Unik_Asal, Nomor_Pallet, Flag_QI, Tgl_Masuk, id_Gedung, ID_Cost_Center "
                                SQL = SQL & "from barang_lain_sn where Serial_Number = '" & .Rows(k).Item("SN_Lama") & "' "
                                ExecuteTrans(SQL)

                                '========================
                                '=     POTONG STOCK     =
                                '========================
                                SQL = "update barang_lain_sn set Jumlah = Jumlah - " & .Rows(k).Item("JumlahMasukKecil") & ", Jumlah_Bags = Jumlah_Bags - " & .Rows(k).Item("Jumlah_Bags") & " where Serial_Number = '" & .Rows(k).Item("SN_Lama") & "' "
                                ExecuteTrans(SQL)

                                '==========================================
                                '=     CEK APAKAH BARANG_LAIN_SN MENJADI 0     =
                                '==========================================
                                Dim kode_SO As String = ""
                                SQL = "select Jumlah, Kode_Stock_Owner from barang_lain_sn where Serial_Number = '" & .Rows(k).Item("SN_Lama") & "' "
                                Using Dr = OpenTrans(SQL)
                                    If Dr.Read Then
                                ...
                                SQL = SQL & "ISNULL((select ROUND(sum(z.Jumlah),2) from barang_lain_sn z where  a.Kode_Perusahaan=z.Kode_Perusahaan "
                                SQL = SQL & "and a.kode_barang=z.Kode_Barang and a.Kode_Stock_Owner=z.Kode_Stock_Owner), 0) as Jumlah_Sn, "
                                SQL = SQL & "ISNULL((select ROUND(sum(z.Jumlah_Bags),2) from barang_lain_sn z where  a.Kode_Perusahaan=z.Kode_Perusahaan "
                                SQL = SQL & "and a.kode_barang=z.Kode_Barang and a.Kode_Stock_Owner=z.Kode_Stock_Owner), 0) as Bags_Sn "
                                SQL = SQL & "from Barang_Lain a "
                                ...
                                '=     INSERT SN BARU     =
                                '==========================
                                SQL = "update EMI_Barang_Masuk_Perpallet_Barang_Lain set Serial_Number_Import = '" & SN_Baru & "' where Kode_Perusahaan = '" & KodePerusahaan & "' "
...
#End Region
            ...
            For a As Integer = 0 To ListViewDet.Items.Count - 1
                ...
                SQL = "INSERT INTO EMI_Pembelian_Detail2_Barang_Lain(Kode_Perusahaan,No_Faktur,Kode_Stock_Owner,"
                SQL = SQL & "Kode_Barang,Serial_Number,Harga,Jumlah,Satuan,Disc_Persen,Nilai_Disc,"
                SQL = SQL & "Total,Pakai_SN,Modal,Upd_HPP,Sisa,Total_Harga, "
            ...
            SQL = "update EMI_Pembelian_PO_Barang_Lain set flag_Pembelian='Y' where "
            ...
            If JumlahDp > 0 Then
                If Not Insert_Pelunasan_Asset() Then
                    CloseTrans()
                    CloseConn()
        ...
        End Try
        Kosong()
        EMI_PO_Pembelian_Display2_Barang_Lain.Cari("Y")
        Me.Close()
    End Sub
...
#Region "Get_ID_Rencana"
            ...
            Dim i As Integer = 0
            SQL = "select Flag_Gabungan from rencana_order_barang_lain where "
            SQL = SQL & "Id_rencana = '" & id_rencana & "'"
            Using Dr2 = OpenTrans(SQL)
                If Dr2.Read Then
                    If General_Class.CekNULL(Dr2("Flag_Gabungan")) = "Y" Then
                        Dr2.Close()
                        SQL = "select a.id_rencana, a.Total_Persen from rencana_order_barang_lain a, rencana_order_gabungan_barang_lain b where "
...
#End Region
            ...
            SQL = "select kode_stock_owner from EMI_Barang_Masuk_Perpallet_Barang_Lain a where "
            SQL = SQL & "Kode_Perusahaan='" & KodePerusahaan & "' and "
            ...
            SQL = SQL & "from Transaksi_Biaya_Import_Barang_Lain a where  a.Id_rencana = '" & id_rencana & "' and status is null"
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
            ...
            SQL = "select Flag_average "
            SQL = SQL & "from Transaksi_Biaya_Import3_Barang_Lain a where  a.Id_rencana = '" & id_rencana & "' and status is null"
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
...
#Region "GET_KET"
            ...
            SQL = "select Tanggal_PO from rencana_order_barang_lain a where "
            ...
            SQL = SQL & "from rencana_order_barang_lain a, Stock_Owner b where "
            ...
            SQL = SQL & "Submit_PO_Barang_Lain A, Detail_Submit_PO_Barang_Lain B, Barang_Lain C, Kategori_Besar d where "
...
#End Region
            ...
            'SQL = "Select c.PPN "
            'SQL = SQL & "From emi_pembelian_loading_detail_barang_lain a, EMI_Pembelian_PO_Detail_Barang_Lain b, EMI_Pembelian_PO_Barang_Lain c Where "
            ...
            SQL = "select flag_HPP, keterangan from binding_hpp_barang_lain where "
...
#Region "Data PO"
            ...
            SQL = SQL & "from HPP_Import_Barang_Lain a, detail_hpp_import_barang_lain b where "
            ...
            SQL = SQL & "from Transaksi_Biaya_Import_Barang_Lain a, detail_transaksi_biaya_import_barang_lain b, Master_Kategori_Biaya_Import c where "
            SQL = SQL & "a.kode_perusahaan = b.kode_perusahaan And "
            SQL = SQL & "a.no_faktur = b.no_faktur And a.status Is null and "
            SQL = SQL & "b.Kode_Perusahaan = c.Kode_Perusahaan and b.Kode_Master_Kategori_Biaya_import = c.Kode_Master_Kategori_Biaya_Import and "
            ...
            Using ds = BindingTrans(SQL)
                With ds.Tables("MyTable")
                    For index3 As Integer = 0 To .Rows.Count - 1
                        ...
                        SQL = SQL & "from HPP_Import_Barang_Lain a, detail_hpp_import_barang_lain b,Detail_HPP_Import_Biaya_Barang_Lain c where "
            ...
            Using ds = BindingTrans(SQL)
                With ds.Tables("MyTable")
                    For index3 As Integer = 0 To .Rows.Count - 1
                        ...
                        SQL = SQL & "from HPP_Import_Barang_Lain a, detail_hpp_import2_barang_lain b,detail_hpp_import2_biaya_barang_lain c where "
                        SQL = SQL & "a.kode_perusahaan=b.Kode_Perusahaan and a.No_faktur=b.No_Faktur and b.no_faktur=c.No_Faktur "
            ...
            SQL = SQL & "from Transaksi_Biaya_Import3_Barang_Lain a, detail_transaksi_biaya_import3_barang_lain b, Master_Kategori_Biaya_Import c where "
            SQL = SQL & "a.kode_perusahaan = b.kode_perusahaan And "
            SQL = SQL & "a.no_faktur = b.no_faktur And a.status Is null and "
            SQL = SQL & "b.Kode_Perusahaan = c.Kode_Perusahaan and b.Kode_Master_Kategori_Biaya_import = c.Kode_Master_Kategori_Biaya_Import and "
...
#Region "Persediaan"
            ...
            Using Dr = OpenTrans(SQL)
                ...
                Else
                    ...
                    KodePerusahaan, KodeProyek, ket + "; PERSEDIAAN", Hutang_Dalam_Proses_temp, "0", pagenumber, LvSo, Bahasa_Pilihan, Ket_Cost_Center_HO)
                    ExecuteTrans(SQL)
            ...
            'Data Persediaan
            SQL = "select kode_perusahaan from Pelunasan_Pembelian_Barang_Lain where kode_perusahaan = '" & KodePerusahaan & "' and "
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Hutang_Dalam_Proses_temp & " where "
                    SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                    SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                    SQL = SQL & "Kode = 'PERSEDIAAN' and "
                    SQL = SQL & "Kode_Akun = '" & coa_Hutang_Dalam_Proses & "'  "
                ...
                Else
                    ...
                    SQL = "insert into Pelunasan_Pembelian_Barang_Lain(Kode_perusahaan, No_Faktur, Kode, Nilai, Kode_Akun) "
            ...
            If pib_temp <> 0 Then 'ada ppn
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_ppn, 1),
                            ...
                            KodePerusahaan, KodeProyek, ket + "; PPN", pib_temp, "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & pib_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'PPN' and "
                        SQL = SQL & "Kode_Akun = '" & coa_ppn & "'  "
                ...
                If Val(Arr_Biaya_Import_temp.Item(indexKategoriImport)) <> 0 Then
                    ...
                    Using Dr = OpenTrans(SQL)
                        ...
                        Else
                            ...
                            SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(Arr_Akun2_temp.Item(indexKategoriImport), 1),
                                ...
                                KodePerusahaan, KodeProyek, ket & "; " & Arr_Biaya_Import_Kategori_temp.Item(indexKategoriImport), "0", Arr_Biaya_Import_temp.Item(indexKategoriImport), pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                            ExecuteTrans(SQL)
                            pagenumber = pagenumber + 1
                    ...
                    Using Dr = OpenTrans(SQL)
                        If Dr.Read Then
                            ...
                            SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Arr_Biaya_Import_temp.Item(indexKategoriImport) & " where "
                            SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                            SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                            SQL = SQL & "Kode = '" & Arr_Biaya_Import_Kategori_temp.Item(indexKategoriImport) & "' and "
                            SQL = SQL & "Kode_Akun = '" & Arr_Akun2_temp.Item(indexKategoriImport) & "'  "
                ...
                If Val(Arr_Biaya_Bongkar_Import_temp.Item(indexKategoriImport)) <> 0 Then
                    ...
                    Using Dr = OpenTrans(SQL)
                        ...
                        Else
                            ...
                            SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(Arr_Akun2_Bongkar_temp.Item(indexKategoriImport), 1),
                                ...
                                KodePerusahaan, KodeProyek, ket2, "0", Arr_Biaya_Import_temp.Item(indexKategoriImport), pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                            ExecuteTrans(SQL)
                            pagenumber = pagenumber + 1
                    ...
                    Using Dr = OpenTrans(SQL)
                        If Dr.Read Then
                            ...
                            SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Arr_Biaya_Bongkar_Import_temp.Item(indexKategoriImport) & " where "
                            SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                            SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                            SQL = SQL & "Kode = '" & Arr_Biaya_Bongkar_Import_Kategori_temp.Item(indexKategoriImport) & "' and "
                            SQL = SQL & "Kode_Akun = '" & Arr_Akun2_Bongkar_temp.Item(indexKategoriImport) & "'  "
            ...
            If Storage_temp <> 0 Then 'ada ppn
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Storage, 1),
                            ...
                            KodePerusahaan, KodeProyek, ket & "; STORAGE", "0", Storage_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Storage_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'STORAGE' and "
                        SQL = SQL & "Kode_Akun = '" & coa_Storage & "'  "
            ...
            If freigt_temp > 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_freigt, 1),
                            ...
                            KodePerusahaan, KodeProyek, ket & "; FREIGHT", "0", freigt_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & freigt_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'FREIGHT' and "
                        SQL = SQL & "Kode_Akun = '" & coa_freigt & "'  "
            ...
            If Billing_temp > 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Billing, 1),
                            ...
                            KodePerusahaan, KodeProyek, ket & "; BILLING", "0", Billing_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Billing_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'BILLING' and "
                        SQL = SQL & "Kode_Akun = '" & coa_Billing & "'  "
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_pib, 1),
                            ...
                            KodePerusahaan, KodeProyek, ket & "; PIB", "0", pib_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
            ...
            If Tdk_Pot_Stock_Hutang_IDR_Utama_temp <> 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Tdk_Pot_Stock_Hutang_IDR_Utama, 1),
                            ...
                            KodePerusahaan, KodeProyek, ket + "; BAHAN UTAMA", "0", Tdk_Pot_Stock_Hutang_IDR_Utama_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Tdk_Pot_Stock_Hutang_IDR_Utama_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'BAHAN UTAMA' and "
                        SQL = SQL & "Kode_Akun = '" & coa_Tdk_Pot_Stock_Hutang_IDR_Utama & "'  "
...
#Region "Data Selisih"
            ...
            SQL = "select Akun_Bahan, Akun_Perjalanan from EMI_Pembelian_Selisih_Barang_Masuk_Barang_Lain "
            ...
            If Hutang_Dalam_Proses_selisih_temp > 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Hutang_Dalam_Proses, 1),
                            Strings.Mid(coa_Hutang_Dalam_Proses, 2, 1),
                            Strings.Mid(Ganti(coa_Hutang_Dalam_Proses), 3),
                            KodePerusahaan, KodeProyek, ket, Hutang_Dalam_Proses_selisih_temp, "0", pagenumber, LvSo, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Hutang_Dalam_Proses_selisih_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'PERSEDIAAN TAMBAHAN' and "
                        SQL = SQL & "Kode_Akun = '" & coa_Hutang_Dalam_Proses & "'  "
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Hutang_Dalam_Proses, 1),
                            Strings.Mid(coa_Hutang_Dalam_Proses, 2, 1),
                            Strings.Mid(Ganti(coa_Hutang_Dalam_Proses), 3),
                            KodePerusahaan, KodeProyek, ket, "0", Math.Abs(Hutang_Dalam_Proses_selisih_temp), pagenumber, LvSo, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                    ...
                    If Val(Arr_Biaya_Import_selisih_temp.Item(index_temp)) > 0 Then
                        ...
                        Using Dr = OpenTrans(SQL)
                            ...
                            Else
                                ...
                                KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", "0", Arr_Biaya_Import_selisih_temp.Item(index_temp), pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                                ExecuteTrans(SQL)
                                pagenumber = pagenumber + 1
                        ...
                        Using Dr = OpenTrans(SQL)
                            If Dr.Read Then
                                ...
                                SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Arr_Biaya_Import_selisih_temp.Item(index_temp) & " where "
                                SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                                SQL = SQL & "Kode = 'BIAYA TAMBAHAN' and "
                                SQL = SQL & "Kode_Akun = '" & akun_hutang_perjalanan_selisih & "'  "
                    ...
                    ElseIf Val(Arr_Biaya_Import_selisih_temp.Item(index_temp)) < 0 Then
                        ...
                        Using Dr = OpenTrans(SQL)
                            ...
                            Else
                                ...
                                Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                                Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                                KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", Math.Abs(Arr_Biaya_Import_selisih_temp.Item(index_temp)), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                                ExecuteTrans(SQL)
                                pagenumber = pagenumber + 1
                    ...
                    If Arr_Biaya_Bongkar_Import_selisih_temp.Item(index_temp) > 0 Then
                        ...
                        Using Dr = OpenTrans(SQL)
                            ...
                            Else
                                ...
                                SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_hutang_perjalanan_selisih, 1),
                                    Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                                    Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                                    KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", "0", Arr_Biaya_Bongkar_Import_selisih_temp.Item(index_temp), pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                                ExecuteTrans(SQL)
                                pagenumber = pagenumber + 1
                        ...
                        Using Dr = OpenTrans(SQL)
                            If Dr.Read Then
                                ...
                                SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Arr_Biaya_Bongkar_Import_selisih_temp.Item(index_temp) & " where "
                                SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                                SQL = SQL & "Kode = 'BIAYA TAMBAHAN' and "
                                SQL = SQL & "Kode_Akun = '" & akun_hutang_perjalanan_selisih & "'  "
                        ...
                        Using Dr = OpenTrans(SQL)
                            ...
                            Else
                                ...
                                SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_hutang_perjalanan_selisih, 1),
                                    Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                                    Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                                    KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", Math.Abs(Arr_Biaya_Bongkar_Import_selisih_temp.Item(index_temp)), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                                ExecuteTrans(SQL)
                                pagenumber = pagenumber + 1
            ...
            If Storage_selisih_temp > 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                        Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                        KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", "0", Storage_selisih_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Storage_selisih_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'BIAYA TAMBAHAN' and "
                        SQL = SQL & "Kode_Akun = '" & akun_hutang_perjalanan_selisih & "'  "
            ...
            ElseIf Storage_selisih_temp < 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                        Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                        KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", Math.Abs(Storage_selisih_temp), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
            ...
            If freigt_selisih_temp > 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                        Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                        KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", "0", freigt_selisih_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & freigt_selisih_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'BIAYA TAMBAHAN' and "
                        SQL = SQL & "Kode_Akun = '" & akun_hutang_perjalanan_selisih & "'  "
            ...
            ElseIf freigt_selisih_temp < 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                        Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                        KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", Math.Abs(freigt_selisih_temp), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
            ...
            If Billing_selisih_temp > 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                        Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                        KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", "0", Billing_selisih_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Billing_selisih_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'BIAYA TAMBAHAN' and "
                        SQL = SQL & "Kode_Akun = '" & akun_hutang_perjalanan_selisih & "'  "
            ...
            ElseIf Billing_selisih_temp < 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                        Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                        KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", Math.Abs(Billing_selisih_temp), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
            ...
            If Tdk_Pot_Stock_Hutang_IDR_Utama_selisih_temp > 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", "0", Tdk_Pot_Stock_Hutang_IDR_Utama_selisih_temp, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Tdk_Pot_Stock_Hutang_IDR_Utama_selisih_temp & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = 'BIAYA TAMBAHAN' and "
                        SQL = SQL & "Kode_Akun = '" & akun_hutang_sup_selisih & "'  "
            ...
            ElseIf Tdk_Pot_Stock_Hutang_IDR_Utama_selisih_temp < 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        Strings.Mid(akun_hutang_sup_selisih, 2, 1),
                        Strings.Mid(Ganti(akun_hutang_sup_selisih), 3),
                        KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", Math.Abs(Tdk_Pot_Stock_Hutang_IDR_Utama_selisih_temp), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
...
#Region "Jurnal_PO2"
        ...
        If Selisih_Import_AVG < 0 Then
            SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Selisih_AVG_Import, 1),
                    Strings.Mid(coa_Selisih_AVG_Import, 2, 1),
                    Strings.Mid(Ganti(coa_Selisih_AVG_Import), 3),
                    KodePerusahaan, KodeProyek, ket, Math.Abs(Selisih_Import_AVG), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
            ExecuteTrans(SQL)
            pagenumber = pagenumber + 1
        ...
        If Selisih_Hutang <> 0 Then
            If Selisih_Hutang < 0 Then
                SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Selisih_Hutang_Import, 1),
                        ...
                        KodePerusahaan, KodeProyek, ket, Math.Abs(Selisih_Hutang), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                ExecuteTrans(SQL)
                pagenumber = pagenumber + 1
            Else
                SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Selisih_Hutang_Import, 1),
                        Strings.Mid(coa_Selisih_Hutang_Import, 2, 1),
                        Strings.Mid(Ganti(coa_Selisih_Hutang_Import), 3),
                        KodePerusahaan, KodeProyek, ket + "; SELISIH", "0", Selisih_Hutang, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                ExecuteTrans(SQL)
                pagenumber = pagenumber + 1
        ...
        If Selisih_Import_AVG_selisih > 0 Then
            ...
            Using Dr = OpenTrans(SQL)
                ...
                Else
                    ...
                    Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                    Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                    KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", "0", Selisih_Import_AVG_selisih, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                    ExecuteTrans(SQL)
                    pagenumber = pagenumber + 1
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Selisih_Import_AVG_selisih & " where "
                    SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                    SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                    SQL = SQL & "Kode = 'BIAYA TAMBAHAN' and "
                    SQL = SQL & "Kode_Akun = '" & akun_hutang_perjalanan_selisih & "'  "
        ...
        ElseIf Selisih_Import_AVG_selisih < 0 Then
            ...
            Using Dr = OpenTrans(SQL)
                ...
                Else
                    ...
                    Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                    Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                    KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", Math.Abs(Selisih_Import_AVG_selisih), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                    ExecuteTrans(SQL)
                    pagenumber = pagenumber + 1
        ...
        If Selisih_Hutang_selisih > 0 Then
            ...
            Using Dr = OpenTrans(SQL)
                ...
                Else
                    ...
                    Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                    Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                    KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", "0", Selisih_Hutang_selisih, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                    ExecuteTrans(SQL)
                    pagenumber = pagenumber + 1
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Selisih_Hutang_selisih & " where "
                    SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                    SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                    SQL = SQL & "Kode = 'BIAYA TAMBAHAN' and "
                    SQL = SQL & "Kode_Akun = '" & akun_hutang_perjalanan_selisih & "'  "
        ...
        ElseIf Selisih_Hutang_selisih < 0 Then
            ...
            Using Dr = OpenTrans(SQL)
                ...
                Else
                    ...
                    Strings.Mid(akun_hutang_perjalanan_selisih, 2, 1),
                    Strings.Mid(Ganti(akun_hutang_perjalanan_selisih), 3),
                    KodePerusahaan, KodeProyek, ket & "; BIAYA TAMBAHAN", Math.Abs(Selisih_Hutang_selisih), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                    ExecuteTrans(SQL)
                    pagenumber = pagenumber + 1
...
#End Region
        ...
        SQL = "Update EMI_Pembelian_Barang_Lain "
    ...
    Private Sub Jurnal_Lokal()
        ...
        SQL = "select inisial_faktur_barang_lain from stock_owner "
        SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' and kode_stock_owner = '" & CmbPembelian_Lokasi.Text & "' "
        Using Dr = OpenTrans(SQL)
            If Dr.Read Then
                'akun_persediaan_dari = Dr("persediaan")
                inisial_faktur_dari = Dr("inisial_faktur_barang_lain")
            Else
                Dr.Close()
                CloseTrans()
                CloseConn()
        ...
        For index = 0 To LvPembelian_DataPembelian.Items.Count - 1
            ...
            If NilaiPersediaan <> 0 Then
                ...
                If Not Insert_Jurnal(Kode_voucher, akun_persediaan_dari, "Persediaan; ", NilaiPersediaan, pagenumber, LvSo, "D") Then
                    isError = False
                    Exit Sub
                End If
            End If
            ...
            If NilaiPPN <> 0 Then
                ...
                If Not Insert_Jurnal(Kode_voucher, akun_ppn, "PPN; ", NilaiPPN, pagenumber, CmbPembelian_Lokasi.Text, "D") Then
                    isError = False
                    Exit Sub
                End If
            End If
            ...
            If NilaiHutang <> 0 Then
                If Not Insert_Jurnal(Kode_voucher, akun_hutang_sup, "Hutang Supplier; ", NilaiHutang, pagenumber, CmbPembelian_Lokasi.Text, "K") Then
                    isError = False
                    Exit Sub
                End If
            End If
            ...
            If selisih <> 0 Then
                ...
                If selisih > 0 Then
                    If Not Insert_Jurnal(Kode_voucher, akun_hutang_sup_selisih, "Selisih Hutang; ", NilaiSelisihHutang, pagenumber, CmbPembelian_Lokasi.Text, "D") Then
                        isError = False
                        Exit Sub
                    End If
                ElseIf selisih < 0 Then
                    If Not Insert_Jurnal(Kode_voucher, akun_hutang_sup_selisih, "Selisih Hutang; ", Math.Abs(NilaiSelisihHutang), pagenumber, CmbPembelian_Lokasi.Text, "K") Then
                        isError = False
                        Exit Sub
                    End If
                End If
            ...
            If Val(Arr_Biaya_Lokal.Item(indexKategoriImport)) <> 0 Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(Arr_Akun2.Item(indexKategoriImport), 1),
                                    ...
                                    KodePerusahaan, KodeProyek, "Hutang " & Arr_Biaya_Lokal_Kategori.Item(indexKategoriImport) & "; " & TxtPembelian_NoFaktur.Text, "0", Arr_Biaya_Lokal.Item(indexKategoriImport), pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                        pagenumber = pagenumber + 1
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Arr_Biaya_Lokal.Item(indexKategoriImport) & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                        SQL = SQL & "Kode = '" & Arr_Biaya_Lokal_Kategori.Item(indexKategoriImport) & "' and "
                        SQL = SQL & "Kode_Akun = '" & Arr_Akun2.Item(indexKategoriImport) & "'  "
...
#End Region
        ...
        If nilai_selisih <> 0 Then
            If nilai_selisih < 0 Then
                SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_Selisih_pembulatan, 1),
                        ...
                        KodePerusahaan, KodeProyek, "Selisih Pembulatan; ", Math.Abs(nilai_selisih), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                ExecuteTrans(SQL)
                pagenumber = pagenumber + 1
            Else
                SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_Selisih_pembulatan, 1),
                        Strings.Mid(akun_Selisih_pembulatan, 2, 1),
                        Strings.Mid(Ganti(akun_Selisih_pembulatan), 3),
                        KodePerusahaan, KodeProyek, "Selisih Pembulatan; ", "0", nilai_selisih, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                ExecuteTrans(SQL)
                pagenumber = pagenumber + 1
    ...
    Private Function Insert_Jurnal(ByVal Kode_voucher As String, ByVal akun As String, ByVal Kode_Akun_Pembelian As String, ByVal Nilai As String, ByVal pagenumber As Integer, ByVal lks As String, ByVal Type As String) As Boolean
        ...
        Try
                ...
                Else
                    ...
                    If Type = "D" Then
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun, 1),
                              ...
                              KodePerusahaan, KodeProyek, Kode_Akun_Pembelian & "; " & TxtPembelian_NoFaktur.Text, Nilai, "0", pagenumber, lks, Bahasa_Pilihan, Ket_Cost_Center_HO)

                    ElseIf Type = "K" Then
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun, 1),
                              Strings.Mid(akun, 2, 1),
                              Strings.Mid(Ganti(akun), 3),
                              KodePerusahaan, KodeProyek, Kode_Akun_Pembelian & "; " & TxtPembelian_NoFaktur.Text, "0", Nilai, pagenumber, lks, Bahasa_Pilihan, Ket_Cost_Center_HO)
                    End If
                    ExecuteTrans(SQL)
                    pagenumber = pagenumber + 1
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    SQL = "update Pelunasan_Pembelian_Barang_Lain set Nilai = Nilai+ " & Nilai & " where "
                    SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                    SQL = SQL & "No_Faktur = '" & TxtPembelian_NoFaktur.Text.Trim & "' and "
                    SQL = SQL & "Kode = '" & Kode_Akun_Pembelian & "' and "
                    SQL = SQL & "Kode_Akun = '" & akun & "'  "
    ...
    Private Function Insert_Pelunasan_Asset() As Boolean
        ...
        Try
            ...
            Dim GrandTotal As Double = Val(HilangkanTanda(TxtPembelian_GrandTotal.Text))
            ...
            SQL = SQL & "from EMI_Detail_PPH_PO_Barang_Lain a, EMI_Pembelian_PO_Barang_Lain b "
            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan "
            ...
            If JumlahDPA <> 0 Then
                ...
                DPP = Val(HilangkanTanda(Format(JumlahDPA / Persentase, "N0")))
            ...
            SQL = SQL & "('" & KodePerusahaan & "', '" & Txt_Faktur_Pelunasan.Text.Trim & "', '" & Format(tgl_skg, "yyyy-MM-dd") & "', "
            SQL = SQL & "'" & Format(tgl_skg, "HH:mm:ss") & "', 'PELUNASAN : PEMBELIAN', '" & UserID & "', '" & Kode_voucher2 & "', "
            SQL = SQL & "'" & CmbPembelian_MataUang.Text & "', '" & HilangkanTanda(JumlahDPA) & "', '" & HilangkanTanda(NilaiPPN) & "', '" & HilangkanTanda(NilaiPPH) & "', "
            SQL = SQL & "'" & HilangkanTanda(JumlahDPA) & "', '" & HilangkanTanda(DPP) & "', "
            ...
            SQL = SQL & "from barang a, EMI_Group_Jenis_Lain b "
            SQL = SQL & "where a.kode_perusahaan = b.kode_perusahaan "
            ...
            SQL = SQL & "'" & CmbPembelian_MataUang.Text & "', " & HilangkanTanda(JumlahDPA) & ", "
            ...
            SQL = SQL & "'" & CmbPembelian_Lokasi.Text & "', 0, " & HilangkanTanda(DPP) & ", " & HilangkanTanda(NilaiGrandDPP) & ", "
            SQL = SQL & HilangkanTanda(TxtPembelian_Kurs.Text) & ", " & HilangkanTanda(DPP) & ", " & HilangkanTanda(TxtPembelian_Kurs.Text) & ", " & HilangkanTanda(DPP) & ", "
...
#Region "JURNAL DP"
            ...
            SQL = "select Akun_DP_Asset, Hutang_Supplier "
            SQL = SQL & "from stock_owner "
...
#Region "INSERT JURNAL HUTANG"
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    If Type = "D" Then
                        SQL = "update detail_jurnal set debit = debit+ " & HilangkanTanda(NilaiGrandDPP) & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "kode_voucher = '" & Kode_voucher2 & "' and "
                        SQL = SQL & "kode_master_acc + kode_acc + kode_detail_acc = '" & Akun_Hutang & "'  "
                        SQL = SQL & "and debit <> 0"
                    ...
                    ElseIf Type = "K" Then
                        SQL = "update detail_jurnal set kredit = kredit+ " & HilangkanTanda(NilaiGrandDPP) & " where "
                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                        SQL = SQL & "kode_voucher = '" & Kode_voucher2 & "' and "
                        SQL = SQL & "kode_master_acc + kode_acc + kode_detail_acc = '" & Akun_Hutang & "'  "
                        SQL = SQL & "and kredit <> 0"
                ...
                Else
                    ...
                    If Type = "D" Then
                        SQL = Get_Detail_Jurnal(Kode_voucher2, Strings.Left(Akun_Hutang, 1),
                              ...
                              KodePerusahaan, KodeProyek, "Hutang ; " & TxtPembelian_NmSupplier.Text & "; " & TxtPembelian_NoFaktur.Text, HilangkanTanda(NilaiGrandDPP), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)

                    ElseIf Type = "K" Then
                        SQL = Get_Detail_Jurnal(Kode_voucher2, Strings.Left(Akun_Hutang, 1),
                              Strings.Mid(Akun_Hutang, 2, 1),
                              Strings.Mid(Ganti(Akun_Hutang), 3),
                              KodePerusahaan, KodeProyek, "Hutang; " & TxtPembelian_NmSupplier.Text & "; " & TxtPembelian_NoFaktur.Text, "0", HilangkanTanda(NilaiGrandDPP), pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                    End If
                    ExecuteTrans(SQL)
                    pagenumber = pagenumber + 1
...
#Region "INSERT JURNAL DP"
            ...
            SQL = "select kode_perusahaan from detail_jurnal where kode_perusahaan = '" & KodePerusahaan & "' and "
            SQL = SQL & "kode_voucher = '" & Kode_voucher2 & "' and "
            SQL = SQL & "kode_master_acc + kode_acc + kode_detail_acc = '" & Akun_DP & "' "
            If Type = "D" Then
                SQL = SQL & "and debit <> 0 "
            Else
                SQL = SQL & "and kredit <> 0 "
