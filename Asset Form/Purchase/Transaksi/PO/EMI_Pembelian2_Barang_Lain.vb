Public Class EMI_Pembelian2_Barang_Lain
    ...
    Public Sub TxtPembelian_NoPO_Leave(sender As Object, e As EventArgs) Handles TxtPembelian_NoPO.Leave
        Try
            ...
            SQL = SQL & "ISNULL(( "
            SQL = SQL & "select sum(z.nilai) from EMI_Pelunasan_Detail_DP_Barang_Lain z, EMI_Pelunasan_Barang_Lain w "
...
#Region "Update Harga"
                ...
                SQL = SQL & "and Flag_angkut = 'Y' and Serial_Number_Import is null "
...
#Region "Jurnal_PO2"
        ...
        If Selisih_Import_AVG > 0 Then
            SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(coa_Selisih_AVG_Import, 1),
                    ...
                    KodePerusahaan, KodeProyek, ket & "; " & TxtPembelian_NmSupplier.Text.Trim, "0", Selisih_Import_AVG, pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
            ExecuteTrans(SQL)
            pagenumber = pagenumber + 1
...
#End Region
        ...
        If nilai_selisih <> 0 Then
            If nilai_selisih < 0 Then
                SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_Selisih_pembulatan, 1),
                        ...
                        KodePerusahaan, KodeProyek, "Selisih Pembulatan; " & TxtPembelian_NoFaktur.Text & "; " & ket_lokal & "; " & TxtPembelian_NmSupplier.Text.Trim, Math.Abs(nilai_selisih), "0", pagenumber, CmbPembelian_Lokasi.Text, Bahasa_Pilihan, Ket_Cost_Center_HO)
                ExecuteTrans(SQL)
                pagenumber = pagenumber + 1
            Else
                SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_Selisih_pembulatan, 1),
    ...
    Private Function Insert_Jurnal(ByVal Kode_voucher As String, ByVal akun As String, ByVal Kode_Akun_Pembelian As String, Keterangan As String, ByVal Nilai As String, ByVal pagenumber As Integer, ByVal lks As String, ByVal Type As String) As Boolean
                ...
                Else
                    ...
                    If Type = "D" Then
                        SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun, 1),
                              ...
                              KodePerusahaan, KodeProyek, Kode_Akun_Pembelian & "; " & TxtPembelian_NoFaktur.Text & "; " & Keterangan, Nilai, "0", pagenumber, lks, Bahasa_Pilihan, Ket_Cost_Center_HO)
...
#End Region
            ...
            SQL = SQL & "ISNULL(( select sum(z.nilai) from EMI_Pelunasan_Detail_DP_Barang_Lain z, EMI_Pelunasan_Barang_Lain w where "
