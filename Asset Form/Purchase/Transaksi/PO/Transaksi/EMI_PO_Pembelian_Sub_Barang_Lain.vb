...
Public Class EMI_PO_Pembelian_Sub_Barang_Lain
    ...
    Dim arrInisialFakturLoadingPO As String = ""
    ...
    Dim FLoadingPO As String = "LP"
    Dim fakturLoadingPO As String
    ...
    Private Sub get_no_faktur_loading_Po()
        fakturLoadingPO = FLoadingPO & arrInisialFakturLoadingPO & "-" & Format(tgl_skg, "MM/yy") & "-" &
                          General_Class.Get_Last_Number2("EMI_Pembelian_Loading_Barang_Lain", "No_Faktur", JumlahDigit,
                          "Kode_perusahaan", KodePerusahaan,
                          "And", "substring(No_Faktur,1," & Len(FLoadingPO) + Len(arrInisialFakturLoadingPO) + 6 & ")",
                           FLoadingPO & arrInisialFakturLoadingPO & "-" & Format(tgl_skg, "MM/yy"))
    End Sub
    ...
    Private Sub HitungGrandTotal()
        ...
        Try
            ...
            SQL = "select Persentase, Kode_Tarif from EMI_Detail_PPH_PO_Induk_Barang_Lain where kode_perusahaan = '" & KodePerusahaan & "' and no_faktur = '" & Txt_Faktur_Induk.Text & "' and flag_ppn is null "
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
            ...
            TxtPO_GrandTotal.Text = Format((TotalSeluruh + PPN) - totalPajak, "N2")
    ...
    Private Sub BtnPO_Simpan_Click(sender As Object, e As EventArgs) Handles BtnPO_Simpan.Click
        ...
        Try
            ...
            If BtnPO_Simpan.Tag = "&Simpan" Then
                ...
                SQL = SQL & "UserID, No_Fak_Submit_PO, no_sj,no_plat,driver"
                SQL = SQL & ") values( "
                SQL = SQL & "'" & KodePerusahaan & "', '" & fakturLoadingPO & "', '" & TxtPO_KdSupplier.Text & "', '" & CmbPO_Lokasi.Text & "', "
                SQL = SQL & "'" & Format(DtpPO_Tgl.Value, " yyyy-MM-dd") & "', '" & Format(tgl_skg, "HH:mm:ss") & "', "
                SQL = SQL & "'" & UserID & "', '" & fakturSubmitPO & "','-','-','-')"
                ExecuteTrans(SQL)

                '==========================
                '=     GET DETAIL PPH     =
                '==========================
                SQL = "select Persentase, Kode_Tarif, Flag_PPN, Kode_Akun from EMI_Detail_PPH_PO_Induk_Barang_Lain where kode_perusahaan = '" & KodePerusahaan & "' and no_faktur = '" & Txt_Faktur_Induk.Text & "' "
                Using Ds = BindingTrans(SQL)
                    With Ds.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            For i As Integer = 0 To .Rows.Count - 1
                                ...
                                SQL = "insert into EMI_Detail_PPH_PO_Barang_Lain (Kode_Perusahaan, No_faktur_Induk, No_faktur, Persentase, Nilai, Kode_Tarif, Flag_PPN, Kode_Akun) values "
                ...
                For index = 0 To LvPO_DataPO.Rows.Count - 1
                        ...
                        With Ds.Tables("MyTable")
                            If .Rows.Count <> 0 Then
                                If Val(HilangkanTanda(.Rows(0).Item("Sisa"))) = 0 Then
                                    ...
                                    SQL = "update EMI_Pembelian_PO_Det_Induk_Barang_Lain set Flag_Selesai = 'Y' "
                    ...
                    '=     UPDATE PO INDUK     =
                    '===========================
                    SQL = "select Kode_Perusahaan from EMI_Pembelian_PO_Det_Induk_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & LvPO_Fakinduk & "' and Flag_Selesai is null"
                    Using Ds = BindingTrans(SQL)
                        With Ds.Tables("MyTable")
                            If .Rows.Count = 0 Then
                                SQL = "update EMI_Pembelian_PO_Induk_Barang_Lain set Flag_Selesai_SubPO = 'Y' where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & LvPO_Fakinduk & "' "
                                ExecuteTrans(SQL)
                            End If
                        End With
                    End Using
                ...
                SQL = "select no_faktur, No_Urut, kode_stock_owner, kode_barang, jumlah, satuan, "
                SQL = SQL & "Nilai_Barang, Satuan_Barang, Harga_Barang from emi_pembelian_po_detail_Barang_Lain where "
                SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' "
                SQL = SQL & "and no_faktur = '" & TxtPO_NoFaktur.Text & "' "
                Using Ds = BindingTrans(SQL)
                    With Ds.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            For i As Integer = 0 To .Rows.Count - 1
                                ...
                                SQL = "insert into emi_pembelian_loading_detail_barang_Lain("
                                SQL = SQL & "Kode_Perusahaan, No_Faktur, No_PO, Urut_PO, Kode_Stock_Owner,"
                                SQL = SQL & "kode_barang, Tanggal_Produksi, Tanggal_Expired, Jumlah, Satuan, "
                                SQL = SQL & "Jumlah_Barang, Satuan_Barang, Harga_Barang "
                                SQL = SQL & ") values( "
                                SQL = SQL & "'" & KodePerusahaan & "', '" & fakturLoadingPO & "', '" & TxtPO_NoFaktur.Text & "', "
                                SQL = SQL & "" & .Rows(i).Item("No_Urut") & ", '" & .Rows(i).Item("kode_stock_owner") & "', "
                                SQL = SQL & "'" & .Rows(i).Item("kode_barang") & "', '" & Format(DtpPO_Tgl.Value, " yyyy-MM-dd") & "', "
                                SQL = SQL & "'" & Format(DtpPO_Tgl.Value, " yyyy-MM-dd") & "', " & .Rows(i).Item("jumlah") & ", '" & .Rows(i).Item("satuan") & "', "
                                SQL = SQL & "" & .Rows(i).Item("Nilai_Barang") & ", '" & .Rows(i).Item("Satuan_Barang") & "', " & .Rows(i).Item("Harga_Barang") & ") "
                                ExecuteTrans(SQL)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If flag_kategori_Supplier = "Y" Then
            ...
            For indexxxx = 0 To LvPO_DataPO.Rows.Count - 1
                ...
                SQL = "select kode_barang,kode_kontainer,qty from barang_per_kontainer_lain "
                SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
                SQL = SQL & "and kode_barang = '" & lvPO_KdBarang & "' "
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                ...
                Using Dr = OpenTrans(SQL)
                    ...
                    Else
                        ...
                        SQL = "insert into rencana_order_Barang_Lain(kode_perusahaan,periode,kode_supplier,lokasi,kode_kontainer,no_prepare_bahan_baku,no_po,tanggal_po,tanggal_input,jam_input,userid,keterangan,kolom)values("
                ...
                SQL = "select satuan from barang_detail_satuan_lain where kode_barang='" & lvPO_KdBarang & "' "
                ...
                SQL = "select dbo.ubah_satuan_Lain('" & KodePerusahaan & "', 'masa','" & lvPO_KdBarang & "', '" & lvPO_Satuan_SB & "',"
                ...
                SQL = "select kode_perusahaan from detail_rencana_order_Barang_Lain  "
                ...
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        ...
                        SQL = "update detail_rencana_order_Barang_Lain set "
                    ...
                    Else
                        ...
                        SQL = "insert into detail_rencana_order_Barang_Lain(id_rencana, kode_Perusahaan,kode_Barang,jumlah_po, "
                ...
                SQL = "select top(1) a.kode_Perusahaan from rencana_order_Barang_Lain a, detail_rencana_order_Barang_Lain b where "
                ...
                Using drr = OpenTrans(SQL)
                    If Not drr.Read Then
                        ...
                        SQL = "insert into detail_rencana_order_Barang_Lain(id_rencana, kode_Perusahaan,kode_Barang,jumlah_po, isi_satuan_besar, "
                        ...
                        SQL = SQL & "from rencana_order_Barang_Lain c "
            ...
            SQL = SQL & "sum(Jumlah_PO) as total_jml from Detail_Rencana_order_Barang_Lain where "
            ...
            SQL = "update rencana_order_Barang_Lain set total_jml = " & totalJumlahPo & " , "
            ...
            SQL = "insert into submit_PO_Barang_Lain(kode_perusahaan, no_faktur, Id_rencana, tanggal, jam, UserID, Jenis_Transaksi, "
            ...
            SQL = SQL & "from detail_rencana_order_Barang_Lain a, barang_Lain b, rencana_order_Barang_Lain c where "
                ...
                With Ds.Tables("MyTable")
                    ...
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            SQL = "insert into detail_submit_PO_Barang_Lain (kode_perusahaan, No_faktur, Kode_Stock_Owner, Kode_Barang, Jumlah, "
            ...
            SQL = "update rencana_Order_Barang_Lain set Flag_Submit_PO = 'Y' "
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        SD_Sub_PO_Barang_Lain.Kode_Supplier = TxtPO_KdSupplier.Text
        ...
        If Not LvPO_DataPO.Rows.Count = 0 Then
            ...
            If LvPO_DataPO.CurrentCell.ColumnIndex = cellPO_Jumlah Then
                ...
                Try
                    ...
                    'UBAH SATUAN
                    SQL = "select dbo.ubah_satuan_Lain('" & KodePerusahaan & "', 'masa','" & KdBarang & "', '" & satuanBesar & "', '" & satuanKecil & "', '" & HilangkanTanda(formattedValue) & "' ) as hasil"
                    Using Dr = OpenTrans(SQL)
                        If Dr.Read Then
    ...
    Private Sub Txt_GrandPPH_DoubleClick(sender As Object, e As EventArgs) Handles Txt_GrandPPH.DoubleClick
        ...
        SD_Detail_PajakPO_Sub_Barang_Lain.Txt_NoFakInduk.Text = Txt_Faktur_Induk.Text
        SD_Detail_PajakPO_Sub_Barang_Lain.TxtPO_GrandTotal.Text = TxtPO_Total.Text
        SD_Detail_PajakPO_Sub_Barang_Lain.asal = "SUBPO"
        SD_Detail_PajakPO_Sub_Barang_Lain.ShowDialog()
    End Sub
