Public Class EMI_Validasi_Pengajuan_Selesai_PR_Barang_Lain
    ...
    Private Sub Cari()
        ...
        Try
            ...
            SQL = SQL & "From EMI_Purchase_Requisition_Barang_Lain a, EMI_Purchase_Requisition_Barang_Lain_Detail b , barang_Lain c "
            ...
            SQL = SQL & "And flag_release = 'Y' and b.flag_sudah_po is null and b.Flag_Pengajuan_Selesai = 'Y' and kode_kategori_gudang in( "
            SQL = SQL & "select distinct b.kode_stock_owner_gudang from "
            SQL = SQL & "N_EMI_Master_Kategori_Gudang_Binding_User_Barang_Lain a, N_EMI_Master_Kategori_Gudang_Barang_Lain b "
            SQL = SQL & "where a.kode_perusahaan=b.kode_perusahaan and a.kode_kategori_gudang=b.kode_kategori_gudang "
            SQL = SQL & "and b.jenis_gudang='Warehouse' and a.user_id='" & UserID & "' "
            SQL = SQL & ") "
            SQL = SQL & ") "
