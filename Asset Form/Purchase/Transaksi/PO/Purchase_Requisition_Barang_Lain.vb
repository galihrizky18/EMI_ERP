Public Class Purchase_Requisition_Barang_Lain
    ...
    Dim LvIdCostCenter, LvIdGedung, LvIsStock, LvNmCostCenter, LvNmGedung, LvNmStock As String
    ...
    Dim CellIDCostCenter As Integer = 9
    Dim CellIDGedung As Integer = 10
    Dim CellIsStock As Integer = 11
    Dim CellNmCostCenter As Integer = 12
    Dim CellNmGedung As Integer = 13
    Dim CellNmStock As Integer = 14
        ...
        Try
            ...
            If Btn_Simpan.Tag = "&Simpan" Then
                ...
                For i As Integer = 0 To Dgv_DataBarang.Rows.Count - 2
                    ...
                    SQL = SQL & " Id_Cost_Center, ID_Gedung, Flag_Stock ) values( "
