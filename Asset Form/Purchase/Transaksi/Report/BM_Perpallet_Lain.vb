...
Public Class BM_Perpallet_Lain
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.BM_Perpallet_Lain.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBM_Perpallet_Lain
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BM_Perpallet_Lain = New BM_Perpallet_Lain()
        rpt.Site = Me.Site
        Return rpt
    End Function
