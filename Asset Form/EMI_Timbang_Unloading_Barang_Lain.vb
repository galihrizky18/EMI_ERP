...
Public Class EMI_Timbang_Unloading_Barang_Lain
    ...
    Public Sub Get_DGVKeluar()
        ...
        Try
            ...
            SQL = SQL & "from EMI_Timbang_Unloading_Barang_Lain a, EMI_Timbang_Unloading_PO_Det_Barang_Lain b, emi_pembelian_loading_detail_barang_lain c, Barang_Lain d "
            ...
            SQL = SQL & ",isnull((select sum(Jumlah_Bags) from EMI_Barang_Masuk_Perpallet_Barang_Lain x where "
            ...
            SQL = SQL & ",isnull((select sum(Jumlah) from EMI_Barang_Masuk_Perpallet_Barang_Lain x where "
            SQL = SQL & "x.Kode_Perusahaan=a.Kode_Perusahaan and x.No_Pembelian_Loading=a.No_Faktur and x.status is null "
            SQL = SQL & "and x.Kode_Barang=b.Kode_Barang),0) as Jumlah_Barang "

            SQL = SQL & ",isnull((select sum(Jumlah_Pallet) from EMI_Barang_Masuk_Perpallet_Barang_Lain x where "
            SQL = SQL & "x.Kode_Perusahaan=a.Kode_Perusahaan and x.No_Pembelian_Loading=a.No_Faktur and x.status is null "
            SQL = SQL & "and x.Kode_Barang=b.Kode_Barang),0) as Jumlah_Pallet, b.Flag_Tolak "

            SQL = SQL & "from emi_pembelian_loading_barang_lain a, emi_pembelian_loading_detail_barang_lain b, Barang_Lain c where "
            ...
            SQL = SQL & "Select distinct b.Kode_Barang from EMI_Timbang_Unloading_Barang_Lain a, EMI_Timbang_Unloading_PO_Det_Barang_Lain b "
            ...
            Using ds = BindingTrans(SQL)
                With ds.Tables("MyTable")
                    For id2 = 0 To .Rows.Count - 1
                        ...
                        SQL = "select dbo.ubah_satuan_lain('" & KodePerusahaan & "','MASA','" & .Rows(id2).Item("Kode_Barang") & "',"
    ...
    Public Sub Get_DGVMasuk()
        ...
        Try
            ...
            SQL = SQL & "from emi_pembelian_loading_barang_lain a, emi_pembelian_loading_detail_barang_lain b, Barang_Lain c, Suppliers d "
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            If jenisMasuk = "MASUK" Then
                ...
                SQL = "Insert into EMI_Timbang_Unloading_Barang_Lain (Kode_Perusahaan, "
                ...
                For i As Integer = 0 To DgvPO.RowCount - 1
                    ...
                    If LvNoPO <> noPO Then
                        SQL = "Insert into EMI_Timbang_Unloading_PO_Barang_Lain ("
                    ...
                    SQL = "Insert into EMI_Timbang_Unloading_PO_Det_Barang_Lain ("
                    ...
                    SQL = "update emi_pembelian_loading_detail_barang_lain set flag_timbang_masuk='Y' where No_Faktur='" & TxtNo_Loading.Text & "' "
                ...
                'FLAGING BRUTO
                SQL = "update emi_pembelian_loading_barang_lain set "
                ...
                SQL = "select Kode_Perusahaan from emi_pembelian_loading_detail_barang_lain where "
                SQL = SQL & "No_faktur='" & TxtNo_Loading.Text & "' and Kode_Perusahaan='" & KodePerusahaan & "' "
                SQL = SQL & "and Flag_Timbang_masuk is null "
                Using dr = OpenTrans(SQL)
                    If Not dr.Read Then
                        dr.Close()
                        SQL = "update emi_pembelian_loading_barang_lain set Flag_Timbang ='Y' "
                        SQL = SQL & "where No_faktur='" & TxtNo_Loading.Text & "' and Kode_Perusahaan='" & KodePerusahaan & "' "
                        ExecuteTrans(SQL)
                ...
                kosong()
                EMI_Display_Timbang_Barang_Lain.kosong()
                Me.Close()
                'Exit Sub
            ElseIf jenisMasuk = "KELUAR" Then
                ...
                SQL = "select inisial_faktur from Stock_Owner_Gudang_Lain "
                ...
                SQL = "Update EMI_Timbang_Unloading_Barang_Lain "
                ...
                SQL = "Select Flag_Import, Flag_Import_HPP from emi_pembelian_loading_barang_lain "
                ...
                For i As Integer = 0 To DgvPO.RowCount - 1
                    ...
                    SQL = "select distinct Satuan from Barang_Lain where "
                    ...
                    SQL = "update emi_pembelian_loading_detail_barang_lain set Jumlah_Masuk = " & jumlah_masuk_Barang & " "
                    SQL = SQL & ", flag_timbang_keluar='Y'"
                    SQL = SQL & "where No_Faktur='" & TxtNo_Loading.Text & "' and Urut_Oto='" & LvUrutLoading & "'"
                    ExecuteTrans(SQL)

                    SQL = "update EMI_Timbang_Unloading_PO_Det_Barang_Lain set "
                ...
                If metodeTruckScale = "TRUCK SCALE" Then
                    ...
                    SQL = "Update EMI_Barang_Masuk_Perpallet_Barang_Lain set "
                ...
                SQL = SQL & "Jumlah_Bags, Qr_Code, Batch_Number, warna from EMI_Barang_Masuk_Perpallet_Barang_Lain a where "
                SQL = SQL & "Kode_Perusahaan='" & KodePerusahaan & "' and "
                SQL = SQL & "No_Pembelian_Loading='" & TxtNo_Loading.Text & "' and status is null and Flag_Timbang_Keluar is null "
                Using ds = BindingTrans(SQL)
                    With ds.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            For index = 0 To .Rows.Count - 1
                                ...
                                SQL = "select Tanggal_Masuk from emi_pembelian_loading_barang_lain where No_Faktur = '" & .Rows(index).Item("No_Pembelian_Loading") & "' and No_SJ = '" & .Rows(index).Item("No_SJ") & "' "
                                ...
                                SQL = "insert into barang_lain_sn(kode_perusahaan, kode_stock_owner, kode_barang, "
                                ...
                                SQL = SQL & "FROM Barang_Lain a WHERE a.Kode_Stock_Owner = '" & .Rows(index).Item("kode_stock_owner") & "' "
                ...
                SQL = "Update emi_pembelian_loading_barang_lain "
                SQL = SQL & "Set Flag_Proses_loading = null, flag_sdh_update = 'Y' "
                SQL = SQL & "Where No_Faktur = '" & TxtNo_Loading.Text & "' "
                ExecuteTrans(SQL)

                'CEK APAKAH PO TERPENUHI
                SQL = "select * from emi_pembelian_loading_detail_barang_lain where No_Faktur='" & TxtNo_Loading.Text & "' "
        ...
        Try
            ...
            If jenisMasuk = "MASUK" Then
                ...
                SQL = "select top 1 No_Faktur from EMI_Timbang_Unloading_PO_Det_Barang_Lain where no_Faktur='" & No_Faktur & "'"
                Using Ds = BindingTrans(SQL)
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then
                        ...
                        '    CrDoc.RecordSelectionFormula = "{EMI_Timbang_Unloading_PO_Det_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {EMI_Timbang_Unloading_PO_Det_Barang_Lain.No_Faktur}='" & No_Faktur & "' "
                        ...
                        CrDoc = New Rpt_Surat_Perintah_Bongkar_Barang_Lain
                        kertas = "Faktur"
            ...
            ElseIf jenisMasuk = "KELUAR" Then
                ...
                Using Ds = BindingTrans(SQL)
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then
                        'CrDoc = New Rpt_Bukti_Penerimaan_Barang_Lain
                        'With A_Place_For_Printing2
                        '    CrDoc.SetDataSource(Ds)
                        '    CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                        '    CrDoc.PrintOptions.PrinterName = ""
                ...
                SQL = "select Kode_Jenis_Muatan from Vw_Bukti_Timbang_Barang_Lain where No_Faktur = '" & No_Faktur & "'"
                Using Ds = BindingTrans(SQL)
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then
                        'CrDoc = New Rpt_Bukti_Timbang_Barang_Lain
                        'With A_Place_For_Printing3
                        '    CrDoc.SetDataSource(Ds)
                        '    CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                        '    CrDoc.PrintOptions.PrinterName = ""
                        '    CrDoc.RecordSelectionFormula = "{EMI_Timbang_Unloading_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {EMI_Timbang_Unloading_Barang_Lain.No_Faktur}='" & No_Faktur & "' "
                        '    CrDoc.SummaryInfo.ReportTitle = "Surat Bukti Penerimaan Barang"
                        ...
                        CrDoc.RecordSelectionFormula = "{Vw_Bukti_Timbang_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {Vw_Bukti_Timbang_Barang_Lain.No_Faktur}='" & No_Faktur & "' "
                        'CrDoc.SummaryInfo.ReportTitle = "Halaman : " & min & "/" & max
    ...
    Private Sub get_no_faktur()
        Txt_NoFaktur.Text = fTransTimbanganKosongLain & Format(tgl_skg, "MMyy") & "-" &
                             General_Class.Get_Last_Number2("EMI_Timbang_Unloading_Barang_Lain", "No_Faktur", 5,
                             "Kode_perusahaan", KodePerusahaan,
                             "And", "substring(no_Faktur, 1, " & Len(fTransTimbanganKosongLain) + 4 & ")", fTransTimbanganKosongLain & Format(tgl_skg, "MMyy"))
    End Sub
    ...
    Private Sub Jurnal_Import()
        ...
        SQL = "select sum(Jumlah * hpp_satuan_display) as Biaya from emi_pembelian_loading_detail_barang_lain "
    ...
    Private Sub Jurnal_Lokal()
        ...
        For index = 0 To DgvPO.Rows.Count - 1
            ...
            SQL = SQL & "from EMI_Group_Jenis_Lain a, Barang_Lain b, EMI_Group_Jenis_Akun c where "
    ...
    Private Sub loadJenisMuatan()
        Try
            ...
            If jenisMasuk = "KELUAR" Then
                ...
                SQL = "select timbang_masuk, id_jenis_muatan, tgl_timbang_masuk, Jam_Timbang_Masuk from EMI_Timbang_Unloading_Barang_Lain where "
            ...
            If jenisMasuk = "MASUK" Then
                ...
                SQL = SQL & "from EMI_Timbang_Unloading_Barang_Lain a, emi_pembelian_loading_barang_lain b, EMI_Master_Jenis_Muatan c "
    ...
    Private Sub Transaksi_Timbang_Unloading_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If jenisMasuk = "MASUK" Then
                Lbl_Judul.Text = "Transaksi - Timbang Barang Lain 1 " 'Base_Language.Lang_TransUnloading_Judul + " | " + Base_Language.Lang_Global_Bruto
            ...
            ElseIf jenisMasuk = "KELUAR" Then
                Lbl_Judul.Text = "Transaksi - Timbang Barang Lain 2 " 'Base_Language.Lang_TransUnloading_Judul + " | " + Base_Language.Lang_Global_Tara
                ...
                SQL = "select No_Faktur from EMI_Timbang_Unloading_Barang_Lain a where "
            ...
            '================================
            SQL = "select b.Kode_Stock_Owner from Binding_Lokasi_Gudang_Lain a, Stock_Owner_Gudang_Lain b "
