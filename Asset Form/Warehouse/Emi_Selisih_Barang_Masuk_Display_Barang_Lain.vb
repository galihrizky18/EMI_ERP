Public Class Emi_Selisih_Barang_Masuk_Display_Barang_Lain
    ...
    Private Sub Lv_Data_DoubleClick(sender As Object, e As EventArgs) Handles Lv_Data.DoubleClick
        ...
        Emi_Selisih_Barang_Masuk2_Barang_Lain.P_NoFakturPO = Lv_NoFaktur
        Emi_Selisih_Barang_Masuk2_Barang_Lain.P_Supplier = Lv_Supplier
        Emi_Selisih_Barang_Masuk2_Barang_Lain.P_KdSupplier = Lv_KdSupplier
        Emi_Selisih_Barang_Masuk2_Barang_Lain.P_NoSJ = Lv_NoSJ
        Emi_Selisih_Barang_Masuk2_Barang_Lain.P_NoPlat = Lv_NoPlat
        Emi_Selisih_Barang_Masuk2_Barang_Lain.P_Driver = Lv_Driver
