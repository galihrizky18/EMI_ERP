...
Public Class Master_Barang_Lain
    ...
    Private Sub Kosong()
        ...
        Cmb_Kategori.Items.Clear() : Cmb_Kelompok.Items.Clear() : Cmb_Kd_Aktiva.Items.Clear()
    ...
    Private Sub Perusahaan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ListView1.Columns.Add(Base_Language.Lang_Global_Aktif, 75, HorizontalAlignment.Center)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
                    ...
                    With Ds.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            For i As Integer = 0 To .Rows.Count - 1
                                ...
                                SQL = SQL & ", Keterangan, Flag_Grouping, ID_Kategori, ID_Kelompok, Kode_Aktiva) "
                                SQL = SQL & "values ('" & KodePerusahaan & "', '" & .Rows(i).Item("kode_stock_owner") & "', "

                                SQL = SQL & "'" & TextBox1.Text.Trim & "', '" & TextBox1.Text.Trim & "', "
                                SQL = SQL & "'" & TextBox2.Text.Trim & "', '" & TextBox2.Text.Trim & "', '" & cmbSatuan.Text.Trim & "', "
            ...
            Else
                ...
                SQL = "delete Barang_Detail_Satuan_Lain where kode_perusahaan = '" & KodePerusahaan & "' and kode_barang = '" & TextBox1.Text & "' "
                ExecuteTrans(SQL)
    ...
    Private Sub cmbJenis_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbJenis.SelectedIndexChanged
        ...
        Try
            ...
            Cmb_Kelompok.Items.Clear() : Cmb_Kd_Aktiva.Items.Clear()
