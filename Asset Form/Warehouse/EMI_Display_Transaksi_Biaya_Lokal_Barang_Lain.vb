Public Class EMI_Display_Transaksi_Biaya_Lokal_Barang_Lain
    ...
    Private Sub Lv_PO_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_PO.SelectedIndexChanged
        ...
        Try
            ...
            SQL = SQL & "(dbo.ubah_satuan_lain(a.Kode_Perusahaan, 'masa',b.Kode_Barang, b.Satuan_Barang, b.Satuan, sum(c.Jumlah_Masuk) )) as Jumlah_Masuk, "

            SQL = SQL & "ISNULL(((dbo.ubah_satuan_lain(a.Kode_Perusahaan, 'masa',b.Kode_Barang, b.Satuan_Barang, b.Satuan, sum(c.Jumlah_Masuk) )) - b.Jumlah), 0) as Selisih_Barang "

            SQL = SQL & "From EMI_Pembelian_PO_Barang_Lain a, EMI_Pembelian_PO_Detail_Barang_Lain b, emi_pembelian_loading_detail_barang_lain c, Barang_Lain d, emi_pembelian_loading_barang_lain e "
    ...
    Private Sub Lv_PO_DoubleClick(sender As Object, e As EventArgs) Handles Lv_PO.DoubleClick
        ...
        Try
            ...
            '========================================
            SQL = "select top 1 Kode_Perusahaan from emi_pembelian_loading_detail_barang_lain where Kode_Perusahaan = '" & KodePerusahaan & "' and No_PO = '" & Lv_NoPO & "' "
            Using Dr = OpenTrans(SQL)
                If Not Dr.Read Then
                    Dr.Close()
                    CloseConn()
            ...
            SQL = SQL & "from EMI_Pembelian_PO_Detail_Barang_Lain "
        ...
        Transaksi_Biaya_Lokal_Barang_Lain.Kosong()
        Transaksi_Biaya_Lokal_Barang_Lain.Cmb_Lokasi.Text = Lv_Lokasi
        Transaksi_Biaya_Lokal_Barang_Lain.TxtNo_PO.Text = Lv_NoPO
        Transaksi_Biaya_Lokal_Barang_Lain.Txt_Keterangan.Text = Lv_Keterangan
        Transaksi_Biaya_Lokal_Barang_Lain.Txt_Kd_Supplier.Text = Lv_KdSupplier
        Transaksi_Biaya_Lokal_Barang_Lain.Txt_NmSupllier.Text = Lv_NmSupplier
        Transaksi_Biaya_Lokal_Barang_Lain.Txt_TglPO.Text = Lv_Tanggal
        Transaksi_Biaya_Lokal_Barang_Lain.Txt_User.Text = Lv_User
        Transaksi_Biaya_Lokal_Barang_Lain.Txt_JumlahPO.Text = Format(JumlahPO, "N2")
        Transaksi_Biaya_Lokal_Barang_Lain.Txt_Berat.Text = Format(TotalBerat, "N2")
        Transaksi_Biaya_Lokal_Barang_Lain.TxtJumlahMobil.Text = JumlahMobil
        Transaksi_Biaya_Lokal_Barang_Lain.ShowDialog()
    ...
    Private Sub Cmb_Filter_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Cmb_Filter.SelectedIndexChanged
        ...
        Transaksi_Biaya_Lokal_Barang_Lain.Kosong()
        Transaksi_Biaya_Lokal_Barang_Lain.Cmb_Lokasi.Text = ""
    ...
    Private Sub TanpaBiayaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TanpaBiayaToolStripMenuItem.Click
        ...
        Try
            ...
            SQL = SQL & "from EMI_Pembelian_PO_Barang_Lain a, EMI_Pembelian_PO_Detail_Barang_Lain b, emi_pembelian_loading_detail_barang_lain c "
            ...
            '=     UPATE FLAG_BIAYA     =
            '============================
            SQL = "update EMI_Pembelian_PO_Barang_Lain set Flag_Biaya = 'Y' where Kode_Perusahaan = '" & KodePerusahaan & "' and no_faktur = '" & Lv_NoPO & "' "
            ExecuteTrans(SQL)
