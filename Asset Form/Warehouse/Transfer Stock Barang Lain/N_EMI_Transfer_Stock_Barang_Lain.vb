...
Public Class N_EMI_Transfer_Stock_Barang_Lain
    ...
    Dim dgv_Rekap_lokasi, dgv_Rekap_KdBarang, dgv_Rekap_NmBarang, dgv_Rekap_Jumlah, dgv_Rekap_JumlahBags, dgv_Rekap_JumlahBersih, dgv_Rekap_Satuan, dgv_Rekap_SatuanKecil, dgv_Rekap_Oto, dgv_Rekap_JnsTransfer, dgv_rekap_otoReqGen, dgv_rekap_UrutKeep, dgv_rekap_JnsGudang As String
        ...
        If asal <> "Emi_Display_Request_Material" Then
            ...
            Try
                ...
                SQL = $"
                    ...
                    select top(20) a.kode_stock_owner, a.kode_barang, a.nama, dbo.ubah_satuan(a.kode_Perusahaan, 'masa', a.kode_barang, a.satuan,
    ...
    Public Sub Btn_Insert_Click(sender As Object, e As EventArgs) Handles Btn_GetData.Click
        ...
        Try
            ...
            SQL = SQL & "dbo.ubah_satuan(a.kode_Perusahaan, 'masa', a.kode_barang, b.satuan, '" & TxtSatuan.Text & "', sum(a.jumlah)) as jumlah, "
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            For i As Integer = 0 To Dgv_DataRekap.Rows.Count - 1
                ...
                SQL = SQL & "Total_Barang, Satuan_Barang, Total_Bags, urut_material_requisition_convert, Flag_Timbang, Flag_Jenis_Request, Urut_Keep_Stock) values "
                ...
                SQL = SQL & "'" & HilangkanTanda(dgv_Rekap_JumlahBags) & "', '" & dgv_Rekap_Oto & "', '" & Flag_Timbang & "', " & dgv_Rekap_JnsTransfer & ", '" & dgv_rekap_UrutKeep & "' )"
                ExecuteTrans(SQL)
    ...
    Private Sub Btn_SimpanSementara_Click(sender As Object, e As EventArgs) Handles Btn_SimpanSementara.Click
        ...
        If isProduction Then
            ...
            Try
                ...
                'Dim Persen_Toleransi_Min As Double = 0
                'Dim Persen_Toleransi_Max As Double = 0
                'SQL = "select Toleransi_Tf_Min, Toleransi_Tf_Max from barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' "
                'SQL = SQL & "and Kode_Stock_Owner = '" & arrSO(CmbSO_Asal.SelectedIndex) & "' and Kode_Barang = '" & DGV_Data_TF.CurrentRow.Cells(itemDgvKodeBarang).Value & "' "
                'Using Dr = OpenTrans(SQL)
                '    If Dr.Read Then
                '        Persen_Toleransi_Min = Dr("Toleransi_Tf_Min")
                ...
                'SQL = "select c.Jumlah, "
                'SQL = SQL & "ISNULL(( "
                'SQL = SQL & "select sum(w.jumlah) from N_EMI_Transfer_Stock_Barang_Lain x,  N_EMI_Transfer_Stock_Barang_Lain_Detail y, "
                'SQL = SQL & "N_EMI_Transfer_Stock_Barang_Lain_Det z, N_EMI_Transfer_Stock_Barang_Lain_Det2 w  "
