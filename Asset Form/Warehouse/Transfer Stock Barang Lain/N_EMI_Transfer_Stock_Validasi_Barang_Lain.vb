Public Class N_EMI_Transfer_Stock_Validasi_Barang_Lain
    ...
    Private Sub Lv_List_Barang_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_List_Barang.SelectedIndexChanged
    ...
    Private Sub Popup_Timbang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Label1.Text = "Display - List Transfer Stock Barang Lain"
    ...
    Private Sub Btn_TimbangFloorScale_Click(sender As Object, e As EventArgs) Handles Btn_TimbangFloorScale.Click
        ...
        Try
            ...
            SQL = "select serial_number, Blok_SN from barang_lain_sn "
            ...
            SQL = SQL & "From Tf_Stock_Parent_Barang_Lain a, tf_stock_Barang_Lain b, tf_stock_det_barang_lain c, Barang_Lain d Where "
        ...
        '--------------------------------------------------------------- 
        EMI_Timbang_Floor_Scale_Barang_Lain.kosong()
        EMI_Timbang_Floor_Scale_Barang_Lain.txtUrutOto.Text = GetDataUrutOto
        EMI_Timbang_Floor_Scale_Barang_Lain.txtKodeTransfer.Text = GetDataKodeTransfer
        EMI_Timbang_Floor_Scale_Barang_Lain.TxtKdBarang.Text = GetDataKdBrg
        EMI_Timbang_Floor_Scale_Barang_Lain.txt_lokasi.Text = GetDataLokasi
        EMI_Timbang_Floor_Scale_Barang_Lain.txt_barang.Text = GetDataNmBrg
        EMI_Timbang_Floor_Scale_Barang_Lain.txt_Barang_SN.Text = GetDataBrgSN
        EMI_Timbang_Floor_Scale_Barang_Lain.txt_Jml_Estimasi.Text = GetDataJmlEstimasi
        EMI_Timbang_Floor_Scale_Barang_Lain.TxtJumlahBags.Text = GetDataJumlahBags
        EMI_Timbang_Floor_Scale_Barang_Lain.TxtBeratBags.Text = GetDataBeratBags & " " & GetDataSatuanBeratBags
        EMI_Timbang_Floor_Scale_Barang_Lain.Txt_Berat_Bags_Bersih.Text = GetDataBeratBags
        EMI_Timbang_Floor_Scale_Barang_Lain.TxtSatuan_FloorScale.Text = GetDataSatuanBeratBesar

        EMI_Timbang_Floor_Scale_Barang_Lain.Txt_SatuanKecil.Text = GetDataSatuanKecil
        EMI_Timbang_Floor_Scale_Barang_Lain.TxtBarcode.Text = Txt_ScanBarcode.Text
        EMI_Timbang_Floor_Scale_Barang_Lain.CmbJenisTimbang.SelectedItem = "TRANSFER STOCK"

        EMI_Timbang_Floor_Scale_Barang_Lain.Btn_Refresh.Visible = False
        EMI_Timbang_Floor_Scale_Barang_Lain.UNIX.Visible = False


        EMI_Timbang_Floor_Scale_Barang_Lain.GetSisaTransfer()
        EMI_Timbang_Floor_Scale_Barang_Lain.ShowDialog()
    End Sub
    ...
    Private Sub ListView2_DoubleClick(sender As Object, e As EventArgs) Handles Lv_List_Barang.DoubleClick
        ...
        ''EMI_Timbang_Floor_Scale_Barang_Lain.txtKodeTransfer.Text = LvKodeTransfer
        ''EMI_Timbang_Floor_Scale_Barang_Lain.txt_lokasi.Text = LvSoAwal
        ''EMI_Timbang_Floor_Scale_Barang_Lain.txt_barang.Text = LvNamaBarang
        ''EMI_Timbang_Floor_Scale_Barang_Lain.TxtKdBarang.Text = LvKodeBarang
        ''EMI_Timbang_Floor_Scale_Barang_Lain.txt_Barang_SN.Text = LvSn
        ''EMI_Timbang_Floor_Scale_Barang_Lain.txt_Jml_Estimasi.Text = LvTotal
        ''EMI_Timbang_Floor_Scale_Barang_Lain.Txt_SatuanKecil.Text = LvSatuanBarang
        ''EMI_Timbang_Floor_Scale_Barang_Lain.CmbJenisTimbang.SelectedItem = "TRANSFER STOCK"
        ...
        '    EMI_Timbang_Unloading_Barang_Lain.kosong()
        '    If LvBruto = "-" Or isTimbangMasuk = "Y" Then
        '        EMI_Timbang_Unloading_Barang_Lain.LblNo_Loading.Text = LvNoLoading
        '        EMI_Timbang_Unloading_Barang_Lain.Lbl_KodeSupplier.Text = LvKdSupplier
        '        EMI_Timbang_Unloading_Barang_Lain.Lbl_NamaSupplier.Text = LvNmSupplier
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_Supplier.Text = LvKdSupplier + "(" + LvNmSupplier + ")"
        '        EMI_Timbang_Unloading_Barang_Lain.Lbl_IDEkspedisi.Text = LvIdEkspedisi
        '        EMI_Timbang_Unloading_Barang_Lain.Lbl_NmEkspedisi.Text = LvEkspedisi
        '        EMI_Timbang_Unloading_Barang_Lain.Lbl_NoSJ.Text = LvNoSJ
        '        'EMI_Timbang_Unloading_Barang_Lain.Txt_Ekspedisi.Text = LvEkspedisi
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_Ekspedisi = LvEkspedisi
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_Supir.Text = LvSupir
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_PlatNomor.Text = LvPlatNomor
        '        ' EMI_Timbang_Unloading_Barang_Lain.Get_Timbang_Masuk()


        '        'EMI_Timbang_Unloading_Barang_Lain.Lbl_WaktuTimbangBruto.Visible = True
        '        'EMI_Timbang_Unloading_Barang_Lain.DTP_Bruto.Visible = True
        '        'EMI_Timbang_Unloading_Barang_Lain.Lbl_Timbang1.Visible = True
        '        'EMI_Timbang_Unloading_Barang_Lain.Txt_Timbang1.Visible = True
        '        'EMI_Timbang_Unloading_Barang_Lain.Txt_Timbang1.Enabled = True
        '        'EMI_Timbang_Unloading_Barang_Lain.Label21.Visible = True
        '        'EMI_Timbang_Unloading_Barang_Lain.Lbl_Bruto.Location = New Point(15, 307)
        '        'EMI_Timbang_Unloading_Barang_Lain.Txt_Bruto.Location = New Point(130, 307)
        '        'EMI_Timbang_Unloading_Barang_Lain.Label21.Location = New Point(274, 307)

        '        'EMI_Timbang_Unloading_Barang_Lain.Lbl_Timbang2.Visible = False
        '        'EMI_Timbang_Unloading_Barang_Lain.Lbl_Netto.Visible = False
        '        'EMI_Timbang_Unloading_Barang_Lain.Txt_Timbang2.Visible = False
        '        ' EMI_Timbang_Unloading_Barang_Lain.Txt_Timbang2.Enabled = False
        '        'EMI_Timbang_Unloading_Barang_Lain.Txt_Netto.Visible = False
        '        'EMI_Timbang_Unloading_Barang_Lain.Label8.Visible = False
        '        'EMI_Timbang_Unloading_Barang_Lain.Label23.Visible = False
        '        ' EMI_Timbang_Unloading_Barang_Lain.Lbl_WaktuTimbangTara.Visible = False
        '        'EMI_Timbang_Unloading_Barang_Lain.DTP_Tara.Visible = False

        '        EMI_Timbang_Unloading_Barang_Lain.filterDetailBarang = "and b.Flag_Timbang_Masuk is null and b.Flag_Sudah_Bongkar_Android is null and b.Flag_Timbang_Keluar is null"
        '        EMI_Timbang_Unloading_Barang_Lain.Get_DGV()
        '        EMI_Timbang_Unloading_Barang_Lain.Btn_Simpan.Tag = "&SimpanBruto"
        '        EMI_Timbang_Unloading_Barang_Lain.Btn_Simpan.Text = "&Simpan Bruto"

        '    Else
        '        EMI_Timbang_Unloading_Barang_Lain.LblNo_Loading.Text = LvNoLoading
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_NoFaktur.Text = LvNoTimbangan
        '        'EMI_Timbang_Unloading_Barang_Lain.Txt_Ekspedisi.Text = LvEkspedisi
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_Ekspedisi = LvEkspedisi
        '        EMI_Timbang_Unloading_Barang_Lain.Lbl_KodeSupplier.Text = LvKdSupplier
        '        EMI_Timbang_Unloading_Barang_Lain.Lbl_NamaSupplier.Text = LvNmSupplier
        ...
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_Supir.Text = LvSupir
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_PlatNomor.Text = LvPlatNomor
        '        EMI_Timbang_Unloading_Barang_Lain.Txt_Timbang1.Text = LvBruto
        '        EMI_Timbang_Unloading_Barang_Lain.Lbl_NoSJ.Text = LvNoSJ
        '        EMI_Timbang_Unloading_Barang_Lain.ListView2.CheckBoxes = False
        ...
        '        ' EMI_Timbang_Unloading_Barang_Lain.Lbl_Timbang2.Visible = True
        '        ' EMI_Timbang_Unloading_Barang_Lain.Lbl_Netto.Visible = True
        '        ' EMI_Timbang_Unloading_Barang_Lain.Txt_Timbang2.Visible = True
        '        '  EMI_Timbang_Unloading_Barang_Lain.Txt_Timbang2.Enabled = True
        '        '  EMI_Timbang_Unloading_Barang_Lain.Txt_Netto.Visible = True
        '        ' EMI_Timbang_Unloading_Barang_Lain.Label8.Visible = True
        '        ' EMI_Timbang_Unloading_Barang_Lain.Label23.Visible = True
        '        ' EMI_Timbang_Unloading_Barang_Lain.Lbl_WaktuTimbangTara.Visible = True
        '        '  EMI_Timbang_Unloading_Barang_Lain.DTP_Tara.Visible = True
        '        ' EMI_Timbang_Unloading_Barang_Lain.Lbl_Tara.Location = New Point(15, 307)
        '        'EMI_Timbang_Unloading_Barang_Lain.Txt_Tara.Location = New Point(130, 307)
        '        'EMI_Timbang_Unloading_Barang_Lain.Label8.Location = New Point(274, 307)


        '        ' EMI_Timbang_Unloading_Barang_Lain.Get_Timbang_Keluar()
        '        EMI_Timbang_Unloading_Barang_Lain.filterDetailBarang = "and b.flag_timbang_masuk='Y' and b.Flag_Sudah_Bongkar_Android='Y'"
        '        EMI_Timbang_Unloading_Barang_Lain.Get_DGV()
        '        ' EMI_Timbang_Unloading_Barang_Lain.Hitung_Netto()
        '        EMI_Timbang_Unloading_Barang_Lain.Btn_Simpan.Tag = "&SimpanTara"
        '        EMI_Timbang_Unloading_Barang_Lain.Btn_Simpan.Text = "&Simpan Tara"
        '        EMI_Timbang_Unloading_Barang_Lain.DataGridView1.Columns(4).Visible = True
        '    End If

        '    EMI_Timbang_Unloading_Barang_Lain.ShowDialog()
        ...
        '    'Try
        '    '    OpenConn()
        '    '    SQL = "select Kode_Stock_Owner_gudang from Binding_Lokasi_Gudang_Lain where kode_perusahaan = '" & KodePerusahaan & "' and Gudang_Default = 'Y' and Kode_Stock_Owner='" & LvLokasi & "' "
        '    '    Using dr = OpenTrans(SQL)
        '    '        If dr.Read Then
