...
Public Class EMI_Display_Timbang_Barang_Lain
    ...
    Private Sub Get_Timbangan_Unloading()
        Try
            ...
            SQL = SQL & "isnull((select top(1) 'Y' from emi_pembelian_loading_detail_barang_lain x where x.no_faktur=a.no_faktur and "
            ...
            SQL = SQL & "isnull((select top(1) No_Faktur from EMI_Timbang_Unloading_Barang_Lain x where x.no_loading=a.no_faktur and "
            SQL = SQL & "x.flag_selesai is null ORDER BY x.no_loading),'-') as No_Timbangan "
            SQL = SQL & "FROM emi_pembelian_loading_barang_lain a, Suppliers b WHERE "
    ...
    Private Sub ListView2_DoubleClick(sender As Object, e As EventArgs) Handles Lv_ListKendaraan.DoubleClick
        ...
        If asal = "Unloading_Barang" Then
            ...
            If jenisMasuk = "MASUK" Then
                EMI_Timbang_Unloading_Barang_Lain.TxtNo_Loading.Text = LvNoLoading
                EMI_Timbang_Unloading_Barang_Lain.jenisMasuk = "MASUK"

            ElseIf jenisMasuk = "KELUAR" Then
                EMI_Timbang_Unloading_Barang_Lain.TxtNo_Loading.Text = LvNoLoading
                EMI_Timbang_Unloading_Barang_Lain.jenisMasuk = "KELUAR"
            Else
