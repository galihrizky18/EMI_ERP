...
Public Class N_EMI_Display_Transfer_Stock_Barang_Lain
    ...
    Private Sub N_EMI_Display_Transfer_Stock_Barang_Lain_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        My.Application.ChangeCulture("en-us")
        My.Application.ChangeUICulture("en-us")
    End Sub

    Private Sub N_EMI_Display_Transfer_Stock_Barang_Lain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        My.Application.ChangeCulture("en-us")
        My.Application.ChangeUICulture("en-us")
    ...
    Private Sub Intial_ListView_Stock()
        ...
        Lv_Stock.Columns.Add("Keterangan", 250, HorizontalAlignment.Left)
        ...
        Lv_Stock.Columns.Add("User Batal", 100, HorizontalAlignment.Center).DisplayIndex = 7
        Lv_Stock.Columns.Add("Tanggal Batal", 100, HorizontalAlignment.Center).DisplayIndex = 7
        Lv_Stock.Columns.Add("Jam Batal", 100, HorizontalAlignment.Center).DisplayIndex = 7
        ...
        Lv_Stock_Detail.Columns.Add("No PR", 149, HorizontalAlignment.Left).DisplayIndex = 0
        ' Lv_Stock_Detail.Columns.Add("Departement", 130, HorizontalAlignment.Left).DisplayIndex = 1
    ...
    Private Sub Lv_Stock_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_Stock.SelectedIndexChanged
        ...
        Try
            ...
            'SQL = SQL & " isnull((select y.Kode_Kategori_Gudang From N_EMI_Purchase_Requisition_Barang_Lain_Departement_Detail x, "
            'SQL = SQL & "N_EMI_Purchase_Requisition_Barang_Lain_Departement y where x.Kode_Perusahaan = y.Kode_Perusahaan "
            'SQL = SQL & "and x.No_Faktur= y.No_Faktur and y.Status is null  "
            'SQL = SQL & "and x.Kode_Perusahaan  = b.Kode_Perusahaan and b.Urut_PR_Dept = x.No_Urut "
            'SQL = SQL & "),'-') as Departement, "

            SQL = SQL & " isnull((select y.No_Faktur From N_EMI_Purchase_Requisition_Barang_Lain_Departement_Detail x, "
            SQL = SQL & "N_EMI_Purchase_Requisition_Barang_Lain_Departement y where x.Kode_Perusahaan = y.Kode_Perusahaan  "
            SQL = SQL & "and x.No_Faktur= y.No_Faktur and y.Status is null  "
            SQL = SQL & "and x.Kode_Perusahaan  = b.Kode_Perusahaan and b.Urut_PR_Dept = x.No_Urut "
            SQL = SQL & "),'-') as No_PR  "
            ...
            SQL = SQL & "From N_EMI_Transfer_Stock_Barang_Lain a, N_EMI_Transfer_Stock_Barang_Lain_Detail b, barang_lain c "
            ...
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    ...
                    lv.SubItems.Add(Dr("No_PR"))
                    '     lv.SubItems.Add(Dr("Departement"))
            ...
            SQL = SQL & "isnull(( select SUM(z.jumlah) from N_EMI_Transfer_Stock_Barang_Lain_Det2 z where z.Kode_Perusahaan = a.Kode_Perusahaan "
            ...
            SQL = SQL & "from N_EMI_Transfer_Stock_Barang_Lain_Det a, View_Warehouse_Position_barang_lain b, Barang_Lain_SN c, N_EMI_Transfer_Stock_Barang_Lain_Detail d where   "
    ...
    Private Sub LvwAwal_SelectedIndexChanged(sender As Object, e As EventArgs) Handles LvwAwal.SelectedIndexChanged
        ...
        Try
            ...
            SQL = SQL & "from N_EMI_Transfer_Stock_Barang_Lain_Det2 a, N_EMI_Transfer_Stock_Barang_Lain_Det b, "
            SQL = SQL & "Barang_Lain_SN c, View_Warehouse_Position_barang_lain d, N_EMI_Transfer_Stock_Barang_Lain_Detail e "
    ...
    Private Sub BtnBarangMasuk_Cari_Click(sender As Object, e As EventArgs) Handles BtnBarangMasuk_Cari.Click
        ...
        Try
            ...
            SQL = SQL & ", UserID_Batal,Tanggal_Batal,Jam_Batal "
            SQL = SQL & "from N_EMI_Transfer_Stock_Barang_Lain a "
            SQL = SQL & "where a.Kode_Perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & " and so_awal in (" & inGudang & ") "
            'SQL = SQL & "and a.Status is null "
            ...
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    ...
                    If General_Class.CekNULL(Dr("UserID_Batal")) = "" Then
                        lv.SubItems.Add("-")
                    Else
                        lv.SubItems.Add(Dr("UserID_Batal"))
                    End If

                    If General_Class.CekNULL(Dr("Tanggal_Batal")) = "" Then
                        lv.SubItems.Add("-")
                    Else
                        lv.SubItems.Add(Format(Dr("Tanggal_Batal"), "dd MMM yyyy"))
                    End If

                    If General_Class.CekNULL(Dr("Jam_Batal")) = "" Then
                        lv.SubItems.Add("-")
                    Else
                        lv.SubItems.Add(Dr("Jam_Batal"))
                    End If
    ...
    Private Sub CetakUlangBarcodeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangBarcodeToolStripMenuItem.Click
        ...
        Try
            ...
            SQL = SQL & "ISNULL(( select z.Metode_Pengeluaran_Stok from barang_lain z where z.Kode_Perusahaan = a.Kode_Perusahaan and "
            SQL = SQL & "z.Kode_Stock_Owner = a.Kode_Stock_Owner and a.Kode_Barang = z.Kode_Barang ), '-') as Metode_Pengeluaran_Stok "
            SQL = SQL & "from Barang_Lain_SN a "
        ...
        Try
            ...
            SQL = SQL & "from N_EMI_Cetak_Transfer_Stock_Barang_Lain a "
            SQL = SQL & "where a.Kode_Perusahaan = '" & KodePerusahaan & "' "
            ...
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    ...
                    CrDoc.SetDataSource(Ds)
                    CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                    CrDoc.RecordSelectionFormula = "{N_EMI_Cetak_Transfer_Stock_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_Cetak_Transfer_Stock_Barang_Lain.kode_unik_print} = '" & kode_unik_print & "' "
    ...
    Private Sub CetakUlangFakturToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangFakturToolStripMenuItem.Click
        ...
        Try
            ...
            'SQL = SQL & "from N_EMI_Transfer_Stock_Barang_Lain_Detail a, Barang_Lain b "
            'SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan "
            'SQL = SQL & "and a.Kode_Barang = b.Kode_Barang "
            ...
            'Using Ds = BindingTrans(SQL)
            '    If Ds.Tables("MyTable").Rows.Count <> 0 Then
            '        Dim CrDoc As New N_EMI_CR_Faktur_Transfer_Stock_Barang_Lain      'Nama file CR
            '        With A_Place_For_Printing2
            '            CrDoc.SetDataSource(Ds)
            '            CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
            '            CrDoc.RecordSelectionFormula = "{N_EMI_Transfer_Stock_Barang_Lain_Detail.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_Transfer_Stock_Barang_Lain_Detail.Kode_Transfer} = '" & Lv_Stock.FocusedItem.Text & "'"
            Dim CrDoc As New Object
            Dim kertas As String = ""
            ...
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    ...
                    With A_Place_For_Printing2
                        ...
                        CrDoc.RecordSelectionFormula = "{N_EMI_View_Transfer_Stock_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_View_Transfer_Stock_Barang_Lain.No_Faktur}='" & Lv_Stock.FocusedItem.Text & "' "
    ...
    Private Sub BatalTransferStockToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BatalTransferStockToolStripMenuItem.Click
        ...
        Try
            ...
            Dim JudulNotif As String = "Pembatalan Transfer Stock Operasional"

            '====================
            '=     CEK ROLE     =
            '====================
            If CekButtonRole("Batal_Transfer_Stock_Operasional") = "T" Then
                CloseTrans()
                CloseConn()
            ...
            '===================================================
            SQL = "select Kode_Perusahaan from N_EMI_Transfer_Stock_Barang_Lain "
            ...
            '=====================================================
            SQL = "select a.Kode_Perusahaan from N_EMI_Transfer_Stock_Barang_Lain a, N_EMI_Transfer_Stock_Barang_Lain_Detail b, N_EMI_Transfer_Stock_Barang_Lain_Det c "
            ...
            SQL = SQL & "ISNULL(( select z.Jumlah from Barang_Lain_SN z where d.kode_perusahaan = z.kode_perusahaan and d.Serial_Number = z.Serial_Number ), NULL) as Jumlah_SN, "
            SQL = SQL & "ISNULL (( select z.Jumlah_Bags from Barang_Lain_SN z where d.kode_perusahaan = z.kode_perusahaan and d.Serial_Number = z.Serial_Number  ), NULL) as Jumlah_Bags_SN "
            SQL = SQL & "from N_EMI_Transfer_Stock_Barang_Lain a, N_EMI_Transfer_Stock_Barang_Lain_Detail b, N_EMI_Transfer_Stock_Barang_Lain_Det c, N_EMI_Transfer_Stock_Barang_Lain_Det2 d "
            ...
            SQL = "select Tanggal from N_EMI_Transfer_Stock_Barang_Lain where status is null and Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & NoTransfer & "' "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    HasData = True
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            SQL = SQL & "FROM barang_lain a WHERE a.Kode_Stock_Owner = '" & .Rows(i).Item("SO_Tujuan") & "' "
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            '== ROLLBACK BARANG SN =='
                            ' PENGURANGAN STOCK
                            SQL = "select Jumlah, Jumlah_Bags from Barang_Lain_SN where Kode_Perusahaan = '" & KodePerusahaan & "' and Serial_Number = '" & SN_Tujuan & "' "
                            Using Ds1 = BindingTrans(SQL)
                                If Ds1.Tables("MyTable").Rows.Count <> 0 Then
                                    ...
                                    Else
                                        ...
                                        SQL = "update Barang_Lain_SN set Jumlah = jumlah - " & JumlahRollBack & ", "
                            ...
                            '== UPDATE BARANG =='
                            SQL = "select good_stock, jumlah_bags from Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and kode_Stock_owner = '" & So_Tujuan & "'  and kode_barang = '" & Kd_Barang & "' "
                            Using Ds1 = BindingTrans(SQL)
                                If Ds1.Tables("MyTable").Rows.Count <> 0 Then
                                    ...
                                    Else
                                        ...
                                        SQL = "update Barang_Lain set good_stock = good_stock - " & JumlahRollBack & ", "
                                        SQL = SQL & "jumlah_bags = jumlah_bags - " & JumlahBagsRollBack & "  "
                            ...
                            SQL = SQL & "isnull((select round(sum(Jumlah_Bags), 2) from Barang_Lain_SN y "
                            SQL = SQL & "where a.kode_Barang=y.kode_Barang and a.Kode_Stock_Owner=y.kode_Stock_Owner and a.kode_Perusahaan=y.kode_Perusahaan ), 0) as jumlah_bags_sn "
                            SQL = SQL & "FROM barang_lain a WHERE a.Kode_Stock_Owner = '" & So_Tujuan & "' "
                            ...
                            'PENAMBAHAN STOCK
                            SQL = "select Jumlah, Jumlah_Bags from Barang_Lain_SN where Kode_Perusahaan = '" & KodePerusahaan & "' and Serial_Number = '" & Sn_Awal & "' "
                            Using Ds1 = BindingTrans(SQL)
                                If Ds1.Tables("MyTable").Rows.Count <> 0 Then
                            ...
                            '== UPDATE BARANG =='
                            SQL = "select good_stock, jumlah_bags from Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "' and kode_Stock_owner = '" & So_Awal & "'  and kode_barang = '" & Kd_Barang & "' "
                            Using Ds1 = BindingTrans(SQL)
                                If Ds1.Tables("MyTable").Rows.Count <> 0 Then
                            ...
                            SQL = SQL & "isnull((select round(sum(Jumlah_Bags), 2) from Barang_Lain_SN y "
                            SQL = SQL & "where a.kode_Barang=y.kode_Barang and a.Kode_Stock_Owner=y.kode_Stock_Owner and a.kode_Perusahaan=y.kode_Perusahaan ), 0) as jumlah_bags_sn "
                            SQL = SQL & "FROM barang_lain a WHERE a.Kode_Stock_Owner = '" & So_Awal & "' "
                            SQL = SQL & "AND a.Kode_Barang = '" & Kd_Barang & "' and a.Kode_Perusahaan='" & KodePerusahaan & "' "
                            SQL = SQL & "group by a.kode_Barang, a.Kode_Stock_Owner, a.kode_Perusahaan "
                            Using Ds2 = BindingTrans(SQL)
                                If Ds2.Tables("MyTable").Rows.Count <> 0 Then
            ...
            '=     UPDATE TF STOCK     =
            '===========================
            SQL = "select Kode_Perusahaan from N_EMI_Transfer_Stock_Barang_Lain where Kode_Perusahaan = '" & KodePerusahaan & "'  "
            SQL = SQL & "and No_Faktur = '" & NoTransfer & "' and status is null "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then

                    Dr.Close()
                    SQL = "update N_EMI_Transfer_Stock_Barang_Lain set Status = 'Y', UserID_Batal = '" & UserID & "', Tanggal_Batal = '" & Format(tgl_skg, "yyyy-MM-dd") & "', Jam_Batal = '" & Format(tgl_skg, "HH:mm:ss") & "' "
            ...
            '===========================
            '=     Cek kembalikan nilai berdasarkan pr 
            '===========================

            SQL = "select b.urut_pr_dept,b.total, isnull(b.Flag_Jenis_Request, '-') as Asal_Barang,b.Urut_Keep_Stock from N_EMI_Transfer_Stock_Barang_Lain a, N_EMI_Transfer_Stock_Barang_Lain_Detail b "
            SQL = SQL & "where a.No_Faktur = b.No_Faktur and a.Kode_Perusahaan = b.Kode_Perusahaan "
            SQL = SQL & "and a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.No_Faktur = '" & NoTransfer & "' "
            Using Ds = BindingTrans(SQL)
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            If .Rows(i).Item("asal_barang") = "KEEP STOCK" Then

                                SQL = "update N_EMI_Keep_Stock_Barang_Lain_Departement set Flag_Selesai_Pengeluaran_Barang = null,  "
                                SQL = SQL & "Tgl_Pengeluaran_Barang = null, Jam_Pengeluaran_Barang = null , "
                                SQL = SQL & "Jmlh_Transfer = Jmlh_Transfer - " & .Rows(i).Item("Total") & ""
                                SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' and Urut_Departement=" & .Rows(i).Item("urut_pr_dept") & "  and Urut_Oto = " & .Rows(i).Item("Urut_Keep_Stock") & " "
                                ExecuteTrans(SQL)
                                'ElseIf .Rows(i).Item("asal_barang") = "PR DEPT" Then

                                'Else
                                '    CloseTrans()
                                '    CloseConn()
                                '    MessageBox.Show("Asal barang tidak boleh kosong!!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                '    Exit Sub
                            End If


                            SQL = "update N_EMI_Purchase_Requisition_Barang_Lain_Departement_Detail set "
                            SQL = SQL & "Flag_Selesai_Transfer = null , Jumlah_Transfer = Jumlah_Transfer -  " & .Rows(i).Item("Total") & " "
                            SQL = SQL & "where  Kode_Perusahaan = '" & KodePerusahaan & "' and No_Urut = '" & .Rows(i).Item("urut_pr_dept") & "'"
                            ExecuteTrans(SQL)
