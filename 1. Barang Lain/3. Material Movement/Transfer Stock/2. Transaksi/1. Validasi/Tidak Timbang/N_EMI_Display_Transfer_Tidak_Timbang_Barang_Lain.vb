...
Public Class N_EMI_Display_Transfer_Tidak_Timbang_Barang_Lain
    ...
    Private Sub N_EMI_Display_Transfer_Tidak_Timbang_Barang_Lain_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Lv_List_Barang.Columns.Add("No PR Departement", 120, HorizontalAlignment.Left).DisplayIndex = 0 '9
            ...
            Lv_List_Barang.Columns.Add("Urut PR Departement", 100, HorizontalAlignment.Left).DisplayIndex = 9 '9
            Lv_List_Barang.Columns.Add("No PR Departement", 120, HorizontalAlignment.Left).DisplayIndex = 0 '10
