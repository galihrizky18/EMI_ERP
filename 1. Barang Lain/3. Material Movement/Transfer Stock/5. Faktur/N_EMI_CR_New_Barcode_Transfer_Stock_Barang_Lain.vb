...
Public Class N_EMI_CR_New_Barcode_Transfer_Stock_Barang_Lain
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "N_EMI_CR_New_Barcode_Transfer_Stock_Barang_Lain.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.N_EMI_CR_New_Barcode_Transfer_Stock_Barang_Lain.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedN_EMI_CR_New_Barcode_Transfer_Stock_Barang_Lain
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As N_EMI_CR_New_Barcode_Transfer_Stock_Barang_Lain = New N_EMI_CR_New_Barcode_Transfer_Stock_Barang_Lain()
        rpt.Site = Me.Site
        Return rpt
    End Function
