...
Public Class N_EMI_Transaksi_Adjustment_Stock_Barang_Lain
	...
	Private Sub Dgv_DataDetail_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgv_DataDetail.CellContentClick
	...
	Public Sub Btn_Insert_Click(sender As Object, e As EventArgs) Handles Btn_GetData.Click
		...
		Try
			...
			If CheckBox1.Checked = False Then
				SQL = SQL & "And a.Jumlah <> 0 and flag_sample is null "
			Else
				SQL = SQL & "And flag_sample='Y' "
			End If
...
#End Region
	...
	Private Sub Btn_Scan_Click(sender As Object, e As EventArgs) Handles Btn_Scan.Click
		...
		Dim hasDataOnDgv As Boolean = False
		...
		If Not hasDataOnDgv Then

			Dim hasDatStock0 As Boolean = False
			...
			Try
				...
				SQL = SQL & "a.Kode_Perusahaan ='" & KodePerusahaan & "' "
				SQL = SQL & "And b.Kode_Stock_Owner ='" & arrLokasiAdj(Cmb_LokasiAdj.SelectedIndex) & "' "
				SQL = SQL & "And b.Kode_Barang='" & kd_barang & "' "
				SQL = SQL & "and (a.Qr_Code+'-'+a.Kode_Unik_Berjalan) = '" & Txt_QR.Text.Trim & "' "
				SQL = SQL & "And a.Jumlah = 0 "
				SQL = SQL & "And a.Blok_SN is null "
			...
			If Not hasDatStock0 Then
				MessageBox.Show("Barcode Tidak Ditemukan", "Adjustment Stock", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
			End If

			DGV_Data_TF.FirstDisplayedScrollingRowIndex = DGV_Data_TF.Rows.Count - 1

			'DGV_Data_TF.Rows(DGV_Data_TF.Rows.Count - 1).Cells(itemDgvCheckBox).Value = "True"
			DGV_Data_TF.Rows(DGV_Data_TF.Rows.Count - 1).DefaultCellStyle.BackColor = Color.LightBlue
