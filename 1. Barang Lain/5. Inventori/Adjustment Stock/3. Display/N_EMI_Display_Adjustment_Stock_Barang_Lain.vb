Public Class N_EMI_Display_Adjustment_Stock_Barang_Lain
	...
	Private Sub Btn_Cari_Click(sender As Object, e As EventArgs) Handles Btn_Cari.Click
		Try
			...
			SQL = $"
				...
				from Emi_Adjustment_Stock_Barang_Lain a
	...
	Private Sub Dgv_Parent_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgv_Parent.CellClick
		...
		Try
			...
			SQL = $"
				...
				from Emi_Adjustment_Stock_Barang_Lain a, Emi_Adjustment_Stock_Detail_Barang_Lain b, barang_lain c
	...
	Private Sub Dgv_Detail_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgv_Detail.CellClick
		...
		Try
			...
			SQL = $"
				...
				from Emi_Adjustment_Stock_Barang_Lain a, Emi_Adjustment_Stock_Detail_Barang_Lain b, Emi_Adjustment_Stock_Det_Barang_Lain c, View_Warehouse_Position_Barang_Lain d, EMI_Master_Warna e, Barang_lain_SN f
	...
	Private Sub BatalkanToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BatalkanToolStripMenuItem.Click
		...
		Try
			...
			'=     CEK ROLE BUTTON     =
			'===========================
			If CekButtonRole("Batal_Transaksi_Adjustment_Stock_Barang_Lain") = "T" Then
				CloseTrans()
				CloseConn()
			...
			'==================================================
			SQL = $"
				select Status, Flag_Validation_Accounting from Emi_Adjustment_Stock_Barang_Lain
			...
			'=============================
			SQL = $"
				update Emi_Adjustment_Stock_Barang_Lain set Status = 'Y',
