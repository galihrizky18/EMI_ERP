...
Public Class SD_Data_PR_Barang_Lain
    Dim Jenis = "SD_Data_PR_Barang_Lain"
    ...
    Private Sub ValidasiToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ValidasiToolStripMenuItem.Click
        ...
        Try
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        ...
                        For index As Integer = 0 To .Rows.Count - 1
                            ...
                            SQL = "Select PPN from EMI_Pembelian_PO_Barang_Lain a where "
                            ...
                            If .Rows(index).Item("Qty_PenyelesaianPlus") > 0 Then
                                ...
                                SQL = "select kode_barang, Serial_Number from barang_lain_sn where "
                                SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                ...
                                Using DrQ = OpenTrans(SQL)
                                    If DrQ.Read Then
                                        ...
                                        SQL = "Update barang_lain_sn set jumlah = jumlah + " & .Rows(index).Item("Qty_PenyelesaianPlus") & " where "
                                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                        ...
                                        Using ds2 = BindingTrans(SQL)
                                            With ds2.Tables("MyTable")
                                                For index2 = 0 To ds2.Tables("MyTable").Rows.Count - 1
                                                    ...
                                                    SQL = "select dbo.ubah_satuan_lain('" & KodePerusahaan & "','MASA','" & kd_barang & "',"
                                                    ...
                                                    'Cek Rak Kosong
                                                    SQL = "Select * From View_Warehouse_Position_Detail_Barang_Lain Where Kode_Barang Is null "
                                                    ...
                                                    Using ds3 = BindingTrans(SQL)
                                                        For index3 = 0 To ds3.Tables("MyTable").Rows.Count - 1
                                                            ...
                                                            SQL = SQL & "View_Warehouse_Position_Detail_Barang_Lain where Kode_Barang Is Not null And "
                                                            ...
                                                            If total_Ukuran > 0 Then
                                                                If isi <> 0 Then
                                                                    ...
                                                                    SQL = "select kode_barang from barang_lain_sn where "
                                                                    SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                ...
                                SQL = "select kode_barang from Barang_Lain where "
                                SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                SQL = SQL & "kode_stock_owner = '" & .Rows(index).Item("Kode_Stock_Owner") & "' and "
                                ...
                                Using Dr = OpenTrans(SQL)
                                    If Dr.Read Then
                                        ...
                                        SQL = "Update Barang_Lain set good_stock = good_stock + " & .Rows(index).Item("Qty_PenyelesaianPlus") & " where "
                                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                        SQL = SQL & "kode_stock_owner = '" & .Rows(index).Item("Kode_Stock_Owner") & "' and "
                                        SQL = SQL & "kode_barang = '" & .Rows(index).Item("Kode_Barang") & "' "
                                        Dr.Close()
                            ...
                            ElseIf .Rows(index).Item("Qty_PenyelesaianMin") > 0 Then
                                ...
                                SQL = "select kode_barang, Serial_Number, Jumlah from barang_lain_sn where "
                                SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                SQL = SQL & "kode_stock_owner = '" & .Rows(index).Item("Kode_Stock_Owner") & "' and "
                                SQL = SQL & "kode_barang = '" & .Rows(index).Item("Kode_Barang") & "' and serial_number = '" & sn & "' "
                                Using Dr = OpenTrans(SQL)
                                    If Dr.Read Then
                                        ...
                                        SQL = "Update barang_lain_sn set jumlah = jumlah - " & .Rows(index).Item("Qty_PenyelesaianMin") & " where "
                                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                        SQL = SQL & "kode_stock_owner = '" & .Rows(index).Item("Kode_Stock_Owner") & "' and kode_barang = '" & .Rows(index).Item("Kode_Barang") & "' and "
                                        SQL = SQL & "serial_number = '" & sn & "'"
                                        Dr.Close()
                                ...
                                SQL = "select kode_barang, Good_Stock from Barang_Lain where "
                                SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                SQL = SQL & "kode_stock_owner = '" & .Rows(index).Item("Kode_Stock_Owner") & "' and "
                                SQL = SQL & "kode_barang = '" & .Rows(index).Item("Kode_Barang") & "'"
                                Using Dr = OpenTrans(SQL)
                                    If Dr.Read Then
                                        ...
                                        SQL = "Update Barang_Lain set good_stock = good_stock - " & .Rows(index).Item("Qty_PenyelesaianMin") & " where "
                                        SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                                        SQL = SQL & "kode_stock_owner = '" & .Rows(index).Item("Kode_Stock_Owner") & "' and "
                                        SQL = SQL & "kode_barang = '" & .Rows(index).Item("Kode_Barang") & "' "
                                        Dr.Close()
                            ...
                            SQL = "select good_stock from Barang_Lain "
                            ...
                            Using dr = OpenTrans(SQL)
                                If dr.Read Then
                                    ...
                                    SQL = SQL & "from barang_lain_sn where kode_perusahaan = '" & KodePerusahaan & "' and "
                                    ...
                                    Using dr2 = OpenTrans(SQL)
                                        If dr2.Read Then
                                            ...
                                            If stock_Barang <> dr2("jumlah") Then
                                                ...
                                                CloseTrans()
                                                CloseConn()
                                                MessageBox.Show("Terdapat Selisih Barang_Lain_SN dengan Barang!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                                Exit Sub
                                            End If
                                        Else
                                            dr2.Close()
            ...
            'SQL = "Update EMI_Pembelian_Selisih_Barang_Masuk_Barang_Lain set flag_validasi = 'Y' "
            ...
            'SQL = "Update EMI_Pembelian_PO_Barang_Lain set flag_Val_selisih_BM = 'Y' "
            'SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' and "
    ...
    Private Sub get_Faktur()
        faktur = FBM & arrInisialFaktur & "-" & Format(tgl_skg, "MM/yy") & "-" &
                            General_Class.Get_Last_Number2("EMI_Pembelian_Selisih_Barang_Masuk_Barang_Lain", "No_Faktur", 4,
                            "Kode_perusahaan", KodePerusahaan,
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView1.SelectedIndexChanged
        Try
            ...
            SQL = SQL & "from EMI_Transaksi_Material_Requsition_detail a, Barang_Lain b, Barang_Detail_Satuan_Lain c "
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        ...
        ''    Exit Sub
        ''End If
        'Dim SD_Tambah_PR_Barang_Lain As New SD_Tambah_PR_Barang_Lain(Me)


        Try
            OpenConn()

            SD_Tambah_PR_Barang_Lain.filter_tambahan = "and c.Kode_Stock_Owner = '" & ComboBox6.Text & "'"
            SD_Tambah_PR_Barang_Lain.asal = Jenis

            Dim sendKdBrg As String = DataGridView1.CurrentRow.Cells(CellKdBrg).Value
            SD_Tambah_PR_Barang_Lain.Lbl_GetKdBrg.Text = sendKdBrg
            ...
            SD_Tambah_PR_Barang_Lain.kosong()

            SD_Tambah_PR_Barang_Lain.TxtPilihBarang_KodeBarang.Enabled = False
            SD_Tambah_PR_Barang_Lain.TxtPilihBarang_Satuan.Enabled = False
            SD_Tambah_PR_Barang_Lain.TxtPilihBarang_NamaBarang.Enabled = False
            SD_Tambah_PR_Barang_Lain.txtJumlah.Enabled = False
            ...
            SD_Tambah_PR_Barang_Lain.Lbl_PR.Visible = True
            SD_Tambah_PR_Barang_Lain.Lbl_Order.Visible = True
            SD_Tambah_PR_Barang_Lain.Lbl_Sisa.Visible = True
            SD_Tambah_PR_Barang_Lain.Txt_PR.Visible = True
            SD_Tambah_PR_Barang_Lain.Txt_Order.Visible = True
            SD_Tambah_PR_Barang_Lain.Txt_Sisa.Visible = True

            ''If DataGridView1.CurrentRow.Cells(CellSatuan).Value <> "" Then
            ''End If

            SD_Tambah_PR_Barang_Lain.CmbPilihBarang_Satuan.Text = sendSatuan
            SD_Tambah_PR_Barang_Lain.DateTimePicker1.Text = sendTglDelivery
            SD_Tambah_PR_Barang_Lain.txtKeterangan.Text = sendKeterangan

            SD_Tambah_PR_Barang_Lain.TxtPilihBarang_KodeBarang.Text = sendKdBrg
            SD_Tambah_PR_Barang_Lain.TxtPilihBarang_NamaBarang.Text = sendNmBrg

            SD_Tambah_PR_Barang_Lain.Txt_PR.Text = PR
            SD_Tambah_PR_Barang_Lain.Txt_Order.Text = Order
            SD_Tambah_PR_Barang_Lain.Txt_Sisa.Text = sisa
            SD_Tambah_PR_Barang_Lain.txtJumlah.Text = jmlInput
            ...
            OpenConn()
            SD_Tambah_PR_Barang_Lain.CmbPilihBarang_Satuan.Items.Clear()
            SQL = "select Satuan,Flag_Tampil_Display from Barang_Detail_Satuan_Lain where Kode_Barang= '" & sendKdBrg & "' "
            SQL = SQL & "and flag_tampil_display = 'Y' "
            Using dr = OpenTrans(SQL)
                Do While dr.Read
                    SD_Tambah_PR_Barang_Lain.CmbPilihBarang_Satuan.Items.Add(dr("satuan"))
                ...
                Loop
            End Using
            SD_Tambah_PR_Barang_Lain.CmbPilihBarang_Satuan.SelectedIndex = indexTampilDisplay
            SD_Tambah_PR_Barang_Lain.CmbPilihBarang_Satuan.Enabled = False
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            get_no_faktur()
            '
            SQL = "insert into EMI_Purchase_Requisition_Barang_Lain( Kode_Perusahaan, No_Faktur, Lokasi, Tanggal, Jam, UserId, Keterangan, Flag_Forecast, No_Fak_Material_Requisition) values("
            ...
            For i As Integer = 0 To DataGridView1.Rows.Count - 1
                If DataGridView1.Rows.Item(i).Cells(CellJmlInput).Value > 0 Then
                    ...
                    SQL = "insert into EMI_Purchase_Requisition_Barang_Lain_Detail(Kode_Perusahaan,No_Faktur,Kode_Stock_Owner,Kode_Barang,Jumlah,Satuan,Tanggal_Delivery,keterangan ) values("
    ...
    '    Purchase_Requisition_Barang_Lain.BtnFormulator_Refresh_Click("", e)
    'End Sub


    Private Sub SD_Data_PR_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        Purchase_Requisition_Barang_Lain.kosong()
    End Sub
