...
Public Class Rpt_Bukti_Timbang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.Rpt_Bukti_Timbang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Bukti_Timbang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Bukti_Timbang = New Rpt_Bukti_Timbang()
        rpt.Site = Me.Site
        Return rpt
    End Function
