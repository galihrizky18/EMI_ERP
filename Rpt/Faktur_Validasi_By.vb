...
Public Class Faktur_Validasi_By
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.Faktur_Validasi_By.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFaktur_Validasi_By
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Faktur_Validasi_By = New Faktur_Validasi_By()
        rpt.Site = Me.Site
        Return rpt
    End Function
