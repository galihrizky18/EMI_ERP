...
Public Class Laporan_GI_GR_Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.Laporan_GI_GR_Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_GI_GR_Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_GI_GR_Rpt = New Laporan_GI_GR_Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
