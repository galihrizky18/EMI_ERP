...
Public Class Faktur_Flever
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.Faktur_Flever.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFaktur_Flever
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Faktur_Flever = New Faktur_Flever()
        rpt.Site = Me.Site
        Return rpt
    End Function
