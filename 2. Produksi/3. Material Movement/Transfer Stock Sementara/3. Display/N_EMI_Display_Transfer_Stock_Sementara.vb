...
#End Region
	...
	Private Sub BatalkanToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BatalkanToolStripMenuItem.Click
		...
		Try
			...
			'=     UPDATE TF STOCK     =
			'===========================
			SQL = "select a.No_Transfer_Stock, a.Flag_Validasi_RFID "
			SQL &= $"from N_EMI_Transaksi_Transfer_Stock_Sementara a "
			...
			Using Dr = OpenTrans(SQL)
				If Dr.Read Then
					...
					If General_Class.CekNULL(Dr("Flag_Validasi_RFID")) = "Y" Then
						Dim No_faktur_parent As String = Dr("No_Transfer_Stock")
