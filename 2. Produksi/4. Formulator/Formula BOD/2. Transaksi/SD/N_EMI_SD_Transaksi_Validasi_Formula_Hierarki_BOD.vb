Public Class N_EMI_SD_Transaksi_Validasi_Formula_Hierarki_BOD
	...
	Private Sub N_EMI_SD_Transaksi_Validasi_Formula_Hierarki_BOD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
	...
	Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
		...
		Try
			...
			SQL = $"
                ...
                SET Kode_Hierarki = '{Cmb_Susuan.Text}', Flag_Validasi_Formula_Produksi_BOD = 'Y', Tanggal_Validasi_Formula_Produksi_BOD = '{Format(tgl_skg, "yyyy-MM-dd")}', Jam_Validasi_Formula_Produksi_BOD = '{Format(tgl_skg, "HH:mm:ss")}', UserID_Validasi_Formula_Produksi_BOD = '{UserID}'
