Public Class N_EMI_SD_Trial_Request_Material
	...
	Dim Lv_NoTransaksi, Lv_Tanggal, Lv_Jam, Lv_Jumlah, Lv_Satuan, Lv_NmBarang As String
	...
	Private Sub N_EMI_SD_Trial_Request_Material_Load(sender As Object, e As EventArgs) Handles MyBase.Load
		...
		Lv_Detail_Bahan.Columns.Add("Kode Barang", If(AksesNamaBahan, 130, 150), HorizontalAlignment.Left)
		...
		Lv_Detail_Bahan.Columns.Add("Nama Barang", If(AksesNamaBahan, 300, 0), HorizontalAlignment.Left).DisplayIndex = 2
	...
	Private Sub Get_Data_Formula(ByVal index As Integer)
		...
		Lv_NmBarang = Lv_Data_Formula_Pending.Items(index).SubItems(Item_NmBarang).Text
	End Sub
	...
	Private Sub Btn_Get_Data_Click(sender As Object, e As EventArgs) Handles Btn_Get_Data.Click
		...
		Try
			...
			SQL = "select a.No_Faktur, b.Kode_Stock_Owner, b.Kode_Barang, c.Nama as Nama_Bahan, b.Jumlah, b.Persentase, b.satuan, a.Hasil, a.Satuan_Hasil, "
			SQL &= $"isnull((( "
