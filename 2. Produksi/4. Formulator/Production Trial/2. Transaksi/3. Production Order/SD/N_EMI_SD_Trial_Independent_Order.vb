Public Class N_EMI_SD_Trial_Independent_Order
    ...
    Private Sub Btn_Simpan_Click_1(sender As Object, e As EventArgs) Handles BtnPilihBarang_Simpan.Click
        ...
        Try
            OpenConn()
            get_no_faktur()
            SQL = "insert into N_EMI_Transaksi_Trial_Independent_Order(kode_perusahaan,no_faktur,lokasi,tanggal,jam,userid,keterangan) values ("
        ...
        If asal = "B" Then
            Me.Close()
            N_EMI_Transaksi_Trial_Production_Order.Button1_Click_1(BtnPilihBarang_Simpan, e)
        End If
