...
#End Region
        ...
        If skipCB = "Y" Then
            If LvData.CheckedItems.Count > 0 Then
                ...
                Try
                    ...
                    SQL = SQL & "isnull((select sum(x.jumlah) from N_EMI_Transaksi_Trial_Order_Produksi_Detail_Bahan x, N_EMI_Transaksi_Trial_Order_Produksi y where x.Kode_Perusahaan = a.Kode_Perusahaan and a.Kode_Barang = x.Kode_Barang "
    ...
    Private Sub txtNoFaktur_Leave(sender As Object, e As EventArgs) Handles txtNoFaktur.Leave
        ...
        Try
            ...
            SQL = SQL & ",b.satuan,  "
            SQL = SQL & "isnull((select sum(x.jumlah) from N_EMI_Transaksi_Trial_Order_Produksi_Detail_Bahan x, N_EMI_Transaksi_Trial_Order_Produksi y "
