...
Public Class N_EMI_SD_Transaksi_Validasi_Formula_Main
    ...
    Public Sub TxtFormulator_NoFaktur_Leave(sender As Object, e As EventArgs) Handles TxtFormulator_NoFaktur.Leave
        ...
        Try
            ...
            SQL &= $"select 1 from Barang_SN z where c.kode_stock_owner = z.kode_Stock_owner and c.kode_barang = z.kode_barang and z.blok_sn is null "
            SQL &= $") then ( "
    ...
    Private Sub Btn_Validasi_Click(sender As Object, e As EventArgs) Handles Btn_Validasi.Click, Btn_Tolak.Click
        ...
        Try
            ...
            SQL = $"update Emi_Transaksi_Formulator set Flag_Validasi_Main = {Flag_Validasi}, "
