Public Class N_EMI_Transaksi_Trial_Produksi
	...
	Public Sub LoadDataDGV()
		...
		Try
			...
			SQL = SQL & "from N_EMI_Transaksi_Trial_Order_Produksi_Detail_Bahan a, barang b, EMI_Kategori_Gudang_PerLokasi c, stock_owner_gudang d "
			...
			SQL = "select c.lokasi_gudang, a.kode_barang, b.nama, isnull(d.Flag_Gudang_Default, 'T') as Flag_Gudang_Default "
			SQL = SQL & "from N_EMI_Transaksi_Trial_Order_Produksi_Detail_Packaging a, barang b, EMI_Kategori_Gudang_PerLokasi c, stock_owner_gudang d "
			SQL = SQL & "where a.kode_perusahaan = b.kode_perusahaan and b.kode_perusahaan = c.kode_perusahaan "
			SQL = SQL & "and a.kode_stock_owner = b.Kode_Stock_Owner and a.Kode_Barang = b.Kode_Barang "
			SQL = SQL & "and b.ID_Kategori_Gudang = c.ID_Kategori_Gudang "
			SQL = SQL & "and c.kode_perusahaan = d.kode_perusahaan and c.lokasi_gudang = d.Kode_Stock_Owner "
	...
	Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
		...
		Try
			...
			'SQL = SQL & "from N_EMI_Transaksi_Trial_Order_Produksi_Detail_Packaging a, barang b, barang c, N_EMI_Transaksi_Trial_Order_Produksi d "
			...
			'            SQL = "insert into N_EMI_Transaksi_Trial_Split_Production_Order_Detail_Packaging(Kode_Perusahaan,No_Faktur,Kode_Stock_Owner,Kode_Barang,Jumlah,Satuan,Nilai_Barang,Satuan_Barang, jumlah_barang, Jumlah_Bahan, Jenis) values( "
...
#Region "Auto Request Material"
			...
			'                SQL = SQL & "Flag_Otomatis, Batch, Flag_Trial) values "
			...
			'                                    SQL = SQL & "), 0)) as Sisa "
			'                                    SQL = SQL & "from N_EMI_Transaksi_Trial_Split_Production_Order_Detail_Bahan a "
			'                                    SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' "
			'                                    SQL = SQL & "and a.No_Faktur = '" & Txt_NoFaktur.Text & "' "
			...
			'                                                    SQL = "update N_EMI_Transaksi_Trial_Split_Production_Order_Detail_Bahan set Flag_Terpenuhi =  'Y' where kode_perusahaan = '" & KodePerusahaan & "' "
			...
			'                                    SQL = SQL & "and a.Kode_Stock_Owner = x.Kode_Stock_Owner and a.Kode_Barang = x.Kode_Barang "
			'                                    SQL = SQL & "), 0)) as Sisa "
			'                                    SQL = SQL & "from N_EMI_Transaksi_Trial_Split_Production_Order_Detail_Packaging a "
			'                                    SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' "
			'                                    SQL = SQL & "and a.No_Faktur = '" & Txt_NoFaktur.Text & "' "
			'                                    SQL = SQL & "and a.Kode_Barang = '" & KdBarang & "' "
			'                                    Using Ds1 = BindingTrans(SQL)
			...
			'                                                    SQL = "update N_EMI_Transaksi_Trial_Split_Production_Order_Detail_Packaging set Flag_Terpenuhi =  'Y' where kode_perusahaan = '" & KodePerusahaan & "' "
			'                                                    SQL = SQL & "and No_Faktur = '" & Txt_NoFaktur.Text & "' and Kode_Stock_Owner = '" & kd_so & "' and Kode_Barang = '" & KdBarang & "'"
			'                                                    ExecuteTrans(SQL)
			...
			'            SQL = SQL & "from N_EMI_Transaksi_Trial_Split_Production_Order z, N_EMI_Transaksi_Trial_Split_Production_Order_Detail_Packaging x, N_EMI_Transaksi_Trial_Order_Produksi y, barang w "
			'            SQL = SQL & "where z.Kode_Perusahaan = x.Kode_Perusahaan and z.kode_perusahaan = y.kode_perusahaan "
			'            SQL = SQL & "and z.No_Transaksi = x.No_Faktur "
			'            SQL = SQL & "and z.No_PO = y.No_Faktur "
			'            SQL = SQL & "and z.Kode_Perusahaan = a.Kode_Perusahaan "
			...
			'            SQL = SQL & "from N_EMI_Transaksi_Trial_Split_Production_Order_Detail_Packaging a, Barang b, EMI_Kategori_Gudang_PerLokasi c, Stock_Owner_Gudang d "
			'            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and a.Kode_Stock_Owner = b.Kode_Stock_Owner and a.Kode_Barang = b.Kode_Barang "
			'            SQL = SQL & "and b.Kode_Perusahaan = c.kode_perusahaan and b.ID_Kategori_Gudang = c.Id_Kategori_Gudang "
			'            SQL = SQL & "and c.kode_perusahaan = d.kode_Perusahaan and c.lokasi_gudang = d.kode_Stock_owner "
			'            SQL = SQL & "and a.kode_Perusahaan = '" & KodePerusahaan & "' "
...
#End Region
	...
	Public Sub TextBox4_Leave(sender As Object, e As EventArgs) Handles Txt_NoTransaksi.Leave
		Try
			...
			SQL = SQL & "from N_EMI_Transaksi_Trial_Order_Produksi a, barang b, emi_master_routing c, emi_jenis_produk d "
	...
	Private Sub Handle_Ubah_Lokasi_Tujuan_Bahan(sender As Object, e As EventArgs) Handles Dgv_Data_Bahan.DoubleClick, Dgv_Data_Packaging.DoubleClick
		...
		N_EMI_SD_Trial_Produksi.no_po = no_po
		N_EMI_SD_Trial_Produksi.Kd_Barang = KDbarang
		N_EMI_SD_Trial_Produksi.ShowDialog()
	End Sub
