Public Class N_EMI_Display_Trial_Mulai_Produksi
    ...
    Private Sub kosong3()
        ...
        Try
            ...
            ListView1.Columns.Add("Nama Barang", 270, HorizontalAlignment.Left)
    ...
    Private Sub ListView1_DoubleClick(sender As Object, e As EventArgs) Handles ListView1.DoubleClick
        ...
        N_EMI_Transaksi_Trial_Produksi.Txt_NoTransaksi.Text = LvNo_Faktur
        N_EMI_Transaksi_Trial_Produksi.ShowDialog()
    ...
    Private Sub Lv_Data_Formula_MouseMove(sender As Object, e As MouseEventArgs) Handles ListView1.MouseMove
    ...
    Private Sub Lv_Data_Formula_MouseLeave(sender As Object, e As EventArgs) Handles ListView1.MouseLeave
        ListView1.Cursor = Cursors.Default
    End Sub
