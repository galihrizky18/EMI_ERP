...
Public Class N_EMI_SD_Tambah_PR_Trial
    Public filter_tambahan, filter_kdSupplier As String
    Public asal, faktur_MR As String
    Dim arrcari As New ArrayList
    Dim Jenis = "Tampil_Barang"

    'Private N_EMI_Transaksi_Purchase_Requisition_Trial As N_EMI_Transaksi_Purchase_Requisition_Trial

    '' Buat constructor yang menerima referensi form utama
    'Public Sub New(ByVal formUtamaRef As N_EMI_Transaksi_Purchase_Requisition_Trial)
    '    ' Inisialisasi form utama
    '    InitializeComponent()
    '    N_EMI_Transaksi_Purchase_Requisition_Trial = formUtamaRef
    'End Sub
    ...
    Private Sub SD_Pilih_Barang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            TxtTiba.Text = ""
            If asal = "N_EMI_Transaksi_Purchase_Requisition_Trial" Then
                LvPilihBarang_DataBarang.Items.Clear()
                TxtPilihBarang_KodeBarang.Text = ""
                TxtPilihBarang_NamaBarang.Text = ""
                TxtPilihBarang_Satuan.Text = ""
    ...
    Private Sub Btn_Simpan_Click_1(sender As Object, e As EventArgs) Handles BtnPilihBarang_Simpan.Click
        ...
        ElseIf asal = "N_EMI_Transaksi_Purchase_Requisition_Trial" Then
            ...
            'N_EMI_Transaksi_Purchase_Requisition_Trial.Dgv_DataBarang.Rows(index).Cells(3).Value = txtJumlah.Text.Trim
