Public Class N_EMI_Transaksi_Purchase_Requisition_Trial

    Dim arrCari, arrKd_biaya, arrKeterangan As New ArrayList

    Dim arrInisialFaktur As New ArrayList

    Dim Jenis = "N_EMI_Transaksi_Purchase_Requisition_Trial"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        N_EMI_SD_Data_PR_Trial.ShowDialog()
    End Sub
    ...
    Private Sub BtnFormulator_Simpan_Click(sender As Object, e As EventArgs) Handles BtnPR_Simpan.Click
        ...
        Try
            ...
            If Btn_Simpan.Tag = "&Simpan" Then
                ...
                SQL = "insert into EMI_Purchase_Requisition(Kode_Perusahaan,No_Faktur,Lokasi,Tanggal,Jam,UserId,Keterangan, Flag_Trial) values("
                ...
                SQL = SQL & "'" & UserID & "', '" & TextBox2.Text.Trim & "', 'Y')"
                ExecuteTrans(SQL)
    ...
    Private Sub Dgv_DataBarang_KeyDown(sender As Object, e As KeyEventArgs) Handles Dgv_DataBarang.KeyDown
        ...
        If e.KeyCode = Keys.F1 Then
            ...
            If Not publicFlagRelease = "Y" Then
                ...
                N_EMI_SD_Tambah_PR_Trial.filter_tambahan = "and c.Kode_Stock_Owner = '" & cmb_lokasi.Text & "'"
                'N_EMI_SD_Tambah_PR_Trial.asal = cmb_lokasi.Text
                N_EMI_SD_Tambah_PR_Trial.asal = Jenis
                N_EMI_SD_Tambah_PR_Trial.faktur_MR = Txt_Faktur_MaterialReq.Text
                N_EMI_SD_Tambah_PR_Trial.TxtPilihBarang_KodeBarang.Visible = True
                N_EMI_SD_Tambah_PR_Trial.TxtPilihBarang_Satuan.Visible = True
                N_EMI_SD_Tambah_PR_Trial.TxtPilihBarang_NamaBarang.Visible = True
                N_EMI_SD_Tambah_PR_Trial.LblPilihBarang_NamaBarang.Visible = True
                N_EMI_SD_Tambah_PR_Trial.LblPilihBarang_KodeBarang.Visible = True

                N_EMI_SD_Tambah_PR_Trial.Lbl_PR.Visible = False
                N_EMI_SD_Tambah_PR_Trial.Lbl_Order.Visible = False
                N_EMI_SD_Tambah_PR_Trial.Lbl_Sisa.Visible = False
                N_EMI_SD_Tambah_PR_Trial.Txt_PR.Visible = False
                N_EMI_SD_Tambah_PR_Trial.Txt_Order.Visible = False
                N_EMI_SD_Tambah_PR_Trial.Txt_Sisa.Visible = False
                N_EMI_SD_Tambah_PR_Trial.ShowDialog()
    ...
    Private Sub Dgv_DataBarang_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgv_DataBarang.CellDoubleClick
        ...
        If publicFlagRelease = "T" Then
            ...
            If currentCell = 5 Then
                ...
                N_EMI_SD_Ubah_Tanggal_PR_Trial.DTP_Delivery.Value = Dgv_DataBarang.Rows(currentRow).Cells(currentCell).Value
                N_EMI_SD_Ubah_Tanggal_PR_Trial.rowDgv = currentRow
                N_EMI_SD_Ubah_Tanggal_PR_Trial.cellDgv = currentCell
                N_EMI_SD_Ubah_Tanggal_PR_Trial.EstTiba = Dgv_DataBarang.Rows(currentRow).Cells(CellEstTiba).Value

                N_EMI_SD_Ubah_Tanggal_PR_Trial.ShowDialog()
