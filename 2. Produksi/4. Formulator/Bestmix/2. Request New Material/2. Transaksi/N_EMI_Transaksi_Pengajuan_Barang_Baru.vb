Public Class N_EMI_Transaksi_Pengajuan_Barang_Baru
	...
	Dim arrIDKlasifikasiBahan3, arrPrefixKlasifikasiBahan3, arrKodeKlasifikasiBahan3 As New ArrayList
	...
	Private Sub Kosong()
		...
		arrIDKlasifikasiBahan3.Clear() : arrPrefixKlasifikasiBahan3.Clear() : arrKodeKlasifikasiBahan3.Clear()
	...
	Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
		...
		If arrGudangRawMaterial.Contains(arrIDGroupJenis(Cmb_Group_Jenis.SelectedIndex)) Then
			...
			ElseIf Cmb_Flag_Preservative.SelectedIndex = -1 Then
				MessageBox.Show("Flag Preservative Harus Dipilih Dahulu", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
				Cmb_Flag_Preservative.DroppedDown = True
				Cmb_Flag_Preservative.Focus()
				Exit Sub
			End If
		...
		Try
			...
			SQL &= $"ID_Klasifikasi_Bahan_2, Klasifikasi_Bahan_2, Kode_Barang, Nama_Barang, ID_Klasifikasi_Bahan_3, Kode_Klasifikasi_Bahan_3, Klasifikasi_Bahan_3, Flag_Preservative) "
			...
			SQL &= $"'{arrIDKlasifikasiBahan3(Cmb_Klasifikasi_Bahan_3.SelectedIndex)}', '{arrKodeKlasifikasiBahan3(Cmb_Klasifikasi_Bahan_3.SelectedIndex)}', '{Cmb_Klasifikasi_Bahan_3.Text.Trim}',  "
			SQL &= $"'{Cmb_Flag_Preservative.Text.Trim}' )"
			ExecuteTrans(SQL)
				...
				With Ds.Tables("MyTable")
					If .Rows.Count <> 0 Then
						For i As Integer = 0 To .Rows.Count - 1
							...
							SQL = "insert into barang(Kode_Perusahaan, Id_Group_Jenis, Id_Klasifikasi_Bahan, Id_Klasifikasi_Bahan2, Flag_Request_Barang_Baru, Kode_Stock_Owner, Kode_Barang, Kode_Barang_Inq, Nama, Id_Klasifikasi_Bahan3, Flag_Preservative) "
							...
							SQL &= $"'{Txt_Kd_Barang.Text.Trim}', '{Txt_Nm_Barang.Text.Trim}', '{arrIDKlasifikasiBahan3(Cmb_Klasifikasi_Bahan_3.SelectedIndex)}', '{Cmb_Flag_Preservative.Text.Trim}' )  "
							ExecuteTrans(SQL)
	...
	Private Sub Cmb_Group_Jenis_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Cmb_Group_Jenis.SelectedIndexChanged
		...
		If Cmb_Klasifikasi_Bahan_3.Enabled Then Cmb_Klasifikasi_Bahan_3.Enabled = False
	End Sub
	...
	Private Sub Cmb_Klasifikasi_Bahan_3_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles Cmb_Klasifikasi_Bahan_3.SelectionChangeCommitted
	...
	Private Sub Cmb_Klasifikasi_Bahan_2_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles Cmb_Klasifikasi_Bahan_2.SelectionChangeCommitted
		...
		Else
			...
			Try
				...
				Cmb_Klasifikasi_Bahan_3.Items.Clear() : arrIDKlasifikasiBahan3.Clear() : arrPrefixKlasifikasiBahan3.Clear() : arrKodeKlasifikasiBahan3.Clear()
				'SQL = "select Id_Klasifikasi_Bahan2, Keterangan, Prefix_Klasifikasi_Bahan from EMI_Klasifikasi_Bahan2 "
				'SQL = SQL & "where kode_perusahaan='" & KodePerusahaan & "' and Id_Klasifikasi_Bahan1='" & arrIDKlasifikasiBahan(Cmb_Klasifikasi_Bahan.SelectedIndex) & "'"
				...
				Using Dr = OpenTrans(SQL)
					Do While Dr.Read
						...
						arrIDKlasifikasiBahan3.Add(Dr("Id_Klasifikasi_Bahan3"))
						arrPrefixKlasifikasiBahan3.Add(Dr("Prefix_Klasifikasi_Bahan"))
						arrKodeKlasifikasiBahan3.Add(Dr("Kode_Klasifikasi_Bahan"))
					Loop
