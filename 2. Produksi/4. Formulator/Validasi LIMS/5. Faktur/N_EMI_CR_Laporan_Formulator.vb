...
Public Class N_EMI_CR_Laporan_Formulator
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "N_EMI_CR_Laporan_Formulator.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.N_EMI_CR_Laporan_Formulator.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedN_EMI_CR_Laporan_Formulator
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As N_EMI_CR_Laporan_Formulator = New N_EMI_CR_Laporan_Formulator()
        rpt.Site = Me.Site
        Return rpt
    End Function
