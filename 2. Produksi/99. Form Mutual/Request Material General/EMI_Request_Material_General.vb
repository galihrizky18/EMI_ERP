...
Public Class EMI_Request_Material_General
    ...
    Private Sub Kosong()
        ...
        LvBarang.Columns.Add("Kode Barang", 150, HorizontalAlignment.Left)
        LvBarang.Columns.Add("Nama ", 330, HorizontalAlignment.Left)
        LvBarang.Columns.Add("Jumlah", 130, HorizontalAlignment.Right)
        ...
        LvBrg.Columns.Add("Kode Barang", 120, HorizontalAlignment.Left)
        LvBrg.Columns.Add("Nama", 300, HorizontalAlignment.Left)
        LvBrg.Columns.Add("Jumlah Stock", 120, HorizontalAlignment.Right)
        LvBrg.Columns.Add("Satuan", 75, HorizontalAlignment.Center)
