            ...
            Using dr = OpenTrans(SQL)
                Do While dr.Read
                    ...
                    Else
                        Lvw.SubItems.Add("")
                    End If
                    If General_Class.CekNULL(dr("Ket_kategori")) <> "" Then
                    ...
                    Else
                        Lvw.SubItems.Add("T")
                    End If
                    If General_Class.CekNULL(dr("Id_QC_Formula")) <> "" Then
                        Lvw.SubItems.Add(dr("Id_QC_Formula"))
                    Else
                        Lvw.SubItems.Add("")
                    End If
                    If General_Class.CekNULL(dr("Id_Kategori_Komponen")) <> "" Then
                        Lvw.SubItems.Add(dr("Id_Kategori_Komponen"))
                    Else
                        Lvw.SubItems.Add("")
                    End If
                    If General_Class.CekNULL(dr("Flag_Option")) <> "" Then
