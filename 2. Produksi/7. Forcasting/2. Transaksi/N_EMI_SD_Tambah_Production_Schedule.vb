...
Public Class N_EMI_SD_Tambah_Production_Schedule
    ...
    Sub get_data_production_plan_perbulan()
        ...
        Try
            ...
            SQL = SQL & "MAX(CASE WHEN x.tanggal = '" & TanggalDariKalender.ToString("dd") & "' THEN x.jumlah END) as qty_produksi, "
            SQL = SQL & "MAX(CASE WHEN x.tanggal = '" & TanggalDariKalender.ToString("dd") & "' THEN x.flag_sudah_production_order END) as flag_sudah_po "
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            ' -- Isi ComboBox Formula dari cache Dictionary (tidak query DB lagi) --
                            Dim dgvCmbValueSwitch As DataGridViewComboBoxCell
                            dgvCmbValueSwitch = DataGridView1.Rows(ind).Cells(cellFormula)
                            dgvCmbValueSwitch.Items.Clear()

                            Dim kbInq As String = .Rows(i).Item("kode_barang_inq").ToString()
                            If dictFormula.ContainsKey(kbInq) Then
                                For Each f As String In dictFormula(kbInq)
                                    dgvCmbValueSwitch.Items.Add(f)
                                Next
                            End If
        ...
        Try
            ...
            For indexGridView As Integer = 0 To DataGridView1.Rows.Count - 1
                    ...
                    With Ds.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            ...
                            For indexBaru As Integer = 0 To .Rows.Count - 1
                                ...
                                SQL = SQL & "kode_formula = '" & lvFormula & "', "
                ...
                If cekSudahPernahInput = False Then
                    ...
                    SQL = "insert into N_EMI_Production_Plan_Schedule_detail (Kode_Perusahaan,No_Transaksi,Tanggal_Full,Tanggal,Kode_Formula,Jumlah "
                    ...
                    SQL = SQL & "'" & TanggalDariKalender.ToString("dd") & "','" & lvFormula & "','" & HilangkanTanda(LvJumlah) & "', '" & LvSatuan & "','" & LvNo_Urut & "', "
