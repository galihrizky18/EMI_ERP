...
Public Class N_EMI_SD_Input_Jumlah_PO
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        EMI_Production_Order.cmb_routing.Enabled = True
        EMI_Production_Order.Cmb_Jenis.Enabled = True
        EMI_Production_Order.Btn_Simpan.Enabled = True
        EMI_Production_Order.btnRefresh.Enabled = True
