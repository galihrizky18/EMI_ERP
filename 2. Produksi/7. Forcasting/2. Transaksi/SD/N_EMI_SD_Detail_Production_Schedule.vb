...
Public Class N_EMI_SD_Detail_Production_Schedule
    ...
    Private Sub DGV_Data_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DGV_Data.CellContentClick
        ...
        Dim jumlah As String =
             Val(HilangkanTanda(DGV_Data.Rows(e.RowIndex).Cells(3).Value))
        ...
        If e.ColumnIndex = 0 Then
            ...
            Try
                ...
                SQL = $"
                    update N_EMI_Production_Plan_Schedule_Detail set Jumlah_Sudah_Production_Order = Jumlah_Sudah_Production_Order -  '{Val(HilangkanTanda(DGV_Data.Rows(e.RowIndex).Cells(3).Value))}'
                    where No_Urut = '{txt_NoUrut.Text}' and kode_perusahaan= '{KodePerusahaan}'
                "
        ...
        If e.ColumnIndex = 1 Then
            ...
            EMI_Production_Order.Btn_Simpan.Enabled = False
            EMI_Production_Order.btnRefresh.Enabled = False
