...
Public Class EMI_Transaksi_MaterialRequisition_Backup_020526
    ...
    Private Sub FunTotalJumlahCurrentMonth(ByVal jumlahProductionPlan As Double, ByVal stok As Double, ByVal Jumlah_out_pr As Double, ByVal Jumlah_out_po As Double, ByVal index As Integer, ByVal Jumlah_PRD As Double)
        ...
        If Jumlah_PRD > jumlahProductionPlan Then
            EstJumlahPlan = 0
        Else
            EstJumlahPlan = jumlahProductionPlan - Jumlah_PRD
        End If
        ...
        If EstJumlahPlan > EstJumlahStok Then
            estreq_awal = 0
        Else
    ...
    Private Sub FunTotalJumlahLooping(ByVal jumlahProductionPlan As Double, ByVal jumlah_out_pr As Double, ByVal Jumlah_out_po As Double, ByVal index As Integer, ByVal cells As Integer)
        ...
        If jumlahProductionPlan > EstJumlahStok Then
            estreq_awal = 0
        Else
...
"
    ...
    Private Sub GetDataRix()
        ...
        For i As Integer = 1 To 2
            ...
            DataGridView1.Columns(cellPRoutStanding).HeaderText = "Pr Outstanding " & b & " - " & fthn
            DataGridView1.Columns(cellPOoutStanding).HeaderText = "PO Outstanding " & b & " - " & fthn
            DataGridView1.Columns(cellRequireStok).HeaderText = "Requirement Stok " & b & " - " & fthn
...
"
        ...
        Try
            ...
            If Arrbarang.Count > 0 Then
                ...
                For i As Integer = 0 To Arrbarang.Count - 1
                    ...
                    If dictBarangInfo.ContainsKey(kb) AndAlso dictSatuanDisplay.ContainsKey(kb) Then
                        ...
                        "dbo.Ubah_Satuan('" & KodePerusahaan & "','MASA','" & kb & "'," &
                        "'" & info.satuan & "','" & satuanDisplay & "'," & info.good_stock & ") AS hasil"
                    )
                    End If
                Next
            ...
            SQL = $"
                   ...
                   SELECT DISTINCT ISNULL(f.No_Faktur,'') AS kode_formula,
                    ...
                    b.Kode_Formula,
                    dbo.Ubah_Satuan(a.kode_perusahaan,'MASA',b.kode_Barang,b.satuan,e.satuan_berat,b.nilai_ppic-total_qty) AS nilai_ppic,
                    dbo.Ubah_Satuan(a.kode_perusahaan,'MASA',b.kode_Barang,c.satuan_hasil,e.satuan_berat,c.hasil) AS nilai_Formula, z.Kode_Perusahaan, z.id_group_jenis
                    ...
                    SELECT a.bulan,a.tahun,b.kode_Barang AS kode_fg, d.kode_barang AS Kode_Bahan, d.Nilai_Barang, d.satuan_barang,
                    f.Kode_Formula,
                    dbo.Ubah_Satuan(a.kode_perusahaan,'MASA',b.kode_Barang,b.satuan,e.satuan_berat,f.Jumlah) AS nilai_ppic,
                    dbo.Ubah_Satuan(a.kode_perusahaan,'MASA',b.kode_Barang,c.satuan_hasil,e.satuan_berat,c.hasil) AS nilai_Formula, z.Kode_Perusahaan, z.id_group_jenis
            ...
            For indexxx = 0 To Arrbarang.Count - 1
                ...
                Dim jumlahProductionPlan As Double = Val(HilangkanTanda(DataGridView1.Rows(ind).Cells(CellCurrentMonth).Value))

                estreq_awal = 0

                FunTotalJumlahCurrentMonth(nilai, good_stock_tampil_display, totalPrBelumPO, totalPRSudahPO, ind, totalPRD)
    ...
    Private Sub ExportToExcel()
        ...
        CellKd_Barang, CellNm_Barang, CellAvg_3Bln, CellSatuanBarang,
        CellCurrentMonth, CellStock_BB, CellOPRequesition,
        CellOPOrder, cellCarryOver, cellRequirmentStok,
        CellNBom_1, CellOPRequesition_1, CellOPOrder_1, cellRequireStok_1,
        CellNBom_2, CellOPRequesition_2, CellOPOrder_2, cellRequireStok_2
    }
