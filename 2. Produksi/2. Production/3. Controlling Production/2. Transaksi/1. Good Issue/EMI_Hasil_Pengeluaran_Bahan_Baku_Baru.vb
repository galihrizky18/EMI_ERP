...
#Region "Cek Semua Batch Sudah Terpenuhi"
            ...
            SQL = SQL & "where a.kode_Perusahaan='" & KodePerusahaan & "' and a.No_Transaksi='" & TextBox4.Text.Trim & "' "
            Using dr = OpenTrans(SQL)
                If dr.Read Then
            ...
            SQL = SQL & "And a.kode_Perusahaan='" & KodePerusahaan & "' and a.No_Production_Order='" & TextBox4.Text.Trim & "' and b.Tanggal is not null "
            Using dr = OpenTrans(SQL)
                If dr.Read Then
...
#End Region
            ...
            If IsBatchComplete Then
                If IsAutomaticValidation Then
                    ...
                    SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' and no_transaksi = '" & TextBox4.Text.Trim & "' "
                    Using Dr = OpenTrans(SQL)
                        If Dr.Read Then
