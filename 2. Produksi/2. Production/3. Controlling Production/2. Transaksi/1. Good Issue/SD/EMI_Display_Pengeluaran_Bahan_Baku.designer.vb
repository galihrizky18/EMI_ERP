...
Partial Class EMI_Display_Pengeluaran_Bahan_Baku
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Display Production Order (Bahan Baku)"
        '
        'Panel2
        '
        ...
        '
        'EMI_Display_Pengeluaran_Bahan_Baku
        '
        ...
        Me.Name = "EMI_Display_Pengeluaran_Bahan_Baku"
