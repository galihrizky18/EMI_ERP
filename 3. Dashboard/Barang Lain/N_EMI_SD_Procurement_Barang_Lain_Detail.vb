Public Class N_EMI_SD_Procurement_Barang_Lain_Detail
        ...
        Try
            ...
            Dim Query = $"
                SELECT
                    ...
                    pod.Jumlah AS Qty
                FROM EMI_Pembelian_PO_Det_Induk_Barang_Lain pod
            ...
            Dim Query = $"
                WITH SubPO_Data AS (
                    SELECT
                        ...
                        sp.Tanggal_Release,
                        FORMAT(sp.Tanggal_Release, 'dd MMM yyyy HH:mm') AS Waktu,
                        spd.Jumlah AS Qty_Mentah,
                        ROW_NUMBER() OVER (ORDER BY sp.Tanggal_Release, spd.No_Faktur) AS RN
                    FROM EMI_Pembelian_PO_Det_Barang_Lain spd
                    INNER JOIN EMI_Pembelian_PO_Barang_Lain sp
            ...
            Using Dr = OpenTrans(Query)
                While Dr.Read()
                    ...
                    If qtyDistribusi <> qtyMentah Then
                        Guna2DataGridView2.Rows(idx).Cells("Qty").Style.BackColor = Color.FromArgb(255, 204, 0)
                        Guna2DataGridView2.Rows(idx).Cells("Qty").Style.ForeColor = Color.FromArgb(57, 18, 13)
                        Guna2DataGridView2.Rows(idx).Cells("Qty").ToolTipText = $"Qty Sub PO: {qtyMentah}{vbCrLf}Qty untuk PR ini: {qtyDistribusi}"
                    End If
                End While
            End Using
        ...
        Try
            ...
            Dim Query = $"
                ...
                SubPO_All_PRs AS (
                    ...
                    JOIN EMI_Pembelian_PO_Det_Induk_Barang_Lain poi_d ON spo_d.No_FakInduk = poi_d.No_Faktur 
                    ...
                    JOIN EMI_Purchase_Requisition_Barang_Lain_Detail pr_d ON pr_d.No_Urut = poi_d.No_Urut_PR
                        AND pr_d.Kode_Perusahaan = poi_d.Kode_Perusahaan
                    JOIN EMI_Purchase_Requisition_Barang_Lain pr ON pr.No_Faktur = pr_d.No_Faktur
                ...
                DO_All AS (
                    SELECT 
                        ...
                        CASE
                            ...
                            ELSE '-'
                        END AS Status
                    FROM EMI_Pembelian_Loading_Detail_Barang_Lain ldd
                    JOIN EMI_Pembelian_Loading_Barang_Lain ld ON ld.No_Faktur = ldd.No_Faktur
