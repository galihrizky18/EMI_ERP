...
Public Class N_EMI_SD_Procurement_Barang_Lain_PO
    ...
    Private Sub SD_Card_PO_Outstanding_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            OpenConn()
            If CekButtonRole("Ubah_ETD_ETA_PO_Induk_Barang_Lain") = "T" Then
        ...
        Try
            If e.RowIndex >= 0 Then
                ...
                If Not String.IsNullOrEmpty(noPO) Then
                    Try
                        OpenConn()
                        SQL = $"SELECT ETD_Simulasi FROM EMI_Pembelian_PO_Induk_Barang_Lain WHERE No_Faktur = '{noPO}'"
        ...
        Try
            ...
            SQL = $"
                ;WITH SubPO AS (
                    ...
                    INNER JOIN EMI_Pembelian_PO_Barang_Lain spo 
                ...
                INNER JOIN EMI_Pembelian_PO_Det_Induk_Barang_Lain poi_d 
                ...
                WHERE
                    ...
                    {statusFilter}
                    AND poi_d.Kode_Barang IN ({FilterKodeBarang})
                ORDER BY 
    ...
    Private Sub Button_Simpan_Click(sender As Object, e As EventArgs) Handles Button_Simpan.Click
        ...
        Try
            ...
            SQL = $"SELECT DISTINCT No_Faktur FROM EMI_Pembelian_PO_Det_Barang_Lain WHERE No_FakInduk = '{noPO}'"
            ...
            If hasETDChanged Then
                SQL = $"UPDATE EMI_Pembelian_PO_Induk_Barang_Lain SET ETD_Simulasi = '{newETD:yyyy-MM-dd}' WHERE No_Faktur = '{noPO}'"
                ExecuteTrans(SQL)
                ...
                SQL = $"INSERT INTO N_EMI_LOG_PO_INDUK_ETA_ETD_Barang_Lain 
                    (Kode_Perusahaan, Tanggal, Jam, UserID, No_Faktur, ETD) 
                    VALUES 
                    ('{KodePerusahaan}', '{currentDate:yyyy-MM-dd HH:mm:ss}', '{currentTime}', '{UserID}', '{noPO}', {etdLamaStr})"
                ExecuteTrans(SQL)
            End If
    ...
    Private Sub Button_Export_Excel_Click(sender As Object, e As EventArgs) Handles Button_Export_Excel.Click
        ...
        Dim nama_file As String = "PO_Induk_Outstanding_Barang_Lain_" & format_akhir & ".xlsx"
        ...
        If saveFileDialog.ShowDialog() = DialogResult.OK Then
            Try
                ...
                MsgBox("PO Induk Outstanding Barang Lain berhasil di-export!", MsgBoxStyle.Information)
                xlWorkBook.Close()
                xlApp.Quit()
                releaseObject(xlWorkSheet)
                releaseObject(xlWorkBook)
    ...
    Private Sub BatalkanPOInduk_Click(sender As Object, e As EventArgs) Handles BatalkanPOInduk.Click
        ...
        Try
            ...
            If CekButtonRole("Batal_PO_Induk_Barang_Lain") = "T" Then
            ...
            FROM emi_pembelian_po_det_induk_Barang_Lain epd
            LEFT JOIN SubPO s 
            ...
            LEFT JOIN Emi_Purchase_Requisition_Barang_Lain_Detail pr
        ...
        "
            ...
            Cmd.Parameters.AddWithValue("@KodePerusahaan", KodePerusahaan)
            Cmd.Parameters.AddWithValue("@NoPOInduk", NoPOInduk)
            Cmd.CommandText = "SELECT COUNT(*) FROM Emi_Pembelian_PO_Induk_Barang_Lain WHERE Kode_Perusahaan = @KodePerusahaan AND No_Faktur = @NoPOInduk"
            ...
            Dim SQL_Batal_PO_Induk As String = "UPDATE Emi_Pembelian_PO_Induk_Barang_Lain SET Status = 'Y', UserID_Batal = @UserID, Tanggal_Batal = @TanggalBatal WHERE Kode_Perusahaan = @KodePerusahaan AND No_Faktur = @NoPOInduk"
            ...
            SELECT DISTINCT
                ...
                po_d.Kode_Barang
            FROM emi_pembelian_po_det_induk_Barang_Lain po_d
        ...
        "
            ...
            For Each prRow As DataRow In dtPR.Rows
                ...
                Cmd.CommandText = "SELECT COUNT(*) FROM Emi_Purchase_Requisition_Barang_Lain_Detail WHERE Kode_Perusahaan = @KodePerusahaan AND No_Faktur = @NoPR AND Kode_Barang = @KodeBarang AND No_Urut = @NoUrutPR"
                ...
                SQL = "UPDATE Emi_Purchase_Requisition_Barang_Lain_Detail SET Flag_Sudah_PO = NULL WHERE Kode_Perusahaan = @KodePerusahaan AND No_Faktur = @NoPR AND Kode_Barang = @KodeBarang AND No_Urut = @NoUrutPR"
                ExecuteTrans(SQL)
            Next
    ...
    Private Sub SelesaikanPOInduk_Click(sender As Object, e As EventArgs) Handles SelesaikanPOInduk.Click
        ...
        Try
            ...
            If CekButtonRole("Selesai_PO_Induk_Barang_Lain") = "T" Then
            ...
            Cmd.CommandText = "
            SELECT COUNT(*) 
            FROM EMI_Pembelian_PO_Induk_Barang_Lain_Origin
        ...
        "
            ...
            If CekPOInduk = 0 Then
                ...
                Dim SQL_Backup_PO_Induk As String = "
                    INSERT INTO EMI_Pembelian_PO_Induk_Barang_Lain_Origin (
                        Kode_Perusahaan,
                        No_Faktur,
                        No_Nota,
                        Status,
                    ...
                    SELECT
                        ...
                        Jam_Selesai,
                        ETA_Simulasi
                    FROM EMI_Pembelian_PO_Induk_Barang_Lain
                    WHERE Kode_Perusahaan = @KodePerusahaan
                      AND No_Faktur = @NoPOInduk
                    "
            ...
            Cmd.CommandText = "
            SELECT COUNT(*) 
            FROM EMI_Pembelian_PO_Det_Induk_Barang_Lain_Origin
            WHERE Kode_Perusahaan = @KodePerusahaan 
            AND No_Faktur = @NoPOInduk
        "
            ...
            If CekPODetInduk = 0 Then
                ...
                Dim SQL_Backup_PO_Det_Induk As String = "
                    INSERT INTO EMI_Pembelian_PO_Det_Induk_Barang_Lain_Origin (
                        Kode_Perusahaan,
                        No_Faktur,
                        Kode_Stock_Owner,
                        Kode_Barang,
                    ...
                    SELECT
                        ...
                        Flag_selesai
                        --Kategori_Gudang
                    FROM EMI_Pembelian_PO_Det_Induk_Barang_Lain
                    WHERE Kode_Perusahaan = @KodePerusahaan
                      AND No_Faktur = @NoPOInduk
                    "
            ...
            Cmd.CommandText = "
            SELECT COUNT(*) 
            FROM EMI_Pembelian_PO_Detail_Induk_Barang_Lain_Origin
            WHERE Kode_Perusahaan = @KodePerusahaan 
            AND No_Faktur = @NoPOInduk
        "
            ...
            If CekPODetailInduk = 0 Then
                ...
                Dim SQL_Backup_PO_Detail_Induk As String = "
                    INSERT INTO EMI_Pembelian_PO_Detail_Induk_Barang_Lain_Origin (
                        Kode_Perusahaan,
                        No_Faktur,
                        Kode_Stock_Owner,
                        Kode_Barang,
                    ...
                    SELECT
                        ...
                        Harga_Refraksi--,
                        --Kategori_Gudang
                    FROM EMI_Pembelian_PO_Detail_Induk_Barang_Lain
                    WHERE Kode_Perusahaan = @KodePerusahaan
                      AND No_Faktur = @NoPOInduk
                    "
        ...
        "
            ...
            For Each detRow As DataRow In dtDetail.Rows
                ...
                SQL = "
                    INSERT INTO Emi_Pembelian_PO_Det_Induk_Barang_Lain_Log (
                        Kode_Perusahaan,
                        No_Faktur,
                        Kode_Stock_Owner,
                        Kode_Barang,
                ...
                SQL = "
                    UPDATE emi_pembelian_po_det_induk_Barang_Lain SET 
                        Flag_Selesai = 'Y',
                        Jumlah = @QtySubPO,
                ...
                SQL = "
                        UPDATE emi_pembelian_po_detail_induk_Barang_Lain SET 
                            Jumlah = (
                                SELECT SUM(Jumlah) 
                                FROM emi_pembelian_po_det_induk_barang_lain 
                                WHERE Kode_Perusahaan = @KodePerusahaan
                ...
                If Not String.IsNullOrEmpty(NoPR) AndAlso Not String.IsNullOrEmpty(NoUrutPR) Then
                    ...
                    Cmd.CommandText = "
                            SELECT COUNT(*) 
                            FROM Emi_Purchase_Requisition_Barang_Lain_Detail
                            WHERE 
                                Kode_Perusahaan = @KodePerusahaan 
                                AND No_Faktur = @NoPR 
                    ...
                    SQL = "UPDATE Emi_Purchase_Requisition_Barang_Lain_Detail SET Flag_Sudah_PO = NULL WHERE Kode_Perusahaan = @KodePerusahaan AND No_Faktur = @NoPR AND No_Urut = @NoUrutPR"
                    ExecuteTrans(SQL)
                End If
            Next
            ...
            Cmd.CommandText = "
                SELECT ISNULL(SUM(epd.Total), 0) AS Total, 
                       ...
                       epo.Kurs, 
                       epo.Total_MUA 
                FROM emi_pembelian_po_detail_induk_Barang_Lain epd 
                INNER JOIN Emi_Pembelian_PO_Induk_Barang_Lain epo ON epd.No_Faktur = epo.No_Faktur 
            ...
            Cmd.CommandText = "SELECT ISNULL(SUM(persentase), 0) AS Persentase_PPH FROM EMI_Detail_PPH_PO_Induk_Barang_Lain WHERE Kode_Perusahaan = @KodePerusahaan AND No_Faktur = @NoPOInduk"
            Cmd.Parameters.Clear()
            Cmd.Parameters.AddWithValue("@KodePerusahaan", KodePerusahaan)
            Cmd.Parameters.AddWithValue("@NoPOInduk", NoPOInduk)
    ...
    Private Sub SelesaikanPOIndukBarangIni_Click(sender As Object, e As EventArgs) Handles SelesaikanPOIndukBarangIni.Click
        ...
        Try
            ...
            If CekButtonRole("Selesai_Barang_PO_Induk_Barang_Lain") = "T" Then
    ...
    "
            ...
            Cmd.CommandText = "
        SELECT ISNULL(SUM(epd.Total), 0) AS Total, epo.Mata_Uang, epo.PPN, epo.Kurs, epo.Total_MUA FROM emi_pembelian_po_detail_Induk_Barang_Lain epd 
        INNER JOIN Emi_Pembelian_PO_Induk_Barang_Lain epo ON epd.No_Faktur = epo.No_Faktur 
    ...
    "
            ...
            "
                ...
                ' Update PR Detail
                Dim SQL_Update_PR As String = "UPDATE Emi_Purchase_Requisition_Barang_Lain_Detail SET Flag_Sudah_PO = NULL WHERE Kode_Perusahaan = @KodePerusahaan AND No_Faktur = @NoPR AND No_Urut = @NoUrutPR"
