...
Public Class N_EMI_SD_Procurement_Barang_Lain_POValue
        ...
        Try
            ...
            SQL = $"
                SELECT 
                    ...
                    FORMAT(p.Tanggal_Release, 'dd MMM yyyy') AS Tgl_PO,
                    d.Kode_Barang,
                    b.Nama AS Nama_Barang,
                    d.Satuan,
                    d.Jumlah,
                    d.Total
                FROM EMI_Pembelian_PO_Barang_Lain p
                INNER JOIN EMI_Pembelian_PO_Det_Barang_Lain d 
                    ON p.No_Faktur = d.No_Faktur
                LEFT JOIN Barang_Lain b
                    ON b.Kode_Perusahaan = p.Kode_Perusahaan
