...
Public Class N_EMI_SD_Procurement_PR
    ...
    Private Sub Fetch_PR_Outstanding()
        Try
            ...
            ' Prepare Parameters
            Dim searchKeyword As String = TB_Search.Text
            ...
            SQL = $"
                ...
                WHERE
                    ...
                    AND (
                        pr.No_Faktur LIKE @SearchKeyword
                        OR b.Kode_Barang LIKE @SearchKeyword
                        OR b.Nama LIKE @SearchKeyword
                    )
                    {statusFilter}
                GROUP BY
                    pr.User_Release,
            ...
            Using Dr = OpenTrans(SQL)
                While Dr.Read()
                    ...
                    If sisaWaktu.StartsWith("Telat", StringComparison.OrdinalIgnoreCase) Then
                        With Guna2DataGridView1.Rows(idx).DefaultCellStyle
                            .BackColor = Color.FromArgb(215, 53, 53)
    ...
    Private Sub Button_Export_Excel_Click(sender As Object, e As EventArgs) Handles Button_Export_Excel.Click
        ...
        Dim nama_file As String = "PR_Outstanding_" & format_akhir & ".xlsx"
        ...
        If saveFileDialog.ShowDialog() = DialogResult.OK Then
            Try
                ...
                MsgBox("PR Outstanding berhasil di-export!", MsgBoxStyle.Information)
                xlWorkBook.Close()
                xlApp.Quit()
                releaseObject(xlWorkSheet)
                releaseObject(xlWorkBook)
