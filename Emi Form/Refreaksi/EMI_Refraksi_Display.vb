...
Public Class EMI_Refraksi_Display
    ...
    Private Sub Lv_PO_DoubleClick(sender As Object, e As EventArgs) Handles Lv_PO.DoubleClick
        ...
        Try
            ...
            SQL = "select a.No_Faktur, b.Kode_Barang, c.Nama, b.Jumlah, b.Satuan, a.Mata_Uang, b.Total, b.No_Urut, b.satuan_barang, b.Kode_Stock_Owner "
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        ...
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            Txt_HargaPO.Text = Format(.Rows(i).Item("Total"), "N2")
