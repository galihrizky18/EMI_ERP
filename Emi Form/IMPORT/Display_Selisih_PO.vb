Public Class Display_Selisih_PO
    ...
    Private Sub Display_Selisih_PO_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            SQL = "select a.no_val,a.id_rencana ,a.sisa,a.urut from  Selisih_Kurs_hutang_loading_barang a, rencana_order b "
    ...
    Private Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Hitung_HPP_Import.arrNoUrutPO.Clear()
        Hitung_HPP_Import.arrNilaiPakaiPO.Clear()
        Hitung_HPP_Import.TxtJmlPakaiPO.Clear()
        ...
        For index As Integer = 0 To DataGridView1.Rows.Count - 1
            ...
            If DGVPakai <> "" And DGVSisa <> 0 Then
                Hitung_HPP_Import.arrNoUrutPO.Add(DGVUrut)



                If DGVJenis = "Deposit" Then
                    jmlDeposit += Val(HilangkanTanda(DGVPakai))
                    Hitung_HPP_Import.arrNilaiPakaiPO.Add(DGVPakai * -1)
                ElseIf DGVJenis = "Hutang" Then
                    jmlHutang += Val(HilangkanTanda(DGVPakai))
                    Hitung_HPP_Import.arrNilaiPakaiPO.Add(DGVPakai)
                End If
            End If
        ...
        Hitung_HPP_Import.TxtJmlPakaiPO.Text = Format(jmlHutang - jmlDeposit, "N0")
