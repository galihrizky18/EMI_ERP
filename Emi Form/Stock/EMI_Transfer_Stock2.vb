...
Public Class EMI_Transfer_Stock2
    ...
    Private Sub CmbSO_Asal_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CmbSO_Asal.SelectedIndexChanged, TxtKd_Barang.TextChanged
    ...
    Private Sub TxtJumlah_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TxtJumlah.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            Dim lv As New System.Windows.Forms.ListViewItem
