Public Class Emi_Display_Request_Material
    ...
    Private Sub Emi_Display_Request_Material_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Lv_Data.Columns.Add("Kode Barang", 150, HorizontalAlignment.Left) '2
        Lv_Data.Columns.Add("Nama Barang", 0, HorizontalAlignment.Left) '3
    ...
    Private Sub Lv_Data_DoubleClick(sender As Object, e As EventArgs) Handles Lv_Data.DoubleClick
        ...
        If asal = "TF_Stock" Then
            ...
            Transfer_Stock_3.Txt_JumlahPermintaan.Text = Format(lv_Jumlah, "N4")
            Transfer_Stock_3.Txt_SatuanPermintaan.Text = lv_SatuanDisplay
            Transfer_Stock_3.TxtjmlPermintaanDisplay.Text = Format(Val(HilangkanTanda(lv_Jumlah)), "N4") + " " + lv_SatuanDisplay
            Transfer_Stock_3.TxtjmlPermintaanBersih.Text = HilangkanTanda(Format(Val(HilangkanTanda(lv_Jumlah)), "N4"))
