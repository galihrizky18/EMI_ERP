...
Public Class Emi_Request_Material_Display
    ...
    Dim Lv_NoFaktur, Lv_Lokasi, Lv_KdBarang, Lv_Tanggal, Lv_Jam, Lv_Jmlh, Lv_Satuan, Lv_User As String
    ...
    Private Sub Initial_Lv()
        Lv_Data.Columns.Add("No Faktur", 145, HorizontalAlignment.Left)
        Lv_Data.Columns.Add("Lokasi", 145, HorizontalAlignment.Left)
        Lv_Data.Columns.Add("Kode Barang", 145, HorizontalAlignment.Left)
        'Lv_Data.Columns.Add("Nama Barang", 270, HorizontalAlignment.Left)
        Lv_Data.Columns.Add("Tanggal Produksi", 125, HorizontalAlignment.Center)
