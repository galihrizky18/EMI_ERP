...
Public Class EMI_Transaksi_OrderPlan
    ...
    Private Sub Master_Gudang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DataGridView2.Rows(0).Cells(0).Value = "TPG-RMIX"
        DataGridView2.Rows(0).Cells(1).Value = "TEPUNG READY MIX 50KG"
        ' DataGridView2.Rows(0).Cells(2).Value = "350"
        DataGridView2.Rows(0).Cells(2).Value = "400"
        DataGridView2.Rows(0).Cells(3).Value = "500"
        DataGridView2.Rows(0).Cells(4).Value = "100"
        '  datagridview2.Rows(0).Cells(4).Style.BackColor = Color.Yellow

        DataGridView2.Rows.Add(1)
        DataGridView2.Rows(1).Cells(0).Value = "FRSH-TUNA"
        DataGridView2.Rows(1).Cells(1).Value = "FRESH TUNA 50KG"
        '  DataGridView2.Rows(1).Cells(2).Value = "350"
        DataGridView2.Rows(1).Cells(2).Value = "400"
        DataGridView2.Rows(1).Cells(3).Value = "500"
        DataGridView2.Rows(1).Cells(4).Value = "100"
        '   datagridview2.Rows(1).Cells(4).Style.BackColor = Color.LightGreen

        DataGridView2.Rows.Add(1)
        DataGridView2.Rows(2).Cells(0).Value = "TPG-PRTN"
        DataGridView2.Rows(2).Cells(1).Value = "TEPUNG PROTEIN 50KG"
        '  DataGridView2.Rows(2).Cells(2).Value = "1.300"
        DataGridView2.Rows(2).Cells(2).Value = "1.400"
        DataGridView2.Rows(2).Cells(3).Value = "1.400"
        DataGridView2.Rows(2).Cells(4).Value = "0"
        ' datagridview2.Rows(2).Cells(4).Style.BackColor = Color.OrangeRed

        DataGridView2.Rows.Add(1)
        DataGridView2.Rows(3).Cells(0).Value = "PCKG-FOIL85GR"
        DataGridView2.Rows(3).Cells(1).Value = "PACKAGING FOIL 85GR"
        '  DataGridView2.Rows(3).Cells(2).Value = "2.500"
        DataGridView2.Rows(3).Cells(2).Value = "2.500"
        DataGridView2.Rows(3).Cells(3).Value = "3.000"
        DataGridView2.Rows(3).Cells(4).Value = "500"
        '  datagridview2.Rows(3).Cells(4).Style.BackColor = Color.Yellow

        DataGridView2.Rows.Add(1)
        DataGridView2.Rows(4).Cells(0).Value = "PRTGLFC"
        DataGridView2.Rows(4).Cells(1).Value = "PRINTING GLOSSY FULL COLOR"
        ' DataGridView2.Rows(4).Cells(2).Value = "2.500"
        DataGridView2.Rows(4).Cells(2).Value = "2.500"
        DataGridView2.Rows(4).Cells(3).Value = "2.500"
        DataGridView2.Rows(4).Cells(4).Value = "0"
        ' datagridview2.Rows(4).Cells(4).Style.BackColor = Color.Yellow

        DataGridView1.Rows.Add(1)
        DataGridView1.Rows(0).Cells(0).Value = "TPG-RMIX"
        DataGridView1.Rows(0).Cells(1).Value = "TEPUNG READY MIX 50KG"
        DataGridView1.Rows(0).Cells(2).Value = "350"
        DataGridView1.Rows(0).Cells(3).Value = "400"
        DataGridView1.Rows(0).Cells(4).Value = "100"
        '  DataGridView1.Rows(0).Cells(4).Style.BackColor = Color.Yellow

        DataGridView1.Rows.Add(1)
        DataGridView1.Rows(1).Cells(0).Value = "FRSH-TUNA"
        DataGridView1.Rows(1).Cells(1).Value = "FRESH TUNA 50KG"
        DataGridView1.Rows(1).Cells(2).Value = "350"
        DataGridView1.Rows(1).Cells(3).Value = "400"
        DataGridView1.Rows(1).Cells(4).Value = "50"
        '   DataGridView1.Rows(1).Cells(4).Style.BackColor = Color.LightGreen

        DataGridView1.Rows.Add(1)
        DataGridView1.Rows(2).Cells(0).Value = "TPG-PRTN"
        DataGridView1.Rows(2).Cells(1).Value = "TEPUNG PROTEIN 50KG"
        DataGridView1.Rows(2).Cells(2).Value = "1.300"
        DataGridView1.Rows(2).Cells(3).Value = "1.400"
        DataGridView1.Rows(2).Cells(4).Value = "1.200"
        ' DataGridView1.Rows(2).Cells(4).Style.BackColor = Color.OrangeRed

        DataGridView1.Rows.Add(1)
        DataGridView1.Rows(3).Cells(0).Value = "PCKG-FOIL85GR"
        DataGridView1.Rows(3).Cells(1).Value = "PACKAGING FOIL 85GR"
        DataGridView1.Rows(3).Cells(2).Value = "2.500"
        DataGridView1.Rows(3).Cells(3).Value = "2.500"
        DataGridView1.Rows(3).Cells(4).Value = "1.000"
        '  DataGridView1.Rows(3).Cells(4).Style.BackColor = Color.Yellow

        DataGridView1.Rows.Add(1)
        DataGridView1.Rows(4).Cells(0).Value = "PRTGLFC"
        DataGridView1.Rows(4).Cells(1).Value = "PRINTING GLOSSY FULL COLOR"
        DataGridView1.Rows(4).Cells(2).Value = "2.500"
        DataGridView1.Rows(4).Cells(3).Value = "2.500"
        DataGridView1.Rows(4).Cells(4).Value = "1.500"
        ' DataGridView1.Rows(4).Cells(4).Style.BackColor = Color.Yellow
