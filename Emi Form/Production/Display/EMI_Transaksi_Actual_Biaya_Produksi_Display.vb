...
Public Class EMI_Transaksi_Actual_Biaya_Produksi_Display
    ...
    Private Sub Display_Trx_Formula_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            ListView1.Columns.Add("Work Center", 120, HorizontalAlignment.Center)
            ...
            ComboBox2.Items.Add("Jenis Biaya") : arr_Lain.Add("b.keterangan")
            ComboBox2.Items.Add("Work Center") : arr_Lain.Add("c.keterangan")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            SQL = "select status,no_faktur,tanggal,jam,iduser,b.keterangan as jenis_biaya, c.Keterangan as Work_Center,"
            SQL = SQL & "a.Jumlah, a.Satuan "
            SQL = SQL & "from EMI_Actual_Biaya_Produksi a, Emi_Jenis_Biaya_Produksi b, EMI_Master_Work_Center c "
            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and a.Id_Jenis_Biaya = b.Id_Jenis_Biaya_Produksi "
            SQL = SQL & "and a.Kode_Perusahaan = c.Kode_Perusahaan and a.Id_Work_Center = c.Id_Work_Center "
            ...
            Using Ds = BindingTrans(SQL)
                With Ds.Tables("MyTable")
                    For i As Integer = 0 To .Rows.Count - 1
                        ...
                        Lvw.SubItems.Add(.Rows(i).Item("work_center"))
