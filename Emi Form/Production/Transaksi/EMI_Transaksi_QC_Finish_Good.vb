...
Public Class EMI_Transaksi_QC_Finish_Good
    ...
    Dim Lv_NoTrans, Lv_Nama, Lv_Rak, Lv_Tgl, Lv_Jam, Lv_Jumlah, Lv_Satuan, Lv_SnBaru, Lv_KdBarang, LvKso, Lv_UrutOto, Lv_UrutScanQI As String
    ...
    Dim item_Urut_Scan_QI As Integer = 11
    ...
    Private Sub Get_Data_Lv(ByVal index As Integer)
        ...
        Lv_UrutScanQI = EMI_Display_QC_Produksi.Lv_Data.Items(index).SubItems(item_Urut_Scan_QI).Text
    End Sub
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            For i As Integer = 0 To EMI_Display_QC_Produksi.Lv_Data.Items.Count - 1
                ...
                SQL = "update EMI_Scan_QI_Detail set "
                SQL = SQL & "flag_sudah_qi = 'Y' "
                SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
                SQL = SQL & "and urut_oto = '" & Lv_UrutScanQI & "' "
                ExecuteTrans(SQL)


            Next

            SQL = "update EMI_Scan_QI set "
            SQL = SQL & "flag_qi = null "
            SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and no_transaksi = '" & EMI_Display_QC_Produksi.Lv_Data.Items(0).SubItems(item_NoTrans).Text & "' "
            ExecuteTrans(SQL)
