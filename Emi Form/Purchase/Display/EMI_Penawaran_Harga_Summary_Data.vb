...
Public Class EMI_Penawaran_Harga_Summary_Data
    ...
    Dim Arr1, Arr2, Arr3, Arr4, arrSubmited As New ArrayList
    ...
    Private Sub kosong()
        ...
        LvPenawaranHarga.Columns.Add(Base_Language.Lang_global_Periode_Akhir, 120, HorizontalAlignment.Center)
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles LvPenawaranHarga.SelectedIndexChanged
        Try
            ...
            SQL = SQL & "From EMI_Master_Penawaran_Detail a, Barang b "
            SQL = SQL & "Where a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.Kode_Perusahaan = b.Kode_Perusahaan and "
            SQL = SQL & "a.Kode_Barang = b.Kode_Barang and b.Kode_Stock_Owner = '" & gudangDefault & "' and "
            SQL = SQL & "a.No_Faktur = '" & LvPenawaranHarga.FocusedItem.Text & "' "
