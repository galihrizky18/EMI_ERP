...
Public Class Jf_Master_Karyawan2_st
    Dim Perusahaan_List As New ArrayList
    Dim LGolongan As New ArrayList
    Dim LLevelJabatan, idlevel As New ArrayList
    Dim LDivisiSubDivisi, iddivisi As New ArrayList
    ...
    Private Sub Perusahaan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        LvKaryawan.Columns.Add("No.Induk Karyawan", 150, HorizontalAlignment.Center)
        LvKaryawan.Columns.Add("ID Absen", 80, HorizontalAlignment.Center)
        ...
        LvKaryawan.Columns.Add("Tgl Masuk", 100, HorizontalAlignment.Center)
        LvKaryawan.Columns.Add("Tgl PKWT", 100, HorizontalAlignment.Center)
        LvKaryawan.Columns.Add("Shift", 150, HorizontalAlignment.Left)
        LvKaryawan.Columns.Add("Lembur", 150, HorizontalAlignment.Left)

        LvKaryawan.Columns.Add("Bank", 100, HorizontalAlignment.Left)
        LvKaryawan.Columns.Add("Nama Rekening", 150, HorizontalAlignment.Left)
        LvKaryawan.Columns.Add("No.Rekening", 100, HorizontalAlignment.Center)
    ...
    Private Sub Kosong()
        Try
            ...
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Nama, dbo.HRIS_Transaksi_Karyawan.Alamat, dbo.HRIS_Transaksi_Karyawan.Telepon, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.HP, dbo.HRIS_Transaksi_Karyawan.Jenis, dbo.HRIS_Transaksi_Karyawan.Aktif, dbo.HRIS_Transaksi_Karyawan.No_Rek, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Kode_Jabatan, dbo.HRIS_Transaksi_Karyawan.Email, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Tgl_Masuk, dbo.HRIS_Transaksi_Karyawan.Cabang_Untuk_Gaji, dbo.HRIS_Transaksi_Karyawan.NPWP, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.NIK, dbo.HRIS_Transaksi_Karyawan.Status_Karyawan, dbo.HRIS_Transaksi_Karyawan.Jenis_Perayaan, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Lokasi, dbo.HRIS_Transaksi_Karyawan.Tgl_PKWT, dbo.HRIS_Transaksi_Karyawan.No_Induk_Karyawan, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.ID_Perusahaan, dbo.HRIS_Transaksi_Karyawan.Pendidikan_Terakhir, dbo.HRIS_Transaksi_Karyawan.Agama, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Kepala, dbo.HRIS_Transaksi_Karyawan.Tgl_Lahir, dbo.HRIS_Transaksi_Karyawan.Jenis_Kelamin, dbo.HRIS_Transaksi_Karyawan.Bank, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Nama_Rekening, dbo.HRIS_Transaksi_Karyawan.Flag_OK, dbo.HRIS_Transaksi_Karyawan.Tanggal_OK, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.ID_Level_Jabatan, dbo.HRIS_Transaksi_Karyawan.ID_Divisi_Sub_Divisi, dbo.HRIS_Transaksi_Karyawan.ID_Shift, "
            SQL = SQL & "dbo.HRIS_Shift_Kerja.Nama AS NamaShift, dbo.HRIS_Transaksi_Karyawan.ID_Waktu_Lembur, dbo.HRIS_Waktu_Lembur.Kode_Waktu_Lembur, "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.UserID_Absen, dbo.Perusahaan.Nama AS nama_perusahaan, dbo.HRIS_Level_Jabatan.ID_Level, dbo.HRIS_Level.Keterangan AS KetLevel, "
            ...
            SQL = SQL & "dbo.HRIS_Sub_Divisi ON dbo.HRIS_Divisi_Sub_Divisi.ID_Sub_Divisi = dbo.HRIS_Sub_Divisi.ID_Sub_Divisi INNER JOIN "
            SQL = SQL & "dbo.HRIS_Shift_Kerja ON dbo.HRIS_Transaksi_Karyawan.ID_Shift = dbo.HRIS_Shift_Kerja.ID_Shift INNER JOIN "
            SQL = SQL & "dbo.HRIS_Waktu_Lembur ON dbo.HRIS_Transaksi_Karyawan.Kode_Perusahaan = dbo.HRIS_Waktu_Lembur.Kode_Perusahaan AND "
            SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.ID_Waktu_Lembur = dbo.HRIS_Waktu_Lembur.ID_Waktu_Lembur "

            SQL = SQL & "WHERE HRIS_Transaksi_Karyawan.kode_perusahaan = '" & KodePerusahaan & "' and HRIS_Transaksi_Karyawan.aktif = 'Y' and "
            SQL = SQL & "HRIS_Transaksi_Karyawan.Flag_OK = 'T' "
            ...
            Using dr = OpenTrans(SQL)
                Do While dr.Read
                    ...
                    Lvw.SubItems.Add(dr("no_induk_karyawan"))
                    Lvw.SubItems.Add(dr("userid_absen"))
                    ...
                    Lvw.SubItems.Add(Format(dr("tgl_masuk"), "dd MMM yyyy"))
                    Lvw.SubItems.Add(Format(dr("tgl_pkwt"), "dd MM yyyy"))
                    Lvw.SubItems.Add(dr("namashift"))
                    Lvw.SubItems.Add(dr("kode_waktu_lembur"))

                    Lvw.SubItems.Add(dr("bank"))
                    Lvw.SubItems.Add(dr("nama_rekening"))
                    Lvw.SubItems.Add(dr("no_rek"))
            ...
            ' Level dan Divisi
            '=================================================================
            CmbLevel.Items.Clear() : LLevelJabatan.Clear() : idlevel.Clear()
            ...
            SQL = SQL & "dbo.HRIS_Golongan.Keterangan AS KetGolongan, dbo.HRIS_Sub_Golongan.Keterangan AS KetSubGolongan,dbo.HRIS_Level_Jabatan.ID_Level "
            ...
            CmbDivisi.Items.Clear() : LDivisiSubDivisi.Clear() : iddivisi.Clear()
            ...
            SQL = SQL & "dbo.HRIS_Divisi_Sub_Divisi.ID_Divisi "
        ...
        CmbKolom.Items.Add("No.Induk Karyawan") : LKolom.Add("No_Induk_Karyawan")
        CmbKolom.Items.Add("ID Absen") : LKolom.Add("UserID")
        ...
        CmbKolom.Items.Add("Bank") : LKolom.Add("Bank")
        CmbKolom.Items.Add("Nama Rekening") : LKolom.Add("Nama_Rekening")
        CmbKolom.Items.Add("No.Rekening") : LKolom.Add("No_Rek")
        ...
        TxtNoFaktur.Text = "M" & Format(TglFaktur.Value, "yyMMdd") &
                            General_Class.Get_Last_Number("HRIS_Transaksi_Karyawan", "No_Faktur", 3,
                                                            "Kode_Perusahaan", KodePerusahaan, "and",
                                                            "left(no_faktur,7)", "M" & Format(TglFaktur.Value, "yyMMdd"))
    ...
    Private Sub CmbPerayaan_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CmbPerayaan.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            TxtNoIndukKaryawan.Focus()
        End If
    End Sub

    Private Sub TxtNoIndukKaryawan_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtNoIndukKaryawan.KeyPress
        If e.KeyChar = Chr(13) Then TxtIDAbsen.Focus()
    End Sub

    Private Sub TxtIDAbsen_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtIDAbsen.KeyPress
    ...
    Private Sub CmbStatusKaryawan_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CmbStatusKaryawan.KeyPress
        If e.KeyChar = Chr(13) Then TglMasuk.Focus()
    End Sub

    Private Sub TglMasuk_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TglMasuk.KeyPress
        If e.KeyChar = Chr(13) Then TglPKWT.Focus()
    End Sub

    Private Sub TglPKWT_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TglPKWT.KeyPress
        If e.KeyChar = Chr(13) Then CmbShift.Focus()
    End Sub
    ...
    Private Sub CmbShift_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CmbShift.KeyPress
        If e.KeyChar = Chr(13) Then CmbLembur.Focus()
    End Sub

    Private Sub CmbLembur_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles CmbLembur.KeyPress
        If e.KeyChar = Chr(13) Then
    ...
    Private Sub TxtBank_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtBank.KeyPress
        If e.KeyChar = Chr(13) Then TxtNamaRek.Focus()
    End Sub

    Private Sub TxtNamaRek_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtNamaRek.KeyPress
        If e.KeyChar = Chr(13) Then TxtNoRek.Focus()
    End Sub

    Private Sub TxtNoRek_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtNoRek.KeyPress
    ...
    Private Sub TxtNoFaktur_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtNoFaktur.Leave
        ...
        Try
            ...
            SQL = "Select * From HRIS_Transaksi_Karyawan "
                ...
                If Dr.Read Then
                    ...
                    If Dr("flag_ok") = "Y" Then
                        MessageBox.Show("Data yang anda cari sudah di validasi, " & Chr(13) & _
                                        "proses tidak dapat dilanjutkan!", "Transaksi Karyawan", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                        Kosong()
                        TxtKodeKaryawan.Focus()
                        Exit Sub
                    End If
    ...
    Private Sub BtSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtSimpan.Click
        ...
        If TxtKodeKaryawan.Text.Trim.Length = 0 Then
            MessageBox.Show("Kode Karyawan harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage1
        ...
        ElseIf TxtNoIndukKaryawan.Text.Trim.Length = 0 Then
            MessageBox.Show("No induk karyawan harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage2
            TxtNoIndukKaryawan.Focus() : Exit Sub
        ElseIf TxtIDAbsen.Text.Trim.Length = 0 Then
            MessageBox.Show("ID absen harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage2
            TxtIDAbsen.Focus() : Exit Sub
        ...
        ElseIf CmbStatusKaryawan.SelectedIndex = -1 Then
            MessageBox.Show("Status karyawan harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage2
            CmbStatusKaryawan.Focus() : Exit Sub
        ElseIf CmbShift.SelectedIndex = -1 Then
            MessageBox.Show("Shift harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage2
            CmbShift.Focus() : Exit Sub
        ElseIf CmbLembur.SelectedIndex = -1 Then
            MessageBox.Show("Kode lembur harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage2
            CmbLembur.Focus() : Exit Sub

        ElseIf TxtBank.Text.Trim.Length = 0 Then
            MessageBox.Show("Bank harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage3
            TxtBank.Focus() : Exit Sub
        ElseIf TxtNamaRek.Text.Trim.Length = 0 Then
            MessageBox.Show("Nama rekening harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage3
            TxtNamaRek.Focus() : Exit Sub
        ElseIf TxtNoRek.Text.Trim.Length = 0 Then
            MessageBox.Show("Nomor rekening harus diisi!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            TabControl1.SelectedTab = TabPage3
            TxtNoRek.Focus() : Exit Sub
        End If
        ...
        Dim Tanya As String = MessageBox.Show("Anda yakin akan simpan data ini?", "Transaksi Karyawan", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        ...
        Try
            ...
            If BtSimpan.Text = "&Simpan" Then
                TxtNoFaktur.Text = "M" & Format(TglFaktur.Value, "yyMMdd") & _
                    General_Class.Get_Last_Number("HRIS_Transaksi_Karyawan", "No_Faktur", 3, _
                                                    "Kode_Perusahaan", KodePerusahaan, "and", _
                                                    "left(no_faktur,7)", "M" & Format(TglFaktur.Value, "yyMMdd"))

                SQL = "Insert Into HRIS_Transaksi_Karyawan(Kode_Perusahaan,no_faktur,tanggal,jam,userid,Kode_karyawan,nama,Alamat,Telepon,HP,tgl_lahir,"
                SQL = SQL & "jenis_kelamin,jenis,aktif,userid_absen,email,tgl_masuk,nik,no_induk_karyawan,npwp,id_perusahaan,jenis_perayaan,"
                SQL = SQL & "Pendidikan_terakhir,agama,id_level_jabatan,id_divisi_sub_divisi,lokasi,cabang_untuk_gaji,"
                SQL = SQL & "status_karyawan,tgl_pkwt,kepala,bank,nama_rekening,no_rek,flag_ok,id_shift,id_waktu_lembur)"
                ...
                SQL = SQL & TxtIDAbsen.Text.Trim & "','" & TxtEmail.Text.Trim & "','" & Format(TglMasuk.Value, "yyyy-MM-dd") & "','"
                SQL = SQL & TxtNIK.Text.Trim & "','" & TxtNoIndukKaryawan.Text.Trim & "','"
                ...
                SQL = SQL & CmbStatusKaryawan.Text & "','" & Format(TglPKWT.Value, "yyyy-MM-dd") & "','" & TxtKepala.Text.Trim & "','"
                SQL = SQL & TxtBank.Text.Trim & "','" & TxtNamaRek.Text.Trim & "','" & TxtNoRek.Text & "','T','"
                SQL = SQL & LShift(CmbShift.SelectedIndex) & "','" & LLembur(CmbLembur.SelectedIndex) & "')"
                ExecuteTrans(SQL)
                ...
                '                SQL = "insert into HRIS_Transaksi_Karyawan_Approval(Kode_Perusahaan,No_Faktur,UserID_Approval,ID_Level_Jabatan,"
                ...
                '    End With
                'End Using
                Approval_Hierarchy("Approval Karyawan", idlevel.Item(CmbLevel.SelectedIndex), iddivisi.Item(CmbDivisi.SelectedIndex))
                ...
                For a As Integer = 0 To Data_User_App.Count - 1
                    ...
                    SQLSQL = "insert into HRIS_Transaksi_Karyawan_Approval(No_Faktur,User_ID,"
                    SQLSQL = SQLSQL & "Level_Hierarchy,pin,kode_unik) values('" & TxtNoFaktur.Text.Trim & "',"
                ...
                Next
            Else
                SQL = "Update HRIS_Transaksi_Karyawan Set userid = '" & UserID & "', kode_karyawan = '" & TxtKodeKaryawan.Text.Trim & "',"
                ...
                SQL = SQL & "jenis_kelamin = '" & CmbJK.Text & "',jenis = '" & CmbJenis.Text & "',aktif = '" & CmbAktif.Text & "',userid_absen = '" & TxtIDAbsen.Text.Trim & "',"
                SQL = SQL & "email = '" & TxtEmail.Text.Trim & "',tgl_masuk = '" & Format(TglMasuk.Value, "yyyy-MM-dd") & "',"
                SQL = SQL & "nik = '" & TxtNIK.Text.Trim & "',no_induk_karyawan = '" & TxtNoIndukKaryawan.Text.Trim & "',"
                ...
                SQL = SQL & "tgl_pkwt = '" & Format(TglPKWT.Value, "yyyy-MM-dd") & "',kepala = '" & TxtKepala.Text.Trim & "',"
                SQL = SQL & "bank = '" & TxtBank.Text.Trim & "',nama_rekening = '" & TxtNamaRek.Text.Trim & "',no_rek = '" & TxtNoRek.Text.Trim & "',"
                SQL = SQL & "id_shift = '" & LShift(CmbShift.SelectedIndex) & "',id_waktu_lembur = '" & LLembur(CmbLembur.SelectedIndex) & "' "
                SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' and no_faktur = '" & TxtNoFaktur.Text.Trim & "'"
                ExecuteTrans(SQL)
            End If
    ...
    Private Sub BtHapus_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtHapus.Click
        ...
        If Hapus1 = vbYes Then
            Try
                ...
                ExecuteTrans("Delete From HRIS_Transaksi_Karyawan where Kode_Perusahaan = '" & KodePerusahaan & "' and no_faktur = '" & TxtNoFaktur.Text & "'")
    ...
    Private Sub BtCari_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtCari.Click
        ...
        SQL = "SELECT dbo.HRIS_Transaksi_Karyawan.Kode_Perusahaan, dbo.HRIS_Transaksi_Karyawan.No_Faktur, dbo.HRIS_Transaksi_Karyawan.Tanggal, "
        SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Jam, dbo.HRIS_Transaksi_Karyawan.UserID, dbo.HRIS_Transaksi_Karyawan.Kode_Karyawan, "
        SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Nama, dbo.HRIS_Transaksi_Karyawan.Alamat, dbo.HRIS_Transaksi_Karyawan.Telepon, "
        SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.HP, dbo.HRIS_Transaksi_Karyawan.Jenis, dbo.HRIS_Transaksi_Karyawan.Aktif, dbo.HRIS_Transaksi_Karyawan.No_Rek, "
        SQL = SQL & "dbo.HRIS_Transaksi_Karyawan.Kode_Jabatan, dbo.HRIS_Transaksi_Karyawan.Email, "
    ...
    Private Sub TxtKodeKaryawan_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtKodeKaryawan.Leave
        ...
        SQL = "Select kode_karyawan from karyawan where kode_perusahaan = '" & KodePerusahaan & "' and "
        SQL = SQL & "kode_karyawan = '" & TxtKodeKaryawan.Text & "'"
        Using Dr = OpenTrans(SQL)
            If Dr.Read Then
                MessageBox.Show("Kode karyawan sudah ada, input kode lain!", "Perhatian", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
