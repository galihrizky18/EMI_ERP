...
Public Class Jf_Master_Rekrutmen_Display_Input
    ...
    Dim Cell_KodeTunjangan As Integer = 0
    Dim Cell_Nama As Integer = 1
    Dim Cell_Nilai As Integer = 2
    Dim Cell_Range As Integer = 3
    ...
    Private Sub Kosong()
        Try
            ...
            LvKaryawan.Items.Clear() : DataGridView1.Rows.Clear()
            ...
            SQL = SQL & "WHERE HRIS_Rekrutmen_Karyawan.kode_perusahaan = '" & KodePerusahaan & "' and HRIS_Rekrutmen_Karyawan.flag_ok = 'Y' and HRIS_Rekrutmen_Karyawan.Flag_Input_Gaji is null "
        ...
        Tgl1.Enabled = False : Tgl1.Value = CDate(FMenuDev.ToolStripStatusLabel3.Text)
        Tgl2.Enabled = False : Tgl2.Value = CDate(FMenuDev.ToolStripStatusLabel3.Text)
        ...
        TglFaktur.Value = CDate(FMenuDev.ToolStripStatusLabel3.Text)
        TxtNoFaktur.Text = ""
        TxtKodeKaryawan.Text = "" : TxtNamaKaryawan.Text = "" : TxtAlamat.Text = "" : TxtTelepon.Text = "" : TxtHp.Text = ""
        TglLahir.Value = CDate(FMenuDev.ToolStripStatusLabel3.Text)
        TxtEmail.Text = ""
    ...
    Private Sub TxtNoFaktur_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtNoFaktur.Leave
        ...
        Try
            ...
            LvTunjangan.Items.Clear() : DataGridView1.Rows.Clear()
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            DataGridView1.Rows(i).Cells(0).Value = .Rows(i).Item("Kode_Komponen").ToString
                            DataGridView1.Rows(i).Cells(1).Value = .Rows(i).Item("Keterangan").ToString
                            DataGridView1.Rows(i).Cells(2).Value = .Rows(i).Item("Tunjangan").ToString
                            StrRange = Format(.Rows(i).Item("RangeTJ"), "N0")
                            StrRange2 = Format(.Rows(i).Item("RangeT2"), "N0")
                            DataGridView1.Rows(i).Cells(3).Value = StrRange & " - " & StrRange2
                        Next
                    End If
                End With
            End Using
    ...
    Private Sub ChkTanggal_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChkTanggal.CheckedChanged
        ...
        Else
            CmbTanggal.SelectedIndex = -1 : Tgl1.Value = CDate(FMenuDev.ToolStripStatusLabel3.Text) : Tgl2.Value = CDate(FMenuDev.ToolStripStatusLabel3.Text)
    ...
    Private Sub BtnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSimpan.Click
        ...
        Try
            ...
            Else
                ...
                Kd_unik = Format(CDate(FMenuDev.ToolStripStatusLabel3.Text), "Mdd") & Format(rand.Next(0, 100000), "00000")
                ...
                SQL = "Update HRIS_Rekrutmen_Karyawan Set Flag_OK = 'Y', Tanggal_OK = '" & Format(CDate(FMenuDev.ToolStripStatusLabel3.Text), "yyyy-MM-dd") & "' "
                ...
                If fLebih = "Y" Then
                    ...
                    '    level = 0
                    '    SQLSQL = "select count(Id) as id from HRIS_Transaksi_Rekrutmen_Approval where No_Faktur = '" & TxtNoFaktur.Text.Trim & "'"
                    ...
                    '        SQLSQL = SQLSQL & "No_Faktur = '" & TxtNoFaktur.Text.Trim & "' and "
                    '        SQLSQL = SQLSQL & "User_ID = '" & Data_User_App_Flag_Khusus.Item(vv) & "'"
                    '        Using Dr = OpenTransSQL(SQLSQL)
                    '            If Dr.Read Then
                    ...
                    '                SQLSQL = SQLSQL & "'" & Data_Nama_App_Flag_Khusus.Item(vv) & "', "
                    '                SQLSQL = SQLSQL & "'" & Data_Email_App_Flag_Khusus.Item(vv) & "', '" & Data_Jabatan_App_Flag_Khusus.Item(vv) & "', "
                    '                SQLSQL = SQLSQL & "'" & Data_Divisi_App_Flag_Khusus.Item(vv) & "', '" & fHp & "')"
                    '                ExecuteTransSQL(SQLSQL)
    ...
    Private Sub LvTunjangan_DoubleClick(sender As Object, e As EventArgs) Handles LvTunjangan.DoubleClick
        ...
        TxtCari1.Focus()
    End Sub
    Private Sub Jf_Master_Rekrutmen_Display_Input_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        My.Application.ChangeCulture("en-us")
        My.Application.ChangeUICulture("en-us")
    End Sub
    ...
    Private Sub DataGridView1_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellEndEdit
        ...
        If Not DataGridView1.Rows.Count = 0 Then
            ...
            If DataGridView1.CurrentCell.ColumnIndex = Cell_Nilai Then
                ...
                If cellKuantity.Contains(",") Then
                    ...
                    DataGridView1.CurrentRow.Cells(Cell_Nilai).Value = Format(0, "N2")
                    Exit Sub
                End If
                ...
                DataGridView1.CurrentRow.Cells(Cell_Nilai).Value = formattedValue
            End If
        End If
    End Sub
    ...
    Private Sub TxtGapok_Leave(sender As Object, e As EventArgs) Handles TxtGapok.Leave
        If Not TxtGapok.Text.Trim.Count = 0 Then
            ...
            If TxtGapok.Text.Contains(",") Then
                'MessageBox.Show("Kuantity Tidak Boleh Koma, Ganti dengan Titik", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                'TxtGapok.Text = Format(0, "N0")
                'Exit Sub

                TxtGapok.Text = TxtGapok.Text.Replace(",", ".").Trim
            End If

            Dim nilai As Decimal = Val(TxtGapok.Text.Trim)
            Dim formattedValue As String = nilai.ToString("N0", culture)

            TxtGapok.Text = formattedValue

        End If
    End Sub

    Private Sub TxtGapok_Enter(sender As Object, e As EventArgs) Handles TxtGapok.Enter
        If Not TxtGapok.Text.Trim.Count = 0 Then
            ...
            Dim cleanedStr As String = HilangkanTanda(TxtGapok.Text) ' Menghapus titik
            Dim nilai As Decimal = Decimal.Parse(cleanedStr)
