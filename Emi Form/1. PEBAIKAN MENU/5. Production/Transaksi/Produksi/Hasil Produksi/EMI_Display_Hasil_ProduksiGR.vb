Public Class EMI_Display_Hasil_ProduksiGR
    ...
    Private Sub isi_lv()
        Try
            ...
            SQL = SQL & "and a.Kode_Perusahaan = d.Kode_Perusahaan and a.Flag_Produksi = 'Y' and b.status is null and a.status is null and a.Flag_Hasil_Produksi_GR is null  "
    ...
    Private Sub kosong3()
        ...
        Try
            ...
            Label1.Text = "Display - Hasil Produksi GR"
    ...
    Private Sub ListView1_DoubleClick(sender As Object, e As EventArgs) Handles ListView1.DoubleClick
        ...
        EMI_Hasil_ProductionGR.TextBox4.Text = LvNo_Faktur

        EMI_Hasil_ProductionGR.ShowDialog()
