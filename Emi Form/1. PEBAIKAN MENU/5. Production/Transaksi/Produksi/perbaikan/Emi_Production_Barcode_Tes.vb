...
Public Class Emi_Production_Barcode_Tes

    Public fno_po As String = ""
    Public Prefix As String = ""
    Public id_routing As String = ""
    Public kategoriQuality As New ArrayList({"HIJAU", "MERAH"})
    Public kategoriQualityKet As New ArrayList({"Good Stock", "Bad Stock"})
    Public arrInisialFaktur, arrSO, arrSoGudangSisa As New ArrayList
    Public arrKdBarangSrap, arrNamaScrap, arrSatuanScrap, arrSatuanKecilScrap As New ArrayList
    ...
    Public Lv_Life_Time As String
    Public Tahun_MulaiProduksi As String
    ...
    Private Sub kosong()
        ...
        Try
            ...
            Else
                SQL = SQL & "And Flag_Penyimpanan ='Y' "
            End If
...
#End Region
            ...
            sw1.Stop()
            Dim lv As ListViewItem = Lv_Timer.Items.Add("Ambil Packaging")
            lv.SubItems.Add($"{sw1.Elapsed.TotalMilliseconds} ms")

            SQL = $"
                insert into N_EMI_Temp_Waktu_GR_1 (Kode_Perusahaan, No_faktur, Keterangan, Waktu)
                values ({KodePerusahaan}'', '{TxtFormulator_NoFaktur.Text}', 'Ambil Packaging', '{sw1.Elapsed.TotalMilliseconds} ms')
            "
            executeTrans(sql)
...
#End Region
            sw2.Stop()
            Dim lv2 As ListViewItem = Lv_Timer.Items.Add("Ambil WorkCenter")
            lv2.SubItems.Add($"{sw2.Elapsed.TotalMilliseconds} ms")
...
#Region "Generate Barcode FG"
            ...
            If Val(HilangkanTanda(Txt_Jumlah.Text)) <> 0 Then
                ...
                'Cek ukuran file
                'Dim info = My.Computer.FileSystem.GetFileInfo(FileToSaveAs1)
                'Dim ukuranFile As Long = info.Length
                'MessageBox.Show("Ukuran file: " & ukuranFile & " byte")
...
#End Region
            sw3.Stop()
            Dim lv3 As ListViewItem = Lv_Timer.Items.Add("Generate Barcode FG")
            lv3.SubItems.Add($"{sw3.Elapsed.TotalMilliseconds} ms")
            ...
            sw4.Stop()
            Dim lv4 As ListViewItem = Lv_Timer.Items.Add("Innsert Detail Barang")
            lv4.SubItems.Add($"{sw4.Elapsed.TotalMilliseconds} ms")
...
#End Region
            ...
            sw5.Stop()
            Dim lv5 As ListViewItem = Lv_Timer.Items.Add("Innsert Produksi")
            lv5.SubItems.Add($"{sw5.Elapsed.TotalMilliseconds} ms")
...
#Region "Insert Scrap"
            ...
            If Val(TxtJmlScrap.Text) <> 0 Then
                ...
                sw11.Stop()
                Dim lv11 As ListViewItem = Lv_Timer.Items.Add("Genereate Barcode Scrap")
                lv11.SubItems.Add($"{sw11.Elapsed.TotalMilliseconds} ms")
...
#End Region
            ...
            sw6.Stop()
            Dim lv6 As ListViewItem = Lv_Timer.Items.Add("Innsert Scrap")
            lv6.SubItems.Add($"{sw6.Elapsed.TotalMilliseconds} ms")
...
#End Region
            ...
            sw7.Stop()
            Dim lv7 As ListViewItem = Lv_Timer.Items.Add("Jurnal Awal")
            lv7.SubItems.Add($"{sw7.Elapsed.TotalMilliseconds} ms")
...
#End Region
                sw8.Stop()
                Dim lv8 As ListViewItem = Lv_Timer.Items.Add("Jurnal PAckaging")
                lv8.SubItems.Add($"{sw8.Elapsed.TotalMilliseconds} ms")
...
#End Region
                ...
                sw9.Stop()
                Dim lv9 As ListViewItem = Lv_Timer.Items.Add("Jurnal FOrmulator")
                lv9.SubItems.Add($"{sw9.Elapsed.TotalMilliseconds} ms")
...
#End Region
            ...
            sw10.Stop()
            Dim lv10 As ListViewItem = Lv_Timer.Items.Add("Jurnal Scrap")
            lv10.SubItems.Add($"{sw10.Elapsed.TotalMilliseconds} ms")


            sw90.Stop()
            Dim lv90 As ListViewItem = Lv_Timer.Items.Add("Waktu Commit")
            lv90.SubItems.Add($"{sw90.Elapsed.TotalMilliseconds} ms")
            ...
            CloseTrans()
            CloseConn()
            'MessageBox.Show("Berhasil Simpan", Judul, MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            CloseTrans()
            CloseConn()
            MessageBox.Show(ex.Message)
            ...
            Try
                ...
                Using Ds = BindingTrans(SQL)
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then
                        ...
                        Dim sw15 As New Stopwatch()
                        sw15.Start()
                        '==========================
                        '=     BARCODEE BESAR     =
                        '==========================
                        Dim printerDitemukan As Boolean = True
                        ...
                        If printerDitemukan Then
                            ...
                            'CrDoc.PrintOptions.PaperSize = CType(257, CrystalDecisions.Shared.PaperSize)
                        ...
                        sw15.Stop()
                        Dim lv15 As ListViewItem = Lv_Timer.Items.Add("Waktu Connect Printer FG")
                        lv15.SubItems.Add($"{sw15.Elapsed.TotalMilliseconds} ms")
        ...
        sw12.Stop()
        Dim lv12 As ListViewItem = Lv_Timer.Items.Add("Ceteak Barcode FG")
        lv12.SubItems.Add($"{sw12.Elapsed.TotalMilliseconds} ms")
        ...
        If Val(TxtJmlScrap.Text) <> 0 Then
            ...
            'MessageBox.Show("Berhasil Cetak Barcode Scrap", Judul, MessageBoxButtons.OK, MessageBoxIcon.Information)

        End If

        sw13.Stop()
        Dim lv13 As ListViewItem = Lv_Timer.Items.Add("Ceteak Barcode Scrap")
        lv13.SubItems.Add($"{sw13.Elapsed.TotalMilliseconds} ms")
        ...
        kosong()
        sw14.Stop()
        Dim lv14 As ListViewItem = Lv_Timer.Items.Add("Waktu Kosong")
        lv14.SubItems.Add($"{sw14.Elapsed.TotalMilliseconds} ms")
