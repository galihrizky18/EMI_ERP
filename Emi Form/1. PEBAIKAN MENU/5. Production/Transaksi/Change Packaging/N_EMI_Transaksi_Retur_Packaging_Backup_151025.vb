...
Public Class N_EMI_Transaksi_Retur_Packaging_Backup_151025
    ...
    Private Sub N_EMI_Transaksi_Retur_Packaging_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Lv_Data_Split.Columns.Add("Routing", 150, HorizontalAlignment.Left)
    ...
    Private Sub Lv_Data_Split_DoubleClick(sender As Object, e As EventArgs) Handles Lv_Data_Split.DoubleClick
        ...
        Try
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    Txt_Jumlah_Tot_Retur.Text = Format(Dr("Jumlah_Request"), "N0")
                    Cmb_Satuan_Tot_Retur.Text = Dr("Satuan_Awal")
                Else
                    Txt_Jumlah_Tot_Retur.Text = 0
...
#Region "Auto Request Material"
                    ...
                    If Jumlah_Ganti <> 0 Then
                        ...
                        SQL = SQL & "'PCS', '" & HilangkanTanda(Jumlah_Ganti) & "', '" & arrSatuan_Req_Packaging(Cmb_Satuan_Retur.SelectedIndex) & "', 'Packaging')"
                        ExecuteTrans(SQL)
                        ...
                        SQL = SQL & "'" & HilangkanTanda(Jumlah_Ganti) & "', "
                        SQL = SQL & "'PCS', '" & HilangkanTanda(Jumlah_Ganti) & "', '" & arrSatuan_Req_Packaging(Cmb_Satuan_Retur.SelectedIndex) & "', 'Hijau', '" & x_ident_currentPackaging & "')"
                        ExecuteTrans(SQL)
...
#Region "Tambah Stock"
                    ...
                    SQL = SQL & "and a.Kode_Stock_Owner='" & arrGudang_Packaging(Cmb_Lokasi_Retur.SelectedIndex) & "' and b.Kode_Barang is null"
...
#End Region
                    ...
                    SQL = SQL & Val(HilangkanTanda(Txt_Jumlah_Retur.Text)) & " ,'PCS', " & HilangkanTanda(Jumlah_Convert_Scrap) & ", "
    ...
    Private Sub Cmb_Lokasi_Retur_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Cmb_Lokasi_Retur.SelectedIndexChanged
        ...
        Try
            ...
            Cmb_Barang_Retur.Items.Clear() : arrBarang_Req_Packaging_Satuan.Clear()
