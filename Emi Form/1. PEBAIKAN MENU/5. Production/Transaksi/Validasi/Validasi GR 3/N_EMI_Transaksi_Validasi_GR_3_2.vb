...
Public Class N_EMI_Transaksi_Validasi_GR_3_2
    ...
    Private Sub HapusToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles HapusToolStripMenuItem1.Click
        ...
        Try
            ...
            SQL = "select Kode_Perusahaan from N_EMI_Validation_GR3_Temp where Kode_Perusahaan = '" & KodePerusahaan & "' and no_split = '" & SelectedSplit & "' and No_Transaksi = '" & SelectedNoTransaksi & "' and UserID = '" & UserID & "' "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    Dr.Close()
                    ...
                    SQL = "delete N_EMI_Validation_GR3_Temp where Kode_Perusahaan = '" & KodePerusahaan & "' and no_split = '" & SelectedSplit & "' and No_Transaksi = '" & SelectedNoTransaksi & "' and UserID = '" & UserID & "' "
                    ExecuteTrans(SQL)
                Else
                    CloseConn()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            For i As Integer = 0 To Lv_Data.Items.Count - 1
                ...
                SQL = SQL & "'" & Cmb_Jenis.Text & "', '" & arrKdBarangSrap(Cmb_Jenis.SelectedIndex) & "', '" & LvData_KdSoAwal & "', '" & arrSO(Cmb_LokasiTujuan.SelectedIndex) & "', '" & HilangkanTanda(LvData_Jumlah) & "', '" & UserID & "')"
                ExecuteTrans(SQL)
    ...
    Private Sub Kosong()
        ...
        LvBarcode.Columns.Add("No_Transaksi", 130, HorizontalAlignment.Left)
    ...
    Private Sub KosongTab1()
        ...
        Btn_Tambah.Enabled = True : Button1.Enabled = True
    ...
    Private Sub Btn_Tambah_Click(sender As Object, e As EventArgs) Handles Btn_Tambah.Click
        ...
        Try
            ...
            SQL = "select no_transaksi from N_EMI_Validation_GR3_Temp where kode_perusahaan = '" & KodePerusahaan & "' and no_split = '" & Txt_NoSplit.Text & "'"
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    Dr.Close()
                    get_no_faktur_Temp()
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            SQL = "select kode_Perusahaan, No_Transaksi, No_Transaksi_GR2, No_Split, Qr_Code, Kode_Unik_Berjalan, Jenis, Kd_Barang, So_Awal, So_Tujuan, Jumlah, UserID "
            SQL = SQL & "from N_EMI_Validation_GR3_Temp  "
            SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
            ...
            Using Ds0 = BindingTrans(SQL)
                If Ds0.Tables("MyTable").Rows.Count <> 0 Then
                    For z As Integer = 0 To Ds0.Tables("MyTable").Rows.Count - 1
                        ...
                        Dim Temp_NoSplit As String = Ds0.Tables("MyTable").Rows(z).Item("No_Split")
                        ...
                        SQL = SQL & "values ('" & KodePerusahaan & "', '" & Temp_NoTransksi & "', '" & Temp_NoSplit & "', "
                        SQL = SQL & "'" & Format(tgl_skg, "yyyy-MM-dd") & "', '" & Format(tgl_skg, "HH:mm:ss") & "', '" & TxtKeterangan.Text & "', '" & Temp_UserID & "')"
                        ExecuteTrans(SQL)
                            ...
                            With Ds.Tables("MyTable")
                                If .Rows.Count <> 0 Then
                                    ...
                                    For j As Integer = 0 To .Rows.Count - 1
                                        ...
                                        SQL = SQL & "'" & Temp_KdBarang & "', '" & .Rows(j).Item("Serial_Number_Tujuan") & "', "
                                        SQL = SQL & "NULL, '" & .Rows(j).Item("Batch_Number") & "', '" & KualitasBarang & "', '" & HilangkanTanda(JumlahInsert) & "', "
                                        SQL = SQL & "'" & Satuan & "', '" & Temp_Jenis & "', '" & Temp_NoTransksi_GR2 & "')"
                                        ExecuteTrans(SQL)
...
#Region "JURNAL"
                        ...
                        SQL = SQL & "And a.kode_perusahaan = '" & KodePerusahaan & "' and a.No_Transaksi = '" & Temp_NoSplit & "' "
                        Using Dr = OpenTrans(SQL)
                            If Dr.Read Then
                        ...
                        SQL = SQL & "and a.Kode_Perusahaan = '" & KodePerusahaan & "' "
                        SQL = SQL & "and a.no_faktur = '" & Temp_NoSplit & "' "
                        Using Ds = BindingTrans(SQL)
                            With Ds.Tables("MyTable")
                                If .Rows.Count <> 0 Then
...
#Region "Jurnal 1"
                     ...
                     KodePerusahaan, KodeProyek, keterangan2 & Temp_NoTransksi, SumHPPAwal + sumPackaging, "0", pagenumber, Lokasi, Bahasa_Pilihan, Ket_Cost_Center_HO)
                        ExecuteTrans(SQL)
                                ...
                                If General_Class.CekNULL(Dr("flag_hasil_Produksi_GR")) = "Y" Then
                                    ...
                                    Using dr2 = OpenTrans(SQL)
                                        If Not dr2.Read Then
                                            ...
                                            SQL = "update Emi_Split_Production_Order set Flag_Hasil_Produksi_GR2 = 'Y', UserID_Selesai_GR2 = '" & Temp_UserID & "', "
