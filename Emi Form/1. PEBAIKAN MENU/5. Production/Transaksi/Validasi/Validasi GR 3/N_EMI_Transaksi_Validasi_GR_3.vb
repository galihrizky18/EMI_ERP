...
Public Class N_EMI_Transaksi_Validasi_GR_3
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            SQL = "select kode_Perusahaan, '' as No_Transaksi, No_Transaksi_GR2, No_Split, Qr_Code, Kode_Unik_Berjalan, Jenis, Kd_Barang, So_Awal, So_Tujuan, Jumlah, UserID "
            SQL = SQL & "from N_EMI_Validation_GR3_Temp  "
            SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
            ...
            Using Ds0 = BindingTrans(SQL)
                If Ds0.Tables("MyTable").Rows.Count <> 0 Then
                    For z As Integer = 0 To Ds0.Tables("MyTable").Rows.Count - 1
                        ...
                        Temp_NoSplit = Ds0.Tables("MyTable").Rows(z).Item("No_Split")
                            ...
                            With Ds.Tables("MyTable")
                                If .Rows.Count <> 0 Then
                                    ...
                                    For j As Integer = 0 To .Rows.Count - 1
                                        ...
                                        SumHPPAwal += Get_Harga_SN(.Rows(j).Item("Serial_Number_Tujuan")) * JumlahKurang
...
#End Region
                                        ...
                                        ' GENEREATE SN BARU
                                        Dim hppSekarang As Double = Get_Harga_SN(.Rows(j).Item("Serial_Number_Tujuan")) * JumlahKurang / JumlahInsert
