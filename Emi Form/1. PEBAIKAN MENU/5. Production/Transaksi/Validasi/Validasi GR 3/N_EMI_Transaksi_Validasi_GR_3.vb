Public Class N_EMI_Transaksi_Validasi_GR_3
    ...
    Dim LvData_QR, LvData_KdUnikBerjalan, LvData_TglExpired, LvData_KdBarangScrap, LvData_NoTransGR2 As String
    ...
    Dim itemData_Barcode As Integer = 2
    Dim itemData_BatchNumber As Integer = 3
    Dim itemData_KdBarang As Integer = 4
    Dim itemData_NmBarang As Integer = 5
    Dim itemData_Jenis As Integer = 6
    Dim itemData_Jumlah As Integer = 7
    Dim itemData_Satuan As Integer = 8
    Dim itemData_ID As Integer = 9
    Dim itemData_QR As Integer = 10
    Dim itemData_KdUnikBerjalan As Integer = 11
    Dim itemData_TglExpired As Integer = 12
    Dim itemData_KdBarangScrap As Integer = 13
    Dim itemData_NoTransGR2 As Integer = 14
    ...
    Private Sub Kosong()
        ...
        Try
            ...
            Cmb_LokasiAwal.Items.Clear() : Cmb_LokasiAwal.SelectedIndex = -1
            Cmb_LokasiTujuan.Items.Clear() : Cmb_LokasiTujuan.SelectedIndex = -1
            ...
            Using dr = OpenTrans(SQL)
                Do While dr.Read
                    Cmb_LokasiAwal.Items.Add(dr("Keterangan")) : arrSO.Add(dr("kode_stock_owner"))
        ...
        Lv_DataPallet.Columns.Add("Lokasi Barang", 120, HorizontalAlignment.Center) ' 0
        Lv_DataPallet.Columns.Add("Barcode", 180, HorizontalAlignment.Left) '1
        Lv_DataPallet.Columns.Add("Batch Number", 100, HorizontalAlignment.Center) '2
        Lv_DataPallet.Columns.Add("Tanggal Produksi", 110, HorizontalAlignment.Center) '3
        Lv_DataPallet.Columns.Add("Tanggal Expired", 110, HorizontalAlignment.Center) '4
        Lv_DataPallet.Columns.Add("Kode Barang", 110, HorizontalAlignment.Left) '5
        Lv_DataPallet.Columns.Add("Nama Barang", 200, HorizontalAlignment.Left) '6
        Lv_DataPallet.Columns.Add("Jumlah", 120, HorizontalAlignment.Right) '7
        Lv_DataPallet.Columns.Add("Satuan", 80, HorizontalAlignment.Center) '8
        Lv_DataPallet.Columns.Add("Kualitas", 150, HorizontalAlignment.Center) '9
        ...
        Lv_DataPallet.Columns.Add("NoGR2", 0, HorizontalAlignment.Center) '14
        ...
        Lv_Data.Columns.Add("Batch Number", 100, HorizontalAlignment.Center) '3
        Lv_Data.Columns.Add("Kode Barang", 110, HorizontalAlignment.Left) '4
        Lv_Data.Columns.Add("Nama Barang", 200, HorizontalAlignment.Left) '5
        Lv_Data.Columns.Add("Jenis", 130, HorizontalAlignment.Center) '6
        Lv_Data.Columns.Add("Jumlah", 120, HorizontalAlignment.Right) '7
        Lv_Data.Columns.Add("Satuan", 80, HorizontalAlignment.Center) '8
        Lv_Data.Columns.Add("ID", 0, HorizontalAlignment.Center) '9
        Lv_Data.Columns.Add("QR", 0, HorizontalAlignment.Center) '10
        Lv_Data.Columns.Add("KdUnikBerjalan", 0, HorizontalAlignment.Center) '11
        Lv_Data.Columns.Add("TglExpired", 0, HorizontalAlignment.Center) '12
        Lv_Data.Columns.Add("KdBarangScrap", 0, HorizontalAlignment.Center) '13
        Lv_Data.Columns.Add("NoTransGr2", 0, HorizontalAlignment.Center) '14
    ...
    Private Sub Btn_Scan_Click(sender As Object, e As EventArgs) Handles Btn_Scan.Click
        ...
        If Cmb_Barcode.SelectedIndex = 0 Then
            ...
            Try
                ...
                SQL = SQL & "and a.Status is null and Flag_Validasi is null "
    ...
    Private Sub Lv_DataPallet_DoubleClick(sender As Object, e As EventArgs) Handles Lv_DataPallet.DoubleClick
        ...
        Cmb_LokasiAwal.SelectedIndex = arrSO.IndexOf(LvPallet_KdSO)
        ...
        Try
            ...
            'Cmb_Jenis.Items.Add("Finished Good") : arrKdBarangSrap.Add("---")
            'arrNamaScrap.Add("---") : arrSatuanScrap.Add("---")
            'arrSatuanKecilScrap.Add("---")
            ...
            Using Dr = OpenTrans(SQL)
                ...
                Loop
            End Using
            'Cmb_Jenis.Items.Add("Rejected") : arrKdBarangSrap.Add("REJECTED") : arrNamaScrap.Add("REJECTED") : arrSatuanScrap.Add("REJECTED") : arrSatuanKecilScrap.Add("REJECTED")
    ...
    Private Sub Txt_Jumlah_Leave(sender As Object, e As EventArgs) Handles Txt_Jumlah.Leave
        ...
        Txt_Jumlah.Text = Format(Nominal, "N2")
    ...
    Private Sub Btn_Tambah_Click(sender As Object, e As EventArgs) Handles Btn_Tambah.Click
        ...
        If Cmb_Jenis.SelectedIndex = -1 Then
            MessageBox.Show("Harap Pilih Jenis Terlebih Dahulu", JudulForm, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Cmb_Jenis.DroppedDown = True : Cmb_Jenis.Focus() : Exit Sub
        ElseIf Cmb_LokasiTujuan.SelectedIndex = -1 Then
            MessageBox.Show("Harap Pilih Lokasi Tujuan Terlebih Dahulu", JudulForm, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            Cmb_LokasiTujuan.DroppedDown = True : Cmb_LokasiTujuan.Focus() : Exit Sub
        ElseIf Txt_Jumlah.Text.Trim.Length = 0 Then
        ...
        Dim Lv As ListViewItem
        Lv = Lv_Data.Items.Add(arrSO(Cmb_LokasiAwal.SelectedIndex))
        Lv.SubItems.Add(arrSO(Cmb_LokasiTujuan.SelectedIndex))
        Lv.SubItems.Add(Txt_Barcode.Text)
        Lv.SubItems.Add(Txt_SelectedBatch.Text)

        Lv.SubItems.Add(arrKdBarangSrap(Cmb_Jenis.SelectedIndex))
        'If Not Cmb_Jenis.SelectedIndex = 0 And Not Cmb_Jenis.SelectedIndex = Cmb_Jenis.Items.Count - 1 Then
        'Else
        '    Lv.SubItems.Add(Txt_SelectedKdBarang.Text)
        'End If

        Lv.SubItems.Add(Txt_SelectedNmBarang.Text)
        Lv.SubItems.Add(Cmb_Jenis.Text.ToUpper)
        Lv.SubItems.Add(Format(Val(HilangkanTanda(Txt_Jumlah.Text)), "N2"))
        Lv.SubItems.Add(Txt_Satuan.Text)
        Lv.SubItems.Add(Txt_SelectedID.Text)
        Lv.SubItems.Add(Txt_SelectedQR.Text)
        Lv.SubItems.Add(Txt_SelectedKdUnikBerjalan.Text)
        Lv.SubItems.Add(Txt_TglExpired.Text)
        Lv.SubItems.Add(arrKdBarangSrap(Cmb_Jenis.SelectedIndex))
        Lv.SubItems.Add(Txt_NoTransGR2.Text)
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            SQL = SQL & "and a.Status = 'Y' and a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.No_Transaksi = '" & Txt_NoSplit.Text & "'"
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    Dr.Close()
                    CloseTrans()
            ...
            SQL = SQL & "values ('" & KodePerusahaan & "', '" & TxtNo_Transaksi.Text.Trim & "', '" & Txt_NoSplit.Text.Trim & "', "
            ...
            For i As Integer = 0 To Lv_Data.Items.Count - 1
                ...
                SQL = SQL & "and c.Qr_Code = '" & LvData_QR & "' "
                SQL = SQL & "and c.Kode_Unik_Berjalan = '" & LvData_KdUnikBerjalan & "' "
                SQL = SQL & "and c.jumlah <> 0 "
                SQL = SQL & "order by c.Tgl_Expired ASC "
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then

                        newQrCode = Generate_QR_Batch(LvData_KdBarang, Dr("Batch_Number"))
                ...
                Using Ds = BindingTrans(SQL)
                    With Ds.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            sisaPotong = Val(HilangkanTanda(LvData_Jumlah))
                            For j As Integer = 0 To .Rows.Count - 1
                                ...
                                If sisaPotong < Val(HilangkanTanda(.Rows(j).Item("Stock_SN"))) Or sisaPotong = Val(HilangkanTanda(.Rows(j).Item("Stock_SN"))) Then
                                    ...
                                    If LvData_Jenis.ToUpper = "FINISHED GOOD" Or LvData_Jenis.ToUpper = "REJECTED" Then
                                    ...
                                    SQL = SQL & "serial_number = '" & .Rows(j).Item("Serial_Number_Tujuan") & "'"
                                    ExecuteTrans(SQL)
                                ...
                                Else
                                    CloseTrans()
                                    CloseConn()
                                    MessageBox.Show("Terjadi Kesalaham pada Barang SN untuk Kode Barang " & LvData_KdBarang & "!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                                    Exit Sub
                                End If

                                Dim KualitasBarang As String = ""
                                If LvData_Jenis.ToUpper = "REJECTED" Then
                                ...
                                SumHPPAwal += Get_Harga_SN(.Rows(j).Item("Serial_Number_Tujuan")) * JumlahInsert
                                ...
                                SQL = SQL & "Serial_Number_Awal, Serial_Number_Tujuan, Batch_Number, Warna, Jumlah, Satuan, Jenis, No_Transaksi_GR2) "
                                SQL = SQL & "values ('" & KodePerusahaan & "', '" & TxtNo_Transaksi.Text.Trim & "', '" & LvData_KdSoAwal & "', '" & LvData_KdSoTujuan & "', "
                                SQL = SQL & "'" & LvData_KdBarang & "', '" & .Rows(j).Item("Serial_Number_Tujuan") & "', "
                                SQL = SQL & "NULL, '" & .Rows(j).Item("Batch_Number") & "', '" & KualitasBarang & "', '" & HilangkanTanda(JumlahInsert) & "', "
                                SQL = SQL & "'" & Satuan & "', '" & LvData_Jenis & "', '" & LvData_NoTransGR2 & "')"
                                ExecuteTrans(SQL)
                                ...
                                SQL = "select top(1) kode_barang_inq from barang a where a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.kode_barang = '" & LvData_KdBarang & "'  "
                                Using Dr = OpenTrans(SQL)
                                    If Dr.Read Then
...
#End Region
                                ...
                                ' GENEREATE SN BARU
                                Dim hppSekarang As Double = Get_Harga_SN(.Rows(j).Item("Serial_Number_Tujuan"))
                                ...
                                SQL = SQL & "and a.id_group_jenis = b.id_group_jenis and b.kode_barang='" & LvData_KdBarang & "' "
                                SQL = SQL & "and a.id_group_jenis = c.id_group_jenis and b.kode_stock_owner='" & LvData_KdSoTujuan & "' "
                                Using Dr = OpenTrans(SQL)
                                    If Dr.Read Then
                                ...
                                For ind = 0 To ArrHPP_Akun.Count - 1
                                    ...
                                    If idgroup_jenis = ArrHPP_GroupJenisID.Item(ind) And LvData_KdSoTujuan = ArrHPP_Lokasi.Item(ind) Then
                                        ada_data = True
                                ...
                                If ada_data = False Then
                                    ...
                                    ArrHPP_Lokasi.Add(LvData_KdSoTujuan)
                                ...
                                SQL = SQL & "and a.Kode_Stock_Owner='" & LvData_KdSoTujuan & "' and b.Kode_Barang is null"
                                ...
                                If LvData_Jenis.ToUpper = "FINISHED GOOD" Then
                                    ...
                                    SQL = SQL & "'" & LvData_KdSoTujuan & "', '" & LvData_KdBarang & "', "
                                ...
                                Else
                                    ...
                                    SQL = SQL & "values('" & KodePerusahaan & "', '" & LvData_KdSoTujuan & "', '" & LvData_KdBarang & "', '" & SN_Baru & "', "
                                    ...
                                    SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' and "
                                    SQL = SQL & "kode_stock_owner = '" & LvData_KdSoTujuan & "' and kode_barang = '" & LvData_KdBarang & "'"
                                    ExecuteTrans(SQL)
                                ...
                                SQL = SQL & "barang a "
                                SQL = SQL & "WHERE "
                                SQL = SQL & "a.Kode_Perusahaan = '" & KodePerusahaan & "' And a.Kode_Stock_Owner = '" & LvData_KdSoTujuan & "' AND a.Kode_Barang = '" & LvData_KdBarang & "' "
                                SQL = SQL & "GROUP BY "
                        ...
                        Else
                            CloseTrans()
                            CloseConn()
                            MessageBox.Show("Terjadi Kesalahan Pada Barang " & LvData_KdBarang & "!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            Exit Sub
                        End If
                    End With
                End Using
                ...
                '=     CEK KESESUAIAN JUMLAH YANG DI POTONG     =
                '================================================
                If Val(HilangkanTanda(JumlahDipotong)) <> Val(HilangkanTanda(LvData_Jumlah)) Then
                    CloseTrans()
                    CloseConn()
...
#Region "Jurnal 1"
            ...
            SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_HPP_FG, 1),
                     ...
                     KodePerusahaan, KodeProyek, keterangan2 & TxtNo_Transaksi.Text, SumHPPAwal + sumPackaging, "0", pagenumber, Lokasi, Bahasa_Pilihan, Ket_Cost_Center_HO)
            ExecuteTrans(SQL)
...
#End Region
            ...
            SQL = "update N_EMI_Validation_GR_3 set Kode_Voucher1 ='" & Kode_voucher & "', Kode_Voucher2=' " & Kode_voucher2 & "' "
            SQL = SQL & "where no_transaksi='" & TxtNo_Transaksi.Text & "' and kode_perusahaan='" & KodePerusahaan & "' "
            ExecuteTrans(SQL)

            SQL = "select flag_hasil_Produksi_GR, b.no_transaksi from Emi_Split_Production_Order a, emi_production_results b "
            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and a.No_Transaksi = b.No_Production_Order "
            SQL = SQL & "and a.status is null and b.status is null and a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.No_Transaksi = '" & Txt_NoSplit.Text & "'"
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    If General_Class.CekNULL(Dr("flag_hasil_Produksi_GR")) = "Y" Then
                        ...
                        Using dr2 = OpenTrans(SQL)
                            If Not dr2.Read Then
                                ...
                                SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' and no_transaksi = '" & Txt_NoSplit.Text & "' "
                                ExecuteTrans(SQL)
...
#End Region
    ...
    Private Sub Hitung_Data()
        ...
        Dim TotScrap As Double = 0
        For i As Integer = 0 To Lv_Data.Items.Count - 1
            Get_Lv_Data_GR(i)

            If LvData_Jenis.ToUpper = "SCRAP" Then
                TotScrap += LvData_Jumlah
            Else
                TotFG += LvData_Jumlah
            End If
        Next
        ...
        Txt_TotScrap.Text = Format(TotScrap, "N0")
    ...
    Private Sub ContextMenuStrip1_Opening(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles ContextMenuStrip1.Opening
        ...
        If LvData_Jenis.ToUpper = "FINISHED GOOD" Then
            DetailPackagingToolStripMenuItem.Visible = True
        Else
            DetailPackagingToolStripMenuItem.Visible = False
        End If
    End Sub
