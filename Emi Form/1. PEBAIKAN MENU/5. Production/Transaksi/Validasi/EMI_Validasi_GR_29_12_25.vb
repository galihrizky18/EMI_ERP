...
Public Class EMI_Validasi_GR_29_12_25
    ...
    Private Sub HapusToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles HapusToolStripMenuItem1.Click
        ...
        Try
            ...
            SQL = "select Kode_Perusahaan from N_EMI_Validation_GR_Temp where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Production_Order = '" & SelectedSplit & "' and nomor = '" & SelectedNomor & "' and UserID = '" & UserID & "' "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    Dr.Close()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            For i As Integer = 0 To Lv_Data.Items.Count - 1
                ...
                SQL = SQL & "'" & arrIdJenisKategori(Cmb_Jenis_Kategori.SelectedIndex) & "', '" & Cmb_Jenis_Kategori.Text & "')"
                ExecuteTrans(SQL)
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            SQL = SQL & "where a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.No_Production_Order = '" & Txt_NoSplit.Text & "' "
            ...
            Using dsNomor = BindingTrans(SQL)
                If dsNomor.Tables("MyTable").Rows.Count <> 0 Then
                    For IndNomor = 0 To dsNomor.Tables("MyTable").Rows.Count - 1
                        ...
                        '=     GET TOTAL SCRAP     =
                        '===========================
                        'Dim TotalCountValidation As Double = 0
                        'SQL = "select distinct top(1) Nomor from Emi_Production_Results_Validation_Detail where "
                        'SQL = SQL & "no_transaksi = '" & TxtNo_Transaksi.Text.Trim & "' and Kode_Perusahaan='" & KodePerusahaan & "' "
                        'SQL = SQL & "order by Nomor Desc "
                        'Using Dr = OpenTrans(SQL)
                        '    If Dr.Read Then
                        '        If General_Class.CekNULL(Dr("Nomor")) = "" Then
                        '            TotalCountValidation = 1
                        '        Else
                        '            TotalCountValidation = Dr("Nomor") + 1
                        '        End If
                        '    Else
                        '        TotalCountValidation = 1
                        '    End If
                        ...
                        SQL = "select Barcode, Nomor_Sebelum, satuan, sum(jumlah) as Jumlah, Tahap, Jenis, Id_Jenis_Kategori from N_EMI_Validation_GR_Temp a "
                        SQL = SQL & "where "
                        SQL = SQL & "a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.No_production_Order = '" & Txt_NoSplit.Text & "' and a.userid='" & UserID & "' "
                        SQL = SQL & "and a.nomor='" & ID_Nomor & "' "
                        SQL = SQL & "group by Barcode, Nomor_Sebelum, satuan, Tahap, Jenis, Id_Jenis_Kategori "
                        ...
                        Using dsPallet = BindingTrans(SQL)
                            If dsPallet.Tables("MyTable").Rows.Count <> 0 Then
                                For IndPallet = 0 To dsPallet.Tables("MyTable").Rows.Count - 1
                                    ...
                                    SQL = SQL & "And a.Kode_Perusahaan = c.Kode_Perusahaan And (qr_code +'-'+Kode_Unik_Berjalan ) = c.Barcode "
                                    SQL = SQL & "and a.kode_perusahaan = '" & KodePerusahaan & "' "
                                    SQL = SQL & "and (qr_code +'-'+ Kode_Unik_Berjalan ) = '" & Barcode_Pallet & "' "
                                    Using Dr = OpenTrans(SQL)
                                        If Dr.Read Then
...
#End Region
            ...
            SQL = "update Emi_Production_Results_Validation set Kode_Voucher1 ='" & Kode_voucher & "', Kode_Voucher2=' " & Kode_voucher2 & "' "
