Public Class EMI_Request_Material_List
    ...
    Private Sub Display_Trx_Formula_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            ComboBox2.Items.Add(Base_Language.Lang_Display_Transaksi_Formula_No_Inquiry) : arr_Lain.Add("a.no_faktur_order")
            ComboBox2.Items.Add(Base_Language.Lang_Display_Transaksi_Formula_Nama_Usaha) : arr_Lain.Add("a.kode_barang")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            DataGridView1.Rows.Clear()
            DataGridView2.Rows.Clear()
            SQL = "select a.No_Faktur,a.No_Faktur_Order,a.Kode_Stock_Owner,a.Kode_Barang,b.Nama,a.Id_Group_Jenis , c.Kode_Group_Jenis,a.UserId,a.Tanggal, a.status "
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView1.SelectedIndexChanged
        ...
        Try
            ...
            DataGridView2.Rows.Clear()
            SQL = "select a.No_Faktur,a.Kode_Stock_Owner ,a.Kode_Barang,b.Nama , a.Kebutuhan,a.Jumlah,a.Satuan,a.jenis_material "
