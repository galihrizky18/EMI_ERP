Public Class Display_Barang
            ...
            Using ds = BindingTrans(SQL)
                With ds.Tables("MyTable")
                    For i As Integer = 0 To .Rows.Count - 1
                        ...
                        DataGridView1.Rows.Item(i).Cells(0).Value = General_Class.CekNULL(.Rows(i).Item("kode_stock_owner")) '0
                        DataGridView1.Rows.Item(i).Cells(1).Value = General_Class.CekNULL(.Rows(i).Item("kode_group_jenis")) '1
                        DataGridView1.Rows.Item(i).Cells(2).Value = General_Class.CekNULL(.Rows(i).Item("kode_barang")) '2
                        DataGridView1.Rows.Item(i).Cells(3).Value = General_Class.CekNULL(.Rows(i).Item("nama")) '3
                        DataGridView1.Rows.Item(i).Cells(4).Value = Format(If(General_Class.CekNULL(.Rows(i).Item("Total_Stock_Tersedia_Satuan_Besar")) = "", 0, .Rows(i).Item("Total_Stock_Tersedia_Satuan_Besar")), "N2") & " " & .Rows(i).Item("Satuan_Besar") '4
                        DataGridView1.Rows.Item(i).Cells(5).Value = Format(If(General_Class.CekNULL(.Rows(i).Item("jumlah_bags")) = "", 0, .Rows(i).Item("jumlah_bags")), "N2") '5
                        If IsDBNull(.Rows(i).Item("tgl_produksi")) Then
                            DataGridView1.Rows.Item(i).Cells(6).Value = ""
                        Else
                            DataGridView1.Rows.Item(i).Cells(6).Value = Format(.Rows(i).Item("Tgl_produksi"), "dd MMM yyyy") '6 '.Rows(i).Item("Total_Stock_Inquiry_Satuan_Besar") & " " & .Rows(i).Item("Satuan_Besar")
                        End If
                        ...
                        DataGridView1.Rows.Item(i).Cells(14).Value = Format(.Rows(i).Item("Total_Stock_Tersedia_Satuan_Besar_Default"), "N2") & " " & .Rows(i).Item("Satuan_Default")
            ...
            Using ds = BindingTrans(SQL)
                With ds.Tables("MyTable")
                    For i As Integer = 0 To .Rows.Count - 1
                        ...
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(0).Value = If(General_Class.CekNULL(.Rows(i).Item("kode_stock_owner")) = "", "-", .Rows(i).Item("kode_stock_owner"))
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(1).Value = If(General_Class.CekNULL(.Rows(i).Item("kode_group_jenis")) = "", "-", .Rows(i).Item("kode_group_jenis"))
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(2).Value = If(General_Class.CekNULL(.Rows(i).Item("kode_barang")) = "", "-", .Rows(i).Item("kode_barang"))
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(3).Value = If(General_Class.CekNULL(.Rows(i).Item("nama")) = "", "-", .Rows(i).Item("nama"))
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(4).Value = Format(If(General_Class.CekNULL(.Rows(i).Item("Total_Stock_Tersedia_Satuan_Besar")) = "", 0, .Rows(i).Item("Total_Stock_Tersedia_Satuan_Besar")), "N2") & " " & .Rows(i).Item("Satuan_Besar")
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(5).Value = Format(If(General_Class.CekNULL(.Rows(i).Item("jumlah_bags")) = "", 0, .Rows(i).Item("jumlah_bags")), "N2")
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(6).Value = If(General_Class.CekNULL(.Rows(i).Item("satuan_besar")) = "", "-", .Rows(i).Item("satuan_besar"))
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(7).Value = If(General_Class.CekNULL(.Rows(i).Item("warna")) = "", "-", .Rows(i).Item("warna"))
                        Dgv_BarangPerlokasi.Rows.Item(i).Cells(8).Value = Format(.Rows(i).Item("Total_Stock_Tersedia_Satuan_Besar_Default"), "N2") & " " & .Rows(i).Item("Satuan_Default")
                    Next
                End With
            End Using
    ...
    Private Sub Perusahaan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DataGridView1.Columns(14).DisplayIndex = 5
        Dgv_BarangPerlokasi.Columns(8).DisplayIndex = 5
