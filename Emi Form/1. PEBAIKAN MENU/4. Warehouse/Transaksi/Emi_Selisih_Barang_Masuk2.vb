    ...
    Private Sub BtnSelisihBrgMsk_Simpan_Click(sender As Object, e As EventArgs) Handles BtnSelisihBrgMsk_Simpan.Click
        ...
        Try
            ...
            If P_Flag_Selisih = "Y" Then
                If CekButtonRole("Simpan_Validasi_BM_Selisih") = "T" Then
                    CloseTrans()
                    CloseConn()
                ...
                End If
            Else
                If CekButtonRole("Simpan_Validasi_BM_Tidak_Selisih") = "T" Then
                    CloseTrans()
                    CloseConn()
        ...
        Try
            ...
            SQL = "insert into EMI_Pembelian_Selisih_Barang_Masuk(Kode_Perusahaan, No_Faktur, Tanggal, Jam, UserID, Kode_Supplier, Total_Selisih, Total_Harga_Selisih, No_Faktur_BM, jenis_selisih, akun_bahan,akun_perjalanan, Flag_Masuk_Hutang_Bahan, Keterangan) values( "
