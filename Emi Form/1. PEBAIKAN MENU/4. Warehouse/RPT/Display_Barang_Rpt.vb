...
Public Class Display_Barang_Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.Display_Barang_Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDisplay_Barang_Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Display_Barang_Rpt = New Display_Barang_Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
