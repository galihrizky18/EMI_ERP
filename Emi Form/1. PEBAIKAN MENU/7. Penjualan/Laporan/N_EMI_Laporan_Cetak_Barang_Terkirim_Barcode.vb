Public Class N_EMI_Laporan_Cetak_Barang_Terkirim_Barcode
    Dim CrDoc As Object
...
#End Region
            ...
            Else
                ...
                If ComboBox1.SelectedIndex <> 0 Then
                    ...
                    SF = SF & "AND {N_EMI_View_Sub_Invoice_Barcode.Kode_Kategori_Besar} = '" & ComboBox1.Text & "' "
                    ...
                    If ComboBox2.SelectedIndex <> 0 Then
                        ...
                        SF = SF & "AND {N_EMI_View_Sub_Invoice_Barcode.Kode_Kategori_Kecil} = '" & ComboBox2.Text & "' "
                    End If
                    ...
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then
                        If bolehliathpp = "Y" Then
                            ...
                            If HPPyangMana = "1" Then
                                CrDoc = New N_EMI_CR_Laporan_Barang_Terkirim_Barcode_Detail_HPP
                            ElseIf HPPyangMana = "2" Then
                                CrDoc = New N_EMI_CR_Laporan_Barang_Terkirim_Barcode_Detail_HPP_2
                            Else
                                CloseConn()
                        ...
                        Else
                            CrDoc = New N_EMI_CR_Laporan_Barang_Terkirim_Barcode_Detail
                        End If
