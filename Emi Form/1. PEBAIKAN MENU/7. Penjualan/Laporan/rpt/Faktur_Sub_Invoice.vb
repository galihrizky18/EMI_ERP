...
Public Class Faktur_Sub_Invoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.Faktur_Sub_Invoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFaktur_Sub_Invoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Faktur_Sub_Invoice = New Faktur_Sub_Invoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
