Public Class Jf_Cetak_Barang_Terkirim_Gudang
    Dim CrDoc As Object
...
#End Region
                ...
                Using Ds = BindingTrans(SQL)
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then
                        CrDoc = New N_EMI_CR_Laporan_Barang_Terkirim_Rekap_Warehouse
            ...
            Else
                ...
                Using Ds = BindingTrans(SQL)
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then
                        CrDoc = New N_EMI_CR_Laporan_Barang_Terkirim_Detail_Warehouse

                        With A_Place_For_Printing
                            CrDoc.SetDataSource(Ds)
                            CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                            CrDoc.RecordSelectionFormula = SF
                            CrDoc.SummaryInfo.ReportTitle = CmbJenis.Text.ToUpper & Chr(13) & _
                                                                "Periode : " & Format(Tgl1.Value, "dd MMM yyyy") & " s/d " & _
                                                                Format(Tgl2.Value, "dd MMM yyyy") & Chr(13) & _
                                                                "Lokasi : " & CmbLokasi.Text
