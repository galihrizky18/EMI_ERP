...
Public Class EMI_PO_Pembelian_Display_View
    ...
    Private Sub Cari()
        Try
            ...
            SQL = SQL & "b.Jumlah - isnull((select  sum(y.Jumlah) from  EMI_Pembelian_PO_induk x, EMI_Pembelian_PO_Det_induk y "
    ...
    Private Sub Dgv_Pr_DoubleClick(sender As Object, e As EventArgs) Handles Dgv_Pr.DoubleClick
        ...
        If currentCell = 7 And Dgv_Pr.Rows(currentRow).Cells(0).Value = True Then
            ...
            SD_Pilih_Harga_PO.kodeBarang = Dgv_Pr.Rows(currentRow).Cells(3).Value
