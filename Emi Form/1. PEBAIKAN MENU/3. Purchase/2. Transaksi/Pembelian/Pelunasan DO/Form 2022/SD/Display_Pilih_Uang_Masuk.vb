Public Class Display_Pilih_Uang_Masuk
    ...
    Private Sub Form_Input_No_Invoice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            DateTimePicker4.Value = CDate(FMenuDevFix.ToolStripStatusLabel3.Text)
            DateTimePicker1.Value = DateAdd("d", -2, CDate(FMenuDevFix.ToolStripStatusLabel3.Text))
            DateTimePicker3.Value = DateAdd("d", -2, CDate(FMenuDevFix.ToolStripStatusLabel3.Text))


            If DateTimePicker1.Value > DateTimePicker2.Value Then
                MessageBox.Show("Periode I tidak boleh lebih dari periode II!", Judul)
                DateTimePicker1.Value = DateAdd("d", -2, CDate(FMenuDevFix.ToolStripStatusLabel3.Text)) : DateTimePicker2.Value = CDate(FMenuDevFix.ToolStripStatusLabel3.Text)
                Exit Sub
            End If
            ...
            If DateTimePicker3.Value > DateTimePicker4.Value Then
                MessageBox.Show("Periode I tidak boleh lebih dari periode II!", Judul)
                DateTimePicker3.Value = DateAdd("d", -2, CDate(FMenuDevFix.ToolStripStatusLabel3.Text)) : DateTimePicker4.Value = CDate(FMenuDevFix.ToolStripStatusLabel3.Text)
                Exit Sub
            End If
