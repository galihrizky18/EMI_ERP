...
Public Class N_EMI_Laporan_Pelunasan_DO_Kredit
    ...
    Private Sub N_EMI_Laporan_Pelunasan_DO_Tunai_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        ...
        ListView5.Columns.Add("Kode Customers", 100, HorizontalAlignment.Left)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Else
                ...
                status_formula = status_formula & "and {val_do.cara_bayar} = '" & ComboBox1.Text & "' "
            End If
            ...
            SQL = "select a.kode_perusahaan from val_do a, detail_val_do b, penjualan c, do_new d where "
            ...
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    Dim CrDoc As Object
                    CrDoc = New N_EMI_CR_Laporan_Pelunasan_DO_Kredit

                    With A_Place_For_Printing
                        CrDoc.SetDataSource(Ds)
                        CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                        CrDoc.RecordSelectionFormula = "{val_do.kode_perusahaan} = '" & KodePerusahaan & "' and isnull({val_do.status}) and isnull({val_do.status}) and {val_do.Tanggal} >= # " & Format(DateTimePicker3.Value, "yyyy-MM-dd") & " # and {val_do.Tanggal} <= # " & Format(DateTimePicker4.Value, "yyyy-MM-dd") & " # " & status_formula & " " & sales_formula
                        CrDoc.SummaryInfo.ReportTitle = "Laporan Pelunasan Invoice Kredit (Reseller) " & Chr(13) & Format(DateTimePicker3.Value, "dd MMM yyyy") & " s/d " & Format(DateTimePicker4.Value, "dd MMM yyyy") & ""
                        .Text = "Laporan Pelunasan Invoice Kredit (Reseller) " & Format(DateTimePicker3.Value, "dd MMM yyyy") & " s/d " & Format(DateTimePicker4.Value, "dd MMM yyyy") & ""
