Public Class N_EMI_Transaksi_Pelunasan_Kredit_Per_DO_St2
    ...
    Private Sub get_unik()
        ...
        Label11.Text = Format(CDate(FMenuDevFix.ToolStripStatusLabel3.Text), "MMddHHmmss") & Format(rand.Next(0, 100000), "00000") & Format(rand.Next(0, 10000000), "0000000")
    End Sub
