Public Class N_EMI_Transaksi_Uang_Masuk_Global
    ...
    Private Sub Get_No_Faktur()
        Dim fUG = "UG"
        TxtNoFak.Text = fUG & Format(Tgl.Value, "MMyy") & "-" &
                             General_Class.Get_Last_Number2("Uang_Masuk_Global", "No_Val", 5,
    ...
    Private Sub BtnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSimpan.Click
        ...
        Try
            ...
            SQL = SQL & "'" & Format(tgl_skg, "HH:mm:ss") & "', '" & TxtKet.Text.Trim & "', "
            ...
            For i As Integer = 0 To LvUMG.Items.Count - 1
                ...
                SQL = Get_Detail_Jurnal(Kode_Voucher, Strings.Left(LvKd_Akun, 1),
                               ...
                               KodePerusahaan, KodeProyek, LvKd_CB & "; " & "UM Reseller" & "; " & TxtNoFak.Text.Trim, HilangkanTanda(LvJml), "0", pagenumber + 1, lksi_jurnal, Cost_center:=Ket_Cost_Center_HO)
                ExecuteTrans(SQL)
                ...
                SQL = Get_Detail_Jurnal(Kode_Voucher, Strings.Left(X_Pelunasan_Dimuka, 1),
                                 ...
                                 KodePerusahaan, KodeProyek, LvKd_CB & "; " & "UM Reseller" & "; " & TxtNoFak.Text.Trim, "0", HilangkanTanda(LvJml), pagenumber + 1, Ket_Lokasi_HO, Cost_center:=Ket_Cost_Center_HO)
                ExecuteTrans(SQL)
        ...
        Try
            ...
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    Dim CrDoc As New N_EMI_CR_Faktur_Uang_Masuk_Global    'Nama file CR
