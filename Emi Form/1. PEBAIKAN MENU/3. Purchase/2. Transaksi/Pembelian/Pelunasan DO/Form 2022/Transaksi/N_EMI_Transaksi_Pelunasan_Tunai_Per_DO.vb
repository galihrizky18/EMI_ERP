Public Class N_EMI_Transaksi_Pelunasan_Tunai_Per_DO
        ...
        Try
            ...
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    Dim CrDoc As New N_EMI_CR_Faktur_Pelunasan_DO_Tunai     'Nama file CR
    ...
    Private Sub Get_No_Faktur()
        TxtFaktur.Text = fValDOTunai & Format(DateTimePicker1.Value, "MMyy") & "-" &
                             General_Class.Get_Last_Number2("val_do_tunai", "no_val", 5,
    ...
    Private Sub get_unik()
        ...
        Label23.Text = Format(tgl_skg, "MMddHHmmss") & Format(rand.Next(0, 100000), "00000") & Format(rand.Next(0, 10000000), "0000000")
    End Sub
                    ...
                    Using Dr = OpenTrans(SQL)
                        ...
                        Else
                            ...
                            SQL = Get_Detail_Jurnal(Kode_Voucher, Strings.Left(coa_piutang, 1),
                                   ...
                                   KodePerusahaan, KodeProyek, "Pelunasan piutang " & TxtFaktur.Text.Trim & ";" & TextBox2.Text.Trim, "0", (Val(HilangkanTanda(LvJml)) + Val(HilangkanTanda(LvDiscCash))), pagenumber + 1, lokasi_penj, Bahasa_Pilihan, Ket_Cost_Center_HO)
                            ExecuteTrans(SQL)
                        End If
                    End Using
...
#End Region
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        Try
            ...
            SQL = "delete from Perlunasan_Per_Step_Sementara where Kode_unik='" & Label23.Text & "' and no_do ='" & ListView1.FocusedItem.Text & "' "
            ExecuteTrans(SQL)

            'SQL = "delete from Perlunasan_Per_Step_Sementara_deposit where Kode_unik='" & Label23.Text & "' and no_do ='" & ListView1.FocusedItem.Text & "' "
            'ExecuteTrans(SQL)
    ...
    Private Sub TextBox6_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox6.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            cek_data = False
            N_EMI_SD_Pilih_Uang_Masuk.LabelDari.Text = "TN3"
            ...
            N_EMI_SD_Pilih_Uang_Masuk.Label4.Text = Label23.Text
