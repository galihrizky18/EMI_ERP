Public Class Pelunasan_Kredit_Per_DO_St2
    ...
    Private Sub Get_No_Faktur()
        TxtFaktur.Text = fValDOKredit & Format(DateTimePicker1.Value, "MMyy") & "-" & _
                             General_Class.Get_Last_Number2("val_do", "no_val", 5, _
    ...
    Private Sub get_unik()
        ...
        Label11.Text = Format(CDate(FMenu.ToolStripStatusLabel3.Text), "MMddHHmmss") & Format(rand.Next(0, 100000), "00000") & Format(rand.Next(0, 10000000), "0000000")
    End Sub
                    ...
                    Using Dr = OpenTrans(SQL)
                        ...
                        Else
                            ...
                            SQL = Get_Detail_Jurnal(Kode_Voucher, Strings.Left(coa_piutang, 1),
                                   ...
                                   KodePerusahaan, KodeProyek, "Pelunasan piutang " & TxtFaktur.Text.Trim & ";" & TextBox2.Text.Trim, "0", (Val(HilangkanTanda(LvJml))), pagenumber + 1, lokasi_penj)
                            ExecuteTrans(SQL)
                        End If
                    End Using
                    ...
                    If deposit_inputRBT <> 0 Then
                        ...
                        Using Dr = OpenTrans(SQL)
                            ...
                            Else
                                Dr.Close()
                                'insert
                                SQL = Get_Detail_Jurnal(Kode_Voucher2, Strings.Left(coa_HutangPromo, 1), _
                                        Strings.Mid(coa_HutangPromo, 2, 1), _
                                        Strings.Mid(Ganti(coa_HutangPromo), 3), _
                                        KodePerusahaan, KodeProyek, "Pelunasan piutang " & TxtFaktur.Text.Trim & ";" & TextBox2.Text.Trim, deposit_inputRBT, "0", pagenumber, lokasi_penj)
                                ExecuteTrans(SQL)
                        ...
                        Using Dr = OpenTrans(SQL)
                            ...
                            Else
                                Dr.Close()
                                'insert
                                SQL = Get_Detail_Jurnal(Kode_Voucher2, Strings.Left(coa_Rebate, 1), _
                                        Strings.Mid(coa_Rebate, 2, 1), _
                                        Strings.Mid(Ganti(coa_Rebate), 3), _
                    ...
                    If deposit_inputB2B <> 0 Then
                        ...
                        Using Dr = OpenTrans(SQL)
                            ...
                            Else
                                Dr.Close()
                                'insert
                                SQL = Get_Detail_Jurnal(Kode_Voucher2, Strings.Left(coa_B2B, 1), _
                                        Strings.Mid(coa_B2B, 2, 1), _
                                        Strings.Mid(Ganti(coa_B2B), 3), _
                    ...
                    If SisaHutang = Val(HilangkanTanda(LvJml)) Then
                        ...
                        Using Ds2 = BindingTrans(SQL)
                            For index3 As Integer = 0 To Ds2.Tables("MyTable").Rows.Count - 1
                                RRRRRR = 31
                                If plafon + Tambahan_Plafon >= Ds2.Tables("MyTable").Rows(index3).Item("Plafond_Dari") And _
                                plafon + Tambahan_Plafon <= Ds2.Tables("MyTable").Rows(index3).Item("Plafond_Sampai") And _
                                Hari >= Ds2.Tables("MyTable").Rows(index3).Item("Hari_Dari") And _
