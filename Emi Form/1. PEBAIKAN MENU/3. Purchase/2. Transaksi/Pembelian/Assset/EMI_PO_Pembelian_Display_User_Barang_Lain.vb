...
Public Class EMI_PO_Pembelian_Display_User_Barang_Lain
    ...
    Private Sub Cari()
        ...
        Try
            ...
            SQL = SQL & "c.id_kategori_PO = d.kategori_po And d.userid = '" & UserID & "' and b.flag_sudah_po is null and b.flag_tolak is null "
            SQL = SQL & ") "
...
#End Region
    ...
    Private Sub TolakPrToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TolakPrToolStripMenuItem.Click
        ...
        Dim data = Dgv_Pr.Rows(currentRow).Cells(cellNoUrutPR)


        Try
            OpenConn()

            SQL = "update EMI_Purchase_Requisition_Barang_Lain_Detail set flag_tolak = 'Y'  "
            SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' and no_urut = '" & data.Value & "' "
            ExecuteTrans(SQL)


            MessageBox.Show("PR berhasil ditolak", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            kosong()
