...
Public Class Purchase_Requisition_Barang_Lain
    ...
    Private Sub BtnFormulator_Simpan_Click(sender As Object, e As EventArgs) Handles BtnPR_Simpan.Click
        ...
        Try
            ...
            Else
                ...
                SQL = "select status,flag_po,flag_release from EMI_Purchase_Requisition_Barang_Lain "
                ...
                SQL = "insert into EMI_Purchase_Requisition_Barang_Lain_Detail_log(Kode_Perusahaan, No_Faktur, Kode_Stock_Owner, Kode_Barang, Jumlah, Satuan, Tanggal_Delivery, keterangan) "
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles BtnPR_Release.Click
        ...
        Try
            ...
            SQL = "select a.No_Faktur from EMI_Purchase_Requisition_Barang_Lain a, EMI_Purchase_Requisition_Barang_Lain_Detail b, barang_lain c "
                ...
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    With Ds.Tables(0)
                        ...
                        With A_Place_For_Printing2
                            ...
                            CrDoc.RecordSelectionFormula = " {EMI_Purchase_Requisition_Barang_Lain.Kode_Perusahaan} = '" & KodePerusahaan & "' and {EMI_Purchase_Requisition_Barang_Lain.No_Faktur} = '" & Ds.Tables("MyTable").Rows(0).Item("No_Faktur") & "'"
    ...
    Private Sub DtpFormulator_Tanggal_ValueChanged(sender As Object, e As EventArgs) Handles DtpFormulator_Tanggal.ValueChanged
