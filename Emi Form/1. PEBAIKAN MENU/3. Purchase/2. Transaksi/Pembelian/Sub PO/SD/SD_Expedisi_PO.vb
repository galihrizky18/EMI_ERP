Public Class SD_Expedisi_PO
    ...
    Private Sub CekSementara()
        ...
        Try
            ...
            SQL = SQL & "from Emi_Expedition_PO_Sementara where Kode_Perusahaan = '" & KodePerusahaan & "' and No_FakturSubPO = '" & UserID & "'"
    ...
    Private Sub BtnPO_Simpan_Click(sender As Object, e As EventArgs) Handles BtnPO_Simpan.Click
        ...
        Try
            ...
            For i As Integer = 0 To Lv_DataInput.Items.Count - 1
                ...
                SQL = "select Kode_Perusahaan from Emi_Expedition_PO_Sementara  "
                ...
                Using Ds = BindingTrans(SQL)
                    With Ds.Tables("MyTable")
                        If .Rows.Count = 0 Then
                            ...
                            SQL = "insert into Emi_Expedition_PO_Sementara (Kode_Perusahaan, No_FakturSubPO, No_Faktur_Ekspedisi, No_Penawaran, Kode_Biaya, Mata_Uang, Tarif, BiayaLain, Total, userid, Urut_Penawaran) "
