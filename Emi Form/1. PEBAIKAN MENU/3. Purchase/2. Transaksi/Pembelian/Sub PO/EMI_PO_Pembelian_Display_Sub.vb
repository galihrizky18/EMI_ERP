Public Class EMI_PO_Pembelian_Display_Sub
    ...
    Public Sub Cari(ByVal semua As String)
        Try
            ...
            SQL = SQL & "FROM rencana_order ro, suppliers s, emi_pembelian_Po c "
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles BtnNewPO.Click
        ...
        EMI_PO_Pembelian_Sub.Asal = ""
        EMI_PO_Pembelian_Sub.Txt_Faktur_Induk.Text = ""
        EMI_PO_Pembelian_Sub.kosong()
        EMI_PO_Pembelian_Sub.ShowDialog()
    ...
    Private Sub DgvPO_DataLocal_DoubleClick(sender As Object, e As EventArgs)
        ...
        EMI_PO_Pembelian_Sub.kosong()
        EMI_PO_Pembelian_Sub.TxtPO_NoFaktur.Text = LvNo_PoLocal
        EMI_PO_Pembelian_Sub.CmbPO_Lokasi.Text = LvLokasiLocal
        EMI_PO_Pembelian_Sub.TxtPO_NoFaktur_Leave(Me, e)
        EMI_PO_Pembelian_Sub.Asal = "edit"
        EMI_PO_Pembelian_Sub.ShowDialog()
