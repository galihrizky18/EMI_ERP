Public Class EMI_PO_Pembelian
    ...
    Dim tempDataPajak As New List(Of (Pajak As String, Nilai As String, akun As String, isPPN As Boolean, KodeTarif As String))
    ...
    Dim cellPO_JnsKategori As Integer = 17
