        ...
        If Btn_Simpan.Text = "&Simpan" Then
            ...
            Try
                ...
                For i As Integer = 0 To ListViewMT11.Items.Count - 1
                    ...
                    SQL = SQL & "from Display_Biaya_Import_PPH_Detail a, EMI_Master_Pajak b "
                    SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan "
                    ...
                    '=     INSERT DETAIL PPN     =
                    '=============================
                    SQL = "select Persentase, Kode_Tarif, Kode_Akun from EMI_Detail_PPH_PO "
                    ...
                    If Jenis1.Trim.ToUpper = "SUPPLIER" Then
                        SQL = "select Hutang_Supplier, akun_selisih_PO, Akun_DP "
...
#End Region
    ...
    Private Sub ListViewMT11_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListViewMT11.SelectedIndexChanged
