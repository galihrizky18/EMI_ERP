...
Public Class EMI_Pelunasan
    ...
    Private Sub Get_Isi_Listview1(ByVal No_Index As Integer)
        ...
        Lv1_TglPO = ListViewMT1.Items(No_Index).SubItems(Cell1_TglPO).Text
    ...
    Private Sub Cari(ByVal param As String)
        ...
        Try
            ...
            SQL = "select no_po, keterangan, tanggal_PO, Kode_perusahaan_Biaya_Import, Nama as NmPerusahaanBiayaImport, Kode_Master_Kategori_Biaya_Import, "
...
#End Region
    ...
    Private Sub ListViewMT1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListViewMT1.DoubleClick
        ...
        For i As Integer = 0 To ListViewMT11.Items.Count - 1
            ...
            If ListViewMT11.Items(i).SubItems(CellFak).Text.Trim.ToUpper = ListViewMT1.FocusedItem.SubItems(Cell1_NoPO).Text.Trim.ToUpper And
            ListViewMT11.Items(i).SubItems(CellLokasi).Text.Trim.ToUpper = ListViewMT1.FocusedItem.SubItems(Cell1_Lokasi).Text.Trim.ToUpper And
            ListViewMT11.Items(i).SubItems(CellMT).Text.Trim.ToUpper = ListViewMT1.FocusedItem.SubItems(Cell1_MataUang).Text.Trim.ToUpper Then
                MessageBox.Show("Faktur ini sudah dimasukkan sebelumnya!", Judul, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Exit Sub
            End If
        ...
        TextBoxtgl.Text = ListViewMT1.FocusedItem.SubItems(Cell1_TglPO).Text
