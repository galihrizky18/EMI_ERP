...
Public Class N_EMI_Laporan_Pembayaran_Di_Muka_CutOff_Proyek
...
#End Region
            ...
            '		from EMI_Transaksi_Pembayaran_Dimuka_Proyek a
            '		inner join EMI_Transaksi_Pembayaran_Dimuka_Detail_Proyek b on a.Kode_Perusahaan = b.Kode_Perusahaan and a.No_Transaksi = b.No_Transaksi
            '		cross apply (
            '			select round(sum(z.Nilai), 0) as Total_Pajak from EMI_Transaksi_Pembayaran_Dimuka_Proyek_Pajak z
    ...
    Private Sub BtnCetak_Click(sender As Object, e As EventArgs) Handles BtnCetak.Click
        ...
        Try
            ...
            SQL = "exec N_EMI_SP_Down_Payment_Cut_Off_Proyek @Kode_Perusahaan='" & KodePerusahaan & "', "
