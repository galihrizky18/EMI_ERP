...
Public Class N_EMI_Laporan_Down_Payment_CutOff
    ...
    Private Sub Txt_NoTransaksi_TextChanged(sender As Object, e As EventArgs) Handles Txt_NoTransaksi.TextChanged
        ...
        If Txt_NoTransaksi.Text.Trim.Length = 0 Then
            ...
            Lv_Transaksi.Location = New Point(550, 154)
            Txt_NoTransaksi.Text = ""
            Exit Sub
        Else
            Me.Size = New Size(561, 365)
            Lv_Transaksi.Location = New Point(142, 154)
...
#End Region
            ...
            '            from EMI_Transaksi_Pembayaran_Dimuka a
            '            inner join EMI_Transaksi_Pembayaran_Dimuka_Detail b on a.Kode_Perusahaan = b.Kode_Perusahaan and a.No_Transaksi = b.No_Transaksi
            '            cross apply (
            '                select round(sum(z.Nilai), 0) as Total_Pajak from EMI_Transaksi_Pembayaran_Dimuka_Pajak z
            ...
            '  from EMI_Pelunasan_Detail_DP z, emi_pelunasan y
    ...
    Private Sub BtnCetak_Click(sender As Object, e As EventArgs) Handles BtnCetak.Click
        ...
        ElseIf Cmb_JenisLaporan.SelectedIndex = -1 Then
            MessageBox.Show("Jenis Laporan Hasil Dipilih Dahulu", "Perhatian", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        ...
        Try
            ...
            SQL = "exec N_EMI_SP_Down_Payment_Cut_Off @Kode_Perusahaan='" & KodePerusahaan & "', "
                ...
                With DS.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        ...
                        If Cmb_JenisLaporan.SelectedIndex = 0 Then
                            CrDoc = New N_EMI_CR_Laporan_Down_Payment_CutOff
                        Else
                            CrDoc = New N_EMI_CR_Laporan_Down_Payment_CutOff_Rekap
                            SelectionRecord = "{N_EMI_SP_Down_Payment_Cut_Off.Sisa} <> 0"
                        End If
