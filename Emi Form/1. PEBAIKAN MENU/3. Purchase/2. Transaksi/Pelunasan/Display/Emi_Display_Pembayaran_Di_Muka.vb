Public Class Emi_Display_Pembayaran_Di_Muka
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            SQL = SQL & "from EMI_Transaksi_Pembayaran_Dimuka a, Suppliers b, Rekening_Suppliers c "
    ...
    Private Sub Lv_DetailDP_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_DetailDP.SelectedIndexChanged
        ...
        Try
            ...
            SQL = SQL & "from EMI_Transaksi_Pembayaran_Dimuka a, EMI_Transaksi_Pembayaran_Dimuka_Detail b, EMI_Transaksi_Pembayaran_Dimuka_Pajak c "
            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and b.Kode_Perusahaan = c.Kode_Perusahaan "
            SQL = SQL & "and a.No_Transaksi = b.No_Transaksi "
