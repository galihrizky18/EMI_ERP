Public Class Emi_Display_Pembayaran_Di_Muka_Barang_Lain
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            SQL = SQL & "from EMI_Transaksi_Pembayaran_Dimuka_Asset a, Suppliers b, Rekening_Suppliers c "
    ...
    Private Sub Lv_DataDP_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_DataDP.SelectedIndexChanged
        ...
        Try
            ...
            SQL = SQL & "from EMI_Transaksi_Pembayaran_Dimuka_Asset a, EMI_Transaksi_Pembayaran_Dimuka_Detail_Asset b, EMI_Pembelian_PO_Induk_Barang_Lain c "
            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and b.Kode_Perusahaan = c.Kode_Perusahaan  "
            SQL = SQL & "and a.No_Transaksi = b.No_Transaksi "
            SQL = SQL & "and b.No_Fak_PO = c.No_Faktur "
            SQL = SQL & "and a.Status is null "
    ...
    Private Sub Lv_DetailDP_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_DetailDP.SelectedIndexChanged
        ...
        Try
            ...
            SQL = SQL & "from EMI_Transaksi_Pembayaran_Dimuka_Asset a, EMI_Transaksi_Pembayaran_Dimuka_Detail_Asset b, EMI_Transaksi_Pembayaran_Dimuka_Asset_Pajak c "
            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and b.Kode_Perusahaan = c.Kode_Perusahaan "
            SQL = SQL & "and a.No_Transaksi = b.No_Transaksi "
