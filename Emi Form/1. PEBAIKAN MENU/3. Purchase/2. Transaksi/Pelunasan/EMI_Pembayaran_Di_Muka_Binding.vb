Public Class EMI_Pembayaran_Di_Muka_Binding
        ...
        Try
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    If total_sudah_dp = Dr("nilai") Then
                        Dr.Close()
                        SQL = "Update EMI_Transaksi_Pembayaran_Dimuka set Flag_PO='Y' "
            ...
            SQL = "insert into EMI_Transaksi_Pembayaran_Dimuka_Detail(Kode_Perusahaan, no_transaksi, Tanggal, Jam, UserId, "
