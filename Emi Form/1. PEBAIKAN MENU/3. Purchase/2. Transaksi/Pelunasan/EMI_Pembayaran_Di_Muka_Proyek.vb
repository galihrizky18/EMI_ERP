...
Public Class EMI_Pembayaran_Di_Muka_Proyek
    ...
    Private Sub get_no_faktur()
        ...
        'TxtFakturPembayaran.Text = fDownPayProyek & arrInisialFaktur.Item(CmbLokasi.SelectedIndex) & "-" & Format(Dtp1.Value, "MMyy") & "-" &
        '                    General_Class.Get_Last_Number2("emi_transaksi_pembayaran_dimuka_Proyek", "no_transaksi", Jumlah_Digit,
        '                    "Kode_perusahaan", KodePerusahaan,
        '                    "And", "substring(no_transaksi, 1, " & Len(fDownPayProyek) + Len(arrInisialFaktur.Item(CmbLokasi.SelectedIndex)) + 5 & ")", fDownPayProyek & arrInisialFaktur.Item(CmbLokasi.SelectedIndex) & "-" & Format(Dtp1.Value, "MMyy"))
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            SQL = "select Akun_DP "
            SQL = SQL & "from stock_owner_proyek "
            ...
            'SQL = SQL & "" & HilangkanTanda(TxtTotalIDR.Text) & ", 'T', NULL, 'Proyek')"
            'ExecuteTrans(SQL)
            ...
            SQL = SQL & "values('" & KodePerusahaan & "', '" & no_fakturPengajuan & "', '" & Format(Dtp1.Value, "yyyy-MM-dd") & "', "
            SQL = SQL & "'" & Format(Tanggal_Sekarang, "HH:mm:ss") & "', '" & TxtKeterangan.Text & "', '" & UserID & "', "
            SQL = SQL & "" & HilangkanTanda(NilaiTranfer) & ", 'T', NULL, 'Proyek')"
            ExecuteTrans(SQL)

            SQL = "insert into emi_transaksi_pembayaran_dimuka_Proyek(Kode_Perusahaan,No_Transaksi	,Tanggal, Jam, UserID, "
            ...
            If CbNoFaktur.Checked Then
                SQL = "select No_Faktur, Persentase, Kode_Tarif, Kode_Akun, Flag_PPN from Detail_PO_Pembelian_Proyek_PPH  "
                        ...
                        If .Rows.Count <> 0 Then
                            For i As Integer = 0 To .Rows.Count - 1
                                ...
                                If General_Class.CekNULL(.Rows(i).Item("Flag_PPN")) = "Y" Then
                                    ...
                                    SQL = "insert into EMI_Transaksi_Pembayaran_Dimuka_Proyek_Pajak (Kode_Perusahaan, No_Faktur_Induk, No_Faktur, Persentase, Nilai, Kode_Tarif, Flag_PPN, Kode_Akun) "
            ...
            If CbNoFaktur.Checked = True Then
                ...
                End If
                SQL = "insert into emi_transaksi_pembayaran_dimuka_detail_Proyek(Kode_Perusahaan,No_Transaksi,Tanggal, Jam,UserId,no_fak_po, Nilai, Nilai_IDR, Persen_DP) "
                SQL = SQL & "values ( "
                SQL = SQL & "'" & KodePerusahaan & "' , '" & TxtFakturPembayaran.Text.Trim & "', '" & Format(Dtp1.Value, "yyyy-MM-dd") & "', "
    ...
    Private Sub CmbNoPO_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CmbNoPO.SelectedIndexChanged
        ...
        Try
            ...
            SQL = "select 'RP' as Mata_Uang, grand "
            SQL = SQL & "From PO_Pembelian_Proyek a where a.Kode_Perusahaan = '" & KodePerusahaan & "' and "
            ...
            SQL = SQL & "from emi_transaksi_pembayaran_dimuka_Proyek a, emi_transaksi_pembayaran_dimuka_Detail_Proyek b "
    ...
    Private Sub CheckBox1_CheckedChanged(sender As Object, e As EventArgs) Handles CbNoFaktur.CheckedChanged
        ...
        If CbNoFaktur.Checked = True Then
            ...
            Try
                ...
                SQL = SQL & "isnull((select top(1) 'Y' from EMI_Transaksi_Pembayaran_Dimuka_Proyek x, EMI_Transaksi_Pembayaran_Dimuka_Detail_Proyek y where "
                ...
                SQL = SQL & "From PO_Pembelian_Proyek a where a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.Kode_Supplier = '" & TxtKodeSupplier.Text & "' and a.status is null "
                SQL = SQL & ") select * From cte where kode_perusahaan = '" & KodePerusahaan & "' "
                'SQL = SQL & "flag is null "
                SQL = SQL & "order by no_faktur"
                Using Dr = OpenTrans(SQL)
                    Do While Dr.Read
