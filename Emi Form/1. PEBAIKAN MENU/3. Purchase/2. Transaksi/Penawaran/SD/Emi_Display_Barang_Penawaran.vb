Public Class Emi_Display_Barang_Penawaran
    ...
    Private Sub kosong()
        ...
        Try
            ...
            SQL = "select Kode_Group_Jenis from EMI_Group_Jenis where Kode_Perusahaan = '" & KodePerusahaan & "' and Flag_Penawaran = 'Y' order by Kode_Group_Jenis"
            Using dr = OpenTrans(SQL)
    ...
    Private Sub Initial_Lv()
        ...
        Lv_Data.Columns.Add("Kategori", 140, HorizontalAlignment.Center)
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            Lv_Data.Items.Clear()
            SQL = ";with cte as( "
            SQL = SQL & "(select a.kode_perusahaan, a.kode_barang, a.Nama, a.Kode_Kategori_Besar, a.Kode_Kategori_Kecil, a.Flag_PPN, b.Kode_Group_Jenis, "
            ...
            SQL = SQL & "and b.Flag_Penawaran = 'Y' "
            SQL = SQL & "and a.Kode_Perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "group by a.kode_perusahaan, a.kode_barang, a.Nama, a.Kode_Kategori_Besar, a.Kode_Kategori_Kecil, a.Flag_PPN, b.Kode_Group_Jenis )) "
            'SQL = SQL & "union all "
            ...
            If Cmb_GroupJenis.SelectedIndex <> -1 And Cmb_GroupJenis.SelectedIndex <> 0 Then
                If Not Strings.Right(UCase(SQL), 6) = "WHERE " Then SQL = SQL & "AND "
                SQL = SQL & "Kode_Group_Jenis = '" & Cmb_GroupJenis.Text & "' "
            End If
            ...
            End If
            SQL = SQL & "order by kode_barang, Kode_Group_Jenis "
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            Lv.SubItems.Add(.Rows(i).Item("Kode_Group_Jenis"))
