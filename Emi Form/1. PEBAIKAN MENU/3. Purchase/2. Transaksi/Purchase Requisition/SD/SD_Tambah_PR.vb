        ...
        ElseIf asal = "Purchase_Requisition" Then
            ...
            For i As Integer = 0 To Purchase_Requisition.Dgv_DataBarang.Rows.Count - 1
                If TxtPilihBarang_KodeBarang.Text.Trim = Purchase_Requisition.Dgv_DataBarang.Rows(i).Cells(1).Value Then
                    If CmbPilihBarang_Satuan.Text = Purchase_Requisition.Dgv_DataBarang.Rows(i).Cells(4).Value Then
                        If Format(DateTimePicker1.Value, "dd MMM yyyy") = Purchase_Requisition.Dgv_DataBarang.Rows(i).Cells(5).Value Then
                            Purchase_Requisition.Dgv_DataBarang.Rows(i).Cells(3).Value = Val(Purchase_Requisition.Dgv_DataBarang.Rows(i).Cells(3).Value) + Val(txtJumlah.Text)
                            Me.Close()
                            Exit Sub
                        End If
                    End If
            ...
            index = Purchase_Requisition.Dgv_DataBarang.Rows.Count - 1
            ...
            jumlahIndexDGv = Purchase_Requisition.Dgv_DataBarang.Rows.Count - 1

            'Purchase_Requisition
            Purchase_Requisition.Dgv_DataBarang.Rows(index).Cells(0).Value = CmbPilihBarang_Lokasi.Text
            Purchase_Requisition.Dgv_DataBarang.Rows(index).Cells(1).Value = TxtPilihBarang_KodeBarang.Text
            Purchase_Requisition.Dgv_DataBarang.Rows(index).Cells(2).Value = TxtPilihBarang_NamaBarang.Text
            'Purchase_Requisition.Dgv_DataBarang.Rows(index).Cells(3).Value = txtJumlah.Text.Trim
            Purchase_Requisition.Dgv_DataBarang.Rows(index).Cells(3).Value = 0
            ...
            Purchase_Requisition.Dgv_DataBarang.Rows(index).Cells(9).Value = TxtTiba.Text
            ...
            Purchase_Requisition.Dgv_DataBarang.Rows(jumlahIndexDGv).Cells(2).ReadOnly = True
            Purchase_Requisition.Dgv_DataBarang.Rows(jumlahIndexDGv).Cells(3).ReadOnly = False
            Purchase_Requisition.Dgv_DataBarang.Rows(jumlahIndexDGv).Cells(4).ReadOnly = True
            Purchase_Requisition.Dgv_DataBarang.Rows(jumlahIndexDGv).Cells(5).ReadOnly = True
            Purchase_Requisition.Dgv_DataBarang.Rows(jumlahIndexDGv).Cells(6).ReadOnly = False
