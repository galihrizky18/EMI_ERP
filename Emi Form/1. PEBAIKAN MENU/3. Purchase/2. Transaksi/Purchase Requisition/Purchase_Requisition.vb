        ...
        Try
            ...
            If Btn_Simpan.Tag = "&Simpan" Then
                ...
                For i As Integer = 0 To Dgv_DataBarang.Rows.Count - 2
                    Get_Isi_Listview(i)
                    SQL = "insert into emi_purchase_requisition_detail(Kode_Perusahaan,No_Faktur,Kode_Stock_Owner,Kode_Barang,Jumlah,Satuan,Tanggal_Delivery,keterangan, Estimasi ) values("
