Public Class EMI_Pembelian_PR_Summary_Data
    ...
    Private Sub kosong()
        ...
        Lv_PR.Columns.Add("Status", 0, HorizontalAlignment.Center)
        ...
        Lv_PRDetail.Columns.Add("Status Validasi", 130, HorizontalAlignment.Center)
        ...
        Lv_Detail.Columns.Add("Lokasi", 0, HorizontalAlignment.Left)
        Lv_Detail.Columns.Add("Kode Barang", 130, HorizontalAlignment.Left)
        Lv_Detail.Columns.Add("Jumlah", 190, HorizontalAlignment.Right)
        Lv_Detail.Columns.Add("Satuan", 0, HorizontalAlignment.Center)
        Lv_Detail.Columns.Add("Urut", 0, HorizontalAlignment.Center)
        Lv_Detail.View = View.Details

        Lv_DetailSubPO.Items.Clear() : Lv_DetailSubPO.Columns.Clear()
        Lv_DetailSubPO.Columns.Add("No PO", 150, HorizontalAlignment.Left)
        Lv_DetailSubPO.Columns.Add("Tanggal PO", 150, HorizontalAlignment.Center)
        Lv_DetailSubPO.Columns.Add("Lokasi", 0, HorizontalAlignment.Left)
        Lv_DetailSubPO.Columns.Add("Kode Barang", 180, HorizontalAlignment.Left)
        Lv_DetailSubPO.Columns.Add("Jumlah", 220, HorizontalAlignment.Right)
        Lv_DetailSubPO.Columns.Add("Satuan", 0, HorizontalAlignment.Center)
        Lv_DetailSubPO.View = View.Details

        Lv_Detail_Sub.Items.Clear() : Lv_Detail_Sub.Columns.Clear()
        Lv_Detail_Sub.Columns.Add("No Sub PO", 130, HorizontalAlignment.Left)
        Lv_Detail_Sub.Columns.Add("Jumlah", 160, HorizontalAlignment.Right)
        Lv_Detail_Sub.View = View.Details
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_PR.SelectedIndexChanged
        Try
            ...
            SQL = SQL & "isnull(a.flag_sudah_po,'T') as flag_selesai_po, a.Status_Validasi "
            ...
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    ...
                    If General_Class.CekNULL(Dr("Status_Validasi")) = "T" Then
                        lvw.SubItems.Add("Ditolak")
                        lvw.ForeColor = Color.White
                        lvw.BackColor = Color.DarkRed
                    ElseIf General_Class.CekNULL(Dr("Status_Validasi")) = "Y" Then
                        lvw.SubItems.Add("Divalidasi")
                        lvw.ForeColor = Color.Black
                        lvw.BackColor = Color.LightGreen
                    ElseIf General_Class.CekNULL(Dr("Status_Validasi")) = "" Then
                        lvw.SubItems.Add("Belum Validasi")
                        lvw.ForeColor = Color.Black
            ...
            SQL = "select a.No_Faktur, d.No_Faktur as No_PO, c.Kode_Stock_Owner, c.Kode_Barang, c.Jumlah, c.Satuan, d.Tanggal, d.Status, c.No_Urut "
            ...
            SQL = SQL & "and a.Kode_Perusahaan = '" & KodePerusahaan & "' and d.status is null "
            SQL = SQL & "and a.No_Faktur ='" & Lv_PR.FocusedItem.SubItems(0).Text & "' "
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    ...
                    Lv.SubItems.Add(Format(Dr("Jumlah"), "N2") + " " + Dr("Satuan"))
            ...
            Lv_DetailSubPO.Items.Clear()
            SQL = "select a.No_Faktur, d.No_Faktur as No_PO, c.Kode_Stock_Owner, c.Kode_Barang, c.Jumlah, c.Satuan, d.Tanggal, d.Status "
            SQL = SQL & "from EMI_Purchase_Requisition a, EMI_Purchase_Requisition_Detail b,EMI_Pembelian_PO_Det c,EMI_Pembelian_PO d  "
            SQL = SQL & "where a.Kode_Perusahaan = b.Kode_Perusahaan and b.Kode_Perusahaan = c.Kode_Perusahaan and c.Kode_Perusahaan = d.Kode_Perusahaan  "
            SQL = SQL & "and a.No_Faktur = b.No_Faktur and c.No_Faktur = d.No_Faktur and b.No_Urut = c.No_Urut_PR  "
            SQL = SQL & "and a.Kode_Perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and a.No_Faktur ='" & Lv_PR.FocusedItem.SubItems(0).Text & "' and d.status is null "
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    Dim Lv As ListViewItem
                    Lv = Lv_DetailSubPO.Items.Add(Dr("No_PO"))
                    Lv.SubItems.Add(Format(Dr("Tanggal"), "dd MMM yyyy"))
                    Lv.SubItems.Add(Dr("Kode_Stock_Owner"))
                    Lv.SubItems.Add(Dr("Kode_Barang"))
                    Lv.SubItems.Add(Format(Dr("Jumlah"), "N2") + " " + Dr("Satuan"))
    ...
    Private Sub Lv_Detail_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_Detail.SelectedIndexChanged
        If Lv_Detail.Items.Count = 0 Or Lv_Detail.SelectedItems.Count = 0 Then
            Exit Sub
        End If
        ...
        Try
            ...
            Lv_Detail_Sub.Items.Clear()
            SQL = "select c.No_Faktur, c.Jumlah, c.Satuan "
            SQL = SQL & "from EMI_Pembelian_PO_Det c,EMI_Pembelian_PO d  "
            SQL = SQL & "where c.Kode_Perusahaan = d.Kode_Perusahaan  "
            SQL = SQL & "and c.No_Faktur = d.No_Faktur and d.status is null  "
            SQL = SQL & "and c.Kode_Perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and c.urut_det_induk ='" & Lv_Detail.FocusedItem.SubItems(6).Text & "' "
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    Dim Lv As ListViewItem
                    Lv = Lv_Detail_Sub.Items.Add(Dr("No_Faktur"))
                    Lv.SubItems.Add(Format(Dr("Jumlah"), "N2") + " " + Dr("Satuan"))
                Loop
            End Using
