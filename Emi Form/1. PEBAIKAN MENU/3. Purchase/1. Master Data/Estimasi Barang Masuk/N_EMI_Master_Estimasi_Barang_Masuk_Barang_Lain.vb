...
Public Class N_EMI_Master_Estimasi_Barang_Masuk_Barang_Lain
    ...
    Private Sub Load_Data()
        ...
        Try
            ...
            SQL = $"
                ...
                FROM EMI_Detail_Proses_Pengiriman_PO_Barang_Lain a
        ...
        Try
            ...
            If Btn_Simpan.Tag.ToString.ToUpper = "SIMPAN" Then
                ...
                SQL = $"
                    ...
                    FROM EMI_Detail_Proses_Pengiriman_PO_Barang_Lain
                    WHERE Kode_Perusahaan = '{KodePerusahaan}'
                ...
                SQL = $"
                    insert INTO EMI_Detail_Proses_Pengiriman_PO_Barang_Lain (kode_perusahaan, Id_Kategori_Supplier, Kode_Barang, Waktu_Pabrikasi, Waktu_Pengiriman)
            ...
            ElseIf Btn_Simpan.Tag.ToString.ToUpper = "UPDATE" Then
                ...
                SQL = $"
                    UPDATE EMI_Detail_Proses_Pengiriman_PO_Barang_Lain SET Waktu_Pabrikasi = '{Txt_Waktu_Pabrikasi.Text}', Waktu_Pengiriman = '{Txt_Waktu_Pengiriman.Text}' 
    ...
    Private Sub Btn_Hapus_Click(sender As Object, e As EventArgs) Handles Btn_Hapus.Click
        ...
        Try
            ...
            SQL = $"
                DELETE EMI_Detail_Proses_Pengiriman_PO_Barang_Lain 
                where Kode_Perusahaan = '{KodePerusahaan}' 
                AND Id_Kategori_Supplier = '{arrJenisSupplier(Cmb_Jenis_Supplier.SelectedIndex)}' 
                and Kode_Barang = '{Txt_Kd_Barang.Text.Trim}'
            "
