Public Class N_EMI_Master_Persentase_Penentu_Barang

    Dim arrFilter As New ArrayList
    Dim JudulForm As String = "Master Persentase Penentu Barang"
    Private PersentaseStep As Integer = 1

    Private Sub N_EMI_Master_Persentase_Penentu_Barang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Lv_DataPersentase.Columns.Add("Persentase Penentu (%)", 420, HorizontalAlignment.Left)
    ...
    Private Sub Kosong()
        ...
        LoadDataPersentasePenentuBarang(False)
    End Sub
    ...
    Private Sub Btn_Cari_Click(sender As Object, e As EventArgs) Handles Btn_Cari.Click
        ...
        LoadDataPersentasePenentuBarang(True)
    End Sub

    Private Sub LoadDataPersentasePenentuBarang(ByVal filter As Boolean)
        Try
            OpenConn()

            Lv_DataPersentase.Items.Clear()
            SQL = "select Kode_Barang, Nama_Barang, Persentase_Penentu "
            SQL = SQL & "from N_EMI_Master_Persentase_Penentu "
            ...
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    ...
                    Lv.SubItems.Add(Dr("Persentase_Penentu"))
                Loop
            End Using
        ...
        Try
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read() Then
                    ...
                    '===========================
                    Dr.Close()
                    SQL = "update N_EMI_Master_Persentase_Penentu set "
                    SQL = SQL & "Persentase_Penentu = '" & TxtPersentase.Text & "' "
                    SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' "
                    SQL = SQL & "and Kode_Barang = '" & TxtPilihBarang_KodeBarang.Text & "' "
                    ExecuteTrans(SQL)
                ...
                Else
                    ...
                    '=     INSERT              =
                    '===========================
                    SQL = "insert into N_EMI_Master_Persentase_Penentu "
                    SQL = SQL & "(Kode_Perusahaan, Kode_Barang, Nama_Barang, Persentase_Penentu) values "
    ...
    Private Sub Btn_Hapus_Click(sender As Object, e As EventArgs) Handles Btn_Hapus.Click
        ...
        If MessageBox.Show("Yakin ingin Hapus Data Persentase Penentu " & TxtPilihBarang_NamaBarang.Text & " ?", Judul, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then Exit Sub
        ...
        Try
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    SQL = "Delete N_EMI_Master_Persentase_Penentu  "
                    SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' "
                    SQL = SQL & "and Kode_Barang = '" & TxtPilihBarang_KodeBarang.Text & "' "
                    ExecuteTrans(SQL)
        ...
        Try
            ...
            Using dr = OpenTrans(SQL)
                If dr.Read Then
                    ...
                    '=============================================
                    '= CEK DATA PERSENTASE DI TABEL Penentu       =
                    '=============================================
                    SQL = "select Persentase_Penentu "
                    SQL = SQL & "from N_EMI_Master_Persentase_Penentu "
                    SQL = SQL & "where Kode_Perusahaan = '" & KodePerusahaan & "' "
                    SQL = SQL & "and Kode_Barang = '" & TxtPilihBarang_KodeBarang.Text & "' "

                    Using drPenentu = OpenTrans(SQL)
                        If drPenentu.Read Then
                            TxtPersentase.Text = drPenentu("Persentase_Penentu")
