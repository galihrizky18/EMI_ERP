...
Public Class EMI_Validasi_GR_Display
    ...
    Private Sub Dgv_Keranjang_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgv_Keranjang.CellContentClick
    ...
    Private Sub EMI_Display_Validasi_GR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Lv_Validation.Columns.Add("Keterangan", 270, HorizontalAlignment.Left) '6
    ...
    Private Sub Dgv_Keranjang_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgv_Keranjang.CellClick
        ...
        Try
            ...
            SQL = SQL & "sum(a.Jumlah) as Jumlah, a.Satuan, a.Jenis, a.Number, a.Id_Routing, a.Routing "
            SQL = SQL & "from cte a "
            SQL = SQL & "group by a.kode_perusahaan, a.no_production_order, a.Lokasi_Tujuan, a.Kode_Barang, a.Nama_Barang, a.Kode_Unik_Berjalan, a.Batch_Number, a.Qr_Code, a.Satuan, a.Jenis, a.Number, a.Nomor, a.Id_Routing, a.Routing "
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
