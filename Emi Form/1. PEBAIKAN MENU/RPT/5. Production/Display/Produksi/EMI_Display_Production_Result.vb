...
Public Class EMI_Display_Production_Result
    ...
    Private Shared CachedRawKind As Integer = -1
    ...
    Private Sub CetakUlangBarcodeToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangBarcodeToolStripMenuItem.Click
        ...
        Try
            ...
            sw1.Stop()
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Normal', 'Get Detail Data', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw1.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Normal', 'Generate Barcode', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw2.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Normal', 'Insert Database', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw3.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
        ...
        Try
            ...
            'SQL = "select Kode_Perusahaan from N_EMI_Barcode_Label_Barcode_GR_1 where Kode_Perusahaan='" & KodePerusahaan & "' and Kode_Barang='0745114272058' and Kode_Unik_Print = '030614420102236' "
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    ...
                    CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                    CrDoc.RecordSelectionFormula = "{N_EMI_Barcode_Label_Barcode_GR_1.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Barang} = '" & KdBarang & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Unik_Print} = '" & kode_unik_print & "' "
                    'CrDoc.RecordSelectionFormula = "{N_EMI_Barcode_Label_Barcode_GR_1.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Barang} = '0745114272058' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Unik_Print} = '030614420102236' "
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Normal', 'Cetak Barcode', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw3.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
        ...
        MessageBox.Show("Berhasil Cetak", "Cetak Ulang Barcode", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
    End Sub
    ...
    Private Sub CetakUlangBarcodeFGTembakToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangBarcodeFGTembakToolStripMenuItem.Click
        If Lv_DetailFinishedGood.Items.Count = 0 Then Exit Sub
        Dim SelectedIndex As Integer = Lv_DetailFinishedGood.FocusedItem.Index
        Dim NoSplit As String = Lv_ProductionResult.FocusedItem.SubItems(itemPR_NoFak).Text
        ...
        '    sw1.Stop()
        '    SQL = $"
        '        insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Action, Tanggal, Jam, Waktu)
        '        values ('{KodePerusahaan}', '{NoSplit}', 'Get Detail Data', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw1.Elapsed.TotalMilliseconds} ms')
        '    "
        '    ExecuteTrans(SQL)
        ...
        '    SQL = $"
        '        insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Action, Tanggal, Jam, Waktu)
        '        values ('{KodePerusahaan}', '{NoSplit}', 'Generate Barcode', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw2.Elapsed.TotalMilliseconds} ms')
        '    "
        '    ExecuteTrans(SQL)
        ...
        '    SQL = $"
        '        insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Action, Tanggal, Jam, Waktu)
        '        values ('{KodePerusahaan}', '{NoSplit}', 'Insert Database', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw3.Elapsed.TotalMilliseconds} ms')
        '    "
        '    ExecuteTrans(SQL)
        ...
        Try
            ...
            Dim TembakKodeUnik As String = ""
            Dim TembakKdBarang As String = ""
            SQL = "select Tes_Kode_Unik, Tes_Kd_Barang from init "
            SQL &= $"where Kode_Perusahaan = '{KodePerusahaan}' "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    TembakKodeUnik = If(General_Class.CekNULL(Dr("Tes_Kode_Unik")) = "", "-", Dr("Tes_Kode_Unik"))
                    TembakKdBarang = If(General_Class.CekNULL(Dr("Tes_Kd_Barang")) = "", "-", Dr("Tes_Kd_Barang"))
                End If
            End Using
            ...
            sw3.Start()
            'SQL = "select Kode_Perusahaan from N_EMI_Barcode_Label_Barcode_GR_1 where Kode_Perusahaan='" & KodePerusahaan & "' and Kode_Barang='" & KdBarang & "' and Kode_Unik_Print = '" & kode_unik_print & "' "
            SQL = "select Kode_Perusahaan from N_EMI_Barcode_Label_Barcode_GR_1 where Kode_Perusahaan='" & KodePerusahaan & "' and Kode_Barang='" & TembakKdBarang.Trim & "'  and Kode_Unik_Print = '" & TembakKodeUnik & "' "
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    ...
                    CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                    'CrDoc.RecordSelectionFormula = "{N_EMI_Barcode_Label_Barcode_GR_1.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Barang} = '" & KdBarang & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Unik_Print} = '" & kode_unik_print & "' "
                    CrDoc.RecordSelectionFormula = "{N_EMI_Barcode_Label_Barcode_GR_1.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Barang} = '" & TembakKdBarang & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Unik_Print} = '" & TembakKodeUnik & "' "
                    CrDoc.PrintOptions.PrinterName = PrinterBarcode
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Tembak', 'Cetak Barcode Tembak', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw3.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
    ...
    Private Sub CetakUlangBarcodeFGRamToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangBarcodeFGRamToolStripMenuItem.Click
        ...
        Try
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Ram', 'Get Detail Data', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw1.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Ram', 'Generate Barcode', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw2.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            SQL = "insert into N_EMI_Barcode_Label_Barcode_GR_1 (kode_perusahaan, no_split, Barcode, Kode_barang, Nama_Barang, QrUtuh, Qr, Tgl_Produksi, Jam_Produksi, "
                            SQL = SQL & "Proses, Tahap, Jumlah, Satuan, Troli, Nomor, id_routing, routing, Kode_unik_print)  "
                            SQL = SQL & "values ('" & KodePerusahaan & "', '" & .Rows(i).Item("No_Production_Order") & "', " & barcode & ", '" & .Rows(i).Item("Kode_Barang") & "', '" & .Rows(i).Item("Nama_Barang") & "', '" & fullNewQr & "', '" & Qr_Code & "', "
                            SQL = SQL & "'" & Format(Date.Parse(Tgl_Produksi), "yyyy-MM-dd") & "', '" & Format(tgl_skg, "HH:mm:ss") & "', '" & .Rows(i).Item("proses") & "', '" & .Rows(i).Item("tahap") & "', '" & .Rows(i).Item("Jumlah") & "', '" & .Rows(i).Item("Satuan") & "', "
                            SQL = SQL & "'" & .Rows(i).Item("Troli") & "', '" & .Rows(i).Item("nomor") & "', '" & .Rows(i).Item("Id_Routing") & "', '" & .Rows(i).Item("Routing") & "', '" & kode_unik_print & "') "
                            ExecuteTrans(SQL)
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Ram', 'Insert Database', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw3.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
        ...
        Try
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Ram', 'Cetak Barcode', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw3.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
    ...
    Private Sub CetakUlangOptimalToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangOptimalToolStripMenuItem.Click
        ...
        Try
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Optimal', 'Get Detail Data', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw1.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Optimal', 'Generate Barcode', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw2.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Optimal', 'Insert Database', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw3.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
        ...
        Try
            ...
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    ...
                    ' 1. Pastikan DataSet (Ds) hanya berisi data yang diperlukan 
                    ' agar RecordSelectionFormula tidak memproses data sampah di memori.
                    CrDoc.SetDataSource(Ds)
                    CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)

                    ' Filter ini berat jika record di Ds ada jutaan. Pastikan Ds sudah difilter di level SQL.
                    CrDoc.RecordSelectionFormula = "{N_EMI_Barcode_Label_Barcode_GR_1.Kode_Perusahaan} = '" & KodePerusahaan & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Barang} = '" & KdBarang & "' and {N_EMI_Barcode_Label_Barcode_GR_1.Kode_Unik_Print} = '" & kode_unik_print & "' "

                    CrDoc.PrintOptions.PrinterName = PrinterBarcode

                    ' 2. Optimasi Pencarian PaperSize (Gunakan Cache)
                    If CachedRawKind = -1 Then
                        Dim doctoprint As New System.Drawing.Printing.PrintDocument()
                        doctoprint.PrinterSettings.PrinterName = PrinterBarcode

                        For Each ps As System.Drawing.Printing.PaperSize In doctoprint.PrinterSettings.PaperSizes
                            If ps.PaperName = KertasBesar Then
                                ' Gunakan properti RawKind (Hindari Reflection yang sangat lambat)
                                CachedRawKind = ps.RawKind
                                Exit For
                            End If
                        Next
                        doctoprint.Dispose()
                    ...
                    ' 3. Terapkan PaperSize
                    If CachedRawKind <> -1 Then
                        CrDoc.PrintOptions.PaperSize = CType(CachedRawKind, CrystalDecisions.Shared.PaperSize)
                    Else
                        CrDoc.PrintOptions.PaperSize = CrystalDecisions.Shared.PaperSize.DefaultPaperSize
                    End If
            ...
            SQL = $"
                insert into N_EMI_LOG_Waktu_GR_1 (Kode_Perusahaan, No_Transaksi, Jenis, Action, Tanggal, Jam, Waktu)
                values ('{KodePerusahaan}', '{NoSplit}', 'Optimal', 'Cetak Barcode', '{Format(tgl_skg, "yyyy-MM-dd")}', '{Format(tgl_skg, "HH:mm:ss")}', '{sw3.Elapsed.TotalMilliseconds} ms')
            "
            'ExecuteTrans(SQL)
    ...
    Private Sub CetakUlangTSPLToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CetakUlangTSPLToolStripMenuItem.Click
        ...
        Try
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    TglExp = If(General_Class.CekNULL(Dr("Tgl_Expired")) = "", "", Dr("Tgl_Expired"))
                    Batch = Dr("Batch_Number")
                    Tgl_Produksi = If(General_Class.CekNULL(Dr("Tgl_Produksi")) = "", "", Format(Dr("Tgl_Produksi"), "dd MMM yyyy"))
                    Tgl_Masuk = If(General_Class.CekNULL(Dr("Tgl_Masuk")) = "", "", Dr("Tgl_Masuk"))
                    MetodePengeluaranStok = Dr("Metode_Pengeluaran_Stok")
                Else
                    Dr.Close()
            ...
            fullNewQr = Lv_DetailFinishedGood.Items(SelectedIndex).SubItems(itemFG_FullQR).Text
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            Routing = .Rows(i).Item("Routing")
                            Jumlah = Format(.Rows(i).Item("Jumlah"), "N4")
                            Troli = .Rows(i).Item("Troli")
                            Number = .Rows(i).Item("nomor")
        ...
        Generate_Barcode_TSPL(KdBarang, NoSplit, Routing, Batch, Tgl_Produksi, Format(tgl_skg, "HH:mm:ss"), Jumlah, Troli, fullNewQr, Number, fullNewQr)

        MessageBox.Show("Selsai cetak tspl", "Oke", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
    ...
    Private Sub Generate_Barcode_TSPL(KdBarang As String, NoPo As String, Routing As String, BatchNo As String, TglProduksi As String, JamProduksi As String, Qty As String,
                                      Troli As String, QrUtuh As String, Number As String, Barcode As String)
        Try
            ' 1. Koneksi Printer (Nama sesuai Control Panel)
            TSC_Printer_API.openport("TSC TE210")

            ' 2. Konfigurasi Label (100mm x 50mm)
            ' Setup: Width "100", Height "50"
            TSC_Printer_API.setup("100", "50", "4", "15", "0", "3", "0")
            TSC_Printer_API.clearbuffer()

            ' --- 3. Gambar Bingkai & Garis ---
            ' BOX ditingkatkan menjadi lebar 780 dots (sekitar 97mm) untuk estetika
            TSC_Printer_API.sendcommand("BOX 10,10,790,380,4")
            ' Garis horizontal pemisah Header diperpanjang
            TSC_Printer_API.sendcommand("BAR 10,80,780,4")

            ' --- 4. Bagian Header ---
            ' Koordinat X untuk Header disesuaikan agar lebih seimbang
            'TSC_Printer_API.windowsfont(30, 30, 35, 0, 1, 0, "Tahoma", "LIFE CAT 85GR TUNA KITTEN TESTING DATA")
            TSC_Printer_API.windowsfont(30, 30, 35, 0, 1, 0, "Tahoma", KdBarang)
            TSC_Printer_API.windowsfont(710, 30, 35, 0, 1, 0, "Tahoma", "GR 1")

            ' --- 5. Baris Data (Label & Value) ---
            Dim startY As Integer = 100
            Dim gapY As Integer = 35
            Dim labelX As Integer = 30
            Dim valueX As Integer = 200 ' Value digeser ke kanan agar lebih lega

            TSC_Printer_API.windowsfont(labelX, startY, 28, 0, 1, 0, "Tahoma", "No. PO")
            TSC_Printer_API.windowsfont(valueX, startY, 28, 0, 0, 0, "Tahoma", $": {NoPo}")

            TSC_Printer_API.windowsfont(labelX, startY + gapY, 28, 0, 1, 0, "Tahoma", "Routing")
            TSC_Printer_API.windowsfont(valueX, startY + gapY, 28, 0, 0, 0, "Tahoma", $": {Routing}")

            TSC_Printer_API.windowsfont(labelX, startY + (gapY * 2), 28, 0, 1, 0, "Tahoma", "Batch No")
            TSC_Printer_API.windowsfont(valueX, startY + (gapY * 2), 28, 0, 0, 0, "Tahoma", $": {BatchNo}")

            TSC_Printer_API.windowsfont(labelX, startY + (gapY * 3), 28, 0, 1, 0, "Tahoma", "Tgl Produksi")
            TSC_Printer_API.windowsfont(valueX, startY + (gapY * 3), 28, 0, 0, 0, "Tahoma", $": {TglProduksi}, {JamProduksi}")

            TSC_Printer_API.windowsfont(labelX, startY + (gapY * 4), 28, 0, 1, 0, "Tahoma", "Quantity")
            TSC_Printer_API.windowsfont(valueX, startY + (gapY * 4), 28, 0, 0, 0, "Tahoma", $": {Qty} Pcs")

            TSC_Printer_API.windowsfont(labelX, startY + (gapY * 5), 28, 0, 1, 0, "Tahoma", "Trolly")
            TSC_Printer_API.windowsfont(valueX, startY + (gapY * 5), 28, 0, 0, 0, "Tahoma", $": {Troli}")

            ' --- 6. Bagian QR Code ---
            ' QR Code digeser lebih ke kanan (X=600) karena kertas lebih lebar
            TSC_Printer_API.sendcommand("QRCODE 550,110,H,6,A,0,""" & Barcode & """")
            ...
            'Dim qrBitmap As Bitmap = writer.Write(Barcode)

            ' Kirim bitmap ke printer (X, Y, Bitmap)
            'TSC_Printer_API.sendbitmap(550, 110, qrBitmap)

            ' --- 7. Bagian Footer ---
            ' Teks panjang di bawah tetap di kiri
            TSC_Printer_API.windowsfont(30, 345, 20, 0, 0, 0, "Tahoma", QrUtuh)
            ' Label Number digeser menyesuaikan lebar kertas
            'TSC_Printer_API.windowsfont(550, 335, 30, 0, 1, 0, "Tahoma", "Number :")
            '' Angka Number digeser ke ujung kanan
            'TSC_Printer_API.windowsfont(710, 320, 40, 0, 1, 0, "Tahoma", Number)

            ' 8. Eksekusi Cetak
            TSC_Printer_API.printlabel("1", "1")

            ' 9. Tutup Koneksi
            TSC_Printer_API.closeport()
