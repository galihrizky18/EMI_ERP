...
Public Class N_EMI_Laporan_Final_GI_GR_Main
    ...
    Private Sub N_EMI_Laporan_Final_GI_GR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dgv_Rekap.Columns(35).DisplayIndex = 6
        Dgv_Rekap.Columns(36).DisplayIndex = 7
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            Dgv_Rekap.Rows(i).Cells(35).Value = If(General_Class.CekNULL(.Rows(i).Item("Tanggal_GI")) = "", "-", Format(.Rows(i).Item("Tanggal_GI"), "dd MMM yyyy"))
                            Dgv_Rekap.Rows(i).Cells(36).Value = If(General_Class.CekNULL(.Rows(i).Item("Jam_GI")) = "", "-", .Rows(i).Item("Jam_GI"))
...
#End Region
            ...
            SQL = SQL & "WasteGR2_Pcs, WasteGR2_Persen, Reject_GR2_PCS, Reject_GR2_KG, ScrapGR2_PCS, ScrapGR2_KG,NilaiGR2_Pcs, WaktuGR2, Tanggal_GI, Jam_GI, "
...
#End Region
            ...
            Dim stringCenter As New List(Of Integer) From {2, 3, 4, 5, 6, 26}
            ...
            Try
                ...
                Using Ds = BindingTrans(SQL)
                    With Ds.Tables("MyTable")
                        ...
                        Dim targetColorRange As excel.Range = dataRange.Columns(37) ' Kolom yang akan diwarnai
...
#End Region
            ...
            Dim stringCenter As New List(Of Integer) From {2, 3, 4, 5, 6, 9, 21, 30, 39}
                ...
                Using Ds = BindingTrans(SQL)
                    With Ds.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            ...
                            xlWorkSheet.Range(dataRange.Columns(25), dataRange.Columns(33)).Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.LightBlue)
                            xlWorkSheet.Range(dataRange.Columns(34), dataRange.Columns(42)).Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.LightGray)
                            dataRange.Columns(24).Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(252, 105, 108))
                            dataRange.Columns(33).Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(181, 230, 162))
                            dataRange.Columns(42).Interior.Color = System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.White)
