...
Public Class N_EMI_Transaksi_Retur_Packaging_Backup_Galih
...
#Region "JURNAL"
                    ...
                    SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_persediaan_dari, 1),
                          ...
                          KodePerusahaan, KodeProyek, "Persedian " & Txt_NoTransaksi, "0", Nilai_Packaging, pagenumber, arrGudang_Packaging(Cmb_Lokasi_Retur.SelectedIndex), Bahasa_Pilihan, Ket_Cost_Center_HO)
                    ExecuteTrans(SQL)
                    ...
                    SQL = Get_Detail_Jurnal(Kode_voucher, Strings.Left(akun_persediaan_tujuan, 1),
                         ...
                         KodePerusahaan, KodeProyek, "Persedian " & Txt_NoTransaksi, Nilai_Packaging, "0", pagenumber, arrGudang_Packaging(Cmb_Lokasi_Retur.SelectedIndex), Bahasa_Pilihan, Ket_Cost_Center_HO)
                    ExecuteTrans(SQL)
                    pagenumber = pagenumber + 1
