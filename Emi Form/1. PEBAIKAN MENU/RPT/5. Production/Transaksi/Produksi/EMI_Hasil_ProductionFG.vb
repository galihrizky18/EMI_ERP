...
Public Class EMI_Hasil_ProductionFG
    ...
    Private Sub get_no_fakturTF()
        ...
        Txt_NoFak_TF.Text = FPro_Results & arrInisialFaktur.Item(Cmb_LokasiSimpan.SelectedIndex) & "-" & Format(tgl_skg, "MM/yy") & "-" &
                                      ...
                                      "Kode_perusahaan", KodePerusahaan,
                                      "And", "substring(no_faktur,1," & Len(FPro_Results) + Len(arrInisialFaktur.Item(Cmb_LokasiSimpan.SelectedIndex)) + 6 & ")", FPro_Results & arrInisialFaktur.Item(Cmb_LokasiSimpan.SelectedIndex) & "-" & Format(tgl_skg, "MM/yy"))
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            SQL = SQL & "),0) as proses "
            SQL = SQL & "from Emi_Production_Results a where a.Kode_Perusahaan = '" & KodePerusahaan & "' and a.No_Production_Order = '" & TxtNoSplit.Text & "' order by proses desc "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
