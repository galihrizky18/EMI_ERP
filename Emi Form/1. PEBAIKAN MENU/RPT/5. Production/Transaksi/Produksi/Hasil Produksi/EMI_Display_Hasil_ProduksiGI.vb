Public Class EMI_Display_Hasil_ProduksiGI
    ...
    Private Sub isi_lv()
        Try
            ...
            SQL = SQL & "and a.Kode_Perusahaan = d.Kode_Perusahaan and a.Flag_Produksi = 'Y' and b.status is null and a.status is null and a.Flag_Hasil_Produksi_GI is null  "
    ...
    Private Sub ListView1_DoubleClick(sender As Object, e As EventArgs) Handles ListView1.DoubleClick
        ...
        EMI_Hasil_ProductionGI.TextBox4.Text = LvNo_Faktur

        EMI_Hasil_ProductionGI.ShowDialog()
