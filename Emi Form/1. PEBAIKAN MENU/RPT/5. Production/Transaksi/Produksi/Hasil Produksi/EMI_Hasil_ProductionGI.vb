Public Class EMI_Hasil_ProductionGI
    Dim CrDoc As Object
    ...
    Dim CellSelisih As Integer = 4
    Dim CellSelisihPersen As Integer = 5
    ...
    Private Sub Transaksi_Produksi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            SQL = SQL & ",0) as Nilai_Produksi, b.Nilai_Barang as nilai_formula, b.Satuan  "
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            Dgv_HslProduction.Rows.Item(i).Cells(CellNilai_Formula).Value = Format(.Rows(i).Item("nilai_formula"), "N4")
                            Dgv_HslProduction.Rows.Item(i).Cells(CellNilai_Produksi).Value = Format(.Rows(i).Item("Nilai_Produksi"), "N4")

                            Dim selisih As Double = (.Rows(i).Item("nilai_formula") - .Rows(i).Item("Nilai_Produksi"))

                            Dgv_HslProduction.Rows.Item(i).Cells(CellSelisih).Value = Format(selisih, "N4")
                            Dgv_HslProduction.Rows.Item(i).Cells(CellSelisihPersen).Value = Format((selisih / .Rows(i).Item("Nilai_Formula")) * 100, "N4") & " %"
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            SQL = SQL & "and a.No_Transaksi = '" & TextBox4.Text & "' and Flag_Hasil_Produksi_GI is null"
            Using dr = OpenTrans(SQL)
                If dr.Read Then
            ...
            SQL = "update Emi_Split_Production_Order set Flag_Hasil_Produksi_GI = 'Y',Tgl_Hasil_Produksi_GI = '" & Format(tgl_skg, "yyyy-MM-dd") & "',"
            SQL = SQL & "Jam_Hasil_Produksi_GI = '" & Format(tgl_skg, "HH:mm:ss") & "' where Kode_Perusahaan = '" & KodePerusahaan & "' "
        ...
        If Nanya = vbYes Then
            cetak()
            EMI_Display_Hasil_ProduksiGI.Button1_Click(Btn_Simpan, e)
            Me.Close()
        Else
            EMI_Display_Hasil_ProduksiGI.Button1_Click(Btn_Simpan, e)
            Me.Close()
