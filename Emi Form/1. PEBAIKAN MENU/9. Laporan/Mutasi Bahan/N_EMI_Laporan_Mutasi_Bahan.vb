...
Public Class N_EMI_Laporan_Mutasi_Bahan
        ...
        Try
            ...
            Try
                ...
                If Cmb_Jenis_Laporan.SelectedIndex = 0 Then
                    ...
                    SQL = SQL & "isnull((select round(sum(masuk-Keluar),2) from Data_CutOffTracking x "
                ...
                ElseIf Cmb_Jenis_Laporan.SelectedIndex = 1 Then
                    ...
                    SQL = SQL & "isnull((select round(sum(Masuk_Saldo-Keluar_Saldo),2) from Data_CutOffTracking x "
    ...
    Private Sub Btn_Cetak_Rekap_Click(sender As Object, e As EventArgs) Handles Btn_Cetak_Rekap.Click
        ...
        Try
            ...
            If Cmb_Jenis_Laporan.SelectedIndex = 0 Then
                ...
                SQL = "select * from N_EMI_View_Laporan_Mutasi_Bahan_Rekap "
                SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
                SQL = SQL & "and tanggal between '" & Format(Tgl1.Value, "yyyy-MM-dd") & "' and '" & Format(Tgl2.Value, "yyyy-MM-dd") & "' "
                SF = "{N_EMI_View_Laporan_Mutasi_Bahan_Rekap.kode_perusahaan} = '" & KodePerusahaan & "' "
                SF = SF & "AND CDate({N_EMI_View_Laporan_Mutasi_Bahan_Rekap.tanggal}) >= Date(" & Year(Tgl1.Value) & "," & Month(Tgl1.Value) & "," & DateAndTime.Day(Tgl1.Value) & ") "
                SF = SF & "AND CDate({N_EMI_View_Laporan_Mutasi_Bahan_Rekap.tanggal}) <= Date(" & Year(Tgl2.Value) & "," & Month(Tgl2.Value) & "," & DateAndTime.Day(Tgl2.Value) & ")"



                If Cmb_Lokasi.SelectedIndex > 0 Then
                    SQL = SQL & "and lokasi = '" & Cmb_Lokasi.Text & "' "
                    SF = SF & "And {N_EMI_View_Laporan_Mutasi_Bahan_Rekap.lokasi} = '" & Cmb_Lokasi.Text & "' "
                End If

                If Not Txt_KdBarang.Text.ToUpper = OpsiSeluruh.ToUpper Then
                    SQL = SQL & "and kode_barang = '" & Txt_KdBarang.Text & "' "
                    SF = SF & "And {N_EMI_View_Laporan_Mutasi_Bahan_Rekap.kode_barang} = '" & Txt_KdBarang.Text & "' "
                End If

                If Cmb_Barcode.SelectedIndex > 0 Then
                    If Not Txt_Barcode.Text.Trim.Length = 0 Then
                        SQL = SQL & "and QR = '" & Txt_Barcode.Text & "' "
                        SF = SF & "And {N_EMI_View_Laporan_Mutasi_Bahan_Rekap.QR} = '" & Txt_Barcode.Text & "' "
                    Else
                        CloseConn()
                        MessageBox.Show("Barcode Tidak Boleh Kosong")
                        Txt_Barcode.Focus() : Exit Sub
                ...
                Using DS = BindingTrans(SQL)
                    With DS.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            ...
                            Dim CrDoc As New N_EMI_CR_Laporan_Mutasi_Bahan_Rekap
            ...
            ElseIf Cmb_Jenis_Laporan.SelectedIndex = 1 Then
                SQL = "select * from N_EMI_View_Laporan_Mutasi_Bahan_Rekap_Saldo "
                SQL = SQL & "where kode_perusahaan = '" & KodePerusahaan & "' "
                SQL = SQL & "and tanggal between '" & Format(Tgl1.Value, "yyyy-MM-dd") & "' and '" & Format(Tgl2.Value, "yyyy-MM-dd") & "' "
                SF = "{N_EMI_View_Laporan_Mutasi_Bahan_Rekap_Saldo.kode_perusahaan} = '" & KodePerusahaan & "' "
                SF = SF & "AND CDate({N_EMI_View_Laporan_Mutasi_Bahan_Rekap_Saldo.tanggal}) >= Date(" & Year(Tgl1.Value) & "," & Month(Tgl1.Value) & "," & DateAndTime.Day(Tgl1.Value) & ") "
                SF = SF & "AND CDate({N_EMI_View_Laporan_Mutasi_Bahan_Rekap_Saldo.tanggal}) <= Date(" & Year(Tgl2.Value) & "," & Month(Tgl2.Value) & "," & DateAndTime.Day(Tgl2.Value) & ")"



                If Cmb_Lokasi.SelectedIndex > 0 Then
                    SQL = SQL & "and lokasi = '" & Cmb_Lokasi.Text & "' "
                    SF = SF & "And {N_EMI_View_Laporan_Mutasi_Bahan_Rekap_Saldo.lokasi} = '" & Cmb_Lokasi.Text & "' "
                End If

                If Not Txt_KdBarang.Text.ToUpper = OpsiSeluruh.ToUpper Then
                    SQL = SQL & "and kode_barang = '" & Txt_KdBarang.Text & "' "
                    SF = SF & "And {N_EMI_View_Laporan_Mutasi_Bahan_Rekap_Saldo.kode_barang} = '" & Txt_KdBarang.Text & "' "
                End If

                If Cmb_Barcode.SelectedIndex > 0 Then
                    If Not Txt_Barcode.Text.Trim.Length = 0 Then
                        SQL = SQL & "and QR = '" & Txt_Barcode.Text & "' "
                        SF = SF & "And {N_EMI_View_Laporan_Mutasi_Bahan_Rekap_Saldo.QR} = '" & Txt_Barcode.Text & "' "
                    Else
                        CloseConn()
                        MessageBox.Show("Barcode Tidak Boleh Kosong")
                        Txt_Barcode.Focus() : Exit Sub
                ...
                Using DS = BindingTrans(SQL)
                    With DS.Tables("MyTable")
                        If .Rows.Count <> 0 Then
                            ...
                            Dim CrDoc As New N_EMI_CR_Laporan_Mutasi_Bahan_Rekap_Saldo
