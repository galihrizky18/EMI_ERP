Public Class Emi_Laporan_Split_Stock

    Dim arrSO, arrParamLain, arrParamLainSF As New ArrayList
    Dim JudulForm As String = "Laporan Split Stock"
    ...
    Private Sub Kosong()
        ...
        Try
            ...
            Cmb_SOAwal.Items.Add(OpsiSeluruh) : Cmb_SOTujuan.Items.Add(OpsiSeluruh) : arrSO.Add(OpsiSeluruh)
            ...
            Cmb_GroupJenis.Items.Add(OpsiSeluruh)
        ...
        Cmb_JenisTransfer.Items.Add(OpsiSeluruh)
