Public Class N_EMI_Laporan_Pelunasan_Cut_Off
    ...
    Private Sub Txt_Faktur_TextChanged(sender As Object, e As EventArgs) Handles Txt_Faktur.TextChanged
        ...
        Try
            ...
            Lv.SubItems.Add("--- SELURUH ---")
            Lv.SubItems.Add("--- SELURUH ---")
            SQL = "select No_Faktur, Tanggal, Jam, UserID from emi_pembelian where Kode_Perusahaan = '" & KodePerusahaan & "' and Status is null and No_Faktur like '%" & Txt_Faktur.Text & "%' "
    ...
    Private Sub Txt_Faktur_Leave(sender As Object, e As EventArgs) Handles Txt_Faktur.Leave
        ...
        Try
            ...
            If Not Txt_Faktur.Text = "--- SELURUH ---" Then
                ...
                SQL = "select No_Faktur, Tanggal, Jam, UserID from emi_pembelian where Kode_Perusahaan = '" & KodePerusahaan & "' and Status is null and No_Faktur = '" & Txt_Faktur.Text & "' "
                Using Dr = Open(SQL)
                    If Dr.Read Then
    ...
    Private Sub Txt_PO_TextChanged(sender As Object, e As EventArgs) Handles Txt_PO.TextChanged
        ...
        Try
            ...
            Lv.SubItems.Add("--- SELURUH ---")
            Lv.SubItems.Add("--- SELURUH ---")
            SQL = "select No_Faktur, No_Nota, Tanggal, Jam from emi_pembelian_PO where Kode_Perusahaan = '" & KodePerusahaan & "' and status is null and No_Faktur like '%" & Txt_PO.Text & "%' "
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
    ...
    Private Sub Txt_Ket_PO_TextChanged(sender As Object, e As EventArgs) Handles Txt_Ket_PO.TextChanged
        ...
        Try
            ...
            Lv.SubItems.Add("--- SELURUH ---")
            Lv.SubItems.Add("--- SELURUH ---")
            SQL = "select No_Faktur, No_Nota, Tanggal, Jam from emi_pembelian_PO where Kode_Perusahaan = '" & KodePerusahaan & "' and status is null and No_Nota like '%" & Txt_Ket_PO.Text & "%' "
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    Lv = Lv_PO.Items.Add(Dr("No_Faktur"))
                    Lv.SubItems.Add(Dr("No_Nota"))
    ...
    Private Sub Txt_PO_Leave(sender As Object, e As EventArgs) Handles Txt_PO.Leave
        ...
        Try
            ...
            If Not Txt_PO.Text = "--- SELURUH ---" Then
                ...
                SQL = "select No_Faktur, No_Nota, Tanggal, Jam from emi_pembelian_PO where Kode_Perusahaan = '" & KodePerusahaan & "' and status is null and No_Faktur = '" & Txt_PO.Text & "' "
                Using Dr = Open(SQL)
                    If Dr.Read Then
    ...
    Private Sub Txt_Kd_Kategori_TextChanged(sender As Object, e As EventArgs) Handles Txt_Kd_Kategori.TextChanged
        ...
        Try
            ...
            SQL = SQL & "union all "
            SQL = SQL & "select kode as Kode_Master_Kategori_Biaya_Import, kode as Keterangan from Pelunasan_Pembelian where Kode_Perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "union all "
            SQL = SQL & "select top(1) z.Kode_Group_Jenis as Kode_Master_Kategori_Biaya_Import, z.Kode_Group_Jenis as Keterangan "
            SQL = SQL & "from emi_pembelian_detail x, barang y, emi_group_jenis z "
