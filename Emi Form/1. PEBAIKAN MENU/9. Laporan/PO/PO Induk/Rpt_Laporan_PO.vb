...
Public Class Rpt_Laporan_PO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_EMI.Rpt_Laporan_PO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Laporan_PO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Laporan_PO = New Rpt_Laporan_PO()
        rpt.Site = Me.Site
        Return rpt
    End Function
