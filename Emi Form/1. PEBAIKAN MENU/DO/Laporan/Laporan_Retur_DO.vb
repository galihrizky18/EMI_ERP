...
Public Class Laporan_Retur_DO
    Dim arrKd As New ArrayList
    Dim CrDoc As Object

    Private Sub Laporan_Retur_Proforma_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Using Ds = BindingTrans(SQL)
                If Ds.Tables("MyTable").Rows.Count <> 0 Then
                    If bolehliathpp = "Y" Then
                        CrDoc = New Rpt_Laporan_Retur_DO
                    ElseIf bolehliathpp = "T" Then
                        CrDoc = New Rpt_Laporan_Retur_DO_Tdk_Hpp
                    End If
