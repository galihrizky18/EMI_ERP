Public Class Retur_DO_Reseller_Marketing
    ...
    Private Sub ListView3_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView3.DoubleClick
        ...
        Txt_Barcode.Text = ListView3.FocusedItem.Text
        ...
        Try
            ...
            SQL = "select sum(Max_Retur) as Total_Max_Retur from ("
            SQL = SQL & "select isnull(( d.Jumlah - isnull(( "
            ...
            SQL = SQL & "and a.no_do = '" & TextBox1.Text & "' "
            SQL = SQL & "and a.Kode_barang = '" & TextBox8.Text & "' "
            SQL = SQL & ") as T"

            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    TextBox10.Text = Dr("Total_Max_Retur")
                End If
            End Using
    ...
    Private Sub TextBox11_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox11.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            Else
                ...
                lv = ListView2.Items.Add(Txt_Barcode.Text) '0
