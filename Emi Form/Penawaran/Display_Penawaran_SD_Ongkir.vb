...
Public Class Display_Penawaran_SD_Ongkir
    ...
    Private Sub tampil_pengiriman()
        Try
            ...
            SQL = SQL & "from Stock_Owner_Gudang a, Emi_Customer_Gudang b, EMI_Media_Kirim c where  b.Kode_Perusahaan = c.Kode_Perusahaan "
                ...
                With ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            SQL = "select * from EMI_Master_Ongkir  where kode_perusahaan = '" & KodePerusahaan & "'  "
    ...
    Private Sub DataGridView4_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView4.DoubleClick
        ...
        For index = 0 To Transaksi_Penawaran.arrIdProvAsal.Count - 1
            If Transaksi_Penawaran.arrIdProvAsal.Item(index) = DataGridView4.CurrentRow.Cells(12).Value Then
                Transaksi_Penawaran.Cmb_ProvAsal.SelectedIndex = index
            End If
        Next
        Transaksi_Penawaran.Get_KabupatenKota_Asal()
        For index = 0 To Transaksi_Penawaran.arrIdKabKotaAsal.Count - 1
            If Transaksi_Penawaran.arrIdKabKotaAsal.Item(index) = DataGridView4.CurrentRow.Cells(14).Value Then
                Transaksi_Penawaran.Cmb_KabKotaAwal.SelectedIndex = index
            End If
        Next
        Transaksi_Penawaran.Get_Kecamatan_Asal()
        For index = 0 To Transaksi_Penawaran.arrIdKecAsal.Count - 1
            If Transaksi_Penawaran.arrIdKecAsal.Item(index) = DataGridView4.CurrentRow.Cells(16).Value Then
                Transaksi_Penawaran.Cmb_KecAsal.SelectedIndex = index
            End If
        Next
        Transaksi_Penawaran.Get_Kelurahan_Asal()
        For index = 0 To Transaksi_Penawaran.arrIdKelAsal.Count - 1
            If Transaksi_Penawaran.arrIdKelAsal.Item(index) = DataGridView4.CurrentRow.Cells(18).Value Then
                Transaksi_Penawaran.Cmb_KelAsal.SelectedIndex = index
            End If
        Next
        '--------------------------------------------------------------
        For index = 0 To Transaksi_Penawaran.arrIdProvTujuan.Count - 1
            If Transaksi_Penawaran.arrIdProvTujuan.Item(index) = DataGridView4.CurrentRow.Cells(13).Value Then
                Transaksi_Penawaran.Cmb_ProvTujuan.SelectedIndex = index
            End If
        Next
        Transaksi_Penawaran.Get_KabupatenKota_Tujuan()
        For index = 0 To Transaksi_Penawaran.arrIdKabKotaTujuan.Count - 1
            If Transaksi_Penawaran.arrIdKabKotaTujuan.Item(index) = DataGridView4.CurrentRow.Cells(15).Value Then
                Transaksi_Penawaran.Cmb_KabKotaTujuan.SelectedIndex = index
            End If
        Next
        Transaksi_Penawaran.Get_Kecamatan_Tujuan()
        For index = 0 To Transaksi_Penawaran.arrIdKecTujuan.Count - 1
            If Transaksi_Penawaran.arrIdKecTujuan.Item(index) = DataGridView4.CurrentRow.Cells(17).Value Then
                Transaksi_Penawaran.Cmb_KecTujuan.SelectedIndex = index
            End If
        Next
        Transaksi_Penawaran.Get_Kelurahan_Tujuan()
        For index = 0 To Transaksi_Penawaran.arrIdKelTujuan.Count - 1
            If Transaksi_Penawaran.arrIdKelTujuan.Item(index) = DataGridView4.CurrentRow.Cells(19).Value Then
                Transaksi_Penawaran.Cmb_KelTujuan.SelectedIndex = index
            End If
        Next

        For index = 0 To Transaksi_Penawaran.arrCaraKirim.Count - 1
            If Transaksi_Penawaran.arrCaraKirim.Item(index) = DataGridView4.CurrentRow.Cells(20).Value Then
                Transaksi_Penawaran.Cmb_CaraKirim.SelectedIndex = index
            End If
        Next
        Transaksi_Penawaran.Get_Media_Kirim()
        For index = 0 To Transaksi_Penawaran.arrMediaKirim.Count - 1
            If Transaksi_Penawaran.arrMediaKirim.Item(index) = DataGridView4.CurrentRow.Cells(21).Value Then
                Transaksi_Penawaran.Cmb_MediaKirim.SelectedIndex = index
            End If
        Next
        Me.Close()
