...
Public Class Master_Penawaran_SD_Barang
    ...
    Private Sub Btn_Simpan_Click_1(sender As Object, e As EventArgs) Handles BtnPilihBarang_Simpan.Click
        ...
        If asal = "Master_Penawaran" Then
            ...
            Dim rows As Integer = Transaksi_Penawaran.DgvMaster_Penawaran.Rows.Count - 1
            Transaksi_Penawaran.DgvMaster_Penawaran.Rows.Add(1)
            'Transaksi_Penawaran.DgvMaster_Penawaran.Rows(rows).Cells(Transaksi_Penawaran.cellCheckbox).Value = True
            ...
            Transaksi_Penawaran.DgvMaster_Penawaran.Rows(rows).Cells(Transaksi_Penawaran.cellSisaHari).Value = "-"
            Transaksi_Penawaran.DgvMaster_Penawaran.Rows(rows).Cells(Transaksi_Penawaran.cellPPN).Value = Txt_PPN.Text
            ...
            Transaksi_Penawaran.DgvMaster_Penawaran.Rows(rows).Cells(Transaksi_Penawaran.cellHrgSatuan).Value = 0
