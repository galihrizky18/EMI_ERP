...
#End Region
    ...
    Private Sub TextBox2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox2.TextChanged
        ...
        Try
            ...
            SQL = "Select kode_stock_owner,kode_barang,nama,good_stock From barang "
            SQL = SQL & " where kode_perusahaan = '" & KodePerusahaan & "' and kode_stock_owner = '" & Cmb_Lokasi.Text & "' and "
            SQL = SQL & "(kode_barang like '" & TextBox2.Text & "%' or nama like '" & TextBox2.Text & "%') "
            SQL = SQL & "and Flag_Potong_Stok = 'T' "
