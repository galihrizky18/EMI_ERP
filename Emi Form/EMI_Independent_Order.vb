...
Public Class EMI_Independent_Order
    Private Sub EMI_Independent_Order_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    '            LvPilihBarang_DataBarang.Columns.Add(Base_Language.Lang_Global_KodeBarang, 100, HorizontalAlignment.Left)
    '            LvPilihBarang_DataBarang.Columns.Add(Base_Language.Lang_Global_Nama, 250, HorizontalAlignment.Left)
    '            LvPilihBarang_DataBarang.Columns.Add(Base_Language.Lang_Global_Satuan, 150, HorizontalAlignment.Left)
    ...
    '        LvPilihBarang_DataBarang.Location = New Point(174, 145)
    ...
    '                    SQL = SQL & "emi_varian d,emi_jenis_produk e "
    ...
    '                    SQL = SQL & "and a.kode_perusahaan = c.kode_perusahaan and a.id_varian = d.id_varian "
    '                    SQL = SQL & "and d.kode_perusahaan = e.kode_perusahaan and d.id_jenis_produk = e.id_jenis_produk "

    '                    SQL = SQL & " and (b.Flag_Finished_Good='Y' or b.Flag_Tampil_Inquiry='Y') "

    '                    If CmbJenisProduk.Text.Trim.Length <> 0 Then
    '                        SQL = SQL & "and e.id_jenis_produk = '" & arrJenis.Item(CmbJenisProduk.SelectedIndex) & "' "
    '                    End If
    ...
    '                SQL = SQL & "'" & ListView1.Items(i).SubItems(5).Text & "', '" & ListView1.Items(i).SubItems(4).Text & "'," & jenis_produk & ") "
    '                ExecuteTrans(SQL)
    ...
    '        End If
    '        Dim lvw As ListViewItem
    '        lvw = ListView1.Items.Add(data)
    '        lvw.SubItems.Add(CmbJenisProduk.Text)
    '        lvw.SubItems.Add(TxtPilihBarang_KodeBarang.Text)
    '        lvw.SubItems.Add(TxtPilihBarang_NamaBarang.Text)
    '        lvw.SubItems.Add(TxtPilihBarang_Satuan.Text)
    '        lvw.SubItems.Add(TextBox1.Text)

    '        TxtPilihBarang_KodeBarang.Text = ""
    '        CmbJenisProduk.SelectedIndex = -1
    '        TxtPilihBarang_NamaBarang.Text = ""
    '        TxtPilihBarang_Satuan.Text = ""
    '        txtLokasi_Gudang.Text = ""
    '        TextBox1.Text = ""
    ...
    '    Private Sub ComboBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles CmbJenisProduk.KeyPress
    '        TxtPilihBarang_KodeBarang.Focus()
    '    End Sub

    '    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CmbJenisProduk.SelectedIndexChanged
    '        If CmbJenisProduk.SelectedIndex = -1 Then Exit Sub
    ...
    '    Private Sub TxtPilihBarang_KodeBarang_QueryAccessibilityHelp(sender As Object, e As QueryAccessibilityHelpEventArgs) Handles TxtPilihBarang_KodeBarang.QueryAccessibilityHelp
