...
Public Class Emi_Request_Material
    ...
    Private Sub kosong()
        ...
        Try
            ...
            SQL = SQL & "(a.Jumlah - ISNULL((select sum(z.jumlah) from Emi_Material_Requisition_det z where a.Kode_Perusahaan = z.Kode_Perusahaan and a.Kode_Stock_Owner =z.Kode_Stock_Owner and a.Kode_Barang = z.Kode_Barang), 0)) as Sisa "
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            For i As Integer = 0 To Dgv_Data.RowCount - 1
                ...
                SQL = SQL & "('" & KodePerusahaan & "', '" & Txt_NoFaktur_ReqMaterial.Text & "', '" & Dgv_KdSo & "', '" & Dgv_KdBarang & "', '" & Dgv_JmlhOrder & "',  "
