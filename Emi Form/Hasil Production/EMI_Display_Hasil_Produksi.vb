...
Public Class EMI_Display_Hasil_Produksi
    ...
    Private Sub kosong3()
        ...
        Try
            ...
            ListView1.Columns.Add("Qty Good Stock", 150, HorizontalAlignment.Right)
            ListView1.Columns.Add("Qty Bad Stock", 150, HorizontalAlignment.Right)
    ...
    Private Sub ListView1_DoubleClick(sender As Object, e As EventArgs) Handles ListView1.DoubleClick
        ...
        EMI_Hasil_Production.DateTimePicker1.Value = CDate(LvTgl_Produksi)
        EMI_Hasil_Production.TextBox1.Text = LvJam_Produksi
        'Dim a As Double = Val(HilangkanTanda(LvJumlah)) - Val(HilangkanTanda(LvJumlah_Pro))
        EMI_Hasil_Production.TextBox2.Text = LvJumlah
        EMI_Hasil_Production.TextBox6.Text = LvNm_Barang
        EMI_Hasil_Production.fno_po = LvNo_PO
        EMI_Hasil_Production.TextBox5.Text = ""
        EMI_Hasil_Production.TextBox7.Text = ""
        EMI_Hasil_Production.TextBox8.Text = ""
