...
Public Class EMI_Hasil_ProductionFG
    ...
    Private Sub Get_data()
        Try
            ...
            SQL = "select isnull(sum(Jumlah),0) as Jumlah from Emi_Produksi_Hasil_Perpallet a "
            SQL = SQL & "where kode_barang='" & TxtKodeBarang.Text & "' and a.kode_perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and a.no_split = '" & TxtNoSplit.Text & "' and flag_simpan_pallet is null and jenis='good_stock' "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    goodstock = Dr("jumlah")
            ...
            SQL = "select isnull(sum(Jumlah),0) as Jumlah from Emi_Produksi_Hasil_Perpallet a "
            SQL = SQL & "where kode_barang='" & TxtKodeBarang.Text & "' and a.kode_perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and a.no_split = '" & TxtNoSplit.Text & "' and flag_simpan_pallet is null and jenis='Warning_Stock' "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
            ...
            SQL = "select isnull(sum(Jumlah),0) as Jumlah from Emi_Produksi_Hasil_Perpallet a "
            SQL = SQL & "where kode_barang='" & TxtKodeBarang.Text & "' and a.kode_perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and a.no_split = '" & TxtNoSplit.Text & "' and flag_simpan_pallet is null and jenis='Bad_Stock' "
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    badstock = Dr("jumlah")
...
#Region "INSERT PRODUKSI"
            ...
            SQL = "select a.No_Split, a.Kode_Unik_Berjalan, a.Kode_Unik_Asal, a.Qr_Code, a.Jumlah, a.Satuan, a.Batch_Number, a.Kode_Barang, a.ID as urut_oto, a.jenis, a.Serial_Number "
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            SQL = SQL & "Satuan_Barang, Batch_Number, Id_Warehouse, Nomor_Pallet, proses, serial_number, Jenis) values "
                            ...
                            SQL = SQL & "'" & .Rows(i).Item("Batch_Number") & "', '" & available_Id_Warehouse & "', '" & available_NoPallet & "', '" & proses & "', '" & SN & "', '" & .Rows(i).Item("Jenis") & "') "
                            ExecuteTrans(SQL)
...
#End Region
            ...
            '==============================================================
            SQL = "select a.No_Transaksi, a.Proses, a.Jumlah, a.NIlai_Barang, a.Satuan, a.Satuan_Barang, a.Id_Warehouse, a.Serial_Number, a.Jenis, a.Nomor_Pallet, a.Proses "
                ...
                With Ds.Tables("MyTable")
                    If .Rows.Count <> 0 Then
                        For i As Integer = 0 To .Rows.Count - 1
                            ...
                            SQL = SQL & "where a.Id_WMS_Warehouse_Position=b.Id_WMS_Warehouse_Position "
                            SQL = SQL & " And a.kode_Perusahaan = b.kode_Perusahaan And a.kode_Perusahaan ='" & KodePerusahaan & "' "
                            SQL = SQL & "and a.Kode_Stock_Owner='RAW MATERIAL' and b.Kode_Barang is null"
                            Using Dr2 = OpenTrans(SQL)
                                Do While Dr2.Read
