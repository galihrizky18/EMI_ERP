Public Class Display_Tracking_Kendaraan
    ...
    Private Sub Tracking_Kamar_Timbang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Lv_DetBahan.Columns.Add("Lokasi", 130, HorizontalAlignment.Left)
...
#End Region
            ...
            SQL = ";With cte as ( "
            SQL = SQL & "Select a.No_Faktur, a.Lokasi, c.Nama as Supplier, a.No_SJ, a.No_Plat, a.Driver, a.Tanggal as tanggal_sampai,  a.Jam, a.Tanggal_OTW, a.ETA,  "

            'Barang Dalam Perjalanan
            SQL = SQL & "isnull((select top(1) 'Y' from EMI_Pembelian_Loading x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Faktur and a.Flag_Security is null and a.Flag_QC_Pertama is null  and a.Flag_Timbang is null and a.Flag_Proses_Loading is null and a.Flag_Timbang_Keluar is null ),'-') as Barang_Dalam_Perjalanan, "

            'Security
            SQL = SQL & "isnull((select top(1) 'Y' from EMI_Pembelian_Loading x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Faktur and a.Flag_Security = 'Y' and a.Flag_QC_Pertama is null  and a.Flag_Timbang is null and a.Flag_Proses_Loading is null and a.Flag_Timbang_Keluar is null ),'-') as Flag_Security, "

            'Flag Qc 1
            SQL = SQL & "isnull((select top(1) 'Y' from EMI_Pembelian_Loading x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Faktur and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y' and a.Flag_QC is null and a.Flag_Timbang is null and a.Flag_Proses_Loading is null and a.Flag_Timbang_Keluar is null),'-') as Flag_QC, "

            'Keterangan QC 1
            SQL = SQL & "isnull((select top(1) x.Hasil from EMI_Hasil_Quality_Control  x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Fak_Loading_Barang and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y' and a.Flag_QC is null and a.Flag_Timbang is null and a.Flag_Proses_Loading is null and a.Flag_Timbang_Keluar is null order by x.Step desc),'-') as Keterangan_QC, "

            'TImbang Masuk
            SQL = SQL & "isnull((select top(1) 'Y' from EMI_Pembelian_Loading x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Faktur and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y'  and a.Flag_Timbang ='Y' and a.Flag_Proses_Loading = 'Y' and a.Flag_QC is null and a.Flag_Timbang_Keluar is null),'-') as Masuk, "

            'Flag QC 2
            SQL = SQL & "isnull((select top(1) 'Y' from EMI_Pembelian_Loading x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Faktur and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y' and a.Flag_QC = 'Y' and a.Flag_Timbang = 'Y' and a.Flag_Proses_Loading = 'Y' and a.Flag_Timbang_Keluar is null),'-') as Flag_QC_2, "

            'Keterangan QC 2
            SQL = SQL & "isnull((select top(1) x.Hasil from EMI_Hasil_Quality_Control  x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Fak_Loading_Barang and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y' and a.Flag_QC = 'Y' and a.Flag_Timbang ='Y' and a.Flag_Proses_Loading ='Y' and a.Flag_Timbang_Keluar is null order by x.Step desc),'-') as Keterangan_QC_2, "

            'Jenis QC
            SQL = SQL & "isnull(( ISNULL(( select top(1) cast( x.jenis_qc as varchar(10)) from EMI_Hasil_Quality_Control  x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Fak_Loading_Barang and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y'  and a.Flag_Timbang is null and a.Flag_Proses_Loading is null and a.Flag_Timbang_Keluar is null order by x.Step desc ), "
            SQL = SQL & "(select top(1) cast( x.jenis_qc as varchar(10)) from EMI_Hasil_Quality_Control  x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Fak_Loading_Barang and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y'  and a.Flag_Timbang = 'Y' and a.Flag_Proses_Loading = 'Y' and a.Flag_QC = 'Y' and a.Flag_Timbang_Keluar is null order by x.Step desc) )),'-') as jenis_qc, "

            'Step QC
            SQL = SQL & "isnull(( ISNULL(( select top(1) cast( x.Step as varchar(10)) from EMI_Hasil_Quality_Control  x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Fak_Loading_Barang and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y'  and a.Flag_Timbang is null and a.Flag_Proses_Loading is null and a.Flag_Timbang_Keluar is null order by x.Step desc),( "
            SQL = SQL & "select top(1) cast( x.Step as varchar(10)) from EMI_Hasil_Quality_Control  x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Fak_Loading_Barang and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y'  and a.Flag_Timbang = 'Y' and a.Flag_Proses_Loading ='Y' and a.Flag_QC = 'Y' and a.Flag_Timbang_Keluar is null order by x.Step desc )) ),'-') as Step_QC, "

            'Bongkar
            SQL = SQL & "isnull((select top(1) 'Y' from EMI_Pembelian_Loading x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Faktur and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y'  and a.Flag_Timbang ='Y' and a.Flag_Proses_Loading is null and a.Flag_Timbang_Keluar is null),'-') as Bongkar, "

            'Keluar
            SQL = SQL & "isnull((select top(1) 'Y' from EMI_Pembelian_Loading x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Faktur and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y'  and a.Flag_Timbang ='Y' and a.Flag_Proses_Loading = 'Y' and a.Flag_QC = 'Y' and a.Flag_Timbang_Keluar = 'Y' and "
            SQL = SQL & "isnull((select 'T' from EMI_Barang_Masuk_Perpallet y where x.kode_perusahaan=y.kode_perusahaan and x.No_Faktur=y.No_Pembelian_Loading and y.selesai is null ),'Y')='T' "
            SQL = SQL & "),'-') as Keluar, "

            'Selesai
            SQL = SQL & "isnull((select top(1) 'Y' from EMI_Pembelian_Loading x where a.Kode_Perusahaan = x.Kode_Perusahaan and a.No_Faktur = x.No_Faktur and a.Flag_Security = 'Y' and a.Flag_QC_Pertama = 'Y'  and a.Flag_Timbang ='Y' and a.Flag_Proses_Loading = 'Y' and a.Flag_QC = 'Y' and a.Flag_Timbang_Keluar = 'Y' and "
            SQL = SQL & "isnull((select 'T' from EMI_Barang_Masuk_Perpallet y where x.kode_perusahaan=y.kode_perusahaan and x.No_Faktur=y.No_Pembelian_Loading and y.selesai is null ),'Y') = 'Y' "
            SQL = SQL & "),'-') as Selesai "

            SQL = SQL & "From EMI_Pembelian_Loading a, Suppliers c "
            SQL = SQL & "where a.Kode_Perusahaan=c.Kode_Perusahaan "
            SQL = SQL & "and a.Kode_Supplier=c.Kode_Supplier  "
            SQL = SQL & ") select * from cte ORDER BY ETA DESC "
            ...
            Using Dr = OpenTrans(SQL)
                ...
                Do While Dr.Read
                    ...
                    ElseIf Dr("Masuk") = "Y" Then
                        Dgv_Tracking.Rows(idx).Cells(cellStatus).Value = "Timbang Masuk " & Environment.NewLine &
                           "Tanggal : " & Format(Dr("tanggal_sampai"), "dd MMMM yyyy") & " " &
                           "Jam : " & Dr("Jam")
                        Dgv_Tracking.Rows(idx).Cells(cellStatus).Style.BackColor = Color.LightYellow

                    ElseIf Dr("Flag_QC_2") = "Y" Then
                        Dgv_Tracking.Rows(idx).Cells(cellStatus).Value = "Quality Control Assisment " & Dr("jenis_qc") & " (" & Dr("step_qc") & ")" & Environment.NewLine &
                        "Catatan : " & Dr("Keterangan_QC_2") & Environment.NewLine &
                           "Tanggal : " & Format(Dr("tanggal_sampai"), "dd MMMM yyyy") & " " &
                           "Jam : " & Dr("Jam")
                        Dgv_Tracking.Rows(idx).Cells(cellStatus).Style.BackColor = Color.LightYellow
