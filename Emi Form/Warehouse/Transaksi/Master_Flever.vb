...
Public Class Master_Flever
    ...
    Private Sub Lv_DetailBarang_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_DetailBarang.SelectedIndexChanged
    ...
    Private Sub Txt_KdBarangAkhir_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Txt_KdBarangAkhir.KeyPress
        If e.KeyChar = Chr(13) Then Txt_JmlhMaterialAwal.Focus() : Exit Sub
    End Sub
