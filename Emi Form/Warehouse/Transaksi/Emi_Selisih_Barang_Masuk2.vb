...
Public Class Emi_Selisih_Barang_Masuk2
    ...
    Dim Dgv_Selisih_Rp, Dgv_Selisih_Fix, Dgv_HargaPerPcs, Dgv_TglProduksi, Dgv_TglExpired, Dgv_SN, Dgv_JmlhPlHitung, Dgv_JmlhBMHitung, Dgv_HargaHitung, Dgv_Urut As String
    ...
    Private Sub BtnSelisihBrgMsk_Simpan_Click(sender As Object, e As EventArgs) Handles BtnSelisihBrgMsk_Simpan.Click
        ...
        Try
            ...
            For i As Integer = 0 To Dgv_DetailBarang.Rows.Count - 1
                ...
                SQL = "insert into EMI_Pembelian_Selisih_Barang_Masuk_Det(Kode_Perusahaan, No_Faktur, Kode_Stock_Owner, Kode_Barang, Jumlah_PL, Jumlah_BM, Selisih, Qty_PenyelesaianPlus, Qty_PenyelesaianMin, Keterangan, Selisih_Fix, Harga, Selisih_Rp, No_Faktur_Barang_Masuk, Serial_Number, Tgl_Produksi, Tgl_Expired, Satuan, Urut_Loading)values("
                ...
                SQL = SQL & " " & Dgv_Jmlhselisih & ", " & Dgv_JmlhPenyPlus & ", " & Dgv_JmlhPenyMin & ",'" & Dgv_Keterangan & "', '" & Dgv_JmlhselisihFix & "', " & HilangkanTanda(Dgv_HargaHitung) & ", " & HilangkanTanda(Dgv_Selisih_Rp) & ", "
                SQL = SQL & "'" & Txt_FakturPO.Text & "', " & sn & ", " & TglProduksi & ", " & TglExpired & ", '" & satuan_Kecil & "','" & Dgv_Urut & "')"
                ExecuteTrans(SQL)
