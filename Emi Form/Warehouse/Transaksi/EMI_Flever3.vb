...
Public Class EMI_Flever3
    ...
    Dim arrSO, arrInisialFaktur, arrIdWMSWarehouse, WarehosePosition, arrJmlBrngAwal, arrJmlBrgAkhir, arrKdBrg, arrKSO As New ArrayList
    ...
    Dim dgv_JumlahAwal, dgvJumlahAkhir, dgvKdBarang As String
    ...
    Private Sub DGV_Data_TF_CellMouseLeave(sender As Object, e As DataGridViewCellEventArgs) Handles DGV_Data_TF.CellMouseLeave
        ...
        Try
            ...
            For row As Integer = 0 To DGV_Data_TF.RowCount - 1
                ...
                If dgv_CheckBox = True Then
                    ...
                    SQL = "select kode_stock_owner, kode_barang, serial_number,tgl_expired,tgl_produksi, jumlah_bags,jumlah, Id_Warehouse,id_Susunan,Batch_Number,Kode_Unik_Berjalan,Nomor_Pallet from barang_sn where "
                    SQL = SQL & "kode_perusahaan = '" & KodePerusahaan & "' and "
                            ...
                            If .Rows.Count <> 0 Then
                                ...
                                For h As Integer = 0 To .Rows.Count - 1
                                    ...
                                    If jumlahSatuanKecilBrg <> .Rows(h).Item("jumlah") Then
                                        MessageBox.Show(.Rows(h).Item("jumlah"))
                                        CloseTrans()
                                        CloseConn()
