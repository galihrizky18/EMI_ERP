Public Class Transaksi_Biaya_Lokal_Sample
    ...
    Private Sub Get_No_Faktur()
        TxtNo_Faktur.Text = TBiaya_Import & Format(DtTanggal.Value, "MMyy") & "-" &
                             General_Class.Get_Last_Number2("Transaksi_Biaya_Import", "no_Faktur", 5,
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        For index As Integer = 0 To DataGridView1.Rows.Count - 1
            ...
            If DataGridView1.Rows.Item(index).Cells(1).Value = ListView1.FocusedItem.Text And
                ...
                DataGridView1.Rows.Item(index).Cells(5).Value = ListView1.FocusedItem.SubItems(5).Text And
        ...
        Try
            ...
            DataGridView1.Rows.Item(index).Cells(1).Value = ListView1.FocusedItem.Text 'po
            DataGridView1.Rows.Item(index).Cells(2).Value = ListView1.FocusedItem.SubItems(2).Text '1
            DataGridView1.Rows.Item(index).Cells(3).Value = ListView1.FocusedItem.SubItems(3).Text '2
            DataGridView1.Rows.Item(index).Cells(4).Value = ListView1.FocusedItem.SubItems(4).Text '3
            DataGridView1.Rows.Item(index).Cells(5).Value = ListView1.FocusedItem.SubItems(5).Text '4
            DataGridView1.Rows.Item(index).Cells(6).Value = TxtJumlah_conte.Text '5
