Public Class Transaksi_Biaya_Lokal
    ...
    Private Sub Btn_Cari_Click(sender As Object, e As EventArgs) Handles Btn_Cari.Click
        ...
        Try
            ...
            '========================================
            SQL = "select top 1 Kode_Perusahaan from EMI_Pembelian_Loading_Detail where Kode_Perusahaan = '" & KodePerusahaan & "' and No_PO = '" & TxtNo_PO.Text & "' "
            Using Dr = OpenTrans(SQL)
                If Not Dr.Read Then
                    Dr.Close()
                    CloseTrans()
            ...
            For i As Integer = 0 To DataGridView1.Rows.Count - 1
                ...
                SQL = "insert into Transaksi_Biaya_Lokal_Detail (kode_perusahaan, No_faktur, No_PO, Kode_stock_Owner, Kode_Biaya, "
            ...
            For i As Integer = 0 To DataGridView3.Rows.Count - 1
                ...
                SQL = "insert into Detail_Transaksi_Biaya_Lokal_By_Perusahaan(kode_perusahaan, No_faktur, Kode_Perusahaan_Biaya_Import, Mata_Uang, Nilai) "
                SQL = SQL & "values( "
                SQL = SQL & "'" & KodePerusahaan & "', '" & Txt_NoFaktur.Text & "', "
                        ...
                        With Ds.Tables("MyTable")
                            For index2 As Integer = 0 To .Rows.Count - 1
                                ...
                                If General_Class.CekNULL(.Rows(index2).Item("flag_masuk_Jurnal")) = "Y" Then
                                    ...
                                    SQL = "insert into Detail_Transaksi_Biaya_Lokal2 (kode_perusahaan, No_faktur, Kode_Master_Kategori_Biaya_import, Nilai) "
                                    SQL = SQL & " values( "
                                    SQL = SQL & "'" & KodePerusahaan & "', '" & Txt_NoFaktur.Text & "', "
...
#Region "UPDATE HPP SATUAN DISPLAY"
            ...
            'GET TotBeratPerPO
            SQL = SQL & "ISNULL(( select sum(x.Berat * z.Jumlah_Masuk) from EMI_Pembelian_Loading_Detail z, barang x "
...
#End Region
    ...
    Private Sub Get_No_Faktur()
        Txt_NoFaktur.Text = TBiaya_Import & Format(tgl_skg, "MMyy") & "-" &
                             General_Class.Get_Last_Number2("Transaksi_Biaya_Lokal", "no_Faktur", 5,
