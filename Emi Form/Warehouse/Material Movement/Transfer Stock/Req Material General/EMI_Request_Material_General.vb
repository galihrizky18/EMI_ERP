...
Public Class EMI_Request_Material_General
    ...
    Private Sub Kosong()
        ...
        LvBarang.Columns.Add("Kode Barang", 250, HorizontalAlignment.Left)
        LvBarang.Columns.Add("Nama ", 0, HorizontalAlignment.Left)
        LvBarang.Columns.Add("Jumlah", 300, HorizontalAlignment.Right)
        LvBarang.Columns.Add("Satuan", 100, HorizontalAlignment.Center)
        LvBarang.Columns.Add("Keterangan", 500, HorizontalAlignment.Left)
        LvBarang.View = View.Details

        LvBrg.Columns.Clear() : LvBrg.Items.Clear()
        LvBrg.Columns.Add("Kode Barang", 200, HorizontalAlignment.Left)
        LvBrg.Columns.Add("Nama", 0, HorizontalAlignment.Left)
        LvBrg.Columns.Add("Jumlah Stock", 200, HorizontalAlignment.Right)
        LvBrg.Columns.Add("Satuan", 68, HorizontalAlignment.Center)
