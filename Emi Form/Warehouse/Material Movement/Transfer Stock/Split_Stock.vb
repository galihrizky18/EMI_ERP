...
Public Class Split_Stock
    ...
    Dim dgv_IsiPerBags, dgv_SatuanIsiBags, dgv_TglProd, dgv_TglExp, dgv_KetWarna, dgv_JumlahBagi, dgv_Count As String
    ...
    Dim dgv_detail_JumlahBagi, dgv_detail_Count As String
    ...
    Dim itemDGVJumlahBagi As Integer = 22
    Dim itemDGVCount As Integer = 23
    ...
    Dim itemDgvDetai_JumlahBagi As Integer = 16
    Dim itemDgvDetai_Count As Integer = 17
    ...
    Private Sub get_grid_view(ByVal index As Integer)
        ...
        dgv_JumlahBagi = DGV_Data_TF.Rows(index).Cells(itemDGVJumlahBagi).Value
        dgv_Count = DGV_Data_TF.Rows(index).Cells(itemDGVCount).Value
    End Sub
    ...
    Private Sub get_grid_view_Detail(ByVal index As Integer)
        ...
        dgv_detail_JumlahBagi = Dgv_DataDetail.Rows(index).Cells(itemDgvDetai_JumlahBagi).Value
        dgv_detail_Count = Dgv_DataDetail.Rows(index).Cells(itemDgvDetai_Count).Value
    End Sub
    ...
    Private Sub DGV_Data_TF_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles DGV_Data_TF.CellEndEdit
        ...
        If DGV_Data_TF.CurrentRow.Cells(itemDgvCheckBox).Value = "True" Then
            ...
            For i As Integer = 0 To DGV_Data_TF.Columns.Count - 1
                ...
                If i <> Val(itemDgvJumlah) AndAlso
                    i <> Val(itemDgvBags) AndAlso
                    i <> Val(itemDgvRakTujuan) AndAlso
                    i <> Val(itemDGVTglExp) AndAlso
                    i <> Val(itemDGVCount) AndAlso
                    i <> Val(itemDGVJumlahBagi) Then
            ...
            'Else
            If currentColumn = itemDGVJumlahBagi Then
                If Not DGV_Data_TF.CurrentRow.Cells(itemDGVJumlahBagi).Value = "" Then

                    Dim Stock As Double = DGV_Data_TF.CurrentRow.Cells(itemDgvGoodStock).Value
                    Dim JumlahBagi As Double = DGV_Data_TF.CurrentRow.Cells(itemDGVJumlahBagi).Value
                    DGV_Data_TF.CurrentRow.Cells(itemDGVCount).Value = Math.Floor(Stock / JumlahBagi).ToString

                    DGV_Data_TF.CurrentRow.Cells(itemDgvJumlah).Value = JumlahBagi * Math.Floor(Stock / JumlahBagi)
                Else
                    DGV_Data_TF.CurrentRow.Cells(itemDGVCount).Value = ""
                End If
            End If

            If currentColumn = itemDGVCount Then
                If Not DGV_Data_TF.CurrentRow.Cells(itemDGVCount).Value = "" Then

                    Dim count As Double = DGV_Data_TF.CurrentRow.Cells(itemDGVCount).Value
                    Dim JumlahBagi As Double = DGV_Data_TF.CurrentRow.Cells(itemDGVJumlahBagi).Value
                    DGV_Data_TF.CurrentRow.Cells(itemDgvJumlah).Value = JumlahBagi * count
                Else
                    DGV_Data_TF.CurrentRow.Cells(itemDGVCount).Value = ""
                End If
            End If
            ...
            DGV_Data_TF.CurrentRow.Cells(itemDGVJumlahBagi).ReadOnly = False
        ...
        Else
            ...
            DGV_Data_TF.CurrentRow.Cells(itemDGVJumlahBagi).ReadOnly = True
