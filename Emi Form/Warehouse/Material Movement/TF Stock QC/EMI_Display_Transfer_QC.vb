...
Public Class EMI_Display_Transfer_QC
    ...
    Dim GetDataKodeTransfer, GetDataLokasi, GetDataKdBrg, GetDataNmBrg, GetDataBrgSN, GetDataBeratBagi, GetDataSatuanKecil, GetDataUrutOto, GetDataCount, GetDataJumlahPotong, GetDataJumlahBesar As String
    ...
    Private Sub Popup_Timbang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Label1.Text = "Display - List Transfer Stock Quality Control"
    ...
    Private Sub Btn_TimbangFloorScale_Click(sender As Object, e As EventArgs) Handles Btn_TimbangFloorScale.Click
        ...
        Try
            ...
            SQL = SQL & "dbo.ubah_satuan(a.Kode_Perusahaan, 'masa', b.Kode_Barang, b.Satuan_Barang, b.Satuan, c.Total ) as Total_Besar "
            ...
            SQL = SQL & "and b.Flag_Timbang is null "
        ...
        '---------------------------------------------------------------
        EMI_Timbang_Floor_Scale_QC.kosong()
        ...
        EMI_Timbang_Floor_Scale_QC.txtKodeTransfer.Text = GetDataKodeTransfer
        EMI_Timbang_Floor_Scale_QC.txtUrutOto.Text = GetDataUrutOto
        EMI_Timbang_Floor_Scale_QC.txt_lokasi.Text = GetDataLokasi
        EMI_Timbang_Floor_Scale_QC.TxtKdBarang.Text = GetDataKdBrg
        EMI_Timbang_Floor_Scale_QC.txt_barang.Text = GetDataNmBrg
        EMI_Timbang_Floor_Scale_QC.txt_Barang_SN.Text = GetDataBrgSN

        EMI_Timbang_Floor_Scale_QC.txt_Jml_Estimasi.Text = GetDataJumlahBesar

        EMI_Timbang_Floor_Scale_QC.Txt_SatuanKecil.Text = GetDataSatuanKecil
        EMI_Timbang_Floor_Scale_QC.CmbJenisTimbang.SelectedItem = "TRANSFER STOCK"

        EMI_Timbang_Floor_Scale_QC.Btn_Refresh.Visible = False
        EMI_Timbang_Floor_Scale_QC.UNIX.Visible = False

        EMI_Timbang_Floor_Scale_QC.ShowDialog()
    End Sub
