...
Partial Class N_EMI_Transaksi_Pemusnahan_Barang_Barcode2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "List Pengajuan Pemusnahan Barang"
        '
        'Panel2
        '
        ...
        '
        'N_EMI_Transaksi_Pemusnahan_Barang_Barcode2
        '
        ...
        Me.Name = "N_EMI_Transaksi_Pemusnahan_Barang_Barcode2"
