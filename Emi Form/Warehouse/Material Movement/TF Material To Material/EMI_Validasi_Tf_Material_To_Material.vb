...
#End Region
            ...
            If BerhasilInput Then
                ...
                Using Dr = OpenTrans(SQL)
                    If Not Dr.Read Then
                        Dr.Close()
                        SQL = "update EMI_TF_Material_To_Material set Flag_Validasi = 'Y', Kode_Voucher = '" & Kode_voucher & "' where Kode_Perusahaan = '" & KodePerusahaan & "' and Kode_Transfer = '" & Kode_Transfer & "'"
                        ExecuteTrans(SQL)
                    End If
                End Using
            End If
