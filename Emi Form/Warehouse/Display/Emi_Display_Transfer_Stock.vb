...
Public Class Emi_Display_Transfer_Stock
    ...
    Private Sub Intial_ListView_Stock()
        ...
        LvwAwal.Columns.Add("No Pallet", 120, HorizontalAlignment.Center)
        LvwAwal.Columns.Add("Qr Code", 300, HorizontalAlignment.Left)
        ...
        LvwAkhir.Columns.Add("No Pallet", 100, HorizontalAlignment.Center)
        LvwAkhir.Columns.Add("Serial Number", 300, HorizontalAlignment.Left)
    ...
    Private Sub Lv_Stock_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Lv_Stock.SelectedIndexChanged
        ...
        Try
            ...
            SQL = SQL & "and a.kode_perusahaan = '" & KodePerusahaan & "' and a.No_Faktur = '" & Lv_Stock.FocusedItem.Text & "' "
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    Dim lv As New ListViewItem
