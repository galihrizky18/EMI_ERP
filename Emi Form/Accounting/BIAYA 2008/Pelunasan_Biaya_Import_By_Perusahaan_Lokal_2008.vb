Public Class Pelunasan_Biaya_Import_By_Perusahaan_Lokal_2008
    Dim JT As String
    ...
    Dim CellTotal As Integer = 9
    Dim CellPersenPPN As Integer = 10
    Dim CellPersenPPH As Integer = 11
    Dim CellNilaiPPN As Integer = 12
    Dim CellNilaiPPH As Integer = 13
    Dim CellLokasi As Integer = 14
    Dim CellJns As Integer = 15
    ...
    Private Sub Get_Isi_Listview(ByVal No_Index As Integer)
        ...
        LvTgl = ListViewMT11.Items(No_Index).SubItems(CellTgl).Text
    ...
    Private Sub Cari(ByVal param As String)
        ...
        Try
            ...
            SQL = SQL & "a.lokasi, a.kode_perusahaan_biaya_import, a.Perusahaan, a.Kode_Kategori_Biaya_Import, a.kategori, "
            SQL = SQL & "a.Kode_Master_Kategori_Biaya_Import, a.master, a.mata_uang, a.Biaya, a.sudah_bayar, a.Jenis, a.PPN, a.PPH, a.jenis_form, a.flag_lunas, a.keterangan, a.jenis_form "
            SQL = SQL & "from View_Detail_Transaksi_Biaya_import a where flag_lunas is null "
            If param = "Tidak1" Then
                SQL = SQL & " and Mata_Uang = '" & ComboBoxMT1.Text & "' and a.Jenis='LOKAL' "
            ...
            Using Dr = OpenTrans(SQL)
                Do While Dr.Read
                    ...
                    lv.SubItems.Add(Dr("Kode_Kategori_Biaya_Import")) '6
                    lv.SubItems.Add(Dr("kategori")) '7
                    ...
                    lv.SubItems.Add(Format(Val(HilangkanTanda(Format(x_tot, "N2"))) - Val(HilangkanTanda(Format(Dr("sudah_bayar"), "N2"))), "N2"))
    ...
    Public Sub Hitung()
        ...
        TextBoxGrand.Text = (Format((Total + Tambahan) + TotalPPN - TotalPPH, "N0"))

    End Sub

    Private Sub Get_No_Faktur()
        TxtFaktur.Text = fValPelBI & Format(DateTimePicker1.Value, "MMyy") & "-" & _
                             General_Class.Get_Last_Number2("Val_Pel_Biaya_import_by_Perusahaan_Lokal", "no_val", 5, _
    ...
    Private Sub Get_No_Faktur_Pengajuan()
        Dim fNB = "NB"
        no_fakturPengajuan = fNB & Format(DateTimePicker1.Value, "MMyy") & "-" & _
                             General_Class.Get_Last_Number2("Pengajuan", "No_Pengajuan", 5, _
                             "Kode_perusahaan", KodePerusahaan, _
                             "And", "substring(No_Pengajuan, 1, " & Len(fNB) + 4 & ")", fNB & Format(DateTimePicker1.Value, "MMyy"))
    End Sub
    Private Sub Get_No_Faktur_Token()
        Dim fNB = "NT"
        no_fakturToken = fNB & Format(DateTimePicker1.Value, "MMyy") & "-" & _
                             General_Class.Get_Last_Number2("Pengajuan_token", "No_Pengajuan", 5, _
                             "Kode_perusahaan", KodePerusahaan, _
                             "And", "substring(No_Pengajuan, 1, " & Len(fNB) + 4 & ")", fNB & Format(DateTimePicker1.Value, "MMyy"))
    End Sub
    ...
    Private Sub Validasi_Pembelian_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ListViewMT11.Columns.Add("No Faktur", 120, HorizontalAlignment.Left)
        ListViewMT11.Columns.Add("No PO", 0, HorizontalAlignment.Center)
        ListViewMT11.Columns.Add("Kode Perusahaan", 0, HorizontalAlignment.Left)
        ListViewMT11.Columns.Add("Nama Perusahaan", 180, HorizontalAlignment.Left)
        ListViewMT11.Columns.Add("Kode Kategori", 0, HorizontalAlignment.Left)
        ListViewMT11.Columns.Add("Kategori Perusahaan", 180, HorizontalAlignment.Left)
        ListViewMT11.Columns.Add("Mata Uang", 80, HorizontalAlignment.Center)
        ListViewMT11.Columns.Add("Jumlah", 130, HorizontalAlignment.Right)
        ListViewMT11.Columns.Add("Nilai Tambahan", 130, HorizontalAlignment.Right)
        ListViewMT11.Columns.Add("Total", 130, HorizontalAlignment.Right)
        ListViewMT11.Columns.Add("PPN", 0, HorizontalAlignment.Right)
        ListViewMT11.Columns.Add("PPH", 0, HorizontalAlignment.Right)
        ListViewMT11.Columns.Add("Nilai PPN", 90, HorizontalAlignment.Right)
        ListViewMT11.Columns.Add("Nilai PPH", 90, HorizontalAlignment.Right)
        ListViewMT11.Columns.Add("Lokasi", 100, HorizontalAlignment.Left).DisplayIndex = 1
        ListViewMT11.Columns.Add("Jenis Form", 0, HorizontalAlignment.Right)
        ...
        ListViewMT1.Columns.Add("Keterangan", 140, HorizontalAlignment.Left) '2
        ListViewMT1.Columns.Add("No PO", 0, HorizontalAlignment.Center) '3
        ListViewMT1.Columns.Add("Kode Perusahaan", 0, HorizontalAlignment.Left) '4
        ListViewMT1.Columns.Add("Nama Perusahaan", 170, HorizontalAlignment.Left) '5
        ListViewMT1.Columns.Add("Kode Kategori", 0, HorizontalAlignment.Left) '6
        ListViewMT1.Columns.Add("Kategori", 160, HorizontalAlignment.Left) '7
        ListViewMT1.Columns.Add("Mata Uang", 80, HorizontalAlignment.Center) '8
        ListViewMT1.Columns.Add("Total", 100, HorizontalAlignment.Right) '9
        ListViewMT1.Columns.Add("Dibayar", 100, HorizontalAlignment.Right) '10
        ListViewMT1.Columns.Add("PPN", 0, HorizontalAlignment.Right) '11
        ListViewMT1.Columns.Add("PPH", 0, HorizontalAlignment.Right) '12
        ListViewMT1.Columns.Add("Lokasi", 100, HorizontalAlignment.Left).DisplayIndex = 1 '12
        ListViewMT1.Columns.Add("Jenis Form", 0, HorizontalAlignment.Right)
        ListViewMT1.Columns.Add("Sisa", 100, HorizontalAlignment.Right)
        ...
        ListView3.Location = New Point(670, 86)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Button1.Text = "&Simpan" Then
            ...
            Try
                ...
                SQL = SQL & "Kode_Bank_Tujuan, No_Rek_Tujuan, Nama_Penerima, Alamat_Penerima, Kota_Penerima, Negara_Penerima, Telp_Penerima)"
                ...
                SQL = SQL & "'" & HilangkanTanda(TextBoxGrand.Text) & "', '" & ComboBox3.Text & "', '" & TextBox10.Text & "', '" & TextBox7.Text & "', "
                SQL = SQL & "'" & x_alamat & "', '" & x_Kota & "', '" & x_negara & "', '" & x_telp & "')"
                ExecuteTrans(SQL)
                ...
                For i As Integer = 0 To ListViewMT11.Items.Count - 1
                    ...
                    SQL = SQL & "Kode_Perusahaan_biaya_import = '" & LvKP & "' and Mata_Uang = '" & LvMT & "' and Kode_Kategori_Biaya_Import ='" & LvKdKategori & "' and lokasi='" & LvLokasi & "' "
                    Using Dr = OpenTrans(SQL)
                        If Dr.Read Then
                    ...
                    If SisaHutang = Val(HilangkanTanda(LvJml)) Then
                        ...
                        If Dari = "1" Then
                            SQL = "Update detail_transaksi_Biaya_Import set flag_lunas = 'Y', "
                            ...
                            SQL = SQL & "and Kode_Kategori_Biaya_Import ='" & LvKdKategori & "' "
                            ExecuteTrans(SQL)
                        ElseIf Dari = "2" Then
                            SQL = "Update detail_transaksi_Biaya_Import set flag_lunas = 'Y', "
                            SQL = SQL & "Tgl_lunas = '" & Format(DateTimePicker1.Value, "yyyy-MM-dd") & "', "
                    ...
                    SQL = SQL & "Persen_PPN, Persen_PPH, Nilai_PPN, Nilai_PPH, Kode_kategori_biaya_import, Kode_stock_Owner,Tambahan, Total_Tambahan, Subtotal, Jenis_Form) "
                    ...
                    SQL = SQL & "'" & LvLokasi & "', " & HilangkanTanda(LvTambahan) & ", " & HilangkanTanda(LvTotal) & ", " & Val(HilangkanTanda(LvTotal)) + Val(HilangkanTanda(LvNilaiPPN)) - Val(HilangkanTanda(LvNilaiPPH)) & ", '" & Dari & "') "
                    ExecuteTrans(SQL)
                    ...
                    SQL = "select top(1) inisial_faktur, ppn_pembelian, Akun_PPH23, Akun_PPH21, Lokasi_default_PPH, Akun_Biaya_Import from stock_owner where Kode_Stock_Owner='" & LvLokasi & "'"
                    Using Dr = OpenTrans(SQL)
                        If Dr.Read Then
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListViewMT11.DoubleClick
        ...
        Try
            ...
            SQL = SQL & "Kode_Perusahaan_Biaya_Import='" & LvKP & "' and kode_kategori_biaya_import='" & LvKdKategori & "' and mata_uang='" & LvMT & "' and UserID='" & UserID & "' and Lokasi='" & LvLokasi & "' "
            ExecuteTrans(SQL)
    ...
    Private Sub ListViewMT1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListViewMT1.DoubleClick
        ...
        For i As Integer = 0 To ListViewMT11.Items.Count - 1
            ...
            If ListViewMT11.Items(i).SubItems(CellFak).Text.Trim.ToUpper = ListViewMT1.FocusedItem.SubItems(CellFakMU).Text.Trim.ToUpper And _
            ListViewMT11.Items(i).SubItems(CellKP).Text.Trim.ToUpper = ListViewMT1.FocusedItem.SubItems(CellKdPerusahaanBiayaImportMU).Text.Trim.ToUpper And _
            ListViewMT11.Items(i).SubItems(CellKdKategori).Text.Trim.ToUpper = ListViewMT1.FocusedItem.SubItems(CellKdKategoriMU).Text.Trim.ToUpper And _
            ListViewMT11.Items(i).SubItems(CellLokasi).Text.Trim.ToUpper = ListViewMT1.FocusedItem.SubItems(CellLokasiU).Text.Trim.ToUpper And _
    ...
    Private Sub ComboBoxBank1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ComboBoxBank1.SelectedIndexChanged
        ...
        Try
            ...
            ComboBoxRek1.Items.Clear() : ArrAkunRek1.Clear()
            ...
            Using dr = OpenTrans(SQL)
                Do While dr.Read
                    ComboBoxRek1.Items.Add(dr("no_rek")) : ArrAkunRek1.Add(dr("Kode_Akun"))
                Loop
            End Using
    ...
    Private Sub ListViewMT11_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListViewMT11.SelectedIndexChanged
