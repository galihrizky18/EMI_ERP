Public Class Display_Emi_Pelunasan_Hutang
    ...
    Private Sub Laporan_Bahan_Tidak_Potong_Stock_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        LvHutangBiaya.Columns.Add("Jatuh Tempo", 120, HorizontalAlignment.Center) '15
        LvHutangBiaya.Columns.Add("Jenis", 150, HorizontalAlignment.Left) '16
    ...
    Private Sub GetData(ByVal Optional Filter As Boolean = False)
        ...
        Try
            ...
            SQL = SQL & "a.Mata_uang, a.Nilai as TotalHutang, a.PPN, a.PPH, a.sudah_bayar, a.lokasi, a.Tgl_jatuh_Tempo, a.Jenis1 "
            SQL = SQL & "from View_EMI_Pelunasan a "
            SQL = SQL & "where a.kode_Perusahaan = '" & KodePerusahaan & "' "
            SQL = SQL & "and a.flag_lunas is null "
