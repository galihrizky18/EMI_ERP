    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            If Cmb_FlagBudget.SelectedIndex = 0 Then 'Y
                ...
                nilai_budget_bulanan = Txt_N_BudgetBulanan.Text
            Else 'T
    ...
    Private Sub Btn_Hapus_Click(sender As Object, e As EventArgs) Handles Btn_Hapus.Click
        ...
        Try
            ...
            If Hapus1 = vbYes Then
                ...
                SQL = "Select top 1 * from Detail_jurnal where kode_perusahaan = '" & KodePerusahaan & "' and kode_master_acc = '" & Trim(valueKodeAccount(0)) & "' and kode_acc + kode_detail_acc = '" & Txt_KodeDetailAccount.Text & "'"
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        Dr.Close()
                ...
                '======================================
                '=     CEK APAKAH ADA COST CENTER     =
                '======================================
                SQL = "select Kode_Perusahaan from Account_Per_Cost_Center where Kode_Perusahaan = '" & KodePerusahaan & "' and Kode_Account = '" & valueKodeAccount(0).Trim & Txt_KodeDetailAccount.Text.Trim & "'"
                ...
                SQL = "Delete From Detail_Account where kode_perusahaan = '" & KodePerusahaan & "' and kode_master_acc = '" & valueKodeAccount(0).Trim & "' "
                SQL = SQL & "and kode_acc = '" & Strings.Left(Txt_KodeDetailAccount.Text.Trim, 1) & "' and kode_detail_acc = '" & Strings.Mid(Txt_KodeDetailAccount.Text.Trim, 2) & "'"
                ExecuteTrans(SQL)
            ...
            CloseTrans()
            CloseConn()
            MessageBox.Show("Data Berhasil Di Hapus", "Accounting", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
        Catch ex As Exception
            CloseTrans()
            CloseConn()
            MessageBox.Show(ex.Message)
            ...
            Using Dr = OpenTrans(SQL)
                If Dr.Read Then
                    ...
                    If Dr("pakai_budget") = "Y" Then
                        Txt_BudgetHarian.Text = Dr("lama_budget_harian") : Txt_N_BudgetHarian.Text = Dr("budget_harian")
                        Txt_BudgetBulanan.Text = Dr("lama_budget_bulanan") : Txt_N_BudgetBulanan.Text = Dr("budget_bulanan")
