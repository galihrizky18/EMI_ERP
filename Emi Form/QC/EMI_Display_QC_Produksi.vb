Public Class EMI_Display_QC_Produksi
    ...
    Private Sub TxtQRCode_KeyDown(sender As Object, e As KeyEventArgs) Handles TxtQRCode.KeyDown
    ...
    Private Sub Txt_Filter_Value_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TxtQRCode.KeyPress
    ...
    Private Sub Initial_Lv()
        ...
        Lv_Data.Columns.Add("Urut", 5, HorizontalAlignment.Left)
