...
Public Class EMI_Display_QC_Produksi
    ...
    Private Sub Get_Isi_ListView(ByVal NoIndex As Integer)
        ...
        LvKdBrg = ListView1.Items(NoIndex).SubItems(8).Text
        LvKSO = ListView1.Items(NoIndex).SubItems(9).Text
    End Sub
    ...
    Private Sub isi_lv()
        Try
            ...
            SQL = "select a.No_Transaksi,a.Tgl_Produksi,a.kode_stock_owner,a.kode_barang,a.Jam_Produksi,c.Nama,a.Jumlah,d.Keterangan,d.Id_Routing,a.No_PO "
            ...
            SQL = SQL & "and a.Kode_Perusahaan = d.Kode_Perusahaan and a.Flag_Produksi = 'Y' and a.flag_hasil_produksi = 'Y' "
            SQL = SQL & "and a.flag_qc is null "
    ...
    Private Sub kosong3()
        ...
        Try
            ...
            Label1.Text = Base_Language.Lang_Display_Production_Order_Judul & " (Finish Good)"
    ...
    Private Sub Btn_Cari_Click(sender As Object, e As EventArgs) Handles Btn_Cari.Click
        ...
        '    'SQL = SQL & "isnull((select coun(Qty_Hasil_Produksi) from Emi_Production_Results z where z.No_Production_Order = a.No_Transaksi "
        '    'SQL = SQL & "and a.Kode_Perusahaan = z.Kode_Perusahaan),0) as jumlah_produksi,"
        '    'SQL = SQL & "isnull((select coun(Qty_Good_Stock) from Emi_Production_Results z where z.No_Production_Order = a.No_Transaksi "
    ...
    Private Sub ListView1_DoubleClick(sender As Object, e As EventArgs) Handles ListView1.DoubleClick
        ...
        EMI_Transaksi_QC_Finish_Good.TxtNoProduksi.Text = LvNo_Faktur
        EMI_Transaksi_QC_Finish_Good.TxtNamaBarang.Text = LvNm_Barang
        EMI_Transaksi_QC_Finish_Good.TxtKdBarang.Text = LvKdBrg
        EMI_Transaksi_QC_Finish_Good.txtKso.Text = LvKSO
    ...
    Private Sub SelesaiToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelesaiToolStripMenuItem.Click
        ...
        Try
            ...
            SQL = "update Emi_Split_Production_Order set Flag_QC = 'Y' where kode_perusahaan = '" & KodePerusahaan & "' and no_transaksi = '" & LvNo_Faktur & "' "
            ExecuteTrans(SQL)
