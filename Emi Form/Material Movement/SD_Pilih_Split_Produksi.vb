...
Public Class SD_Pilih_Split_Produksi
    ...
    Private Sub get_data_formula()
        Try
            ...
            SQL = SQL & "and c.Flag_Selesai_Produksi is null and c.Selesai is null and c.Flag_Release = 'Y' and a.Flag_Produksi is null "
