...
Public Class EMI_Timbang_Floor_Scale_QC
    ...
    Private Sub Transaksi_Timbang_Unloading_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Lbl_Judul.Text = "Transaksi - Floor Scale Quality Control"
    ...
    Private Sub Btn_Simpan_Click(sender As Object, e As EventArgs) Handles Btn_Simpan.Click
        ...
        Try
            ...
            ElseIf CmbJenisTimbang.Text.Trim.ToUpper = "TRANSFER STOCK" Then
                ...
                SQL = "select a.Status, c.selesai, c.Id_Wms_Tujuan, c.No_Pallet_Tujuan, c.Jumlah_Bags, a.SO_Tujuan  "
                ...
                SQL = SQL & "('" & KodePerusahaan & "', '" & txtKodeTransfer.Text & "', '" & txtUrutOto.Text & "', '" & noPalletTujaun & "', '" & SN_Baru & "', "
        ...
        ElseIf CmbJenisTimbang.Text.Trim.ToUpper = "TRANSFER STOCK" Then
            cetaktransfer()
            EMI_Display_Transfer_QC.kosong()
            Me.Close()
        End If
    ...
    Private Sub cetaktransfer()
        Try
            ...
            If CmbJenisTimbang.Text.Trim.ToUpper = "TRANSFER STOCK" Then
                ...
                SQL = SQL + "where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & txtKodeTransfer.Text & "' and Selesai is null"
                Using Dr = OpenTrans(SQL)
                    If Dr.Read Then
                        CloseConn()
                        kosong()
                ...
                SQL = "select Kode_Perusahaan from Vw_Tf_Stock_Detail_QC where Kode_Perusahaan = '" & KodePerusahaan & "' and No_Faktur = '" & txtKodeTransfer.Text & "'"
                Using Ds = BindingTrans(SQL)
                    If Ds.Tables("MyTable").Rows.Count <> 0 Then
                        ...
                        With A_Place_For_Printing2
                            ...
                            CrDoc.SetDatabaseLogon(CUserId, CPassword, CServer, CDatabase)
                            CrDoc.PrintOptions.PrinterName = ""
                            CrDoc.RecordSelectionFormula = "{Vw_Tf_Stock_Detail_QC.Kode_Perusahaan} = '" & KodePerusahaan & "' and {Vw_Tf_Stock_Detail_QC.No_Faktur}='" & txtKodeTransfer.Text & "' "
                        ...
                        'CrDoc.RecordSelectionFormula = "{Vw_Tf_Stock_Detail_QC.Kode_Perusahaan} = '" & KodePerusahaan & "' and {Vw_Tf_Stock_Detail_QC.No_Faktur}='" & txtKodeTransfer.Text & "' and {Tf_Stock_det.Urut_Oto} =" & txtUrutOto.Text & " "
