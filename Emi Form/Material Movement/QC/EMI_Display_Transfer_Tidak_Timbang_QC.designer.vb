...
Partial Class EMI_Display_Transfer_Tidak_Timbang_QC
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "List Transfer Stock Quality Control ( Tidak Timbang)"
        '
        'Panel2
        '
        ...
        '
        'EMI_Display_Transfer_Tidak_Timbang_QC
        '
        ...
        Me.Name = "EMI_Display_Transfer_Tidak_Timbang_QC"
