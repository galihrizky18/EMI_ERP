...
Public Class Emi_Split_Stock_QC
    ...
    Dim dgv_IsiPerBags, dgv_SatuanIsiBags, dgv_TglProd, dgv_TglExp, dgv_KetWarna, dgv_jmlhBagi, dgv_hslBagi As String
    ...
    Dim dgv_detail_Warna, dgv_detail_JenisKemasan, dgv_detail_TglProduksi, dgv_detail_TglExpired, dgv_detail_JenisKualitas, dgv_detail_Pembagi, dgv_detail_HasilBagi As String
    ...
    Public Sub kosong()
        ...
        Try
            ...
            DGV_Data_TF.Columns(itemDGVJmlhBagi).DisplayIndex = 17
    ...
    Private Sub DGV_Data_TF_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles DGV_Data_TF.CellEndEdit
        ...
        If DGV_Data_TF.CurrentRow.Cells(itemDgvCheckBox).Value = "True" Then
            ...
            For i As Integer = 0 To DGV_Data_TF.Columns.Count - 1
                ...
                If i <> Val(itemDgvJumlah) AndAlso i <> Val(itemDgvBags) AndAlso i <> Val(itemDgvRakTujuan) AndAlso i <> Val(itemDGVTglExp) Then
